...
final class PackageComposerJsonMergerTest extends \Symplify\MonorepoBuilder\Merge\Tests\Package\AbstractMergeTestCase
{
    public function test() : void
    {
        ...
        $expectedComposerJson = $this->createComposerJson(__DIR__ . '/PackageComposerJsonMergerSource/expected-with-relative-paths.json');

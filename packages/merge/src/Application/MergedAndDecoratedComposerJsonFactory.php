...
final class MergedAndDecoratedComposerJsonFactory
{
     ...
     */
    public function createFromRootConfigAndPackageFileInfos(\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $mainComposerJson, array $packageFileInfos) : void
    {
     ...
     * @param SmartFileInfo[] $packageFileInfos
     */
    private function mergePackageFileInfosAndDecorate(array $packageFileInfos) : \Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {

...
abstract class AbstractComposerKeyMerger
{
     ...
     * @required
     */
    public function autowireAbstractComposerKeyMerger(\Symplify\PackageBuilder\Yaml\ParametersMerger $parametersMerger, \Symplify\MonorepoBuilder\Merge\Arrays\ArraySorter $arraySorter) : void
    {

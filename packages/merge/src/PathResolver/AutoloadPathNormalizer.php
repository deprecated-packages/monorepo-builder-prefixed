...
final class AutoloadPathNormalizer
{
     ...
     */
    public function normalizeAutoloadPaths(\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $packageComposerJson, \Symplify\SmartFileSystem\SmartFileInfo $packageFile) : void
    {
     ...
     * @return mixed[]
     */
    private function normalizeAutoloadArray(\Symplify\SmartFileSystem\SmartFileInfo $packageFile, array $autoloadArray) : array
    {
     ...
     * @return mixed[]
     */
    private function relativizePath(array $autoloadSubsection, \Symplify\SmartFileSystem\SmartFileInfo $packageFileInfo) : array
    {
    ...
    private function relativizeSinglePath(string $packageRelativeDirectory, string $path) : string
    {
        ...
        if (\_PhpScoper9ca278c9ad44\Nette\Utils\Strings::startsWith($path, 'vendor/')) {
            return $path;
        }

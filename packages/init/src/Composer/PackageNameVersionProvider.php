...
use _PhpScoper8b183f8218dc\Jean85\PrettyVersions;
use _PhpScoper8b183f8218dc\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoper8b183f8218dc\PharIo\Version\InvalidVersionException;
...
final class PackageNameVersionProvider
{
    ...
    public function provide(string $packageName) : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoper8b183f8218dc\Jean85\PrettyVersions::getVersion($packageName)->getPrettyVersion();
            $version = new \_PhpScoper8b183f8218dc\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoper8b183f8218dc\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractFromComposer(string $packageName) : ?\_PhpScoper8b183f8218dc\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoper8b183f8218dc\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === $packageName) {
                    return new \_PhpScoper8b183f8218dc\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

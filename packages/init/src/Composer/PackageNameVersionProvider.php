...
use _PhpScoper345e6b5f632f\Jean85\PrettyVersions;
use _PhpScoper345e6b5f632f\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoper345e6b5f632f\PharIo\Version\InvalidVersionException;
use _PhpScoper345e6b5f632f\PharIo\Version\Version;
...
final class PackageNameVersionProvider
{
    ...
    public function provide(string $packageName) : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoper345e6b5f632f\Jean85\PrettyVersions::getVersion($packageName)->getPrettyVersion();
            $version = new \_PhpScoper345e6b5f632f\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoper345e6b5f632f\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractFromComposer(string $packageName) : ?\_PhpScoper345e6b5f632f\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoper345e6b5f632f\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === $packageName) {
                    return new \_PhpScoper345e6b5f632f\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

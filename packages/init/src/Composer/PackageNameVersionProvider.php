...
use _PhpScoper912e6d747d7e\Jean85\PrettyVersions;
use _PhpScoper912e6d747d7e\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoper912e6d747d7e\PharIo\Version\InvalidVersionException;
...
final class PackageNameVersionProvider
{
    ...
    public function provide(string $packageName) : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoper912e6d747d7e\Jean85\PrettyVersions::getVersion($packageName)->getPrettyVersion();
            $version = new \_PhpScoper912e6d747d7e\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoper912e6d747d7e\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractFromComposer(string $packageName) : ?\_PhpScoper912e6d747d7e\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoper912e6d747d7e\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === $packageName) {
                    return new \_PhpScoper912e6d747d7e\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

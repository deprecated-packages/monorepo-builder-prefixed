...
use _PhpScoper9aac61c94bdb\Jean85\PrettyVersions;
use _PhpScoper9aac61c94bdb\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoper9aac61c94bdb\PharIo\Version\InvalidVersionException;
...
final class PackageNameVersionProvider
{
    ...
    public function provide(string $packageName) : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoper9aac61c94bdb\Jean85\PrettyVersions::getVersion($packageName)->getPrettyVersion();
            $version = new \_PhpScoper9aac61c94bdb\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoper9aac61c94bdb\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractFromComposer(string $packageName) : ?\_PhpScoper9aac61c94bdb\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoper9aac61c94bdb\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === $packageName) {
                    return new \_PhpScoper9aac61c94bdb\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

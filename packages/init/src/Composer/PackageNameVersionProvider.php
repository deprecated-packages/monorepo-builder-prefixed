...
use _PhpScoper56e9de378e59\Jean85\PrettyVersions;
use _PhpScoper56e9de378e59\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoper56e9de378e59\PharIo\Version\InvalidVersionException;
...
final class PackageNameVersionProvider
{
    ...
    public function provide(string $packageName) : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoper56e9de378e59\Jean85\PrettyVersions::getVersion($packageName)->getPrettyVersion();
            $version = new \_PhpScoper56e9de378e59\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoper56e9de378e59\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractFromComposer(string $packageName) : ?\_PhpScoper56e9de378e59\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoper56e9de378e59\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === $packageName) {
                    return new \_PhpScoper56e9de378e59\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

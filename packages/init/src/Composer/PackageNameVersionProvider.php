...
use _PhpScoperee3ad0c2c096\Jean85\PrettyVersions;
use _PhpScoperee3ad0c2c096\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoperee3ad0c2c096\PharIo\Version\InvalidVersionException;
...
final class PackageNameVersionProvider
{
    ...
    public function provide(string $packageName) : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoperee3ad0c2c096\Jean85\PrettyVersions::getVersion($packageName)->getPrettyVersion();
            $version = new \_PhpScoperee3ad0c2c096\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoperee3ad0c2c096\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractFromComposer(string $packageName) : ?\_PhpScoperee3ad0c2c096\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoperee3ad0c2c096\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === $packageName) {
                    return new \_PhpScoperee3ad0c2c096\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

...
use _PhpScoperf4997c409394\Jean85\PrettyVersions;
use _PhpScoperf4997c409394\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoperf4997c409394\PharIo\Version\InvalidVersionException;
use _PhpScoperf4997c409394\PharIo\Version\Version;
...
final class PackageNameVersionProvider
{
    ...
    public function provide(string $packageName) : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoperf4997c409394\Jean85\PrettyVersions::getVersion($packageName)->getPrettyVersion();
            $version = new \_PhpScoperf4997c409394\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoperf4997c409394\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractFromComposer(string $packageName) : ?\_PhpScoperf4997c409394\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoperf4997c409394\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === $packageName) {
                    return new \_PhpScoperf4997c409394\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

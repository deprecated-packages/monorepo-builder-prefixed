...
use _PhpScoper31b05558ad5c\Jean85\PrettyVersions;
use _PhpScoper31b05558ad5c\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoper31b05558ad5c\PharIo\Version\InvalidVersionException;
...
final class InitCommand extends \_PhpScoper31b05558ad5c\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScoper31b05558ad5c\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        parent::__construct();
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::OUTPUT, \_PhpScoper31b05558ad5c\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Directory to generate monorepo into.', \getcwd());
    }
    ...
    private function getMonorepoBuilderVersion() : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoper31b05558ad5c\Jean85\PrettyVersions::getVersion('symplify/monorepo-builder')->getPrettyVersion();
            $version = new \_PhpScoper31b05558ad5c\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoper31b05558ad5c\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractMonorepoBuilderVersionFromComposer() : ?\_PhpScoper31b05558ad5c\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoper31b05558ad5c\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === 'symplify/monorepo-builder') {
                    return new \_PhpScoper31b05558ad5c\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

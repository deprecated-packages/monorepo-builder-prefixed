...
use _PhpScoper8889bf9b056f\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoper8889bf9b056f\PharIo\Version\InvalidVersionException;
use _PhpScoper8889bf9b056f\PharIo\Version\Version;
use _PhpScoper8889bf9b056f\Symfony\Component\Console\Command\Command;
use _PhpScoper8889bf9b056f\Symfony\Component\Console\Input\InputArgument;
...
final class InitCommand extends \_PhpScoper8889bf9b056f\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScoper8889bf9b056f\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        parent::__construct();
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::OUTPUT, \_PhpScoper8889bf9b056f\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Directory to generate monorepo into.', \getcwd());
    }
    ...
    private function getMonorepoBuilderVersion() : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoper8889bf9b056f\Jean85\PrettyVersions::getVersion('symplify/monorepo-builder')->getPrettyVersion();
            $version = new \_PhpScoper8889bf9b056f\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoper8889bf9b056f\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractMonorepoBuilderVersionFromComposer() : ?\_PhpScoper8889bf9b056f\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoper8889bf9b056f\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === 'symplify/monorepo-builder') {
                    return new \_PhpScoper8889bf9b056f\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

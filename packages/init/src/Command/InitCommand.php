...
use _PhpScoperc4f03b8b365d\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoperc4f03b8b365d\PharIo\Version\InvalidVersionException;
use _PhpScoperc4f03b8b365d\PharIo\Version\Version;
use _PhpScoperc4f03b8b365d\Symfony\Component\Console\Command\Command;
use _PhpScoperc4f03b8b365d\Symfony\Component\Console\Input\InputArgument;
...
use _PhpScoperc4f03b8b365d\Symfony\Component\Console\Style\SymfonyStyle;
use Symplify\MonorepoBuilder\ValueObject\File;
use Symplify\PackageBuilder\Console\Command\CommandNaming;
use Symplify\PackageBuilder\Console\ShellCode;
use Symplify\SmartFileSystem\SmartFileSystem;
use function dirname;
final class InitCommand extends \_PhpScoperc4f03b8b365d\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScoperc4f03b8b365d\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        parent::__construct();
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::OUTPUT, \_PhpScoperc4f03b8b365d\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Directory to generate monorepo into.', \getcwd());
    }
    protected function execute(\_PhpScoperc4f03b8b365d\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoperc4f03b8b365d\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        /** @var string $output */
    ...
    private function getMonorepoBuilderVersion() : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoperc4f03b8b365d\Jean85\PrettyVersions::getVersion('symplify/monorepo-builder')->getPrettyVersion();
            $version = new \_PhpScoperc4f03b8b365d\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoperc4f03b8b365d\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractMonorepoBuilderVersionFromComposer() : ?\_PhpScoperc4f03b8b365d\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoperc4f03b8b365d\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === 'symplify/monorepo-builder') {
                    return new \_PhpScoperc4f03b8b365d\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

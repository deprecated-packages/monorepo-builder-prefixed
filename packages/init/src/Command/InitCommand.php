...
use _PhpScoper5efd9ec7ae1e\Jean85\PrettyVersions;
use _PhpScoper5efd9ec7ae1e\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoper5efd9ec7ae1e\PharIo\Version\InvalidVersionException;
use _PhpScoper5efd9ec7ae1e\PharIo\Version\Version;
...
final class InitCommand extends \_PhpScoper5efd9ec7ae1e\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScoper5efd9ec7ae1e\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        parent::__construct();
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::OUTPUT, \_PhpScoper5efd9ec7ae1e\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Directory to generate monorepo into.', \getcwd());
    }
    ...
    private function getMonorepoBuilderVersion() : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoper5efd9ec7ae1e\Jean85\PrettyVersions::getVersion('symplify/monorepo-builder')->getPrettyVersion();
            $version = new \_PhpScoper5efd9ec7ae1e\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoper5efd9ec7ae1e\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractMonorepoBuilderVersionFromComposer() : ?\_PhpScoper5efd9ec7ae1e\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoper5efd9ec7ae1e\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === 'symplify/monorepo-builder') {
                    return new \_PhpScoper5efd9ec7ae1e\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

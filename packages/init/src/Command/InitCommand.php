...
use _PhpScoperf0acd9a8c4f5\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScoperf0acd9a8c4f5\PharIo\Version\InvalidVersionException;
use _PhpScoperf0acd9a8c4f5\PharIo\Version\Version;
use _PhpScoperf0acd9a8c4f5\Symfony\Component\Console\Command\Command;
use _PhpScoperf0acd9a8c4f5\Symfony\Component\Console\Input\InputArgument;
...
use _PhpScoperf0acd9a8c4f5\Symfony\Component\Console\Style\SymfonyStyle;
use Symplify\MonorepoBuilder\ValueObject\File;
use Symplify\PackageBuilder\Console\Command\CommandNaming;
use Symplify\PackageBuilder\Console\ShellCode;
use Symplify\SmartFileSystem\SmartFileSystem;
use function dirname;
final class InitCommand extends \_PhpScoperf0acd9a8c4f5\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScoperf0acd9a8c4f5\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        parent::__construct();
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::OUTPUT, \_PhpScoperf0acd9a8c4f5\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Directory to generate monorepo into.', \getcwd());
    }
    protected function execute(\_PhpScoperf0acd9a8c4f5\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoperf0acd9a8c4f5\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        /** @var string $output */
    ...
    private function getMonorepoBuilderVersion() : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScoperf0acd9a8c4f5\Jean85\PrettyVersions::getVersion('symplify/monorepo-builder')->getPrettyVersion();
            $version = new \_PhpScoperf0acd9a8c4f5\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScoperf0acd9a8c4f5\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractMonorepoBuilderVersionFromComposer() : ?\_PhpScoperf0acd9a8c4f5\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScoperf0acd9a8c4f5\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === 'symplify/monorepo-builder') {
                    return new \_PhpScoperf0acd9a8c4f5\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

...
use _PhpScopere71e603d103e\Jean85\PrettyVersions;
use _PhpScopere71e603d103e\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScopere71e603d103e\PharIo\Version\InvalidVersionException;
use _PhpScopere71e603d103e\PharIo\Version\Version;
use _PhpScopere71e603d103e\Symfony\Component\Console\Command\Command;
use _PhpScopere71e603d103e\Symfony\Component\Console\Input\InputArgument;
...
final class InitCommand extends \_PhpScopere71e603d103e\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScopere71e603d103e\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        parent::__construct();
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::OUTPUT, \_PhpScopere71e603d103e\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Directory to generate monorepo into.', \getcwd());
    }
    ...
    private function getMonorepoBuilderVersion() : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScopere71e603d103e\Jean85\PrettyVersions::getVersion('symplify/monorepo-builder')->getPrettyVersion();
            $version = new \_PhpScopere71e603d103e\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScopere71e603d103e\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractMonorepoBuilderVersionFromComposer() : ?\_PhpScopere71e603d103e\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScopere71e603d103e\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === 'symplify/monorepo-builder') {
                    return new \_PhpScopere71e603d103e\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

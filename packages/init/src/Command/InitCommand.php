...
use _PhpScopera89333f3e9e2\Jean85\PrettyVersions;
use _PhpScopera89333f3e9e2\Nette\Utils\Json as NetteJson;
use OutOfBoundsException;
use _PhpScopera89333f3e9e2\PharIo\Version\InvalidVersionException;
use _PhpScopera89333f3e9e2\PharIo\Version\Version;
use _PhpScopera89333f3e9e2\Symfony\Component\Console\Command\Command;
use _PhpScopera89333f3e9e2\Symfony\Component\Console\Input\InputArgument;
...
final class InitCommand extends \_PhpScopera89333f3e9e2\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScopera89333f3e9e2\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        parent::__construct();
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::OUTPUT, \_PhpScopera89333f3e9e2\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Directory to generate monorepo into.', \getcwd());
    }
    ...
    private function getMonorepoBuilderVersion() : string
    {
        $version = null;
        try {
            $prettyVersion = \_PhpScopera89333f3e9e2\Jean85\PrettyVersions::getVersion('symplify/monorepo-builder')->getPrettyVersion();
            $version = new \_PhpScopera89333f3e9e2\PharIo\Version\Version(\str_replace('x-dev', '0', $prettyVersion));
        } catch (\OutOfBoundsException|\_PhpScopera89333f3e9e2\PharIo\Version\InvalidVersionException $exceptoin) {
     ...
     */
    private function extractMonorepoBuilderVersionFromComposer() : ?\_PhpScopera89333f3e9e2\PharIo\Version\Version
    {
        ...
        if (\is_file($installedJsonFilename)) {
            ...
            $installedJson = \_PhpScopera89333f3e9e2\Nette\Utils\Json::decode($installedJsonFileContent);
            foreach ($installedJson as $installedPackage) {
                if ($installedPackage->name === 'symplify/monorepo-builder') {
                    return new \_PhpScopera89333f3e9e2\PharIo\Version\Version($installedPackage->version);
                }
            }
        }
        return null;

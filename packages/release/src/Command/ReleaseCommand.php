...
final class ReleaseCommand extends \_PhpScoperf1163522a13e\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\ValueObject\Option::VERSION, \_PhpScoperf1163522a13e\Symfony\Component\Console\Input\InputArgument::REQUIRED, $description);
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::DRY_RUN, null, \_PhpScoperf1163522a13e\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not perform operations, just their preview');
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::STAGE, null, \_PhpScoperf1163522a13e\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Name of stage to perform');
    }
    ...
    private function resolveStage(\_PhpScoperf1163522a13e\Symfony\Component\Console\Input\InputInterface $input) : ?string
    {
    ...
    private function resolveVersion(\_PhpScoperf1163522a13e\Symfony\Component\Console\Input\InputInterface $input, ?string $stage) : \_PhpScoperf1163522a13e\PharIo\Version\Version
    {

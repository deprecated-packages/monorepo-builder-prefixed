...
use _PhpScopercde9d0a21b8c\Symfony\Component\Console\Input\InputOption;
...
final class ReleaseCommand extends \_PhpScopercde9d0a21b8c\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\ValueObject\Option::VERSION, \_PhpScopercde9d0a21b8c\Symfony\Component\Console\Input\InputArgument::REQUIRED, $description);
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::DRY_RUN, null, \_PhpScopercde9d0a21b8c\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not perform operations, just their preview');
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::STAGE, null, \_PhpScopercde9d0a21b8c\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Name of stage to perform');
    }
    ...
    private function resolveStage(\_PhpScopercde9d0a21b8c\Symfony\Component\Console\Input\InputInterface $input) : ?string
    {
    ...
    private function resolveVersion(\_PhpScopercde9d0a21b8c\Symfony\Component\Console\Input\InputInterface $input, ?string $stage) : \_PhpScopercde9d0a21b8c\PharIo\Version\Version
    {

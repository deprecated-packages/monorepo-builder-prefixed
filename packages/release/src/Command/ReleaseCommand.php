...
final class ReleaseCommand extends \_PhpScoperd4e30d8318e8\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\ValueObject\Option::VERSION, \_PhpScoperd4e30d8318e8\Symfony\Component\Console\Input\InputArgument::REQUIRED, $description);
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::DRY_RUN, null, \_PhpScoperd4e30d8318e8\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not perform operations, just their preview');
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::STAGE, null, \_PhpScoperd4e30d8318e8\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Name of stage to perform');
    }
    ...
    private function resolveStage(\_PhpScoperd4e30d8318e8\Symfony\Component\Console\Input\InputInterface $input) : ?string
    {
    ...
    private function resolveVersion(\_PhpScoperd4e30d8318e8\Symfony\Component\Console\Input\InputInterface $input, ?string $stage) : \_PhpScoperd4e30d8318e8\PharIo\Version\Version
    {

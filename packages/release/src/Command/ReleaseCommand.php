...
final class ReleaseCommand extends \_PhpScoper8a421ef9d4c6\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\ValueObject\Option::VERSION, \_PhpScoper8a421ef9d4c6\Symfony\Component\Console\Input\InputArgument::REQUIRED, $description);
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::DRY_RUN, null, \_PhpScoper8a421ef9d4c6\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not perform operations, just their preview');
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::STAGE, null, \_PhpScoper8a421ef9d4c6\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Name of stage to perform');
    }
    ...
    private function resolveStage(\_PhpScoper8a421ef9d4c6\Symfony\Component\Console\Input\InputInterface $input) : ?string
    {
    ...
    private function resolveVersion(\_PhpScoper8a421ef9d4c6\Symfony\Component\Console\Input\InputInterface $input, ?string $stage) : \_PhpScoper8a421ef9d4c6\PharIo\Version\Version
    {

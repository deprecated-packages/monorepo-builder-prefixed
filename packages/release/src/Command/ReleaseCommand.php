...
final class ReleaseCommand extends \_PhpScopere9939b84e968\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\ValueObject\Option::VERSION, \_PhpScopere9939b84e968\Symfony\Component\Console\Input\InputArgument::REQUIRED, $description);
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::DRY_RUN, null, \_PhpScopere9939b84e968\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not perform operations, just their preview');
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::STAGE, null, \_PhpScopere9939b84e968\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Name of stage to perform');
    }
    ...
    private function resolveStage(\_PhpScopere9939b84e968\Symfony\Component\Console\Input\InputInterface $input) : ?string
    {
    ...
    private function resolveVersion(\_PhpScopere9939b84e968\Symfony\Component\Console\Input\InputInterface $input, ?string $stage) : \_PhpScopere9939b84e968\PharIo\Version\Version
    {

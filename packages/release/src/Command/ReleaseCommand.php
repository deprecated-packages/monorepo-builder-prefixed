...
final class ReleaseCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\ValueObject\Option::VERSION, \_PhpScoperd72531165ef5\Symfony\Component\Console\Input\InputArgument::REQUIRED, $description);
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::DRY_RUN, null, \_PhpScoperd72531165ef5\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not perform operations, just their preview');
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::STAGE, null, \_PhpScoperd72531165ef5\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Name of stage to perform', \Symplify\MonorepoBuilder\Release\ValueObject\Stage::MAIN);
    }

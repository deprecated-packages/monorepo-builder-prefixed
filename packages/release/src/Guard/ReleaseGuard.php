...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper0ce3ac6864aa\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper0ce3ac6864aa\PharIo\Version\Version $version) : void
    {

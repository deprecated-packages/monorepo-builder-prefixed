...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper9a38f5ee6cbc\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper9a38f5ee6cbc\PharIo\Version\Version $version) : void
    {

...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScopere1b4619561f2\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScopere1b4619561f2\PharIo\Version\Version $version) : void
    {

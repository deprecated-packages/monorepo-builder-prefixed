...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper8e5d8d76215d\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper8e5d8d76215d\PharIo\Version\Version $version) : void
    {

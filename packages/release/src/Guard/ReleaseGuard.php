...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScopera763b4be90d0\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScopera763b4be90d0\PharIo\Version\Version $version) : void
    {

...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScopere0f28e6b9bde\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScopere0f28e6b9bde\PharIo\Version\Version $version) : void
    {

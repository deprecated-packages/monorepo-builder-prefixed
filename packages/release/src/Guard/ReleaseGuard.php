...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper641780a4edd2\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper641780a4edd2\PharIo\Version\Version $version) : void
    {

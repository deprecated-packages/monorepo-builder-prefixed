...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperef96225926e2\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperef96225926e2\PharIo\Version\Version $version) : void
    {

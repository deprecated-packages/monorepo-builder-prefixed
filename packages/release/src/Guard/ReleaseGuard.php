...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperfd1a6a0ee9af\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperfd1a6a0ee9af\PharIo\Version\Version $version) : void
    {

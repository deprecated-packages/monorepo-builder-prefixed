...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper8d3e33bd2be8\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper8d3e33bd2be8\PharIo\Version\Version $version) : void
    {

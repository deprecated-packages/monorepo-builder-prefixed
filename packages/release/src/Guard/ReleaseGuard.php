...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScopera1d8e0344ecf\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScopera1d8e0344ecf\PharIo\Version\Version $version) : void
    {

...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperebc1087502f3\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperebc1087502f3\PharIo\Version\Version $version) : void
    {

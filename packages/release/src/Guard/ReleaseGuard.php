...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper31a2d0e8f655\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper31a2d0e8f655\PharIo\Version\Version $version) : void
    {

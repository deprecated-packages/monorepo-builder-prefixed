...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper1ceaf4cbd5cb\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper1ceaf4cbd5cb\PharIo\Version\Version $version) : void
    {

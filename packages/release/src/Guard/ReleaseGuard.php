...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper9b5fd937b4d9\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper9b5fd937b4d9\PharIo\Version\Version $version) : void
    {

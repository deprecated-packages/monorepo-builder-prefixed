...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper7ef219076398\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper7ef219076398\PharIo\Version\Version $version) : void
    {

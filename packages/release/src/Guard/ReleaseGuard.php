...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperc86a79e2d6b2\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperc86a79e2d6b2\PharIo\Version\Version $version) : void
    {

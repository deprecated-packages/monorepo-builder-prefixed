...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperf2e2fcfe7ee6\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperf2e2fcfe7ee6\PharIo\Version\Version $version) : void
    {

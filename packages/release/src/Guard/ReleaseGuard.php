...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperdd624bbcb4e5\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperdd624bbcb4e5\PharIo\Version\Version $version) : void
    {

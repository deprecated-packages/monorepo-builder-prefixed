...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperd72531165ef5\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperd72531165ef5\PharIo\Version\Version $version) : void
    {

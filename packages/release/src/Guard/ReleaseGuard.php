...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperab3ccffcffcd\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperab3ccffcffcd\PharIo\Version\Version $version) : void
    {

...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper6da0ff96db02\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper6da0ff96db02\PharIo\Version\Version $version) : void
    {

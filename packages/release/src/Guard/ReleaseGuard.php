...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper9b7e9beaf949\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper9b7e9beaf949\PharIo\Version\Version $version) : void
    {

...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper9aa6186049d8\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper9aa6186049d8\PharIo\Version\Version $version) : void
    {

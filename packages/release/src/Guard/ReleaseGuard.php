...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperec2b815193b4\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperec2b815193b4\PharIo\Version\Version $version) : void
    {

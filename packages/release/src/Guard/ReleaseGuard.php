...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperaa2560a8a931\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperaa2560a8a931\PharIo\Version\Version $version) : void
    {

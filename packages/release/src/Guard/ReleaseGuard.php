...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperc1a0b7b3175f\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperc1a0b7b3175f\PharIo\Version\Version $version) : void
    {

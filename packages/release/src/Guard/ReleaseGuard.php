...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper93a7e58d9dd1\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper93a7e58d9dd1\PharIo\Version\Version $version) : void
    {

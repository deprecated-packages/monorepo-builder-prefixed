...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperbe77f3b0e77d\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperbe77f3b0e77d\PharIo\Version\Version $version) : void
    {

...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper3bda9af7e0fd\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper3bda9af7e0fd\PharIo\Version\Version $version) : void
    {

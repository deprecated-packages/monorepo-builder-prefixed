...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper058a557299a1\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper058a557299a1\PharIo\Version\Version $version) : void
    {

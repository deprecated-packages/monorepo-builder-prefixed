...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperbecbc4cd500f\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperbecbc4cd500f\PharIo\Version\Version $version) : void
    {

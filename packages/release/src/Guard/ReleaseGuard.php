...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperff72c38d4e2a\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperff72c38d4e2a\PharIo\Version\Version $version) : void
    {

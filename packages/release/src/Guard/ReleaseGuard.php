...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper84d68f9a1b63\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper84d68f9a1b63\PharIo\Version\Version $version) : void
    {

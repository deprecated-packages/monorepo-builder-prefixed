...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper1e8bd38a2146\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper1e8bd38a2146\PharIo\Version\Version $version) : void
    {

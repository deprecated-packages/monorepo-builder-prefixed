...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper9e91fe07dbdd\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper9e91fe07dbdd\PharIo\Version\Version $version) : void
    {

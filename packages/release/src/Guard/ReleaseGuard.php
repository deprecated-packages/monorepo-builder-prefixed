...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperf7284855206a\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperf7284855206a\PharIo\Version\Version $version) : void
    {

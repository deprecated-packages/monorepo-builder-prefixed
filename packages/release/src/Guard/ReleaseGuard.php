...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper1ca65afc92f7\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper1ca65afc92f7\PharIo\Version\Version $version) : void
    {

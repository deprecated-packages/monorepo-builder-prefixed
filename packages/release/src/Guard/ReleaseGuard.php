...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperdfdcb3d4cca0\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperdfdcb3d4cca0\PharIo\Version\Version $version) : void
    {

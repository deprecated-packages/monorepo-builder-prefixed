...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper59bf8deb8cc1\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper59bf8deb8cc1\PharIo\Version\Version $version) : void
    {

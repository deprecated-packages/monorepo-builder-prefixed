...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScopera28be7b3fe51\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScopera28be7b3fe51\PharIo\Version\Version $version) : void
    {

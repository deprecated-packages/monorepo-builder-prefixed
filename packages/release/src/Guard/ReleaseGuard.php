...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScopereaa2cae8e093\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScopereaa2cae8e093\PharIo\Version\Version $version) : void
    {

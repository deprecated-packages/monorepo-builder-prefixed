...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper77ed23b49cd3\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper77ed23b49cd3\PharIo\Version\Version $version) : void
    {

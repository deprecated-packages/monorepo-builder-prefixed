...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperb2b5f37d9a43\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperb2b5f37d9a43\PharIo\Version\Version $version) : void
    {

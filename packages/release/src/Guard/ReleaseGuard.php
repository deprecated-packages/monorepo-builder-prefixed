...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperd79f30a2f8be\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperd79f30a2f8be\PharIo\Version\Version $version) : void
    {

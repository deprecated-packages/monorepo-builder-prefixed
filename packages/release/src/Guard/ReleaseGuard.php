...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperd9ee792cdaf4\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperd9ee792cdaf4\PharIo\Version\Version $version) : void
    {

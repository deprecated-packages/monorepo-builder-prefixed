...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperac0a9a33ae94\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperac0a9a33ae94\PharIo\Version\Version $version) : void
    {

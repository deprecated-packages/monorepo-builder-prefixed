...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperc7f1624089a3\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperc7f1624089a3\PharIo\Version\Version $version) : void
    {

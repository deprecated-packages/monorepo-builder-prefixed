...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperc9dc9dec1b4a\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperc9dc9dec1b4a\PharIo\Version\Version $version) : void
    {

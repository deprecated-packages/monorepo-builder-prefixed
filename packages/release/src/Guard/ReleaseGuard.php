...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper6d6fbd28d6a9\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper6d6fbd28d6a9\PharIo\Version\Version $version) : void
    {

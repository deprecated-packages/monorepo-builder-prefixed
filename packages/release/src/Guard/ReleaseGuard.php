...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper3e1a86bff77f\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper3e1a86bff77f\PharIo\Version\Version $version) : void
    {

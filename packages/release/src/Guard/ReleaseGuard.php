...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperb2257feafd7d\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperb2257feafd7d\PharIo\Version\Version $version) : void
    {

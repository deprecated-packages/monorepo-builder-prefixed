...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperf48ea5df9e9b\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperf48ea5df9e9b\PharIo\Version\Version $version) : void
    {

...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperb3d59f519671\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperb3d59f519671\PharIo\Version\Version $version) : void
    {

...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper6b92aa0ec16f\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper6b92aa0ec16f\PharIo\Version\Version $version) : void
    {

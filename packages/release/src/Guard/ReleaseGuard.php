...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperd0ff379dfdc7\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperd0ff379dfdc7\PharIo\Version\Version $version) : void
    {

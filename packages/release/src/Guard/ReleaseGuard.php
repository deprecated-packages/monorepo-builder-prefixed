...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoperb397db9687c8\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoperb397db9687c8\PharIo\Version\Version $version) : void
    {

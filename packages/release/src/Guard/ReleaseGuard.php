...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScoper244a857c31f6\PharIo\Version\Version $version, string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScoper244a857c31f6\PharIo\Version\Version $version) : void
    {

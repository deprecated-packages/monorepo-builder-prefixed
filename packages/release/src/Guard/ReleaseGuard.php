...
final class ReleaseGuard
{
    ...
    public function guardVersion(\_PhpScopere4e8aecb81b9\PharIo\Version\Version $version, ?string $stage) : void
    {
    ...
    private function ensureVersionIsNewerThanLastOne(\_PhpScopere4e8aecb81b9\PharIo\Version\Version $version) : void
    {

...
final class PushNextDevReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoperab93339c6bca\PharIo\Version\Version $version) : void
    {
    ...
    public function getDescription(\_PhpScoperab93339c6bca\PharIo\Version\Version $version) : string
    {
        $versionInString = $this->getVersionDev($version);
        return \sprintf('Push "%s" open to remote repository', $versionInString);
    }
    private function getVersionDev(\_PhpScoperab93339c6bca\PharIo\Version\Version $version) : string
    {

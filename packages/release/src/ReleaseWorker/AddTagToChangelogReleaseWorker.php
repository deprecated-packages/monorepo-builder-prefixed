...
use _PhpScoperd659a053ca1c\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoperd659a053ca1c\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoperd659a053ca1c\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
        $this->smartFileSystem->dumpFile($changelogFilePath, $changelogFileContent);
    }
    public function getDescription(\_PhpScoperd659a053ca1c\PharIo\Version\Version $version) : string
    {
        $newHeadline = $this->createNewHeadline($version);
        return \sprintf('Change "Unreleased" in `CHANGELOG.md` to "%s"', $newHeadline);
    }
    private function createNewHeadline(\_PhpScoperd659a053ca1c\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoperd659a053ca1c\Nette\Utils\DateTime();

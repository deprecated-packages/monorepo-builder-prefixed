...
use _PhpScoperda849baa4a45\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoperda849baa4a45\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoperda849baa4a45\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoperda849baa4a45\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoperda849baa4a45\Nette\Utils\DateTime();

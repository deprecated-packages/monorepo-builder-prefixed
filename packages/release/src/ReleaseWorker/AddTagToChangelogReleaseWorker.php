...
use _PhpScoper14531b498d75\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper14531b498d75\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper14531b498d75\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper14531b498d75\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper14531b498d75\Nette\Utils\DateTime();

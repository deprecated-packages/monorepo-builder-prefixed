...
use _PhpScoper32df52184457\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper32df52184457\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper32df52184457\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper32df52184457\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper32df52184457\Nette\Utils\DateTime();

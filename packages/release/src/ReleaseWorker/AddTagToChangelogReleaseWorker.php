...
use _PhpScopere10afbb60721\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScopere10afbb60721\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScopere10afbb60721\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScopere10afbb60721\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScopere10afbb60721\Nette\Utils\DateTime();

...
use _PhpScoperf968abd60cb0\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoperf968abd60cb0\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoperf968abd60cb0\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoperf968abd60cb0\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoperf968abd60cb0\Nette\Utils\DateTime();

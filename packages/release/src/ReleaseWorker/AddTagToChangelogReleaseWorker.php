...
use _PhpScoper931cda798d50\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper931cda798d50\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper931cda798d50\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper931cda798d50\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper931cda798d50\Nette\Utils\DateTime();

...
use _PhpScoper9a721f934eeb\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper9a721f934eeb\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper9a721f934eeb\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper9a721f934eeb\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper9a721f934eeb\Nette\Utils\DateTime();

...
use _PhpScoper8f797d20934a\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper8f797d20934a\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper8f797d20934a\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper8f797d20934a\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper8f797d20934a\Nette\Utils\DateTime();

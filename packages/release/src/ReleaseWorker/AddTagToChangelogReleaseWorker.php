...
use _PhpScoperf6f8e31183c3\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoperf6f8e31183c3\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoperf6f8e31183c3\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoperf6f8e31183c3\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoperf6f8e31183c3\Nette\Utils\DateTime();

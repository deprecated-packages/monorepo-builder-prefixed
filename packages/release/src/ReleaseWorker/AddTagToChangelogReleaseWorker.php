...
use _PhpScoper66a1b4bf441c\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper66a1b4bf441c\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper66a1b4bf441c\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper66a1b4bf441c\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper66a1b4bf441c\Nette\Utils\DateTime();

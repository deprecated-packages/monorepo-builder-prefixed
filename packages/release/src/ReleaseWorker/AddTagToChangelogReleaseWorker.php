...
use _PhpScoperce084f4275dd\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoperce084f4275dd\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoperce084f4275dd\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
        $this->smartFileSystem->dumpFile($changelogFilePath, $changelogFileContent);
    }
    public function getDescription(\_PhpScoperce084f4275dd\PharIo\Version\Version $version) : string
    {
        $newHeadline = $this->createNewHeadline($version);
        return \sprintf('Change "Unreleased" in `CHANGELOG.md` to "%s"', $newHeadline);
    }
    private function createNewHeadline(\_PhpScoperce084f4275dd\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoperce084f4275dd\Nette\Utils\DateTime();

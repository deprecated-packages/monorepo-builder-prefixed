...
use _PhpScoperfff890f8359a\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoperfff890f8359a\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoperfff890f8359a\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
        $this->smartFileSystem->dumpFile($changelogFilePath, $changelogFileContent);
    }
    public function getDescription(\_PhpScoperfff890f8359a\PharIo\Version\Version $version) : string
    {
        $newHeadline = $this->createNewHeadline($version);
        return \sprintf('Change "Unreleased" in `CHANGELOG.md` to "%s"', $newHeadline);
    }
    private function createNewHeadline(\_PhpScoperfff890f8359a\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoperfff890f8359a\Nette\Utils\DateTime();

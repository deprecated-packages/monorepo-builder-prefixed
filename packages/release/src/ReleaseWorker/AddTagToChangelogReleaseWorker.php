...
use _PhpScoper955845c5b45f\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper955845c5b45f\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper955845c5b45f\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
        $this->smartFileSystem->dumpFile($changelogFilePath, $changelogFileContent);
    }
    public function getDescription(\_PhpScoper955845c5b45f\PharIo\Version\Version $version) : string
    {
        $newHeadline = $this->createNewHeadline($version);
        return \sprintf('Change "Unreleased" in `CHANGELOG.md` to "%s"', $newHeadline);
    }
    private function createNewHeadline(\_PhpScoper955845c5b45f\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper955845c5b45f\Nette\Utils\DateTime();

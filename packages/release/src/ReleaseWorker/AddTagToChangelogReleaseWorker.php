...
use _PhpScoper6bfbe5ea8949\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper6bfbe5ea8949\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper6bfbe5ea8949\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper6bfbe5ea8949\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper6bfbe5ea8949\Nette\Utils\DateTime();

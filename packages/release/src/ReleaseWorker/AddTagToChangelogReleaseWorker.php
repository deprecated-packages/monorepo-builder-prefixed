...
use _PhpScoperabca9a64438b\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoperabca9a64438b\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoperabca9a64438b\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoperabca9a64438b\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoperabca9a64438b\Nette\Utils\DateTime();

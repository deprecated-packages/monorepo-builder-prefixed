...
use _PhpScoperdd624bbcb4e5\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoperdd624bbcb4e5\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoperdd624bbcb4e5\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoperdd624bbcb4e5\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoperdd624bbcb4e5\Nette\Utils\DateTime();

...
use _PhpScoper0c743797b8e7\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper0c743797b8e7\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper0c743797b8e7\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper0c743797b8e7\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper0c743797b8e7\Nette\Utils\DateTime();

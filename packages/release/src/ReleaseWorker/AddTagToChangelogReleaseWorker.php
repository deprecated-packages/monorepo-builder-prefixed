...
use _PhpScoperec2b815193b4\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoperec2b815193b4\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoperec2b815193b4\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoperec2b815193b4\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoperec2b815193b4\Nette\Utils\DateTime();

...
use _PhpScoper43a95e2f69bc\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper43a95e2f69bc\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper43a95e2f69bc\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper43a95e2f69bc\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper43a95e2f69bc\Nette\Utils\DateTime();

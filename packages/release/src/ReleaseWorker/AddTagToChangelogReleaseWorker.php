...
use _PhpScopera42d72b2de70\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScopera42d72b2de70\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScopera42d72b2de70\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
        $this->smartFileSystem->dumpFile($changelogFilePath, $changelogFileContent);
    }
    public function getDescription(\_PhpScopera42d72b2de70\PharIo\Version\Version $version) : string
    {
        $newHeadline = $this->createNewHeadline($version);
        return \sprintf('Change "Unreleased" in `CHANGELOG.md` to "%s"', $newHeadline);
    }
    private function createNewHeadline(\_PhpScopera42d72b2de70\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScopera42d72b2de70\Nette\Utils\DateTime();

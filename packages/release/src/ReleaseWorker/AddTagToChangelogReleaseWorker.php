...
use _PhpScoper2a80719fd449\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper2a80719fd449\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper2a80719fd449\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper2a80719fd449\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper2a80719fd449\Nette\Utils\DateTime();

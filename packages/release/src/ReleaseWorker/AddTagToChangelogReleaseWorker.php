...
use _PhpScoper5818bcaf1010\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper5818bcaf1010\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper5818bcaf1010\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper5818bcaf1010\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper5818bcaf1010\Nette\Utils\DateTime();

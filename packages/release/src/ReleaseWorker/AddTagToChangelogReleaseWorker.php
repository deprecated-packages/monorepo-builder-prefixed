...
use _PhpScoper912e6d747d7e\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\_PhpScoper912e6d747d7e\PharIo\Version\Version $version) : void
    {
        ...
        $changelogFileContent = \_PhpScoper912e6d747d7e\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    private function createNewHeadline(\_PhpScoper912e6d747d7e\PharIo\Version\Version $version) : string
    {
        $dateTime = new \_PhpScoper912e6d747d7e\Nette\Utils\DateTime();

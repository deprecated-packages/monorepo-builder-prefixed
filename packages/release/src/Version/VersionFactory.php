...
final class VersionFactory
{
    ...
    public function createValidVersion(string $versionArgument, ?string $stage) : \_PhpScoper9122d33f3e27\PharIo\Version\Version
    {
        ...
        $version = new \_PhpScoper9122d33f3e27\PharIo\Version\Version($versionArgument);
        $this->releaseGuard->guardVersion($version, $stage);
        return $version;
    }
    private function resolveNextVersionByVersionKind(string $versionKind) : \_PhpScoper9122d33f3e27\PharIo\Version\Version
    {
        // get current version
        $mostRecentVersion = $this->gitManager->getMostRecentTag(\getcwd());
        if ($mostRecentVersion === null) {
            // the very first tag
            return new \_PhpScoper9122d33f3e27\PharIo\Version\Version('v0.1.0');
        }
        $mostRecentVersion = new \_PhpScoper9122d33f3e27\PharIo\Version\Version($mostRecentVersion);
        ...
        return new \_PhpScoper9122d33f3e27\PharIo\Version\Version(\sprintf('v%d.%d.%d', $value, $currentMinorVersion, $currentPatchVersion));
    }
}

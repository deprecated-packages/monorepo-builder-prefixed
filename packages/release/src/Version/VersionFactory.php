...
final class VersionFactory
{
    ...
    public function createValidVersion(string $versionArgument, string $stage) : \_PhpScoperd79f30a2f8be\PharIo\Version\Version
    {
        ...
        $version = new \_PhpScoperd79f30a2f8be\PharIo\Version\Version($versionArgument);
        $this->releaseGuard->guardVersion($version, $stage);
        return $version;
    }
    private function resolveNextVersionByVersionKind(string $versionKind) : \_PhpScoperd79f30a2f8be\PharIo\Version\Version
    {
        // get current version
        $mostRecentVersion = $this->mostRecentTagResolver->resolve(\getcwd());
        if ($mostRecentVersion === null) {
            // the very first tag
            return new \_PhpScoperd79f30a2f8be\PharIo\Version\Version('v0.1.0');
        }
        $mostRecentVersion = new \_PhpScoperd79f30a2f8be\PharIo\Version\Version($mostRecentVersion);
        ...
        return new \_PhpScoperd79f30a2f8be\PharIo\Version\Version(\sprintf('v%d.%d.%d', $value, $currentMinorVersion, $currentPatchVersion));
    }
}

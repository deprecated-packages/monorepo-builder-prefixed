...
final class VersionFactory
{
    ...
    public function createValidVersion(string $versionArgument, string $stage) : \_PhpScopera2ff5fd2b59c\PharIo\Version\Version
    {
        ...
        $version = new \_PhpScopera2ff5fd2b59c\PharIo\Version\Version($versionArgument);
        $this->releaseGuard->guardVersion($version, $stage);
        return $version;
    }
    private function resolveNextVersionByVersionKind(string $versionKind) : \_PhpScopera2ff5fd2b59c\PharIo\Version\Version
    {
        // get current version
        $mostRecentVersion = $this->mostRecentTagResolver->resolve(\getcwd());
        if ($mostRecentVersion === null) {
            // the very first tag
            return new \_PhpScopera2ff5fd2b59c\PharIo\Version\Version('v0.1.0');
        }
        $mostRecentVersion = new \_PhpScopera2ff5fd2b59c\PharIo\Version\Version($mostRecentVersion);
        ...
        return new \_PhpScopera2ff5fd2b59c\PharIo\Version\Version(\sprintf('v%d.%d.%d', $value, $currentMinorVersion, $currentPatchVersion));
    }
}

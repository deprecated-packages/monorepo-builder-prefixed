...
final class VersionFactory
{
    ...
    public function createValidVersion(string $versionArgument, ?string $stage) : \_PhpScopera31d0d6ff47a\PharIo\Version\Version
    {
        ...
        $version = new \_PhpScopera31d0d6ff47a\PharIo\Version\Version($versionArgument);
        $this->releaseGuard->guardVersion($version, $stage);
        return $version;
    }
    private function resolveNextVersionByVersionKind(string $versionKind) : \_PhpScopera31d0d6ff47a\PharIo\Version\Version
    {
        // get current version
        $mostRecentVersion = $this->gitManager->getMostRecentTag(\getcwd());
        if ($mostRecentVersion === null) {
            // the very first tag
            return new \_PhpScopera31d0d6ff47a\PharIo\Version\Version('v0.1.0');
        }
        $mostRecentVersion = new \_PhpScopera31d0d6ff47a\PharIo\Version\Version($mostRecentVersion);
        ...
        return new \_PhpScopera31d0d6ff47a\PharIo\Version\Version(\sprintf('v%d.%d.%d', $value, $currentMinorVersion, $currentPatchVersion));
    }
}

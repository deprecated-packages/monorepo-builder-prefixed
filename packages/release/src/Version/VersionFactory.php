...
final class VersionFactory
{
    ...
    public function createValidVersion(string $versionArgument, ?string $stage) : \_PhpScoperddc6df5a78fd\PharIo\Version\Version
    {
        ...
        $version = new \_PhpScoperddc6df5a78fd\PharIo\Version\Version($versionArgument);
        $this->releaseGuard->guardVersion($version, $stage);
        return $version;
    }
    private function resolveNextVersionByVersionKind(string $versionKind) : \_PhpScoperddc6df5a78fd\PharIo\Version\Version
    {
        // get current version
        $mostRecentVersion = $this->gitManager->getMostRecentTag(\getcwd());
        if ($mostRecentVersion === null) {
            // the very first tag
            return new \_PhpScoperddc6df5a78fd\PharIo\Version\Version('v0.1.0');
        }
        $mostRecentVersion = new \_PhpScoperddc6df5a78fd\PharIo\Version\Version($mostRecentVersion);
        ...
        return new \_PhpScoperddc6df5a78fd\PharIo\Version\Version(\sprintf('v%d.%d.%d', $value, $currentMinorVersion, $currentPatchVersion));
    }
}

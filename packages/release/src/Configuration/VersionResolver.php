...
final class VersionResolver
{
    ...
    public function resolveVersion(\_PhpScoper641780a4edd2\Symfony\Component\Console\Input\InputInterface $input, string $stage) : \_PhpScoper641780a4edd2\PharIo\Version\Version
    {

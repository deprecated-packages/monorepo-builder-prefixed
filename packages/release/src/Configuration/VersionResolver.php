...
final class VersionResolver
{
    ...
    public function resolveVersion(\_PhpScopere1b4619561f2\Symfony\Component\Console\Input\InputInterface $input, string $stage) : \_PhpScopere1b4619561f2\PharIo\Version\Version
    {

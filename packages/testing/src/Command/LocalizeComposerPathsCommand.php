...
final class LocalizeComposerPathsCommand extends \_PhpScoper38889e21c753\Symfony\Component\Console\Command\Command
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->setDescription('Set mutual package paths to local packages - use for pre-monorepo package testing');
        $this->addArgument(\Symplify\MonorepoBuilder\Testing\ValueObject\Option::PACKAGE_COMPOSER_JSON, \_PhpScoper38889e21c753\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Path to package "composer.json"');
    }

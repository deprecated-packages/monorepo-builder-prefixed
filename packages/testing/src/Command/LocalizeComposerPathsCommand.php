...
final class LocalizeComposerPathsCommand extends \_PhpScoperf78d2b40800e\Symfony\Component\Console\Command\Command
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\Testing\ValueObject\Option::PACKAGE_COMPOSER_JSON, \_PhpScoperf78d2b40800e\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Path to package "composer.json"');
    }

...
final class LocalizeComposerPathsCommand extends \_PhpScoperd3e9cfbe9d90\Symfony\Component\Console\Command\Command
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\Testing\ValueObject\Option::PACKAGE_COMPOSER_JSON, \_PhpScoperd3e9cfbe9d90\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Path to package "composer.json"');
    }

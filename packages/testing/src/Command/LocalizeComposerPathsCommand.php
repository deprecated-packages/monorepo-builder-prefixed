...
final class LocalizeComposerPathsCommand extends \_PhpScopera2bd9a9af620\Symfony\Component\Console\Command\Command
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\Testing\ValueObject\Option::PACKAGE_COMPOSER_JSON, \_PhpScopera2bd9a9af620\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Path to package "composer.json"');
    }

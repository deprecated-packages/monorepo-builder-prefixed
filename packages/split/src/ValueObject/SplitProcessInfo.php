...
final class SplitProcessInfo
{
     ...
     */
    private $process;
    public function __construct(\_PhpScoperab37dd4d9c3e\Symfony\Component\Process\Process $process, string $localDirectory, string $remoteRepository)
    {
        $this->process = $process;
        $this->localDirectory = $localDirectory;
        $this->remoteRepository = $remoteRepository;
    }
    public function getProcess() : \_PhpScoperab37dd4d9c3e\Symfony\Component\Process\Process
    {
        return $this->process;
    }

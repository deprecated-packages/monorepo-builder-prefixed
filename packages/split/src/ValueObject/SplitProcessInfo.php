...
final class SplitProcessInfo
{
     ...
     */
    private $process;
    public function __construct(\_PhpScoper05142ca19111\Symfony\Component\Process\Process $process, string $localDirectory, string $remoteRepository)
    {
        $this->process = $process;
        $this->localDirectory = $localDirectory;
        $this->remoteRepository = $remoteRepository;
    }
    public function getProcess() : \_PhpScoper05142ca19111\Symfony\Component\Process\Process
    {
        return $this->process;
    }

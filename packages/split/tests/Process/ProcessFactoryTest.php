...
final class ProcessFactoryTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var ProcessFactory
     */
    ...
    protected function setUp() : void
    {
        ...
        $this->processFactory = self::$container->get(\Symplify\MonorepoBuilder\Split\Process\ProcessFactory::class);
    }
    public function test() : void
    {
        $subsplitProcess = $this->processFactory->createSubsplit('', 'localDirectory', 'git@github.com:symplify/symplify.git', 'master');

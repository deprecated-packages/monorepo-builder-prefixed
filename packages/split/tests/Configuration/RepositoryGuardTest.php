...
final class RepositoryGuardTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var RepositoryGuard
     */
    ...
    protected function setUp() : void
    {
        ...
        $this->repositoryGuard = self::$container->get(\Symplify\MonorepoBuilder\Split\Configuration\RepositoryGuard::class);
    }
    /**

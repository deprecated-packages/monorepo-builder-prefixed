...
use _PhpScoper5d7ea4b0668d\Symfony\Component\EventDispatcher\EventDispatcher;
use _PhpScoper5d7ea4b0668d\Symfony\Component\EventDispatcher\EventDispatcherInterface;
...
return static function (\_PhpScoper5d7ea4b0668d\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper5d7ea4b0668d\Symfony\Component\EventDispatcher\EventDispatcher::class);
    $services->alias(\_PhpScoper5d7ea4b0668d\Symfony\Component\EventDispatcher\EventDispatcherInterface::class, \_PhpScoper5d7ea4b0668d\Symfony\Component\EventDispatcher\EventDispatcher::class);
    ...
    // Symfony 5.1+
    $services->set(\_PhpScoper5d7ea4b0668d\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\Symplify\PackageBuilder\Functions\service_polyfill(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
};

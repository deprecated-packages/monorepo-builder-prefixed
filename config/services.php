...
use _PhpScoperab37dd4d9c3e\Symfony\Component\EventDispatcher\EventDispatcher;
use _PhpScoperab37dd4d9c3e\Symfony\Component\EventDispatcher\EventDispatcherInterface;
...
return static function (\_PhpScoperab37dd4d9c3e\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoperab37dd4d9c3e\Symfony\Component\EventDispatcher\EventDispatcher::class);
    $services->alias(\_PhpScoperab37dd4d9c3e\Symfony\Component\EventDispatcher\EventDispatcherInterface::class, \_PhpScoperab37dd4d9c3e\Symfony\Component\EventDispatcher\EventDispatcher::class);
    ...
    // Symfony 5.1+
    $services->set(\_PhpScoperab37dd4d9c3e\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\Symplify\PackageBuilder\Functions\service_polyfill(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
};

...
return static function (\_PhpScoper8d3e33bd2be8\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper8d3e33bd2be8\Symfony\Component\EventDispatcher\EventDispatcher::class);
    $services->alias(\_PhpScoper8d3e33bd2be8\Symfony\Component\EventDispatcher\EventDispatcherInterface::class, \_PhpScoper8d3e33bd2be8\Symfony\Component\EventDispatcher\EventDispatcher::class);

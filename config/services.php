...
use _PhpScoperebc1087502f3\Symfony\Component\EventDispatcher\EventDispatcher;
use _PhpScoperebc1087502f3\Symfony\Component\EventDispatcher\EventDispatcherInterface;
...
return static function (\_PhpScoperebc1087502f3\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoperebc1087502f3\Symfony\Component\EventDispatcher\EventDispatcher::class);
    $services->alias(\_PhpScoperebc1087502f3\Symfony\Component\EventDispatcher\EventDispatcherInterface::class, \_PhpScoperebc1087502f3\Symfony\Component\EventDispatcher\EventDispatcher::class);
    ...
    // Symfony 5.1+
    $services->set(\_PhpScoperebc1087502f3\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\Symplify\PackageBuilder\Functions\service_polyfill(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
};

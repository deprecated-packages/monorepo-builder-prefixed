...
use _PhpScoper14536d227def\Symfony\Component\EventDispatcher\EventDispatcher;
use _PhpScoper14536d227def\Symfony\Component\EventDispatcher\EventDispatcherInterface;
...
return static function (\_PhpScoper14536d227def\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper14536d227def\Symfony\Component\EventDispatcher\EventDispatcher::class);
    $services->alias(\_PhpScoper14536d227def\Symfony\Component\EventDispatcher\EventDispatcherInterface::class, \_PhpScoper14536d227def\Symfony\Component\EventDispatcher\EventDispatcher::class);
    ...
    // Symfony 5.1+
    $services->set(\_PhpScoper14536d227def\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\Symplify\PackageBuilder\Functions\service_polyfill(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
};

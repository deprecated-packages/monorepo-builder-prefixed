...
use _PhpScoper05142ca19111\Symfony\Component\EventDispatcher\EventDispatcher;
use _PhpScoper05142ca19111\Symfony\Component\EventDispatcher\EventDispatcherInterface;
...
return static function (\_PhpScoper05142ca19111\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper05142ca19111\Symfony\Component\EventDispatcher\EventDispatcher::class);
    $services->alias(\_PhpScoper05142ca19111\Symfony\Component\EventDispatcher\EventDispatcherInterface::class, \_PhpScoper05142ca19111\Symfony\Component\EventDispatcher\EventDispatcher::class);
    ...
    // Symfony 5.1+
    $services->set(\_PhpScoper05142ca19111\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\Symplify\PackageBuilder\Functions\service_polyfill(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
};

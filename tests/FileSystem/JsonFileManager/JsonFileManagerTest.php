...
final class JsonFileManagerTest extends \Symplify\PackageBuilder\Tests\AbstractKernelTestCase
{
    ...
    public function testLoad() : void
    {
        ...
        $this->assertSame($expectedJson, $this->jsonFileManager->loadFromFileInfo(new \Symplify\SmartFileSystem\SmartFileInfo(__DIR__ . '/Source/first.json')));
    }
    ...
    {
        $fileContent = $this->jsonFileManager->encodeJsonToFileContent(['inline_section' => [1, 2, 3], 'normal_section' => [1, 2, 3]]);

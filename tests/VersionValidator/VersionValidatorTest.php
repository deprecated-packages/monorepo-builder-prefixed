...
final class VersionValidatorTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->versionValidator = $this->getService(\Symplify\MonorepoBuilder\VersionValidator::class);
        $this->finderSanitizer = $this->getService(\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    }
    public function test() : void
    {
        $finder = \_PhpScoperad5317739bda\Symfony\Component\Finder\Finder::create()->name('*.json')->in(__DIR__ . '/Source');

...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScoperc9dc9dec1b4a\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScoperc9dc9dec1b4a\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoperc9dc9dec1b4a\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScoperc9dc9dec1b4a\Nette\Utils\Json::encode($data);

...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScoper1ff8e175c295\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScoper1ff8e175c295\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper1ff8e175c295\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScoper1ff8e175c295\Nette\Utils\Json::encode($data);

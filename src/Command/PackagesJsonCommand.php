...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScoper6f057cf7ca7c\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScoper6f057cf7ca7c\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper6f057cf7ca7c\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScoper6f057cf7ca7c\Nette\Utils\Json::encode($data);

...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScoper912e6d747d7e\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScoper912e6d747d7e\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper912e6d747d7e\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScoper912e6d747d7e\Nette\Utils\Json::encode($data);

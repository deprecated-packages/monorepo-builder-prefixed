...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScopera5e5d165d78c\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScopera5e5d165d78c\Symfony\Component\Console\Input\InputInterface $input, \_PhpScopera5e5d165d78c\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScopera5e5d165d78c\Nette\Utils\Json::encode($data);

...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScoper8a1d608a1a7e\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScoper8a1d608a1a7e\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper8a1d608a1a7e\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScoper8a1d608a1a7e\Nette\Utils\Json::encode($data);

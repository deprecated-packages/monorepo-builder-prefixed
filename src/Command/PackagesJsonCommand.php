...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScoperb1086ecf2bcb\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScoperb1086ecf2bcb\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoperb1086ecf2bcb\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScoperb1086ecf2bcb\Nette\Utils\Json::encode($data);

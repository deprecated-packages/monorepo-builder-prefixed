...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScopere97aad8070b4\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScopere97aad8070b4\Symfony\Component\Console\Input\InputInterface $input, \_PhpScopere97aad8070b4\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScopere97aad8070b4\Nette\Utils\Json::encode($data);

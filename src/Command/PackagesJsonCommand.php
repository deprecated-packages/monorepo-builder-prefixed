...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScoper0f23ef1f1d10\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScoper0f23ef1f1d10\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper0f23ef1f1d10\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScoper0f23ef1f1d10\Nette\Utils\Json::encode($data);

...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScopercdc90a6628b6\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScopercdc90a6628b6\Symfony\Component\Console\Input\InputInterface $input, \_PhpScopercdc90a6628b6\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScopercdc90a6628b6\Nette\Utils\Json::encode($data);

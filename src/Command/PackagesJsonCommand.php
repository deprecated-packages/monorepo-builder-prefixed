...
final class PackagesJsonCommand extends \Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(self::NAMES, null, \_PhpScopereaa2cae8e093\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Return package names');
    }
    protected function execute(\_PhpScopereaa2cae8e093\Symfony\Component\Console\Input\InputInterface $input, \_PhpScopereaa2cae8e093\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \_PhpScopereaa2cae8e093\Nette\Utils\Json::encode($data);

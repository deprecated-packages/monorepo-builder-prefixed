...
use _PhpScoper48b8cd584b57\Symfony\Component\Config\Loader\LoaderInterface;
use _PhpScoper48b8cd584b57\Symfony\Component\DependencyInjection\ContainerBuilder;
use _PhpScoper48b8cd584b57\Symfony\Component\HttpKernel\Bundle\BundleInterface;
...
{
    public function registerContainerConfiguration(\_PhpScoper48b8cd584b57\Symfony\Component\Config\Loader\LoaderInterface $loader) : void
    {
    ...
    protected function build(\_PhpScoper48b8cd584b57\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {

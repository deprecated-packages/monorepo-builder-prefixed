...
use _PhpScopercde9d0a21b8c\Symfony\Component\Config\Loader\LoaderInterface;
use _PhpScopercde9d0a21b8c\Symfony\Component\DependencyInjection\ContainerBuilder;
use _PhpScopercde9d0a21b8c\Symfony\Component\HttpKernel\Bundle\BundleInterface;
...
{
    public function registerContainerConfiguration(\_PhpScopercde9d0a21b8c\Symfony\Component\Config\Loader\LoaderInterface $loader) : void
    {
    ...
    protected function build(\_PhpScopercde9d0a21b8c\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {

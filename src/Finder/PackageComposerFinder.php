...
use _PhpScoper5d7ea4b0668d\Symfony\Component\Finder\Finder;
...
final class PackageComposerFinder
{
    ...
    {
        $finder = \_PhpScoper5d7ea4b0668d\Symfony\Component\Finder\Finder::create()->files()->in($this->packageDirectories)->exclude('compiler')->exclude('templates')->exclude('vendor')->exclude('node_modules')->name('composer.json');

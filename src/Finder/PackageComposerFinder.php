...
use _PhpScoper690f6ea278e4\Symfony\Component\Finder\Finder;
...
final class PackageComposerFinder
{
    ...
    {
        $finder = \_PhpScoper690f6ea278e4\Symfony\Component\Finder\Finder::create()->files()->in($this->packageDirectories)->exclude('compiler')->exclude('templates')->exclude('vendor')->exclude('node_modules')->name('composer.json');

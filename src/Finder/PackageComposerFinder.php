...
final class PackageComposerFinder
{
    ...
    {
        $finder = \_PhpScoper94f327c48d46\Symfony\Component\Finder\Finder::create()->files()->in($this->packageDirectories)->exclude('compiler')->exclude('templates')->exclude('vendor')->exclude('node_modules')->name('composer.json');

...
final class SourcesPresenceValidator
{
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {

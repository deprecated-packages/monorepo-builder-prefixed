...
use _PhpScoper602c6d8f02d8\Symfony\Component\Console\Input\InputDefinition;
use _PhpScoper602c6d8f02d8\Symfony\Component\Console\Input\InputInterface;
use _PhpScoper602c6d8f02d8\Symfony\Component\Console\Input\InputOption;
...
final class MonorepoBuilderApplication extends \Symplify\SymplifyKernel\Console\AbstractSymplifyConsoleApplication
{
    ...
    public function __construct(array $commands, \Symplify\MonorepoBuilder\Validator\SourcesPresenceValidator $sourcesPresenceValidator)
    {
        ...
        $version = \_PhpScoper602c6d8f02d8\Jean85\PrettyVersions::getVersion('symplify/monorepo-builder');
        parent::__construct('Monorepo Builder', $version->getPrettyVersion());
    }
    protected function getDefaultInputDefinition() : \_PhpScoper602c6d8f02d8\Symfony\Component\Console\Input\InputDefinition
    {
        $inputDefinition = parent::getDefaultInputDefinition();
        $inputDefinition->addOption(new \_PhpScoper602c6d8f02d8\Symfony\Component\Console\Input\InputOption(\Symplify\MonorepoBuilder\ValueObject\Option::CONFIG, 'c', \_PhpScoper602c6d8f02d8\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to config file', \Symplify\MonorepoBuilder\ValueObject\File::CONFIG));
        return $inputDefinition;
    }
    protected function doRunCommand(\_PhpScoper602c6d8f02d8\Symfony\Component\Console\Command\Command $command, \_PhpScoper602c6d8f02d8\Symfony\Component\Console\Input\InputInterface $input, \_PhpScoper602c6d8f02d8\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        $this->validateSources($command);
        return $this->doRunCommandAndShowHelpOnArgumentError($command, $input, $output);
    }
    private function validateSources(\_PhpScoper602c6d8f02d8\Symfony\Component\Console\Command\Command $command) : void
    {

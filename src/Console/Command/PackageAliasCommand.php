...
final class PackageAliasCommand extends \_PhpScoper6713430bfe3d\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    {
        $process = new \_PhpScoper6713430bfe3d\Symfony\Component\Process\Process(['git', 'describe', '--abbrev=0', '--tags']);
        $process->run();

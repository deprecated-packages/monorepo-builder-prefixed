...
final class PackageAliasCommand extends \_PhpScoperddc6df5a78fd\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    {
        $process = new \_PhpScoperddc6df5a78fd\Symfony\Component\Process\Process(['git', 'describe', '--abbrev=0', '--tags']);
        $process->run();

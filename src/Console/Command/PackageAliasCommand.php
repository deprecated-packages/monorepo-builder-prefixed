...
final class PackageAliasCommand extends \_PhpScoper06dc1c8ab9c9\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    {
        $process = new \_PhpScoper06dc1c8ab9c9\Symfony\Component\Process\Process(['git', 'describe', '--abbrev=0', '--tags']);
        $process->run();

...
final class PackageAliasCommand extends \_PhpScoper9bfdbb0fd8c5\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    {
        $process = new \_PhpScoper9bfdbb0fd8c5\Symfony\Component\Process\Process(['git', 'describe', '--abbrev=0', '--tags']);
        $process->run();

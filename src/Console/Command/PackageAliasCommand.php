...
final class PackageAliasCommand extends \_PhpScoper8a421ef9d4c6\Symfony\Component\Console\Command\Command
{
    /**
     * @var SymfonyStyle
     */
    ...
    {
        $process = new \_PhpScoper8a421ef9d4c6\Symfony\Component\Process\Process(['git', 'describe', '--abbrev=0', '--tags']);
        $process->run();

...
final class BumpInterdependencyCommand extends \_PhpScoperc4f03b8b365d\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScoperc4f03b8b365d\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\MonorepoBuilder\DependencyUpdater $dependencyUpdater, \Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider)
    {
        parent::__construct();
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::VERSION_ARGUMENT, \_PhpScoperc4f03b8b365d\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'New version of inter-dependencies, e.g. "^4.4.2"');
    }

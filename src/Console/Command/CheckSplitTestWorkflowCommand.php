...
final class CheckSplitTestWorkflowCommand extends \_PhpScoper8aa7c2bece07\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function __construct(\_PhpScoper8aa7c2bece07\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\MonorepoBuilder\Package\PackageProvider $packageProvider, \Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
        parent::__construct();
    ...
    {
        $this->addArgument(self::ARGUMENT_SOURCE, \_PhpScoper8aa7c2bece07\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Path to Github Action workflow file with split tests');
    ...
    private function resolveWorkflowFileInfo(\_PhpScoper8aa7c2bece07\Symfony\Component\Console\Input\InputInterface $input) : \Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    private function resolveMissingPackagesInSplitTests(array $packages, \Symplify\SmartFileSystem\SmartFileInfo $workflowFileInfo) : array
    {
        ...
        foreach ($packages as $package) {
            ...
            if (\_PhpScoper8aa7c2bece07\Nette\Utils\Strings::match($workflowFileInfo->getContents(), $packageNameItemPattern)) {

...
final class VersionUtils
{
     ...
     * @param Version|string $version
     */
    private function normalizeVersion($version) : \_PhpScoper6d6fbd28d6a9\PharIo\Version\Version
    {
    ...
    private function getNextMinorNumber(\_PhpScoper6d6fbd28d6a9\PharIo\Version\Version $version) : int
    {

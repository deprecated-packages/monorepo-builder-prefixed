...
final class VersionUtils
{
     ...
     * @param Version|string $version
     */
    private function normalizeVersion($version) : \_PhpScoperfdd2db5e123d\PharIo\Version\Version
    {
    ...
    private function getNextMinorNumber(\_PhpScoperfdd2db5e123d\PharIo\Version\Version $version) : int
    {

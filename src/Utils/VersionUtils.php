...
final class VersionUtils
{
     ...
     * @param Version|string $version
     */
    private function normalizeVersion($version) : \_PhpScoperdfdcb3d4cca0\PharIo\Version\Version
    {
    ...
    private function getNextMinorNumber(\_PhpScoperdfdcb3d4cca0\PharIo\Version\Version $version) : int
    {

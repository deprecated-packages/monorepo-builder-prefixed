...
final class VersionUtils
{
     ...
     * @param Version|string $version
     */
    private function normalizeVersion($version) : \_PhpScopera28be7b3fe51\PharIo\Version\Version
    {
    ...
    private function getNextMinorNumber(\_PhpScopera28be7b3fe51\PharIo\Version\Version $version) : int
    {

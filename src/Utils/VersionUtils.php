...
final class VersionUtils
{
     ...
     * @param Version|string $version
     */
    private function normalizeVersion($version) : \_PhpScoperfd1a6a0ee9af\PharIo\Version\Version
    {
    ...
    private function getNextMinorNumber(\_PhpScoperfd1a6a0ee9af\PharIo\Version\Version $version) : int
    {

...
final class VersionUtils
{
     ...
     * @param Version|string $version
     */
    private function normalizeVersion($version) : \_PhpScoperf2e2fcfe7ee6\PharIo\Version\Version
    {
    ...
    private function getNextMinorNumber(\_PhpScoperf2e2fcfe7ee6\PharIo\Version\Version $version) : int
    {

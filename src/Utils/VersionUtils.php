...
final class VersionUtils
{
     ...
     * @param Version|string $version
     */
    private function normalizeVersion($version) : \_PhpScoperd79f30a2f8be\PharIo\Version\Version
    {
    ...
    private function getNextMinorNumber(\_PhpScoperd79f30a2f8be\PharIo\Version\Version $version) : int
    {

...
namespace _PhpScoperb2257feafd7d\Composer;

use _PhpScoperb2257feafd7d\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoperb2257feafd7d\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {

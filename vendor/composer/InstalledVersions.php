...
namespace _PhpScoper056b892061ac\Composer;

use _PhpScoper056b892061ac\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper056b892061ac\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {

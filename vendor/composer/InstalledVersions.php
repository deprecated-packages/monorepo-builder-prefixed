...
namespace _PhpScoper8e5d8d76215d\Composer;

use _PhpScoper8e5d8d76215d\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper8e5d8d76215d\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {

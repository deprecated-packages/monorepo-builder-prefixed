...
namespace _PhpScoper8a4bdaafa6ec\Composer;

use _PhpScoper8a4bdaafa6ec\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper8a4bdaafa6ec\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {

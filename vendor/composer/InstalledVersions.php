...
namespace _PhpScopera2bd9a9af620\Composer;

use _PhpScopera2bd9a9af620\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScopera2bd9a9af620\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {

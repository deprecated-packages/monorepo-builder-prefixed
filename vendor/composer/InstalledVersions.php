...
namespace _PhpScoper31a2d0e8f655\Composer;

use _PhpScoper31a2d0e8f655\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoper31a2d0e8f655\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {

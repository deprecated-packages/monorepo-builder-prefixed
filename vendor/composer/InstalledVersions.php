...
namespace _PhpScoperabca9a64438b\Composer;

use _PhpScoperabca9a64438b\Composer\Semver\VersionParser;
class InstalledVersions
{
    ...
    public static function satisfies(\_PhpScoperabca9a64438b\Composer\Semver\VersionParser $parser, $packageName, $constraint)
    {

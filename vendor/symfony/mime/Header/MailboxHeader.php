 ...
 * @experimental in 4.3
 */
final class MailboxHeader extends \_PhpScoperac0a9a33ae94\Symfony\Component\Mime\Header\AbstractHeader
{
    private $address;
    ...
    public function getBodyAsString() : string
    {
        ...
        if ($this->address instanceof \_PhpScoperac0a9a33ae94\Symfony\Component\Mime\NamedAddress && ($name = $this->address->getName())) {

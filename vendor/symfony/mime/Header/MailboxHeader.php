 ...
 * @experimental in 4.3
 */
final class MailboxHeader extends \_PhpScoperd8a347ec1761\Symfony\Component\Mime\Header\AbstractHeader
{
    private $address;
    ...
    public function getBodyAsString() : string
    {
        ...
        if ($this->address instanceof \_PhpScoperd8a347ec1761\Symfony\Component\Mime\NamedAddress && ($name = $this->address->getName())) {

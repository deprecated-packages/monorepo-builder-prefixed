 ...
 * @experimental in 4.3
 */
final class MailboxHeader extends \_PhpScoperedfa898a454f\Symfony\Component\Mime\Header\AbstractHeader
{
    private $address;
    ...
    public function getBodyAsString() : string
    {
        ...
        if ($this->address instanceof \_PhpScoperedfa898a454f\Symfony\Component\Mime\NamedAddress && ($name = $this->address->getName())) {

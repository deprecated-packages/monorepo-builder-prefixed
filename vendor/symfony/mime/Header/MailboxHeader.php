 ...
 * @experimental in 4.3
 */
final class MailboxHeader extends \_PhpScoperee8f03533f8b\Symfony\Component\Mime\Header\AbstractHeader
{
    private $address;
    ...
    public function getBodyAsString() : string
    {
        ...
        if ($this->address instanceof \_PhpScoperee8f03533f8b\Symfony\Component\Mime\NamedAddress && ($name = $this->address->getName())) {

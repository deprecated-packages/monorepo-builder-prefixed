 ...
 * @experimental in 4.3
 */
final class MailboxHeader extends \_PhpScoper7d1be3c5de07\Symfony\Component\Mime\Header\AbstractHeader
{
    private $address;
    ...
    public function getBodyAsString() : string
    {
        ...
        if ($this->address instanceof \_PhpScoper7d1be3c5de07\Symfony\Component\Mime\NamedAddress && ($name = $this->address->getName())) {

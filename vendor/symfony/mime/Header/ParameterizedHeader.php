 ...
 * @experimental in 4.3
 */
final class ParameterizedHeader extends \_PhpScoperb397db9687c8\Symfony\Component\Mime\Header\UnstructuredHeader
{
    /**
    ...
    public function __construct(string $name, string $value, array $parameters = [])
    {
        ...
        if ('content-disposition' === \strtolower($name)) {
            $this->encoder = new \_PhpScoperb397db9687c8\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
        }
    }

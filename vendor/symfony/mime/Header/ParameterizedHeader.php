...
use _PhpScopere3ed9f66440c\Symfony\Component\Mime\Encoder\Rfc2231Encoder;
/**
 * @author Chris Corbyn
 *
 * @experimental in 4.3
 */
final class ParameterizedHeader extends \_PhpScopere3ed9f66440c\Symfony\Component\Mime\Header\UnstructuredHeader
{
    /**
    ...
    public function __construct(string $name, string $value, array $parameters = [])
    {
        ...
        if ('content-disposition' === \strtolower($name)) {
            $this->encoder = new \_PhpScopere3ed9f66440c\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
        }
    }

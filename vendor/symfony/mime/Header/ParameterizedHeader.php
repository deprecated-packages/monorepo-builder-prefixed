 ...
 * @experimental in 4.3
 */
final class ParameterizedHeader extends \_PhpScoperee8f03533f8b\Symfony\Component\Mime\Header\UnstructuredHeader
{
    /**
    ...
    public function __construct(string $name, string $value, array $parameters = [])
    {
        ...
        if ('content-disposition' === \strtolower($name)) {
            $this->encoder = new \_PhpScoperee8f03533f8b\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
        }
    }

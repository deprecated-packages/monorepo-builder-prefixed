...
use _PhpScoperb2257feafd7d\Symfony\Component\Mime\Encoder\Rfc2231Encoder;
/**
 * @author Chris Corbyn
 *
 * @experimental in 4.3
 */
final class ParameterizedHeader extends \_PhpScoperb2257feafd7d\Symfony\Component\Mime\Header\UnstructuredHeader
{
    /**
    ...
    public function __construct(string $name, string $value, array $parameters = [])
    {
        ...
        if ('content-disposition' === \strtolower($name)) {
            $this->encoder = new \_PhpScoperb2257feafd7d\Symfony\Component\Mime\Encoder\Rfc2231Encoder();
        }
    }

 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScopereb7fcd8f999a\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScopereb7fcd8f999a\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScopereb7fcd8f999a\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

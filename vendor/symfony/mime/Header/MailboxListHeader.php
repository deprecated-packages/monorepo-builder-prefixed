 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScopereaa2cae8e093\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScopereaa2cae8e093\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScopereaa2cae8e093\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

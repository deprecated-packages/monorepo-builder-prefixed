 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScopercd5c1af09a49\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScopercd5c1af09a49\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScopercd5c1af09a49\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

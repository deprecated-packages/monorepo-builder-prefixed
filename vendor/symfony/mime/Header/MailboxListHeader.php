 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoper46d05083fbc3\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoper46d05083fbc3\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoper46d05083fbc3\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

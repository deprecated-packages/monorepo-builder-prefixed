 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoper354754c20063\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoper354754c20063\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoper354754c20063\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

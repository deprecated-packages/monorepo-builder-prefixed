 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoper722a1d9fee2c\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoper722a1d9fee2c\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoper722a1d9fee2c\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScopera3f2f7450f99\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScopera3f2f7450f99\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScopera3f2f7450f99\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperbe77f3b0e77d\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperbe77f3b0e77d\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperbe77f3b0e77d\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

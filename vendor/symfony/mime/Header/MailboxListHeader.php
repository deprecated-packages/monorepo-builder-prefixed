 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperddf2171d3d2c\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperddf2171d3d2c\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperddf2171d3d2c\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

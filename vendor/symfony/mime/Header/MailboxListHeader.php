 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoper1ceaf4cbd5cb\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoper1ceaf4cbd5cb\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoper1ceaf4cbd5cb\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

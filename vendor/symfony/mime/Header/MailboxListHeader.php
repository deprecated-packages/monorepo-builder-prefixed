 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperc41e8050ff3f\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperc41e8050ff3f\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperc41e8050ff3f\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScopere6fd569fd43f\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScopere6fd569fd43f\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScopere6fd569fd43f\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

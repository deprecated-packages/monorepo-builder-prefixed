 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperad3f32c1b87c\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperad3f32c1b87c\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperad3f32c1b87c\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperad5317739bda\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperad5317739bda\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperad5317739bda\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

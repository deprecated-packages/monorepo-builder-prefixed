 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperb1086ecf2bcb\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperb1086ecf2bcb\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperb1086ecf2bcb\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperbc89827b806f\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperbc89827b806f\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperbc89827b806f\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

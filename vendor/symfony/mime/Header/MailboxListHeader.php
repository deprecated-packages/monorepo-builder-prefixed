 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScopere846b54512fc\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScopere846b54512fc\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScopere846b54512fc\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperfdd2db5e123d\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperfdd2db5e123d\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperfdd2db5e123d\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

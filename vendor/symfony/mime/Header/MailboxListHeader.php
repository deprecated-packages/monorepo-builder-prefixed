 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoper97d4f3c5628a\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoper97d4f3c5628a\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoper97d4f3c5628a\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

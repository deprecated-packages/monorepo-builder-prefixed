 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperaff2103cee1d\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperaff2103cee1d\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperaff2103cee1d\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

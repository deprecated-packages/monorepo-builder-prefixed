 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperedfa898a454f\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperedfa898a454f\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperedfa898a454f\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

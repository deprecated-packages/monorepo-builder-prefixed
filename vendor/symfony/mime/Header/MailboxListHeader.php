 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoper53a6895b9c5b\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoper53a6895b9c5b\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoper53a6895b9c5b\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

 ...
 * @experimental in 4.3
 */
final class MailboxListHeader extends \_PhpScoperd79f30a2f8be\Symfony\Component\Mime\Header\AbstractHeader
{
    private $addresses = [];
    /**
     ...
     * @throws RfcComplianceException
     */
    public function addAddress(\_PhpScoperd79f30a2f8be\Symfony\Component\Mime\Address $address)
    {
    ...
    public function getAddressStrings() : array
    {
        ...
        foreach ($this->addresses as $address) {
            ...
            if ($address instanceof \_PhpScoperd79f30a2f8be\Symfony\Component\Mime\NamedAddress && ($name = $address->getName())) {

 ...
 * @experimental in 4.3
 */
final class IdentificationHeader extends \_PhpScoperafeb7177e88e\Symfony\Component\Mime\Header\AbstractHeader
{
    private $ids = [];
    ...
    public function setIds(array $ids)
    {
        ...
        $this->idsAsAddresses = [];
        foreach ($ids as $id) {
            $this->idsAsAddresses[] = new \_PhpScoperafeb7177e88e\Symfony\Component\Mime\Address($id);
            $this->ids[] = $id;
        }
    }
    /**

 ...
 * @experimental in 4.3
 */
abstract class AbstractMultipartPart extends \_PhpScopereb7fcd8f999a\Symfony\Component\Mime\Part\AbstractPart
{
    private $boundary;
    private $parts = [];
    public function __construct(\_PhpScopereb7fcd8f999a\Symfony\Component\Mime\Part\AbstractPart ...$parts)
    {
        parent::__construct();

 ...
 * @experimental in 4.3
 */
final class Base64ContentEncoder extends \_PhpScoperb15c77d6bb3b\Symfony\Component\Mime\Encoder\Base64Encoder implements \_PhpScoperb15c77d6bb3b\Symfony\Component\Mime\Encoder\ContentEncoderInterface
{
    public function encodeByteStream($stream, int $maxLineLength = 0) : iterable
    {
        ...
        if (!\is_resource($filter)) {
            throw new \_PhpScoperb15c77d6bb3b\Symfony\Component\Mime\Exception\RuntimeException('Unable to set the base64 content encoder to the filter.');
        }

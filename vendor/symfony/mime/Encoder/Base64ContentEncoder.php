 ...
 * @experimental in 4.3
 */
final class Base64ContentEncoder extends \_PhpScoperdfdcb3d4cca0\Symfony\Component\Mime\Encoder\Base64Encoder implements \_PhpScoperdfdcb3d4cca0\Symfony\Component\Mime\Encoder\ContentEncoderInterface
{
    public function encodeByteStream($stream, int $maxLineLength = 0) : iterable
    {
        ...
        if (!\is_resource($filter)) {
            throw new \_PhpScoperdfdcb3d4cca0\Symfony\Component\Mime\Exception\RuntimeException('Unable to set the base64 content encoder to the filter.');
        }

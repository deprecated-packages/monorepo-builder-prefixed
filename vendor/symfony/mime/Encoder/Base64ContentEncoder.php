 ...
 * @experimental in 4.3
 */
final class Base64ContentEncoder extends \_PhpScopere10afbb60721\Symfony\Component\Mime\Encoder\Base64Encoder implements \_PhpScopere10afbb60721\Symfony\Component\Mime\Encoder\ContentEncoderInterface
{
    public function encodeByteStream($stream, int $maxLineLength = 0) : iterable
    {
        ...
        if (!\is_resource($filter)) {
            throw new \_PhpScopere10afbb60721\Symfony\Component\Mime\Exception\RuntimeException('Unable to set the base64 content encoder to the filter.');
        }

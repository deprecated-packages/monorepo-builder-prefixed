...
use _PhpScopere6fd569fd43f\Symfony\Component\Mime\Header\DateHeader;
class DateHeaderTest extends \_PhpScopere6fd569fd43f\PHPUnit\Framework\TestCase
{
    /* --
    ...
    {
        $header = new \_PhpScopere6fd569fd43f\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime = new \DateTimeImmutable());
        $this->assertSame($dateTime, $header->getDateTime());
    }
    public function testDateTimeCanBeSetBySetter()
    {
        $header = new \_PhpScopere6fd569fd43f\Symfony\Component\Mime\Header\DateHeader('Date', new \DateTimeImmutable());
    ...
    public function testDateTimeIsConvertedToImmutable()
    {
        ...
        $header = new \_PhpScopere6fd569fd43f\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime);
    ...
    {
        $header = new \_PhpScopere6fd569fd43f\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime = new \DateTime('2000-01-01 12:00:00 Europe/Berlin'));
    ...
    {
        $header = new \_PhpScopere6fd569fd43f\Symfony\Component\Mime\Header\DateHeader('Date', $dateTime = new \DateTimeImmutable('2000-01-01 12:00:00 Europe/Berlin'));

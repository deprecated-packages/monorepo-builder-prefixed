...
class NamedAddressTest extends \_PhpScoperf78d2b40800e\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $a = new \_PhpScoperf78d2b40800e\Symfony\Component\Mime\NamedAddress('fabien@symfonï.com', 'Fabien');

...
class NamedAddressTest extends \_PhpScoperc9dc9dec1b4a\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $a = new \_PhpScoperc9dc9dec1b4a\Symfony\Component\Mime\NamedAddress('fabien@symfonï.com', 'Fabien');

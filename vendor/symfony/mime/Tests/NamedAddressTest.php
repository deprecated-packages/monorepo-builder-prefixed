...
class NamedAddressTest extends \_PhpScopereb7fcd8f999a\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $a = new \_PhpScopereb7fcd8f999a\Symfony\Component\Mime\NamedAddress('fabien@symfonï.com', 'Fabien');

...
class NamedAddressTest extends \_PhpScoperddf2171d3d2c\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $a = new \_PhpScoperddf2171d3d2c\Symfony\Component\Mime\NamedAddress('fabien@symfonï.com', 'Fabien');

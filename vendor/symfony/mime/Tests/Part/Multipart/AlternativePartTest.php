...
class AlternativePartTest extends \_PhpScoperec2b815193b4\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $a = new \_PhpScoperec2b815193b4\Symfony\Component\Mime\Part\Multipart\AlternativePart();

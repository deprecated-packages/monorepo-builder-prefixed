...
class RelatedPartTest extends \_PhpScoper77ed23b49cd3\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $r = new \_PhpScoper77ed23b49cd3\Symfony\Component\Mime\Part\Multipart\RelatedPart($a = new \_PhpScoper77ed23b49cd3\Symfony\Component\Mime\Part\TextPart('content'), $b = new \_PhpScoper77ed23b49cd3\Symfony\Component\Mime\Part\TextPart('HTML content', 'utf-8', 'html'), $c = new \_PhpScoper77ed23b49cd3\Symfony\Component\Mime\Part\TextPart('HTML content again', 'utf-8', 'html'));

 ...
 */
class MimeTypesTest extends \_PhpScoperabca9a64438b\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperabca9a64438b\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperabca9a64438b\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperabca9a64438b\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperabca9a64438b\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperabca9a64438b\Symfony\Component\Mime\MimeTypes();

...
use _PhpScoperf0b2c071f15d\Symfony\Component\Mime\MimeTypeGuesserInterface;
use _PhpScoperf0b2c071f15d\Symfony\Component\Mime\MimeTypes;
/**
 * @requires extension fileinfo
 */
class MimeTypesTest extends \_PhpScoperf0b2c071f15d\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperf0b2c071f15d\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperf0b2c071f15d\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperf0b2c071f15d\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperf0b2c071f15d\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperf0b2c071f15d\Symfony\Component\Mime\MimeTypes();

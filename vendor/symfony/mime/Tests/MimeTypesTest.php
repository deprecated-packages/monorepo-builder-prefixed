 ...
 */
class MimeTypesTest extends \_PhpScoperaff2103cee1d\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperaff2103cee1d\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperaff2103cee1d\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperaff2103cee1d\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperaff2103cee1d\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperaff2103cee1d\Symfony\Component\Mime\MimeTypes();

 ...
 */
class MimeTypesTest extends \_PhpScopercdc90a6628b6\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScopercdc90a6628b6\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScopercdc90a6628b6\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScopercdc90a6628b6\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScopercdc90a6628b6\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScopercdc90a6628b6\Symfony\Component\Mime\MimeTypes();

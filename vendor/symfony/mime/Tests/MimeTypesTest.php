 ...
 */
class MimeTypesTest extends \_PhpScopereaa2cae8e093\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScopereaa2cae8e093\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScopereaa2cae8e093\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScopereaa2cae8e093\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScopereaa2cae8e093\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScopereaa2cae8e093\Symfony\Component\Mime\MimeTypes();

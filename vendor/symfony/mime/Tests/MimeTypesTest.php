 ...
 */
class MimeTypesTest extends \_PhpScopera2ff5fd2b59c\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScopera2ff5fd2b59c\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScopera2ff5fd2b59c\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScopera2ff5fd2b59c\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScopera2ff5fd2b59c\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScopera2ff5fd2b59c\Symfony\Component\Mime\MimeTypes();

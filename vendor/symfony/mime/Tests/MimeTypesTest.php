 ...
 */
class MimeTypesTest extends \_PhpScopere846b54512fc\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScopere846b54512fc\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScopere846b54512fc\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScopere846b54512fc\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScopere846b54512fc\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScopere846b54512fc\Symfony\Component\Mime\MimeTypes();

 ...
 */
class MimeTypesTest extends \_PhpScoperd79f30a2f8be\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperd79f30a2f8be\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperd79f30a2f8be\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperd79f30a2f8be\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperd79f30a2f8be\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperd79f30a2f8be\Symfony\Component\Mime\MimeTypes();

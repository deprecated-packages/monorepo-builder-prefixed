 ...
 */
class MimeTypesTest extends \_PhpScoperef96225926e2\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperef96225926e2\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperef96225926e2\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperef96225926e2\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperef96225926e2\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperef96225926e2\Symfony\Component\Mime\MimeTypes();

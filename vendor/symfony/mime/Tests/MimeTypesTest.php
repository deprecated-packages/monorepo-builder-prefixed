 ...
 */
class MimeTypesTest extends \_PhpScoperc41e8050ff3f\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperc41e8050ff3f\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperc41e8050ff3f\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperc41e8050ff3f\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperc41e8050ff3f\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperc41e8050ff3f\Symfony\Component\Mime\MimeTypes();

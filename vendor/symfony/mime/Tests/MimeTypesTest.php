 ...
 */
class MimeTypesTest extends \_PhpScoperd2185c67a4b4\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperd2185c67a4b4\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperd2185c67a4b4\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperd2185c67a4b4\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperd2185c67a4b4\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperd2185c67a4b4\Symfony\Component\Mime\MimeTypes();

 ...
 */
class MimeTypesTest extends \_PhpScoper22d98a58be40\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper22d98a58be40\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper22d98a58be40\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper22d98a58be40\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper22d98a58be40\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper22d98a58be40\Symfony\Component\Mime\MimeTypes();

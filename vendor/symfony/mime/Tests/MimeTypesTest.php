 ...
 */
class MimeTypesTest extends \_PhpScoperf78d2b40800e\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperf78d2b40800e\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperf78d2b40800e\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperf78d2b40800e\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperf78d2b40800e\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperf78d2b40800e\Symfony\Component\Mime\MimeTypes();

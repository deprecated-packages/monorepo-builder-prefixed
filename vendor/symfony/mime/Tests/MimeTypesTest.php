 ...
 */
class MimeTypesTest extends \_PhpScoperee8f03533f8b\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperee8f03533f8b\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperee8f03533f8b\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperee8f03533f8b\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperee8f03533f8b\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperee8f03533f8b\Symfony\Component\Mime\MimeTypes();

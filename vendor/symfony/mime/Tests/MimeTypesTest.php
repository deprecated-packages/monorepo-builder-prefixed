 ...
 */
class MimeTypesTest extends \_PhpScoper9ea409d355af\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper9ea409d355af\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper9ea409d355af\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper9ea409d355af\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper9ea409d355af\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper9ea409d355af\Symfony\Component\Mime\MimeTypes();

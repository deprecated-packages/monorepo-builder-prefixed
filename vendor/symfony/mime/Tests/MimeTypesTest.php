 ...
 */
class MimeTypesTest extends \_PhpScoperdfa889d8967a\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperdfa889d8967a\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperdfa889d8967a\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperdfa889d8967a\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperdfa889d8967a\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperdfa889d8967a\Symfony\Component\Mime\MimeTypes();

 ...
 */
class MimeTypesTest extends \_PhpScoperb445cd48032c\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperb445cd48032c\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperb445cd48032c\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperb445cd48032c\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperb445cd48032c\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperb445cd48032c\Symfony\Component\Mime\MimeTypes();

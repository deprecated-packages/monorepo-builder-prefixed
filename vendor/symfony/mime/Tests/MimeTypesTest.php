 ...
 */
class MimeTypesTest extends \_PhpScoperbd03d493ccc6\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperbd03d493ccc6\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperbd03d493ccc6\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperbd03d493ccc6\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperbd03d493ccc6\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperbd03d493ccc6\Symfony\Component\Mime\MimeTypes();

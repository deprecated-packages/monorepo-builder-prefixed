 ...
 */
class MimeTypesTest extends \_PhpScoperfec5e512f2f8\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperfec5e512f2f8\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperfec5e512f2f8\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperfec5e512f2f8\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperfec5e512f2f8\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperfec5e512f2f8\Symfony\Component\Mime\MimeTypes();

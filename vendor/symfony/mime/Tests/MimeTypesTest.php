 ...
 */
class MimeTypesTest extends \_PhpScoperad5317739bda\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperad5317739bda\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperad5317739bda\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperad5317739bda\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperad5317739bda\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperad5317739bda\Symfony\Component\Mime\MimeTypes();

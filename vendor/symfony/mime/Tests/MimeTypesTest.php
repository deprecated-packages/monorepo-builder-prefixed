 ...
 */
class MimeTypesTest extends \_PhpScoperbb737891eded\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperbb737891eded\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperbb737891eded\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperbb737891eded\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperbb737891eded\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperbb737891eded\Symfony\Component\Mime\MimeTypes();

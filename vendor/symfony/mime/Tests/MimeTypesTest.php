 ...
 */
class MimeTypesTest extends \_PhpScoperfdd2db5e123d\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperfdd2db5e123d\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperfdd2db5e123d\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperfdd2db5e123d\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperfdd2db5e123d\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperfdd2db5e123d\Symfony\Component\Mime\MimeTypes();

 ...
 */
class MimeTypesTest extends \_PhpScoper722a1d9fee2c\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoper722a1d9fee2c\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoper722a1d9fee2c\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoper722a1d9fee2c\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoper722a1d9fee2c\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoper722a1d9fee2c\Symfony\Component\Mime\MimeTypes();

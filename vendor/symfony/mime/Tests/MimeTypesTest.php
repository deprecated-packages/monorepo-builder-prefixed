 ...
 */
class MimeTypesTest extends \_PhpScoperdab52924cf3e\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperdab52924cf3e\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperdab52924cf3e\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperdab52924cf3e\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperdab52924cf3e\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperdab52924cf3e\Symfony\Component\Mime\MimeTypes();

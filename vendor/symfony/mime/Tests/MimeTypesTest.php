 ...
 */
class MimeTypesTest extends \_PhpScoperb25e75e9febe\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperb25e75e9febe\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperb25e75e9febe\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperb25e75e9febe\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperb25e75e9febe\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperb25e75e9febe\Symfony\Component\Mime\MimeTypes();

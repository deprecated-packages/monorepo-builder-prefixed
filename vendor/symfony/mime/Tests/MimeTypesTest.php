 ...
 */
class MimeTypesTest extends \_PhpScoperf4d251e01a80\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperf4d251e01a80\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperf4d251e01a80\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperf4d251e01a80\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperf4d251e01a80\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperf4d251e01a80\Symfony\Component\Mime\MimeTypes();

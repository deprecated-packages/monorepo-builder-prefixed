 ...
 */
class MimeTypesTest extends \_PhpScoperb0f70d760c3d\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperb0f70d760c3d\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperb0f70d760c3d\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperb0f70d760c3d\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperb0f70d760c3d\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperb0f70d760c3d\Symfony\Component\Mime\MimeTypes();

 ...
 */
class MimeTypesTest extends \_PhpScoperedfa898a454f\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperedfa898a454f\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperedfa898a454f\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperedfa898a454f\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperedfa898a454f\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperedfa898a454f\Symfony\Component\Mime\MimeTypes();

 ...
 */
class MimeTypesTest extends \_PhpScoperaf523e5605cc\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScoperaf523e5605cc\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScoperaf523e5605cc\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScoperaf523e5605cc\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScoperaf523e5605cc\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScoperaf523e5605cc\Symfony\Component\Mime\MimeTypes();

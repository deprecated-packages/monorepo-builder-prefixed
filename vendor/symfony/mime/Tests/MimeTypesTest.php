 ...
 */
class MimeTypesTest extends \_PhpScopera85504f0ea7b\Symfony\Component\Mime\Tests\AbstractMimeTypeGuesserTest
{
    protected function getGuesser() : \_PhpScopera85504f0ea7b\Symfony\Component\Mime\MimeTypeGuesserInterface
    {
        return new \_PhpScopera85504f0ea7b\Symfony\Component\Mime\MimeTypes();
    }
    public function testUnsupportedGuesser()
    {
        $guesser = $this->getGuesser();
        $guesser->registerGuesser(new class implements \_PhpScopera85504f0ea7b\Symfony\Component\Mime\MimeTypeGuesserInterface
        {
            ...
            {
                throw new \_PhpScopera85504f0ea7b\Symfony\Component\Mime\Exception\RuntimeException('Should never be called.');
            }
        });
    ...
    {
        $mt = new \_PhpScopera85504f0ea7b\Symfony\Component\Mime\MimeTypes();

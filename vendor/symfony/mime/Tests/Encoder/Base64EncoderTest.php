...
use _PhpScoperbecbc4cd500f\Symfony\Component\Mime\Encoder\Base64Encoder;
class Base64EncoderTest extends \_PhpScoperbecbc4cd500f\PHPUnit\Framework\TestCase
{
    /*
    ...
    */
    public function testInputOutputRatioIs3to4Bytes()
    {
        ...
        */
        $encoder = new \_PhpScoperbecbc4cd500f\Symfony\Component\Mime\Encoder\Base64Encoder();

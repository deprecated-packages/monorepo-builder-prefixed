...
use _PhpScopereb7fcd8f999a\Symfony\Component\Mime\Encoder\Base64Encoder;
class Base64EncoderTest extends \_PhpScopereb7fcd8f999a\PHPUnit\Framework\TestCase
{
    /*
    ...
    */
    public function testInputOutputRatioIs3to4Bytes()
    {
        ...
        */
        $encoder = new \_PhpScopereb7fcd8f999a\Symfony\Component\Mime\Encoder\Base64Encoder();

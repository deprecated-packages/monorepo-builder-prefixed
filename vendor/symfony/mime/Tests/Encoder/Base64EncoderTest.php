...
use _PhpScopere57ee17947a3\Symfony\Component\Mime\Encoder\Base64Encoder;
class Base64EncoderTest extends \_PhpScopere57ee17947a3\PHPUnit\Framework\TestCase
{
    /*
    ...
    */
    public function testInputOutputRatioIs3to4Bytes()
    {
        ...
        */
        $encoder = new \_PhpScopere57ee17947a3\Symfony\Component\Mime\Encoder\Base64Encoder();

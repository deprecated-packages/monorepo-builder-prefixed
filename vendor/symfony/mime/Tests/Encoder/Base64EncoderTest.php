...
use _PhpScoperdfdcb3d4cca0\Symfony\Component\Mime\Encoder\Base64Encoder;
class Base64EncoderTest extends \_PhpScoperdfdcb3d4cca0\PHPUnit\Framework\TestCase
{
    /*
    ...
    */
    public function testInputOutputRatioIs3to4Bytes()
    {
        ...
        */
        $encoder = new \_PhpScoperdfdcb3d4cca0\Symfony\Component\Mime\Encoder\Base64Encoder();

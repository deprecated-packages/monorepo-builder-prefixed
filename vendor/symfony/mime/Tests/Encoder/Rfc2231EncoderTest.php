...
class Rfc2231EncoderTest extends \_PhpScoperac0a9a33ae94\PHPUnit\Framework\TestCase
{
    ...
    public function testEncodingAsciiCharactersProducesValidToken()
    {
        ...
        $encoder = new \_PhpScoperac0a9a33ae94\Symfony\Component\Mime\Encoder\Rfc2231Encoder();

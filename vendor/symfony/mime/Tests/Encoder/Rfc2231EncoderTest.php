...
class Rfc2231EncoderTest extends \_PhpScoperf2e2fcfe7ee6\PHPUnit\Framework\TestCase
{
    ...
    public function testEncodingAsciiCharactersProducesValidToken()
    {
        ...
        $encoder = new \_PhpScoperf2e2fcfe7ee6\Symfony\Component\Mime\Encoder\Rfc2231Encoder();

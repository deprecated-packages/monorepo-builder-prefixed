...
class Rfc2231EncoderTest extends \_PhpScoperdfa889d8967a\PHPUnit\Framework\TestCase
{
    ...
    public function testEncodingAsciiCharactersProducesValidToken()
    {
        ...
        $encoder = new \_PhpScoperdfa889d8967a\Symfony\Component\Mime\Encoder\Rfc2231Encoder();

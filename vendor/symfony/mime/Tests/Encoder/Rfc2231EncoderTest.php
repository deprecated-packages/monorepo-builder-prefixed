...
class Rfc2231EncoderTest extends \_PhpScoperfd1a6a0ee9af\PHPUnit\Framework\TestCase
{
    ...
    public function testEncodingAsciiCharactersProducesValidToken()
    {
        ...
        $encoder = new \_PhpScoperfd1a6a0ee9af\Symfony\Component\Mime\Encoder\Rfc2231Encoder();

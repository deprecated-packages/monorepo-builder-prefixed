...
class Rfc2231EncoderTest extends \_PhpScoper93a7e58d9dd1\PHPUnit\Framework\TestCase
{
    ...
    public function testEncodingAsciiCharactersProducesValidToken()
    {
        ...
        $encoder = new \_PhpScoper93a7e58d9dd1\Symfony\Component\Mime\Encoder\Rfc2231Encoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoper8a1d608a1a7e\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper8a1d608a1a7e\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

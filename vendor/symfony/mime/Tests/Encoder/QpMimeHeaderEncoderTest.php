...
class QpMimeHeaderEncoderTest extends \_PhpScoperdab52924cf3e\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperdab52924cf3e\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoper8e5d8d76215d\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper8e5d8d76215d\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperd2185c67a4b4\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperd2185c67a4b4\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

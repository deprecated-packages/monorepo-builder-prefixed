...
class QpMimeHeaderEncoderTest extends \_PhpScoper5efd9ec7ae1e\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper5efd9ec7ae1e\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

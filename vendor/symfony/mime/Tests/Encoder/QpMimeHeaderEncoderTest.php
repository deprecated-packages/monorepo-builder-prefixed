...
class QpMimeHeaderEncoderTest extends \_PhpScoperd8a347ec1761\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperd8a347ec1761\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

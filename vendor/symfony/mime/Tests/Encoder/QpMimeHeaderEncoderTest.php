...
class QpMimeHeaderEncoderTest extends \_PhpScoperd410cf9baa15\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperd410cf9baa15\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

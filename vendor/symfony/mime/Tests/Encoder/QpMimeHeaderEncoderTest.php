...
class QpMimeHeaderEncoderTest extends \_PhpScoperd79f30a2f8be\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperd79f30a2f8be\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

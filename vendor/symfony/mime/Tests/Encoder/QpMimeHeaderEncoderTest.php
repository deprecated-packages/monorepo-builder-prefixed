...
class QpMimeHeaderEncoderTest extends \_PhpScoperc9dee8f3b3e7\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperc9dee8f3b3e7\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

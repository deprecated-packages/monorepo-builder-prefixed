...
class QpMimeHeaderEncoderTest extends \_PhpScoper711ac919263f\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper711ac919263f\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

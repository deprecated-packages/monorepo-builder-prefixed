...
class QpMimeHeaderEncoderTest extends \_PhpScoper1ceaf4cbd5cb\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper1ceaf4cbd5cb\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperdfdcb3d4cca0\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperdfdcb3d4cca0\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScopera1d8e0344ecf\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopera1d8e0344ecf\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

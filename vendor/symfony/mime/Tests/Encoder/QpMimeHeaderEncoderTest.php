...
class QpMimeHeaderEncoderTest extends \_PhpScoperfdd2db5e123d\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperfdd2db5e123d\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

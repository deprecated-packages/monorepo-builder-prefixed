...
class QpMimeHeaderEncoderTest extends \_PhpScoperaa2560a8a931\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperaa2560a8a931\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

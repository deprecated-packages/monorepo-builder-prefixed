...
class QpMimeHeaderEncoderTest extends \_PhpScoper3b1a4d12ef28\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper3b1a4d12ef28\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

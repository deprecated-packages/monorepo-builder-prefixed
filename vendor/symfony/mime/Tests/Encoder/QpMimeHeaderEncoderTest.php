...
class QpMimeHeaderEncoderTest extends \_PhpScoper8a4bdaafa6ec\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper8a4bdaafa6ec\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

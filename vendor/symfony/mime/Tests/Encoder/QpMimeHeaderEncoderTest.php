...
class QpMimeHeaderEncoderTest extends \_PhpScopera28be7b3fe51\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopera28be7b3fe51\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

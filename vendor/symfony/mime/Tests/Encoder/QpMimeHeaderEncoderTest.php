...
class QpMimeHeaderEncoderTest extends \_PhpScoperf78d2b40800e\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperf78d2b40800e\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

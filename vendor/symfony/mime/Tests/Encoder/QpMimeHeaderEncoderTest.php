...
class QpMimeHeaderEncoderTest extends \_PhpScoperc8aee0bf0015\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperc8aee0bf0015\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

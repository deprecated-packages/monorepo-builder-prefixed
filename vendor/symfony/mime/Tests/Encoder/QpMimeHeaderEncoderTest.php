...
class QpMimeHeaderEncoderTest extends \_PhpScoperaff2103cee1d\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperaff2103cee1d\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

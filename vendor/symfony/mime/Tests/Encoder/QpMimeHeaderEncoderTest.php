...
class QpMimeHeaderEncoderTest extends \_PhpScoper058a557299a1\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper058a557299a1\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperbd03d493ccc6\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperbd03d493ccc6\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

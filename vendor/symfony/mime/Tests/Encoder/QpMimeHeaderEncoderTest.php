...
class QpMimeHeaderEncoderTest extends \_PhpScopere1b4619561f2\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopere1b4619561f2\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

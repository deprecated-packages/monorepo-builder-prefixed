...
class QpMimeHeaderEncoderTest extends \_PhpScoper1d5917c620d0\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper1d5917c620d0\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

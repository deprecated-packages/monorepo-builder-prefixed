...
class QpMimeHeaderEncoderTest extends \_PhpScoper621af75be782\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper621af75be782\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

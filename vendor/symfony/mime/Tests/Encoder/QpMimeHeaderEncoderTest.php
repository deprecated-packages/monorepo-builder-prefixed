...
class QpMimeHeaderEncoderTest extends \_PhpScoper204b3b8f3e0d\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper204b3b8f3e0d\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

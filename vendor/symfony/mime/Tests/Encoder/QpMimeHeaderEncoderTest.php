...
class QpMimeHeaderEncoderTest extends \_PhpScoper9b5fd937b4d9\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper9b5fd937b4d9\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

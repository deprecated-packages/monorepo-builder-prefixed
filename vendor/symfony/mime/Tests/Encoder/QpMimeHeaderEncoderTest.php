...
class QpMimeHeaderEncoderTest extends \_PhpScoper7371f586a1d2\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper7371f586a1d2\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperef96225926e2\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperef96225926e2\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

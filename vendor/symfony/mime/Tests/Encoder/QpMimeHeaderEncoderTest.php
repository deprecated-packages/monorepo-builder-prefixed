...
class QpMimeHeaderEncoderTest extends \_PhpScoperdd624bbcb4e5\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperdd624bbcb4e5\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

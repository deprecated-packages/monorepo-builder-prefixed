...
class QpMimeHeaderEncoderTest extends \_PhpScoperf6f8e31183c3\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperf6f8e31183c3\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

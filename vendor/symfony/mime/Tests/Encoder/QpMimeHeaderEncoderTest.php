...
class QpMimeHeaderEncoderTest extends \_PhpScoperbecbc4cd500f\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperbecbc4cd500f\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoper3bda9af7e0fd\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper3bda9af7e0fd\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScopereaa2cae8e093\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopereaa2cae8e093\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperf40000691b7b\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperf40000691b7b\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

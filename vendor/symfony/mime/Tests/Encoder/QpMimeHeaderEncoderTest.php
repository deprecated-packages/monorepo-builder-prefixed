...
class QpMimeHeaderEncoderTest extends \_PhpScoperac0a9a33ae94\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperac0a9a33ae94\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

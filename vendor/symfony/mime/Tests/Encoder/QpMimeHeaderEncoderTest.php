...
class QpMimeHeaderEncoderTest extends \_PhpScoper37010f304ea9\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper37010f304ea9\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

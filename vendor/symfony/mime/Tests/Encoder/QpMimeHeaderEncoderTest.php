...
class QpMimeHeaderEncoderTest extends \_PhpScoper46d05083fbc3\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper46d05083fbc3\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

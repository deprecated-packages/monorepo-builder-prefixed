...
class QpMimeHeaderEncoderTest extends \_PhpScoper66a1b4bf441c\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper66a1b4bf441c\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

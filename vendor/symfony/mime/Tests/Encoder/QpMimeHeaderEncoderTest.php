...
class QpMimeHeaderEncoderTest extends \_PhpScoper963537526adf\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper963537526adf\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

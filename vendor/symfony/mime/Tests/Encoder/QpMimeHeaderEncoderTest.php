...
class QpMimeHeaderEncoderTest extends \_PhpScopere97aad8070b4\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopere97aad8070b4\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoper1e8bd38a2146\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper1e8bd38a2146\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperfd1a6a0ee9af\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperfd1a6a0ee9af\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

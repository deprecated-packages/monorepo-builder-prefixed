...
class QpMimeHeaderEncoderTest extends \_PhpScopere57ee17947a3\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopere57ee17947a3\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

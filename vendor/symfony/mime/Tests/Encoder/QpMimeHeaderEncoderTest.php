...
class QpMimeHeaderEncoderTest extends \_PhpScoperef4638f5d8b1\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperef4638f5d8b1\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

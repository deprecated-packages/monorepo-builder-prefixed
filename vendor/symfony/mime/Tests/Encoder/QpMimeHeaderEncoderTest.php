...
class QpMimeHeaderEncoderTest extends \_PhpScoper8d3e33bd2be8\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper8d3e33bd2be8\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

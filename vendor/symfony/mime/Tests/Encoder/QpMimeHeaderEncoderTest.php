...
class QpMimeHeaderEncoderTest extends \_PhpScoper8db311958ad1\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper8db311958ad1\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

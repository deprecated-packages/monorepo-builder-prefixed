...
class QpMimeHeaderEncoderTest extends \_PhpScoper0fa0b2363a34\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper0fa0b2363a34\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScopera85504f0ea7b\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopera85504f0ea7b\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

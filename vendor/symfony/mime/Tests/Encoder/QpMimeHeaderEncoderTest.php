...
class QpMimeHeaderEncoderTest extends \_PhpScoperb397db9687c8\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperb397db9687c8\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

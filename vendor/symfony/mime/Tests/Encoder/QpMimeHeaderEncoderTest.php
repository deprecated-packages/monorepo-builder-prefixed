...
class QpMimeHeaderEncoderTest extends \_PhpScoper12b9214dc5a9\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper12b9214dc5a9\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

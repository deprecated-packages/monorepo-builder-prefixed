...
class QpMimeHeaderEncoderTest extends \_PhpScoperec2b815193b4\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperec2b815193b4\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

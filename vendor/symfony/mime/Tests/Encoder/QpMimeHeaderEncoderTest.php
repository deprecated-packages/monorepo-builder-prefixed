...
class QpMimeHeaderEncoderTest extends \_PhpScoper44d485ef56a2\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper44d485ef56a2\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

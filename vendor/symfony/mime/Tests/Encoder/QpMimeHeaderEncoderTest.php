...
class QpMimeHeaderEncoderTest extends \_PhpScoperad5317739bda\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperad5317739bda\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

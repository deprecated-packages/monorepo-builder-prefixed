...
class QpMimeHeaderEncoderTest extends \_PhpScoper23507306fdfc\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper23507306fdfc\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

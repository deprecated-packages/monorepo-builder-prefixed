...
class QpMimeHeaderEncoderTest extends \_PhpScoper777981beaf84\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper777981beaf84\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

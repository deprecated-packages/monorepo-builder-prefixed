...
class QpMimeHeaderEncoderTest extends \_PhpScoperb9e77befe692\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperb9e77befe692\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

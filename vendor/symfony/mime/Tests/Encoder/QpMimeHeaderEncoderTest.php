...
class QpMimeHeaderEncoderTest extends \_PhpScoper6da0ff96db02\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper6da0ff96db02\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

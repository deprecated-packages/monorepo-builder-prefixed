...
class QpMimeHeaderEncoderTest extends \_PhpScopera31d0d6ff47a\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopera31d0d6ff47a\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

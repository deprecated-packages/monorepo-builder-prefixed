...
class QpMimeHeaderEncoderTest extends \_PhpScoper77ed23b49cd3\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper77ed23b49cd3\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

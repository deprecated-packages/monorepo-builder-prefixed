...
class QpMimeHeaderEncoderTest extends \_PhpScoper36281e29f54f\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper36281e29f54f\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperb56893078f23\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperb56893078f23\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

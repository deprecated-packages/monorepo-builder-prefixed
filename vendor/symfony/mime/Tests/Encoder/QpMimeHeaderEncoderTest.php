...
class QpMimeHeaderEncoderTest extends \_PhpScoper650fbdd90fa0\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper650fbdd90fa0\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

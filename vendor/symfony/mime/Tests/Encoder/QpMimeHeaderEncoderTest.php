...
class QpMimeHeaderEncoderTest extends \_PhpScoper5a7e73320450\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper5a7e73320450\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoper4cbad741edc5\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper4cbad741edc5\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

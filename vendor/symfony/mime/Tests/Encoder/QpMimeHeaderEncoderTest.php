...
class QpMimeHeaderEncoderTest extends \_PhpScoperd9ee792cdaf4\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperd9ee792cdaf4\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

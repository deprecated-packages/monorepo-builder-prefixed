...
class QpMimeHeaderEncoderTest extends \_PhpScoper9175a5176ce9\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper9175a5176ce9\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

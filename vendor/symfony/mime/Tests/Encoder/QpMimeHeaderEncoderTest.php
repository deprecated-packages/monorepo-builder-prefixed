...
class QpMimeHeaderEncoderTest extends \_PhpScoperf2e2fcfe7ee6\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperf2e2fcfe7ee6\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

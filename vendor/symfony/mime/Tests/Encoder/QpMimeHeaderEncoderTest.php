...
class QpMimeHeaderEncoderTest extends \_PhpScoperff72c38d4e2a\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperff72c38d4e2a\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperf237fc62366a\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperf237fc62366a\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperc7f1624089a3\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperc7f1624089a3\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperf7284855206a\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperf7284855206a\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoper9a3298f96fa4\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper9a3298f96fa4\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoperee8f03533f8b\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperee8f03533f8b\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

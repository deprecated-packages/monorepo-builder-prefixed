...
class QpMimeHeaderEncoderTest extends \_PhpScoper7606a7c2799b\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper7606a7c2799b\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

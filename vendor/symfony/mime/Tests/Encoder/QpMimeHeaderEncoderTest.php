...
class QpMimeHeaderEncoderTest extends \_PhpScopercdc90a6628b6\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScopercdc90a6628b6\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

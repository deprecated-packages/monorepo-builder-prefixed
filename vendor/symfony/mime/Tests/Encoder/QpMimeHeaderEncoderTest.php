...
class QpMimeHeaderEncoderTest extends \_PhpScoper9e91fe07dbdd\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper9e91fe07dbdd\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

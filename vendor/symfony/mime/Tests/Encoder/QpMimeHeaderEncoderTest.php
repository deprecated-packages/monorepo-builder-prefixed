...
class QpMimeHeaderEncoderTest extends \_PhpScoperc9dc9dec1b4a\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperc9dc9dec1b4a\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

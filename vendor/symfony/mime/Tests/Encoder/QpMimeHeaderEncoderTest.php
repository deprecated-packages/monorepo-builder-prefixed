...
class QpMimeHeaderEncoderTest extends \_PhpScoper0217ecc5969a\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper0217ecc5969a\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

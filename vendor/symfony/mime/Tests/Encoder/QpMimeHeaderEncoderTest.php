...
class QpMimeHeaderEncoderTest extends \_PhpScoper12f30d5eda15\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper12f30d5eda15\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

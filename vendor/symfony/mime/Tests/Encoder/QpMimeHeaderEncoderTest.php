...
class QpMimeHeaderEncoderTest extends \_PhpScoperbb737891eded\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperbb737891eded\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

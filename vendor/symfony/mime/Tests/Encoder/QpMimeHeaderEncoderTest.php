...
class QpMimeHeaderEncoderTest extends \_PhpScoperda849baa4a45\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperda849baa4a45\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

...
class QpMimeHeaderEncoderTest extends \_PhpScoper3ceab9fdc42a\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper3ceab9fdc42a\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

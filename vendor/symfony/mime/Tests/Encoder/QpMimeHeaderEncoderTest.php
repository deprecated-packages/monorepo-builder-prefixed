...
class QpMimeHeaderEncoderTest extends \_PhpScoperb2257feafd7d\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperb2257feafd7d\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

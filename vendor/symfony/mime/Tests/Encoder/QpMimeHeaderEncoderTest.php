...
class QpMimeHeaderEncoderTest extends \_PhpScoperc4633daa1458\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoperc4633daa1458\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

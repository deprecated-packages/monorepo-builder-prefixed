...
class QpMimeHeaderEncoderTest extends \_PhpScoper59bf8deb8cc1\PHPUnit\Framework\TestCase
{
    public function testNameIsQ()
    {
        $encoder = new \_PhpScoper59bf8deb8cc1\Symfony\Component\Mime\Encoder\QpMimeHeaderEncoder();

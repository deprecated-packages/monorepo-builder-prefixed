...
use _PhpScopera1d8e0344ecf\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScopera1d8e0344ecf\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScopera1d8e0344ecf\Symfony\Component\Mime\Encoder\QpEncoder();

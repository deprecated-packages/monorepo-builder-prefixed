...
use _PhpScopera31d0d6ff47a\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScopera31d0d6ff47a\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScopera31d0d6ff47a\Symfony\Component\Mime\Encoder\QpEncoder();

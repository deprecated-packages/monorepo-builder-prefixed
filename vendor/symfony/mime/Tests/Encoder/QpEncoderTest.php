...
use _PhpScoperc86a79e2d6b2\Symfony\Component\Mime\Encoder\QpEncoder;
class QpEncoderTest extends \_PhpScoperc86a79e2d6b2\PHPUnit\Framework\TestCase
{
    /* -- RFC 2045, 6.7 --
    ...
    public function testPermittedCharactersAreNotEncoded()
    {
        /* -- RFC 2045, 6.7 --
           (2)   (Literal representation) Octets with decimal values of
                       ...
                       respectively).
                       */
        $encoder = new \_PhpScoperc86a79e2d6b2\Symfony\Component\Mime\Encoder\QpEncoder();

...
use _PhpScopere2a14c1f9852\Symfony\Component\Mime\MessageConverter;
class MessageConverterTest extends \_PhpScopere2a14c1f9852\PHPUnit\Framework\TestCase
{
    public function testToEmail()
    {
        $file = \file_get_contents(__DIR__ . '/Fixtures/mimetypes/test.gif');
        $email = (new \_PhpScopere2a14c1f9852\Symfony\Component\Mime\Email())->from('fabien@symfony.com');
        $this->assertSame($email, \_PhpScopere2a14c1f9852\Symfony\Component\Mime\MessageConverter::toEmail($email));
    ...
    private function assertConversion(\_PhpScopere2a14c1f9852\Symfony\Component\Mime\Email $expected)
    {
        $r = new \ReflectionMethod($expected, 'generateBody');
        $r->setAccessible(\true);
        $message = new \_PhpScopere2a14c1f9852\Symfony\Component\Mime\Message($expected->getHeaders(), $r->invoke($expected));
        $converted = \_PhpScopere2a14c1f9852\Symfony\Component\Mime\MessageConverter::toEmail($message);

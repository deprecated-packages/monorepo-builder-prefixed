...
use _PhpScoperdbf49b510e11\Symfony\Component\Mime\MessageConverter;
class MessageConverterTest extends \_PhpScoperdbf49b510e11\PHPUnit\Framework\TestCase
{
    public function testToEmail()
    {
        $file = \file_get_contents(__DIR__ . '/Fixtures/mimetypes/test.gif');
        $email = (new \_PhpScoperdbf49b510e11\Symfony\Component\Mime\Email())->from('fabien@symfony.com');
        $this->assertSame($email, \_PhpScoperdbf49b510e11\Symfony\Component\Mime\MessageConverter::toEmail($email));
    ...
    private function assertConversion(\_PhpScoperdbf49b510e11\Symfony\Component\Mime\Email $expected)
    {
        $r = new \ReflectionMethod($expected, 'generateBody');
        $r->setAccessible(\true);
        $message = new \_PhpScoperdbf49b510e11\Symfony\Component\Mime\Message($expected->getHeaders(), $r->invoke($expected));
        $converted = \_PhpScoperdbf49b510e11\Symfony\Component\Mime\MessageConverter::toEmail($message);

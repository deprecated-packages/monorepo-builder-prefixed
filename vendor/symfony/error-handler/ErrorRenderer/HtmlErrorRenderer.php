 ...
 */
namespace _PhpScoper9dd242015966\Symfony\Component\ErrorHandler\ErrorRenderer;
 ...
 */
class HtmlErrorRenderer implements \_PhpScoper9dd242015966\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
     ...
     */
    public function __construct($debug = \false, string $charset = null, $fileLinkFormat = null, string $projectDir = null, $outputBuffer = '', \_PhpScoper9dd242015966\Psr\Log\LoggerInterface $logger = null)
    {
     ...
     * {@inheritdoc}
     */
    public function render(\Throwable $exception) : \_PhpScoper9dd242015966\Symfony\Component\ErrorHandler\Exception\FlattenException
    {
        ...
        $exception = \_PhpScoper9dd242015966\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception, null, $headers);
        return $exception->setAsString($this->renderException($exception));
    }
    /**
     * Gets the HTML content associated with the given exception.
     */
    public function getBody(\_PhpScoper9dd242015966\Symfony\Component\ErrorHandler\Exception\FlattenException $exception) : string
    {
    ...
    public static function isDebug(\_PhpScoper9dd242015966\Symfony\Component\HttpFoundation\RequestStack $requestStack, bool $debug) : \Closure
    {
    ...
    public static function getAndCleanOutputBuffer(\_PhpScoper9dd242015966\Symfony\Component\HttpFoundation\RequestStack $requestStack) : \Closure
    {
        return static function () use($requestStack) : string {
            ...
            \_PhpScoper9dd242015966\Symfony\Component\HttpFoundation\Response::closeOutputBuffers($startObLevel + 1, \true);
            return \ob_get_clean();
        };
    }
    private function renderException(\_PhpScoper9dd242015966\Symfony\Component\ErrorHandler\Exception\FlattenException $exception, string $debugTemplate = 'views/exception_full.html.php') : string
    {
        ...
        return $this->include($debugTemplate, ['exception' => $exception, 'exceptionMessage' => $exceptionMessage, 'statusText' => $statusText, 'statusCode' => $statusCode, 'logger' => $this->logger instanceof \_PhpScoper9dd242015966\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null, 'currentContent' => \is_string($this->outputBuffer) ? $this->outputBuffer : ($this->outputBuffer)()]);
    }
    /**

 ...
 */
namespace _PhpScopere7b233920bf2\Symfony\Component\ErrorHandler\ErrorRenderer;
 ...
 */
class HtmlErrorRenderer implements \_PhpScopere7b233920bf2\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
     ...
     */
    public function __construct($debug = \false, string $charset = null, $fileLinkFormat = null, string $projectDir = null, $outputBuffer = '', \_PhpScopere7b233920bf2\Psr\Log\LoggerInterface $logger = null)
    {
     ...
     * {@inheritdoc}
     */
    public function render(\Throwable $exception) : \_PhpScopere7b233920bf2\Symfony\Component\ErrorHandler\Exception\FlattenException
    {
        ...
        $exception = \_PhpScopere7b233920bf2\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception, null, $headers);
        return $exception->setAsString($this->renderException($exception));
    }
    /**
     * Gets the HTML content associated with the given exception.
     */
    public function getBody(\_PhpScopere7b233920bf2\Symfony\Component\ErrorHandler\Exception\FlattenException $exception) : string
    {
    ...
    public static function isDebug(\_PhpScopere7b233920bf2\Symfony\Component\HttpFoundation\RequestStack $requestStack, bool $debug) : \Closure
    {
    ...
    public static function getAndCleanOutputBuffer(\_PhpScopere7b233920bf2\Symfony\Component\HttpFoundation\RequestStack $requestStack) : \Closure
    {
        return static function () use($requestStack) : string {
            ...
            \_PhpScopere7b233920bf2\Symfony\Component\HttpFoundation\Response::closeOutputBuffers($startObLevel + 1, \true);
            return \ob_get_clean();
        };
    }
    private function renderException(\_PhpScopere7b233920bf2\Symfony\Component\ErrorHandler\Exception\FlattenException $exception, string $debugTemplate = 'views/exception_full.html.php') : string
    {

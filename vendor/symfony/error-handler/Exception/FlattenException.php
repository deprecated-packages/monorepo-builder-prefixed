 ...
 */
namespace _PhpScoper3d314ab2cab4\Symfony\Component\ErrorHandler\Exception;
...
class FlattenException
{
    ...
    public static function createFromThrowable(\Throwable $exception, int $statusCode = null, array $headers = []) : self
    {
        ...
        if ($exception instanceof \_PhpScoper3d314ab2cab4\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \_PhpScoper3d314ab2cab4\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\_PhpScoper3d314ab2cab4\Symfony\Component\HttpFoundation\Response::class) && isset(\_PhpScoper3d314ab2cab4\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \_PhpScoper3d314ab2cab4\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {

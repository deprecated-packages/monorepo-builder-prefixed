 ...
 */
namespace _PhpScoperad5317739bda\Symfony\Component\ErrorHandler;

use _PhpScoperad5317739bda\Doctrine\Common\Persistence\Proxy;
use _PhpScoperad5317739bda\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperad5317739bda\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperad5317739bda\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoperad5317739bda\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperad5317739bda\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoperad5317739bda\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoperad5317739bda\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

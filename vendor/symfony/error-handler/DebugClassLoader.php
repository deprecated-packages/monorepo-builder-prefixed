...
use _PhpScoper131024327b3f\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoper131024327b3f\Doctrine\Persistence\Proxy;
use _PhpScoper131024327b3f\Mockery\MockInterface;
use _PhpScoper131024327b3f\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper131024327b3f\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper131024327b3f\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoper131024327b3f\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper131024327b3f\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoper131024327b3f\\Psr\\Log\\LogLevel');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper131024327b3f\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper131024327b3f\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper131024327b3f\Doctrine\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper131024327b3f\ProxyManager\Proxy\ProxyInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper131024327b3f\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper131024327b3f\Mockery\MockInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoper131024327b3f\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

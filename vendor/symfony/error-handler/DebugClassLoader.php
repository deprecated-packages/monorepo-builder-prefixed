...
use _PhpScoperbb737891eded\Doctrine\Common\Persistence\Proxy;
use _PhpScoperbb737891eded\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperbb737891eded\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperbb737891eded\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoperbb737891eded\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperbb737891eded\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoperbb737891eded\\Psr\\Log\\LogLevel');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoperbb737891eded\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbb737891eded\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbb737891eded\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperbb737891eded\ProxyManager\Proxy\ProxyInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoperbb737891eded\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

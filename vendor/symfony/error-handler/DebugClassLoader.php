...
use _PhpScopera2f1d1d42b88\Doctrine\Common\Persistence\Proxy;
use _PhpScopera2f1d1d42b88\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera2f1d1d42b88\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera2f1d1d42b88\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScopera2f1d1d42b88\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera2f1d1d42b88\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScopera2f1d1d42b88\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScopera2f1d1d42b88\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

...
use _PhpScoper8f797d20934a\Doctrine\Common\Persistence\Proxy;
use _PhpScoper8f797d20934a\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper8f797d20934a\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper8f797d20934a\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoper8f797d20934a\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper8f797d20934a\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoper8f797d20934a\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoper8f797d20934a\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

...
use _PhpScoperc00d4390f333\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoperc00d4390f333\Doctrine\Persistence\Proxy;
use _PhpScoperc00d4390f333\Mockery\MockInterface;
use _PhpScoperc00d4390f333\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperc00d4390f333\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperc00d4390f333\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoperc00d4390f333\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperc00d4390f333\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoperc00d4390f333\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoperc00d4390f333\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

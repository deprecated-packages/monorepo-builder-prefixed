...
use _PhpScoper244a857c31f6\Doctrine\Common\Persistence\Proxy;
use _PhpScoper244a857c31f6\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper244a857c31f6\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper244a857c31f6\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoper244a857c31f6\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper244a857c31f6\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoper244a857c31f6\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoper244a857c31f6\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

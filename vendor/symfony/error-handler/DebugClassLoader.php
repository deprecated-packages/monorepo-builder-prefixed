...
use _PhpScopera2ff5fd2b59c\Doctrine\Common\Persistence\Proxy;
use _PhpScopera2ff5fd2b59c\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera2ff5fd2b59c\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera2ff5fd2b59c\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScopera2ff5fd2b59c\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera2ff5fd2b59c\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScopera2ff5fd2b59c\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScopera2ff5fd2b59c\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

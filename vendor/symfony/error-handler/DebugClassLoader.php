...
use _PhpScopere97aad8070b4\Doctrine\Common\Persistence\Proxy;
use _PhpScopere97aad8070b4\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopere97aad8070b4\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopere97aad8070b4\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScopere97aad8070b4\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopere97aad8070b4\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScopere97aad8070b4\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScopere97aad8070b4\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

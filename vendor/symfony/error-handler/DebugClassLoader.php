...
use _PhpScoperfd1a6a0ee9af\Doctrine\Common\Persistence\Proxy;
use _PhpScoperfd1a6a0ee9af\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoperfd1a6a0ee9af\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoperfd1a6a0ee9af\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoperfd1a6a0ee9af\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoperfd1a6a0ee9af\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoperfd1a6a0ee9af\\Psr\\Log\\LogLevel');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoperfd1a6a0ee9af\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoperfd1a6a0ee9af\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoperfd1a6a0ee9af\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoperfd1a6a0ee9af\ProxyManager\Proxy\ProxyInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoperfd1a6a0ee9af\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

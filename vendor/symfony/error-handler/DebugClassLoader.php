...
use _PhpScopera5e5d165d78c\Doctrine\Common\Persistence\Proxy;
use _PhpScopera5e5d165d78c\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera5e5d165d78c\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera5e5d165d78c\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScopera5e5d165d78c\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera5e5d165d78c\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScopera5e5d165d78c\\Psr\\Log\\LogLevel');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScopera5e5d165d78c\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScopera5e5d165d78c\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera5e5d165d78c\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera5e5d165d78c\ProxyManager\Proxy\ProxyInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScopera5e5d165d78c\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

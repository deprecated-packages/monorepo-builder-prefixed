...
use _PhpScoper8b183f8218dc\Doctrine\Common\Persistence\Proxy;
use _PhpScoper8b183f8218dc\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper8b183f8218dc\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper8b183f8218dc\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoper8b183f8218dc\ProxyManager\Proxy\ProxyInterface;
/**
...
{
    private const SPECIAL_RETURN_TYPES = ['mixed' => 'mixed', 'void' => 'void', 'null' => 'null', 'resource' => 'resource', 'static' => 'object', '$this' => 'object', 'boolean' => 'bool', 'true' => 'bool', 'false' => 'bool', 'integer' => 'int', 'array' => 'array', 'bool' => 'bool', 'callable' => 'callable', 'float' => 'float', 'int' => 'int', 'iterable' => 'iterable', 'object' => 'object', 'string' => 'string', 'self' => 'self', 'parent' => 'parent'];
    private const BUILTIN_RETURN_TYPES = ['void' => \true, 'array' => \true, 'bool' => \true, 'callable' => \true, 'float' => \true, 'int' => \true, 'iterable' => \true, 'object' => \true, 'string' => \true, 'self' => \true, 'parent' => \true];
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper8b183f8218dc\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoper8b183f8218dc\\Psr\\Log\\LogLevel');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScoper8b183f8218dc\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScoper8b183f8218dc\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScoper8b183f8218dc\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScoper8b183f8218dc\ProxyManager\Proxy\ProxyInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        $deprecations = [];
        $className = isset($class[15]) && "\0" === $class[15] && 0 === \strpos($class, "class@anonymous\0") ? \get_parent_class($class) . '@anonymous' : $class;
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoper8b183f8218dc\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

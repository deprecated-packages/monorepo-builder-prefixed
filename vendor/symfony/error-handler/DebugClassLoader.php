...
use _PhpScopera42d72b2de70\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScopera42d72b2de70\Doctrine\Persistence\Proxy;
use _PhpScopera42d72b2de70\Mockery\MockInterface;
use _PhpScopera42d72b2de70\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera42d72b2de70\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera42d72b2de70\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScopera42d72b2de70\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera42d72b2de70\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScopera42d72b2de70\\Psr\\Log\\LogLevel');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScopera42d72b2de70\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScopera42d72b2de70\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera42d72b2de70\Doctrine\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera42d72b2de70\ProxyManager\Proxy\ProxyInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera42d72b2de70\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera42d72b2de70\Mockery\MockInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScopera42d72b2de70\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

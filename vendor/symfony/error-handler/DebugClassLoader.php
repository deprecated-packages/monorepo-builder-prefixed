...
use _PhpScopera763b4be90d0\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScopera763b4be90d0\Doctrine\Persistence\Proxy;
use _PhpScopera763b4be90d0\Mockery\MockInterface;
use _PhpScopera763b4be90d0\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScopera763b4be90d0\PHPUnit\Framework\MockObject\MockObject;
use _PhpScopera763b4be90d0\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScopera763b4be90d0\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScopera763b4be90d0\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScopera763b4be90d0\\Psr\\Log\\LogLevel');
    ...
    public static function checkClasses() : bool
    {
        ...
        foreach ($offsets as $getSymbols => $i) {
            ...
            for (; $i < \count($symbols); ++$i) {
                if (!\is_subclass_of($symbols[$i], \_PhpScopera763b4be90d0\PHPUnit\Framework\MockObject\MockObject::class) && !\is_subclass_of($symbols[$i], \_PhpScopera763b4be90d0\Prophecy\Prophecy\ProphecySubjectInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera763b4be90d0\Doctrine\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera763b4be90d0\ProxyManager\Proxy\ProxyInterface::class) && !\is_subclass_of($symbols[$i], \_PhpScopera763b4be90d0\Doctrine\Common\Persistence\Proxy::class) && !\is_subclass_of($symbols[$i], \_PhpScopera763b4be90d0\Mockery\MockInterface::class)) {
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScopera763b4be90d0\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

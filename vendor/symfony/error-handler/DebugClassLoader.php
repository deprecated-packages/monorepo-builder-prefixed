...
use _PhpScoper1600de59048a\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use _PhpScoper1600de59048a\Doctrine\Persistence\Proxy;
use _PhpScoper1600de59048a\Mockery\MockInterface;
use _PhpScoper1600de59048a\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use _PhpScoper1600de59048a\PHPUnit\Framework\MockObject\MockObject;
use _PhpScoper1600de59048a\Prophecy\Prophecy\ProphecySubjectInterface;
use _PhpScoper1600de59048a\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists('_PhpScoper1600de59048a\\Symfony\\Component\\ErrorHandler\\ErrorHandler');
        \class_exists('_PhpScoper1600de59048a\\Psr\\Log\\LogLevel');
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \_PhpScoper1600de59048a\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }

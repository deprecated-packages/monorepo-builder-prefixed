...
class ApplicationTester
{
    ...
    private $input;
    private $statusCode;
    public function __construct(\_PhpScoper36281e29f54f\Symfony\Component\Console\Application $application)
    {
    ...
    {
        $this->input = new \_PhpScoper36281e29f54f\Symfony\Component\Console\Input\ArrayInput($input);

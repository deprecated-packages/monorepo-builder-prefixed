...
class ApplicationTester
{
    ...
    private $input;
    private $statusCode;
    public function __construct(\_PhpScoper68e56c1b5bd9\Symfony\Component\Console\Application $application)
    {
    ...
    {
        $this->input = new \_PhpScoper68e56c1b5bd9\Symfony\Component\Console\Input\ArrayInput($input);

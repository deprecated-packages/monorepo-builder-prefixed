 ...
 */
class OutputFormatterStyle implements \_PhpScopera2c403aec9a8\Symfony\Component\Console\Formatter\OutputFormatterStyleInterface
{
    ...
    public function setForeground(string $color = null)
    {
        ...
        if (!isset(static::$availableForegroundColors[$color])) {
            throw new \_PhpScopera2c403aec9a8\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Invalid foreground color specified: "%s". Expected one of (%s).', $color, \implode(', ', \array_keys(static::$availableForegroundColors))));
        }
    ...
    public function setBackground(string $color = null)
    {
        ...
        if (!isset(static::$availableBackgroundColors[$color])) {
            throw new \_PhpScopera2c403aec9a8\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Invalid background color specified: "%s". Expected one of (%s).', $color, \implode(', ', \array_keys(static::$availableBackgroundColors))));
        }
    ...
    public function setOption(string $option)
    {
        if (!isset(static::$availableOptions[$option])) {
            throw new \_PhpScopera2c403aec9a8\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Invalid option specified: "%s". Expected one of (%s).', $option, \implode(', ', \array_keys(static::$availableOptions))));
        }

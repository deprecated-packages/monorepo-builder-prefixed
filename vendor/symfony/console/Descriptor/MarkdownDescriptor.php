 ...
 * @internal
 */
class MarkdownDescriptor extends \_PhpScoper36281e29f54f\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function describeCommand(\_PhpScoper36281e29f54f\Symfony\Component\Console\Command\Command $command, array $options = [])
    {
        ...
        $this->write('`' . $command->getName() . "`\n" . \str_repeat('-', \_PhpScoper36281e29f54f\Symfony\Component\Console\Helper\Helper::strlen($command->getName()) + 2) . "\n\n" . ($command->getDescription() ? $command->getDescription() . "\n\n" : '') . '### Usage' . "\n\n" . \array_reduce(\array_merge([$command->getSynopsis()], $command->getAliases(), $command->getUsages()), function ($carry, $usage) {
            return $carry . '* `' . $usage . '`' . "\n";
        }));
    ...
    protected function describeApplication(\_PhpScoper36281e29f54f\Symfony\Component\Console\Application $application, array $options = [])
    {
        ...
        $this->write($title . "\n" . \str_repeat('=', \_PhpScoper36281e29f54f\Symfony\Component\Console\Helper\Helper::strlen($title)));
        foreach ($description->getNamespaces() as $namespace) {
            if (\_PhpScoper36281e29f54f\Symfony\Component\Console\Descriptor\ApplicationDescription::GLOBAL_NAMESPACE !== $namespace['id']) {
                $this->write("\n\n");
    ...
    private function getApplicationTitle(\_PhpScoper36281e29f54f\Symfony\Component\Console\Application $application) : string
    {

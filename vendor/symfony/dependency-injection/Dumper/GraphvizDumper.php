...
use _PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException;
 ...
 */
class GraphvizDumper extends \_PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    private $nodes;
    private $edges;
    ...
    private function findEdges(string $id, array $arguments, bool $required, string $name, bool $lazy = \false) : array
    {
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \_PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\Parameter) {
                $argument = $this->container->hasParameter($argument) ? $this->container->getParameter($argument) : null;
            } elseif (\is_string($argument) && \preg_match('/^%([^%]+)%$/', $argument, $match)) {
                $argument = $this->container->hasParameter($match[1]) ? $this->container->getParameter($match[1]) : null;
            }
            if ($argument instanceof \_PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\Reference) {
                $lazyEdge = $lazy;
            ...
            } elseif ($argument instanceof \_PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
    ...
    private function findNodes() : array
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            } catch (\_PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException $e) {
            }
            ...
            $container->setDefinition($id, new \_PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    private function cloneContainer() : \_PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        $parameterBag = new \_PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \_PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);

 ...
 */
class InlineServiceDefinitionsPass extends \_PhpScoper69b0f14b2eca\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    private $inlinedIds = [];
    private $graph;
    public function __construct(\_PhpScoper69b0f14b2eca\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass $analyzingPass = null)
    {
    ...
    public function process(\_PhpScoper69b0f14b2eca\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        if ($this->analyzingPass) {
            $analyzedContainer = new \_PhpScoper69b0f14b2eca\Symfony\Component\DependencyInjection\ContainerBuilder();
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if ($value instanceof \_PhpScoper69b0f14b2eca\Symfony\Component\DependencyInjection\Definition && $this->cloningIds) {
            if ($value->isShared()) {
                return $value;
            }
            $value = clone $value;
        ...
        if (isset($this->cloningIds[$id])) {
            ...
            $ids[] = $id;
            throw new \_PhpScoper69b0f14b2eca\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_slice($ids, \array_search($id, $ids)));
        }
     ...
     */
    private function isInlineableDefinition(string $id, \_PhpScoper69b0f14b2eca\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ($srcCount > 1 && \is_array($factory = $definition->getFactory()) && ($factory[0] instanceof \_PhpScoper69b0f14b2eca\Symfony\Component\DependencyInjection\Reference || $factory[0] instanceof \_PhpScoper69b0f14b2eca\Symfony\Component\DependencyInjection\Definition)) {
            return \false;
        }

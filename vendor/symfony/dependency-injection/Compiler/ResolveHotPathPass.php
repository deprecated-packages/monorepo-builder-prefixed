 ...
 */
class ResolveHotPathPass extends \_PhpScoperb0229f14f861\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $tagName;
    private $resolvedIds = [];
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if ($value instanceof \_PhpScoperb0229f14f861\Symfony\Component\DependencyInjection\Definition && $isRoot) {
        ...
        if ($value instanceof \_PhpScoperb0229f14f861\Symfony\Component\DependencyInjection\Reference && \_PhpScoperb0229f14f861\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE !== $value->getInvalidBehavior() && $this->container->hasDefinition($id = (string) $value)) {

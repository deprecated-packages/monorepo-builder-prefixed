 ...
 */
class ResolveBindingsPass extends \_PhpScoperee8f03533f8b\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\_PhpScoperee8f03533f8b\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        try {
            ...
            foreach ($this->unusedBindings as list($key, $serviceId, $bindingType, $file)) {
                ...
                if (\_PhpScoperee8f03533f8b\Symfony\Component\DependencyInjection\Argument\BoundArgument::DEFAULTS_BINDING === $bindingType) {
                    $message .= 'under "_defaults"';
                } elseif (\_PhpScoperee8f03533f8b\Symfony\Component\DependencyInjection\Argument\BoundArgument::INSTANCEOF_BINDING === $bindingType) {
    ...
    {
        if ($value instanceof \_PhpScoperee8f03533f8b\Symfony\Component\DependencyInjection\TypedReference && $value->getType() === (string) $value) {
            // Already checked
        ...
        if (!$value instanceof \_PhpScoperee8f03533f8b\Symfony\Component\DependencyInjection\Definition || !($bindings = $value->getBindings())) {
            return parent::processValue($value, $isRoot);
        }
        ...
        foreach ($calls as $i => $call) {
            ...
            foreach ($reflectionMethod->getParameters() as $key => $parameter) {
                ...
                $typeHint = \_PhpScoperee8f03533f8b\Symfony\Component\DependencyInjection\LazyProxy\ProxyHelper::getTypeHint($reflectionMethod, $parameter);
     ...
     * @return mixed
     */
    private function getBindingValue(\_PhpScoperee8f03533f8b\Symfony\Component\DependencyInjection\Argument\BoundArgument $binding)
    {

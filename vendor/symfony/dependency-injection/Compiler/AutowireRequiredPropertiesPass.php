 ...
 */
class AutowireRequiredPropertiesPass extends \_PhpScopereb9e28d9f307\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getProperties() as $reflectionProperty) {
            ...
            $type = $type->getName();
            $value->setProperty($name, new \_PhpScopereb9e28d9f307\Symfony\Component\DependencyInjection\TypedReference($type, $type, \_PhpScopereb9e28d9f307\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, $name));
        }
        return $value;
    }
}

 ...
 */
class AutowireRequiredPropertiesPass extends \_PhpScoper2a80719fd449\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getProperties() as $reflectionProperty) {
            ...
            $type = $type->getName();
            $value->setProperty($name, new \_PhpScoper2a80719fd449\Symfony\Component\DependencyInjection\TypedReference($type, $type, \_PhpScoper2a80719fd449\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, $name));
        }
        return $value;
    }
}

 ...
 */
class ResolveInvalidReferencesPass implements \_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $container;
    ...
    public function process(\_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        $this->signalingException = new \_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\Exception\RuntimeException('Invalid reference.');
        try {
    ...
    private function processValue($value, int $rootLevel = 0, int $level = 0)
    {
        if ($value instanceof \_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument) {
            ...
            if ($currentDefinition->innerServiceId === $id && \_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $currentDefinition->decorationOnInvalid) {
                return null;
            }
            $invalidBehavior = $value->getInvalidBehavior();
            if (\_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\ContainerInterface::RUNTIME_EXCEPTION_ON_INVALID_REFERENCE === $invalidBehavior && $value instanceof \_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\TypedReference && !$this->container->has($id)) {
                $e = new \_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, $this->currentId);
                ...
                return new \_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\TypedReference($id, $value->getType(), $value->getInvalidBehavior());
            }
            // resolve invalid behavior
            if (\_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $value = null;
            } elseif (\_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE === $invalidBehavior) {

 ...
 */
class ResolveInvalidReferencesPass implements \_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $container;
    ...
    public function process(\_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        $this->signalingException = new \_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\Exception\RuntimeException('Invalid reference.');
        try {
    ...
    private function processValue($value, int $rootLevel = 0, int $level = 0)
    {
        if ($value instanceof \_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument) {
            ...
            if ($currentDefinition->innerServiceId === $id && \_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $currentDefinition->decorationOnInvalid) {
                return null;
            }
            $invalidBehavior = $value->getInvalidBehavior();
            if (\_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\ContainerInterface::RUNTIME_EXCEPTION_ON_INVALID_REFERENCE === $invalidBehavior && $value instanceof \_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\TypedReference && !$this->container->has($id)) {
                $e = new \_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, $this->currentId);
                ...
                return new \_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\TypedReference($id, $value->getType(), $value->getInvalidBehavior());
            }
            // resolve invalid behavior
            if (\_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $value = null;
            } elseif (\_PhpScoper62894f8143f4\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE === $invalidBehavior) {

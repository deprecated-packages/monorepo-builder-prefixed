 ...
 */
class ResolveInstanceofConditionalsPass implements \_PhpScoperb445cd48032c\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * {@inheritdoc}
     */
    public function process(\_PhpScoperb445cd48032c\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        foreach ($container->getAutoconfiguredInstanceof() as $interface => $definition) {
            if ($definition->getArguments()) {
                throw new \_PhpScoperb445cd48032c\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('Autoconfigured instanceof for type "%s" defines arguments but these are not supported and should be removed.', $interface));
            }
        }
    ...
    private function processDefinition(\_PhpScoperb445cd48032c\Symfony\Component\DependencyInjection\ContainerBuilder $container, string $id, \_PhpScoperb445cd48032c\Symfony\Component\DependencyInjection\Definition $definition) : \_PhpScoperb445cd48032c\Symfony\Component\DependencyInjection\Definition
    {
    ...
    private function mergeConditionals(array $autoconfiguredInstanceof, array $instanceofConditionals, \_PhpScoperb445cd48032c\Symfony\Component\DependencyInjection\ContainerBuilder $container) : array
    {
        ...
        foreach ($instanceofConditionals as $interface => $instanceofDef) {
            ...
            if (!$container->getReflectionClass($interface)) {
                throw new \_PhpScoperb445cd48032c\Symfony\Component\DependencyInjection\Exception\RuntimeException(\sprintf('"%s" is set as an "instanceof" conditional, but it does not exist.', $interface));
            }

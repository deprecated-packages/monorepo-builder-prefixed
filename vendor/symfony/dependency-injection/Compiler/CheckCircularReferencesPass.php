 ...
 */
class CheckCircularReferencesPass implements \_PhpScoper058a557299a1\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $currentPath;
        ...
        foreach ($edges as $edge) {
            ...
            if (empty($this->checkedNodes[$id])) {
                ...
                if (!$node->getValue() || !$edge->isLazy() && !$edge->isWeak()) {
                    ...
                    $this->currentPath[] = $id;
                    if (\false !== $searchKey) {
                        throw new \_PhpScoper058a557299a1\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_slice($this->currentPath, $searchKey));
                    }
                    $this->checkOutEdges($node->getOutEdges());
                }

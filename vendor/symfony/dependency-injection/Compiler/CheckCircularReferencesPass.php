 ...
 */
class CheckCircularReferencesPass implements \_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $currentPath;
        ...
        foreach ($edges as $edge) {
            ...
            if (empty($this->checkedNodes[$id])) {
                ...
                if (!$node->getValue() || !$edge->isLazy() && !$edge->isWeak()) {
                    ...
                    $this->currentPath[] = $id;
                    if (\false !== $searchKey) {
                        throw new \_PhpScoperba481e4bff85\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_slice($this->currentPath, $searchKey));
                    }
                    $this->checkOutEdges($node->getOutEdges());
                }

 ...
 */
class DefinitionErrorExceptionPass extends \_PhpScoperce084f4275dd\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (!$value instanceof \_PhpScoperce084f4275dd\Symfony\Component\DependencyInjection\Definition || !$value->hasErrors()) {
        ...
        if ($isRoot && !$value->isPublic()) {
            ...
            foreach ($graph->getNode($this->currentId)->getInEdges() as $edge) {
                if (!$edge->getValue() instanceof \_PhpScoperce084f4275dd\Symfony\Component\DependencyInjection\Reference || \_PhpScoperce084f4275dd\Symfony\Component\DependencyInjection\ContainerInterface::RUNTIME_EXCEPTION_ON_INVALID_REFERENCE !== $edge->getValue()->getInvalidBehavior()) {
                    $runtimeException = \false;
                    break;
                }

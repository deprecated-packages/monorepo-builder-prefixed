 ...
 */
class DefinitionErrorExceptionPass extends \_PhpScoperaff2103cee1d\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (!$value instanceof \_PhpScoperaff2103cee1d\Symfony\Component\DependencyInjection\Definition || !$value->hasErrors()) {
        ...
        if ($isRoot && !$value->isPublic()) {
            ...
            foreach ($graph->getNode($this->currentId)->getInEdges() as $edge) {
                if (!$edge->getValue() instanceof \_PhpScoperaff2103cee1d\Symfony\Component\DependencyInjection\Reference || \_PhpScoperaff2103cee1d\Symfony\Component\DependencyInjection\ContainerInterface::RUNTIME_EXCEPTION_ON_INVALID_REFERENCE !== $edge->getValue()->getInvalidBehavior()) {
                    $runtimeException = \false;
                    break;
                }

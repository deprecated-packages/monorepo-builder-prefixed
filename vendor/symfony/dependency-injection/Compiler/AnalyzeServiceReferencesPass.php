 ...
 */
class AnalyzeServiceReferencesPass extends \_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass implements \_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\Compiler\RepeatablePassInterface
{
    private $graph;
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if ($value instanceof \_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\Reference) {
            ...
            $this->graph->connect($this->currentId, $this->currentDefinition, $targetId, $targetDefinition, $value, $this->lazy || $this->hasProxyDumper && $targetDefinition && $targetDefinition->isLazy(), \_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE === $value->getInvalidBehavior(), $this->byConstructor);
            if ($inExpression) {

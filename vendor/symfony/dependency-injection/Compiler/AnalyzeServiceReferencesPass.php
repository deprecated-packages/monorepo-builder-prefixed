 ...
 */
class AnalyzeServiceReferencesPass extends \_PhpScoper36281e29f54f\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    private $graph;
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if ($value instanceof \_PhpScoper36281e29f54f\Symfony\Component\DependencyInjection\Reference) {
            ...
            $this->graph->connect($this->currentId, $this->currentDefinition, $targetId, $targetDefinition, $value, $this->lazy || $this->hasProxyDumper && $targetDefinition && $targetDefinition->isLazy(), \_PhpScoper36281e29f54f\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE === $value->getInvalidBehavior(), $this->byConstructor);
            if ($inExpression) {

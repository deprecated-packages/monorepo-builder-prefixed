 ...
 */
class AnalyzeServiceReferencesPass extends \_PhpScoperef4638f5d8b1\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass implements \_PhpScoperef4638f5d8b1\Symfony\Component\DependencyInjection\Compiler\RepeatablePassInterface
{
    private $graph;
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if ($value instanceof \_PhpScoperef4638f5d8b1\Symfony\Component\DependencyInjection\Reference) {
            ...
            $this->graph->connect($this->currentId, $this->currentDefinition, $targetId, $targetDefinition, $value, $this->lazy || $this->hasProxyDumper && $targetDefinition && $targetDefinition->isLazy(), \_PhpScoperef4638f5d8b1\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE === $value->getInvalidBehavior(), $this->byConstructor);
            if ($inExpression) {

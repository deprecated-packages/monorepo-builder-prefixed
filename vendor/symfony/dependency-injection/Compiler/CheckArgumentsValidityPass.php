 ...
 */
class CheckArgumentsValidityPass extends \_PhpScoper3b1dc0f3c466\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \_PhpScoper3b1dc0f3c466\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }

 ...
 */
class CheckArgumentsValidityPass extends \_PhpScoper847a0f3260b6\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \_PhpScoper847a0f3260b6\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }

 ...
 */
class CheckArgumentsValidityPass extends \_PhpScoperddf2171d3d2c\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \_PhpScoperddf2171d3d2c\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }

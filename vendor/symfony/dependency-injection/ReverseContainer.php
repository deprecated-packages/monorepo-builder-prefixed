...
final class ReverseContainer
{
    ...
    public function __construct(\_PhpScoperbd03d493ccc6\Symfony\Component\DependencyInjection\Container $serviceContainer, \_PhpScoperbd03d493ccc6\Psr\Container\ContainerInterface $reversibleLocator, string $tagName = 'container.reversible')
    {
        ...
        }, $serviceContainer, \_PhpScoperbd03d493ccc6\Symfony\Component\DependencyInjection\Container::class);
    }
    /**
    ...
    public function getService(string $id) : object
    {
        ...
        if (isset($this->serviceContainer->getRemovedIds()[$id])) {
            throw new \_PhpScoperbd03d493ccc6\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, null, null, [], \sprintf('The "%s" service is private and cannot be accessed by reference. You should either make it public, or tag it as "%s".', $id, $this->tagName));
        }

...
final class ReverseContainer
{
    ...
    public function __construct(\_PhpScopere57ee17947a3\Symfony\Component\DependencyInjection\Container $serviceContainer, \_PhpScopere57ee17947a3\Psr\Container\ContainerInterface $reversibleLocator, string $tagName = 'container.reversible')
    {
        ...
        }, $serviceContainer, \_PhpScopere57ee17947a3\Symfony\Component\DependencyInjection\Container::class);
    }
    /**
    ...
    public function getService(string $id)
    {
        ...
        if (isset($this->serviceContainer->getRemovedIds()[$id])) {
            throw new \_PhpScopere57ee17947a3\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, null, null, [], \sprintf('The "%s" service is private and cannot be accessed by reference. You should either make it public, or tag it as "%s".', $id, $this->tagName));
        }

 ...
 */
class TypedReference extends \_PhpScoperb0f70d760c3d\Symfony\Component\DependencyInjection\Reference
{
    private $type;
    private $name;
     ...
     */
    public function __construct(string $id, string $type, $invalidBehavior = \_PhpScoperb0f70d760c3d\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, $name = null)
    {
        if (\is_string($invalidBehavior ?? '') || \is_int($name)) {
            ...
            $invalidBehavior = 3 < \func_num_args() ? \func_get_arg(3) : \_PhpScoperb0f70d760c3d\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE;
        } else {

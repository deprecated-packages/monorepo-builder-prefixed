    ...
    public function setDeprecated()
    {
        ...
        if ('' !== $message) {
            ...
            if (\false === \strpos($message, '%alias_id%')) {
                throw new \_PhpScoper0087e037e0f7\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException('The deprecation template must contain the "%alias_id%" placeholder.');
            }
        }

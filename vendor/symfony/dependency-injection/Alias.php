    ...
    public function setDeprecated()
    {
        ...
        if ('' !== $message) {
            ...
            if (\false === \strpos($message, '%alias_id%')) {
                throw new \_PhpScoper8e7700b08cb9\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException('The deprecation template must contain the "%alias_id%" placeholder.');
            }
        }

    ...
    public function setDeprecated()
    {
        ...
        if ('' !== $message) {
            ...
            if (\false === \strpos($message, '%alias_id%')) {
                throw new \_PhpScoper1ceaf4cbd5cb\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException('The deprecation template must contain the "%alias_id%" placeholder.');
            }
        }

 ...
 */
class PrototypeConfigurator extends \_PhpScopere7b233920bf2\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractServiceConfigurator
{
    const FACTORY = 'load';
    ...
    private $excludes;
    private $allowParent;
    public function __construct(\_PhpScopere7b233920bf2\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, \_PhpScopere7b233920bf2\Symfony\Component\DependencyInjection\Loader\PhpFileLoader $loader, \_PhpScopere7b233920bf2\Symfony\Component\DependencyInjection\Definition $defaults, string $namespace, string $resource, bool $allowParent)
    {

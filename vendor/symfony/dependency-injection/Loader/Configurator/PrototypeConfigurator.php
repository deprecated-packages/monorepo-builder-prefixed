 ...
 */
class PrototypeConfigurator extends \_PhpScopere57ee17947a3\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractServiceConfigurator
{
    const FACTORY = 'load';
    ...
    private $excludes;
    private $allowParent;
    public function __construct(\_PhpScopere57ee17947a3\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, \_PhpScopere57ee17947a3\Symfony\Component\DependencyInjection\Loader\PhpFileLoader $loader, \_PhpScopere57ee17947a3\Symfony\Component\DependencyInjection\Definition $defaults, string $namespace, string $resource, bool $allowParent)
    {

...
trait ParentTrait
{
    ...
    {
        if (!$this->allowParent) {
            throw new \_PhpScoperb1086ecf2bcb\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('A parent cannot be defined when either "_instanceof" or "_defaults" are also defined for service prototype "%s".', $this->id));
        }
        if ($this->definition instanceof \_PhpScoperb1086ecf2bcb\Symfony\Component\DependencyInjection\ChildDefinition) {
            ...
            throw new \_PhpScoperb1086ecf2bcb\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The service "%s" cannot have a "parent" and also "bind" arguments.', $this->id));
        } else {

...
trait ParentTrait
{
    ...
    {
        if (!$this->allowParent) {
            throw new \_PhpScoperf48ea5df9e9b\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('A parent cannot be defined when either "_instanceof" or "_defaults" are also defined for service prototype "%s".', $this->id));
        }
        if ($this->definition instanceof \_PhpScoperf48ea5df9e9b\Symfony\Component\DependencyInjection\ChildDefinition) {

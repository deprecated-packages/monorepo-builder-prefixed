 ...
 */
class IniFileLoader extends \_PhpScoperbd03d493ccc6\Symfony\Component\DependencyInjection\Loader\FileLoader
{
    /**
     * {@inheritdoc}
     */
    public function load($resource, string $type = null)
    {
        ...
        if (\false === $result || [] === $result) {
            throw new \_PhpScoperbd03d493ccc6\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" file is not valid.', $resource));
        }
        // real raw parsing
    ...
    private function phpize(string $value)
    {
        ...
        switch (\true) {
            ...
            default:
                return \_PhpScoperbd03d493ccc6\Symfony\Component\Config\Util\XmlUtils::phpize($value);
        }
    }
}

 ...
 */
class IniFileLoader extends \_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\Loader\FileLoader
{
    /**
     * {@inheritdoc}
     */
    public function load($resource, $type = null)
    {
        ...
        if (\false === $result || [] === $result) {
            throw new \_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" file is not valid.', $resource));
        }
        // real raw parsing
    ...
    private function phpize(string $value)
    {
        ...
        switch (\true) {
            ...
            default:
                return \_PhpScoper9e91fe07dbdd\Symfony\Component\Config\Util\XmlUtils::phpize($value);
        }
    }
}

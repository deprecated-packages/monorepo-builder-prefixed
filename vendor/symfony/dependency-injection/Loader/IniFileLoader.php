 ...
 */
class IniFileLoader extends \_PhpScoperb1086ecf2bcb\Symfony\Component\DependencyInjection\Loader\FileLoader
{
    /**
     * {@inheritdoc}
     */
    public function load($resource, $type = null)
    {
        ...
        if (\false === $result || [] === $result) {
            throw new \_PhpScoperb1086ecf2bcb\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" file is not valid.', $resource));
        }
        // real raw parsing
    ...
    private function phpize(string $value)
    {
        ...
        switch (\true) {
            ...
            default:
                return \_PhpScoperb1086ecf2bcb\Symfony\Component\Config\Util\XmlUtils::phpize($value);
        }
    }
}

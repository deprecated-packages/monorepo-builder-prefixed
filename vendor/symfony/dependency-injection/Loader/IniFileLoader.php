 ...
 */
class IniFileLoader extends \_PhpScoper641780a4edd2\Symfony\Component\DependencyInjection\Loader\FileLoader
{
    /**
     * {@inheritdoc}
     */
    public function load($resource, string $type = null)
    {
        ...
        if (\false === $result || [] === $result) {
            throw new \_PhpScoper641780a4edd2\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" file is not valid.', $resource));
        }
        // real raw parsing
    ...
    private function phpize(string $value)
    {
        ...
        switch (\true) {
            ...
            default:
                return \_PhpScoper641780a4edd2\Symfony\Component\Config\Util\XmlUtils::phpize($value);
        }
    }
}

 ...
 */
class IniFileLoader extends \_PhpScoperd4e30d8318e8\Symfony\Component\DependencyInjection\Loader\FileLoader
{
    /**
     * {@inheritdoc}
     */
    public function load($resource, $type = null)
    {
        ...
        if (\false === $result || [] === $result) {
            throw new \_PhpScoperd4e30d8318e8\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" file is not valid.', $resource));
        }
        // real raw parsing
    ...
    private function phpize(string $value)
    {
        ...
        switch (\true) {
            ...
            default:
                return \_PhpScoperd4e30d8318e8\Symfony\Component\Config\Util\XmlUtils::phpize($value);
        }
    }
}

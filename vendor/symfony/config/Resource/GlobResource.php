...
use _PhpScoperab93339c6bca\Symfony\Component\Finder\Finder;
use _PhpScoperab93339c6bca\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \_PhpScoperab93339c6bca\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\_PhpScoperab93339c6bca\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScoperab93339c6bca\Symfony\Component\Finder\Finder();
        $regex = \_PhpScoperab93339c6bca\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {

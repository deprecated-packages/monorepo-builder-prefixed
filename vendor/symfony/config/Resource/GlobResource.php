...
use _PhpScopercdc90a6628b6\Symfony\Component\Finder\Finder;
use _PhpScopercdc90a6628b6\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \_PhpScopercdc90a6628b6\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator()
    {
        ...
        if (!\class_exists(\_PhpScopercdc90a6628b6\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScopercdc90a6628b6\Symfony\Component\Finder\Finder();
        $regex = \_PhpScopercdc90a6628b6\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {

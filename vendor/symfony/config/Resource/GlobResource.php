...
use _PhpScopere3ed9f66440c\Symfony\Component\Finder\Finder;
use _PhpScopere3ed9f66440c\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \_PhpScopere3ed9f66440c\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator()
    {
        ...
        if (!\class_exists(\_PhpScopere3ed9f66440c\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScopere3ed9f66440c\Symfony\Component\Finder\Finder();
        $regex = \_PhpScopere3ed9f66440c\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {

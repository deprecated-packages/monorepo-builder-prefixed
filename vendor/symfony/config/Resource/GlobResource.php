...
use _PhpScopereb9e28d9f307\Symfony\Component\Finder\Finder;
use _PhpScopereb9e28d9f307\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \_PhpScopereb9e28d9f307\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\_PhpScopereb9e28d9f307\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScopereb9e28d9f307\Symfony\Component\Finder\Finder();
        $regex = \_PhpScopereb9e28d9f307\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {

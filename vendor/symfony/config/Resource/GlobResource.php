...
use _PhpScopere6d124d1f7ba\Symfony\Component\Finder\Finder;
use _PhpScopere6d124d1f7ba\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \_PhpScopere6d124d1f7ba\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\_PhpScopere6d124d1f7ba\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScopere6d124d1f7ba\Symfony\Component\Finder\Finder();
        $regex = \_PhpScopere6d124d1f7ba\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {

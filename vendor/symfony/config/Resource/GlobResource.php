...
use _PhpScoperb2067b9f36f8\Symfony\Component\Finder\Finder;
use _PhpScoperb2067b9f36f8\Symfony\Component\Finder\Glob;
/**
 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \_PhpScoperb2067b9f36f8\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\_PhpScoperb2067b9f36f8\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScoperb2067b9f36f8\Symfony\Component\Finder\Finder();
        $regex = \_PhpScoperb2067b9f36f8\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {

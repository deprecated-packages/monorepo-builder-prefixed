 ...
 */
namespace _PhpScoper95efb8ddea2f\Symfony\Component\Config\Resource;

use _PhpScoper95efb8ddea2f\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use _PhpScoper95efb8ddea2f\Symfony\Component\Messenger\Handler\MessageSubscriberInterface;
 ...
 * @final
 */
class ReflectionClassResource implements \_PhpScoper95efb8ddea2f\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $files = [];
    private $className;
    ...
    private function generateSignature(\ReflectionClass $class) : iterable
    {
        ...
        if (\interface_exists(\_PhpScoper95efb8ddea2f\Symfony\Component\EventDispatcher\EventSubscriberInterface::class, \false) && $class->isSubclassOf(\_PhpScoper95efb8ddea2f\Symfony\Component\EventDispatcher\EventSubscriberInterface::class)) {
            (yield \_PhpScoper95efb8ddea2f\Symfony\Component\EventDispatcher\EventSubscriberInterface::class);
            (yield \print_r($class->name::getSubscribedEvents(), \true));
        }
        if (\interface_exists(\_PhpScoper95efb8ddea2f\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class, \false) && $class->isSubclassOf(\_PhpScoper95efb8ddea2f\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class)) {
            (yield \_PhpScoper95efb8ddea2f\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class);
            foreach ($class->name::getHandledMessages() as $key => $value) {
                (yield $key . \print_r($value, \true));
            }
        }
        if (\interface_exists(\_PhpScoper95efb8ddea2f\Symfony\Contracts\Service\ServiceSubscriberInterface::class, \false) && $class->isSubclassOf(\_PhpScoper95efb8ddea2f\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            (yield \_PhpScoper95efb8ddea2f\Symfony\Contracts\Service\ServiceSubscriberInterface::class);

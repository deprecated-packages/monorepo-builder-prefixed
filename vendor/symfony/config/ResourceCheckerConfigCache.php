 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperb0229f14f861\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperb0229f14f861\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperb0229f14f861\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper7aa910bab0da\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper7aa910bab0da\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper7aa910bab0da\Symfony\Component\Filesystem\Exception\IOException $e) {

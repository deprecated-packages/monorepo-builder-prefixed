 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper80b6fe7627f7\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper80b6fe7627f7\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper80b6fe7627f7\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperd410cf9baa15\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperd410cf9baa15\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperd410cf9baa15\Symfony\Component\Filesystem\Exception\IOException $e) {

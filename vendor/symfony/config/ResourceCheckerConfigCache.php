 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperad3f32c1b87c\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperad3f32c1b87c\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperad3f32c1b87c\Symfony\Component\Filesystem\Exception\IOException $e) {

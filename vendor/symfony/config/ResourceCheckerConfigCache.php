 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperb0f70d760c3d\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperb0f70d760c3d\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperb0f70d760c3d\Symfony\Component\Filesystem\Exception\IOException $e) {

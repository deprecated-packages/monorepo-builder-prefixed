 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperf78d2b40800e\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperf78d2b40800e\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperf78d2b40800e\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScopera31d0d6ff47a\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScopera31d0d6ff47a\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScopera31d0d6ff47a\Symfony\Component\Filesystem\Exception\IOException $e) {

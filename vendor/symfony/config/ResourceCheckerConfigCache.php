 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper345e6b5f632f\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper345e6b5f632f\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper345e6b5f632f\Symfony\Component\Filesystem\Exception\IOException $e) {

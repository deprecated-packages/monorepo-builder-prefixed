 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperfdd2db5e123d\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperfdd2db5e123d\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperfdd2db5e123d\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper43a95e2f69bc\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper43a95e2f69bc\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper43a95e2f69bc\Symfony\Component\Filesystem\Exception\IOException $e) {

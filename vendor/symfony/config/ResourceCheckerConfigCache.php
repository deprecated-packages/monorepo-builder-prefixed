 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperdfdcb3d4cca0\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperdfdcb3d4cca0\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperdfdcb3d4cca0\Symfony\Component\Filesystem\Exception\IOException $e) {

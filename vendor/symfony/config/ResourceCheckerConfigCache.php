 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperb1086ecf2bcb\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperb1086ecf2bcb\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperb1086ecf2bcb\Symfony\Component\Filesystem\Exception\IOException $e) {

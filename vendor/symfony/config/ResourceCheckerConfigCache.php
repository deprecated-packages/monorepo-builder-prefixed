 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper5665d3e54f4c\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper5665d3e54f4c\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper5665d3e54f4c\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper0ce3ac6864aa\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper0ce3ac6864aa\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper0ce3ac6864aa\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperf0b2c071f15d\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperf0b2c071f15d\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperf0b2c071f15d\Symfony\Component\Filesystem\Exception\IOException $e) {

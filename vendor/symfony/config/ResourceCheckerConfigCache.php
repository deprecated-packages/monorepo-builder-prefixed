 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperae7532b8c744\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperae7532b8c744\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperae7532b8c744\Symfony\Component\Filesystem\Exception\IOException $e) {

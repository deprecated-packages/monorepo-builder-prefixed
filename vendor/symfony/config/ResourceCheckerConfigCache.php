 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperc9dee8f3b3e7\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperc9dee8f3b3e7\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperc9dee8f3b3e7\Symfony\Component\Filesystem\Exception\IOException $e) {

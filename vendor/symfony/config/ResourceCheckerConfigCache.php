 ...
 */
class ResourceCheckerConfigCache implements \_PhpScopere0f28e6b9bde\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScopere0f28e6b9bde\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScopere0f28e6b9bde\Symfony\Component\Filesystem\Exception\IOException $e) {

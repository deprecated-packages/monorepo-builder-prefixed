 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper50e98fdc5bc0\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper50e98fdc5bc0\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper50e98fdc5bc0\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperbecbc4cd500f\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperbecbc4cd500f\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperbecbc4cd500f\Symfony\Component\Filesystem\Exception\IOException $e) {

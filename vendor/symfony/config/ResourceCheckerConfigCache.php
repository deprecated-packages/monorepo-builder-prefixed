 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperb2724c6b069f\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperb2724c6b069f\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperb2724c6b069f\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperc0c27da9e1f7\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperc0c27da9e1f7\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperc0c27da9e1f7\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper4c229f9734b6\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper4c229f9734b6\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper4c229f9734b6\Symfony\Component\Filesystem\Exception\IOException $e) {

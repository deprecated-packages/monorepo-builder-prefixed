 ...
 */
class ResourceCheckerConfigCache implements \_PhpScopera5e5d165d78c\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScopera5e5d165d78c\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScopera5e5d165d78c\Symfony\Component\Filesystem\Exception\IOException $e) {

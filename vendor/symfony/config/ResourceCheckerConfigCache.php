 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperafeb7177e88e\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperafeb7177e88e\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperafeb7177e88e\Symfony\Component\Filesystem\Exception\IOException $e) {

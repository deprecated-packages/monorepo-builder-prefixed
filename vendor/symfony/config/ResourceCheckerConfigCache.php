 ...
 */
class ResourceCheckerConfigCache implements \_PhpScopera3f2f7450f99\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScopera3f2f7450f99\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScopera3f2f7450f99\Symfony\Component\Filesystem\Exception\IOException $e) {

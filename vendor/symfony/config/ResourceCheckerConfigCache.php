 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperfd1a6a0ee9af\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperfd1a6a0ee9af\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperfd1a6a0ee9af\Symfony\Component\Filesystem\Exception\IOException $e) {

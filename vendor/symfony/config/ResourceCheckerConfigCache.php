 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperaff2103cee1d\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperaff2103cee1d\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperaff2103cee1d\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperf2e2fcfe7ee6\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperf2e2fcfe7ee6\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperf2e2fcfe7ee6\Symfony\Component\Filesystem\Exception\IOException $e) {

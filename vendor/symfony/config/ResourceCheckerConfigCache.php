 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperf6f8e31183c3\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperf6f8e31183c3\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperf6f8e31183c3\Symfony\Component\Filesystem\Exception\IOException $e) {

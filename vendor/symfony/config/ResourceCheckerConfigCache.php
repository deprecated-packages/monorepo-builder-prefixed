 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperdfa889d8967a\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperdfa889d8967a\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperdfa889d8967a\Symfony\Component\Filesystem\Exception\IOException $e) {

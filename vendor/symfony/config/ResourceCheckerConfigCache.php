 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper51570eac51fe\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper51570eac51fe\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper51570eac51fe\Symfony\Component\Filesystem\Exception\IOException $e) {

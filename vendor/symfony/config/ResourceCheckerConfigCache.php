 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperf8eaec7affbd\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperf8eaec7affbd\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperf8eaec7affbd\Symfony\Component\Filesystem\Exception\IOException $e) {

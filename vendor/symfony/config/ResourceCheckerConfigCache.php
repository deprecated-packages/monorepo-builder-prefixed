 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoperdbf49b510e11\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoperdbf49b510e11\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoperdbf49b510e11\Symfony\Component\Filesystem\Exception\IOException $e) {

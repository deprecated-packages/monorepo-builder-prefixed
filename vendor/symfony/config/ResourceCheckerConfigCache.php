 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper7371f586a1d2\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper7371f586a1d2\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper7371f586a1d2\Symfony\Component\Filesystem\Exception\IOException $e) {

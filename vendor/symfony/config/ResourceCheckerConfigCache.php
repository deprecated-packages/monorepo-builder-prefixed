 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper7b254e6a7108\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper7b254e6a7108\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper7b254e6a7108\Symfony\Component\Filesystem\Exception\IOException $e) {

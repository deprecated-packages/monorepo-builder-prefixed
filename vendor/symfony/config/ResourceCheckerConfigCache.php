 ...
 */
class ResourceCheckerConfigCache implements \_PhpScopere4e8aecb81b9\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScopere4e8aecb81b9\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScopere4e8aecb81b9\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper5a7e73320450\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper5a7e73320450\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\_PhpScoper5a7e73320450\Symfony\Component\Filesystem\Exception\IOException $e) {

 ...
 */
class ConfigCacheFactory implements \_PhpScoperbe77f3b0e77d\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    private $debug;
    /**
    ...
    {
        $cache = new \_PhpScoperbe77f3b0e77d\Symfony\Component\Config\ConfigCache($file, $this->debug);
        if (!$cache->isFresh()) {
            $callback($cache);
        }
        return $cache;

 ...
 */
class TreeBuilder implements \_PhpScoperddf2171d3d2c\Symfony\Component\Config\Definition\Builder\NodeParentInterface
{
    protected $tree;
    protected $root;
    public function __construct(string $name = null, string $type = 'array', \_PhpScoperddf2171d3d2c\Symfony\Component\Config\Definition\Builder\NodeBuilder $builder = null)
    {
        if (null === $name) {
            ...
            $builder = $builder ?: new \_PhpScoperddf2171d3d2c\Symfony\Component\Config\Definition\Builder\NodeBuilder();
     ...
     */
    public function root($name, $type = 'array', \_PhpScoperddf2171d3d2c\Symfony\Component\Config\Definition\Builder\NodeBuilder $builder = null)
    {
     ...
     */
    public function getRootNode() : \_PhpScoperddf2171d3d2c\Symfony\Component\Config\Definition\Builder\NodeDefinition
    {
        if (null === $this->root) {
    ...
    {
        if (null === $this->root) {
            throw new \_PhpScoperddf2171d3d2c\Symfony\Component\Config\Definition\Exception\TreeWithoutRootNodeException('The configuration tree has no root node.');
        }
    }
}

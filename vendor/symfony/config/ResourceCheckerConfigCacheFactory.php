 ...
 */
class ResourceCheckerConfigCacheFactory implements \_PhpScoper3e1a86bff77f\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    ...
    {
        $cache = new \_PhpScoper3e1a86bff77f\Symfony\Component\Config\ResourceCheckerConfigCache($file, $this->resourceCheckers);
        if (!$cache->isFresh()) {
            $callable($cache);
        }
        return $cache;

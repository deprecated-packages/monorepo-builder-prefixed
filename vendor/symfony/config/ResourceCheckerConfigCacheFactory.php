 ...
 */
class ResourceCheckerConfigCacheFactory implements \_PhpScoperfa13b4bfa005\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    ...
    {
        $cache = new \_PhpScoperfa13b4bfa005\Symfony\Component\Config\ResourceCheckerConfigCache($file, $this->resourceCheckers);
        if (!$cache->isFresh()) {
            $callable($cache);
        }
        return $cache;

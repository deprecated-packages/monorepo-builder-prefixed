 ...
 */
class ResourceCheckerConfigCacheFactory implements \_PhpScoperff72c38d4e2a\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    ...
    {
        $cache = new \_PhpScoperff72c38d4e2a\Symfony\Component\Config\ResourceCheckerConfigCache($file, $this->resourceCheckers);
        if (!$cache->isFresh()) {
            $callable($cache);
        }
        return $cache;

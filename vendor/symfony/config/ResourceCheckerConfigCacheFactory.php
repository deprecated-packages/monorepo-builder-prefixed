 ...
 */
class ResourceCheckerConfigCacheFactory implements \_PhpScoper95e170f0b4ac\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    ...
    {
        $cache = new \_PhpScoper95e170f0b4ac\Symfony\Component\Config\ResourceCheckerConfigCache($file, $this->resourceCheckers);
        if (!$cache->isFresh()) {
            $callable($cache);
        }
        return $cache;

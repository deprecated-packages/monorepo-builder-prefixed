 ...
 */
class ResourceCheckerConfigCacheFactory implements \_PhpScopereb7fcd8f999a\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    ...
    {
        $cache = new \_PhpScopereb7fcd8f999a\Symfony\Component\Config\ResourceCheckerConfigCache($file, $this->resourceCheckers);
        if (!$cache->isFresh()) {
            $callable($cache);
        }
        return $cache;

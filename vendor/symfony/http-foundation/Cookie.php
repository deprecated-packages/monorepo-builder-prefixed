...
class Cookie
{
    ...
    public static function fromString($cookie, $decode = \false)
    {
        ...
        $parts = \_PhpScoper51570eac51fe\Symfony\Component\HttpFoundation\HeaderUtils::split($cookie, ';=');
        $part = \array_shift($parts);
        $name = $decode ? \urldecode($part[0]) : $part[0];
        $value = isset($part[1]) ? $decode ? \urldecode($part[1]) : $part[1] : null;
        $data = \_PhpScoper51570eac51fe\Symfony\Component\HttpFoundation\HeaderUtils::combine($parts) + $data;

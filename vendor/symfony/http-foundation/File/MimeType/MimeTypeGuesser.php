...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" instead.', \_PhpScopere0f28e6b9bde\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesser::class, \_PhpScopere0f28e6b9bde\Symfony\Component\Mime\MimeTypes::class), \E_USER_DEPRECATED);
/**
 ...
 */
class MimeTypeGuesser implements \_PhpScopere0f28e6b9bde\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface
{
    /**
    ...
    {
        $this->register(new \_PhpScopere0f28e6b9bde\Symfony\Component\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser());
        $this->register(new \_PhpScopere0f28e6b9bde\Symfony\Component\HttpFoundation\File\MimeType\FileinfoMimeTypeGuesser());
    }
    /**
     ...
     */
    public function register(\_PhpScopere0f28e6b9bde\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface $guesser)
    {
    ...
    public function guess($path)
    {
        ...
        if (2 === \count($this->guessers) && !\_PhpScopere0f28e6b9bde\Symfony\Component\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser::isSupported() && !\_PhpScopere0f28e6b9bde\Symfony\Component\HttpFoundation\File\MimeType\FileinfoMimeTypeGuesser::isSupported()) {

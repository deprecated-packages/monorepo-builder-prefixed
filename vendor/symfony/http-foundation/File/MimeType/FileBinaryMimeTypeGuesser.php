...
use _PhpScoper674b08d66902\Symfony\Component\Mime\FileBinaryMimeTypeGuesser as NewFileBinaryMimeTypeGuesser;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" instead.', \_PhpScoper674b08d66902\Symfony\Component\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser::class, \_PhpScoper674b08d66902\Symfony\Component\Mime\FileBinaryMimeTypeGuesser::class), \E_USER_DEPRECATED);
/**
 ...
 */
class FileBinaryMimeTypeGuesser implements \_PhpScoper674b08d66902\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface
{
    private $cmd;
    /**

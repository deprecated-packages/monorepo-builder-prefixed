...
use _PhpScoper9b5fd937b4d9\Symfony\Component\Mime\FileBinaryMimeTypeGuesser as NewFileBinaryMimeTypeGuesser;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" instead.', \_PhpScoper9b5fd937b4d9\Symfony\Component\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser::class, \_PhpScoper9b5fd937b4d9\Symfony\Component\Mime\FileBinaryMimeTypeGuesser::class), \E_USER_DEPRECATED);
/**
 ...
 */
class FileBinaryMimeTypeGuesser implements \_PhpScoper9b5fd937b4d9\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface
{
    private $cmd;
    /**

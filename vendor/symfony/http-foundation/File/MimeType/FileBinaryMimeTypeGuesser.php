...
use _PhpScoper29aa9f1ba53d\Symfony\Component\Mime\FileBinaryMimeTypeGuesser as NewFileBinaryMimeTypeGuesser;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" instead.', \_PhpScoper29aa9f1ba53d\Symfony\Component\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser::class, \_PhpScoper29aa9f1ba53d\Symfony\Component\Mime\FileBinaryMimeTypeGuesser::class), \E_USER_DEPRECATED);
/**
 ...
 */
class FileBinaryMimeTypeGuesser implements \_PhpScoper29aa9f1ba53d\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface
{
    private $cmd;
    /**

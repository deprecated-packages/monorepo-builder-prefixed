...
use _PhpScoper6f057cf7ca7c\Symfony\Component\Mime\FileinfoMimeTypeGuesser as NewFileinfoMimeTypeGuesser;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" instead.', \_PhpScoper6f057cf7ca7c\Symfony\Component\HttpFoundation\File\MimeType\FileinfoMimeTypeGuesser::class, \_PhpScoper6f057cf7ca7c\Symfony\Component\Mime\FileinfoMimeTypeGuesser::class), \E_USER_DEPRECATED);
/**
 ...
 */
class FileinfoMimeTypeGuesser implements \_PhpScoper6f057cf7ca7c\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface
{
    private $magicFile;
    /**

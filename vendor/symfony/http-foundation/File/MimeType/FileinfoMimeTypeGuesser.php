...
use _PhpScoperac0a9a33ae94\Symfony\Component\Mime\FileinfoMimeTypeGuesser as NewFileinfoMimeTypeGuesser;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.3, use "%s" instead.', \_PhpScoperac0a9a33ae94\Symfony\Component\HttpFoundation\File\MimeType\FileinfoMimeTypeGuesser::class, \_PhpScoperac0a9a33ae94\Symfony\Component\Mime\FileinfoMimeTypeGuesser::class), \E_USER_DEPRECATED);
/**
 ...
 */
class FileinfoMimeTypeGuesser implements \_PhpScoperac0a9a33ae94\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface
{
    private $magicFile;
    /**

 ...
 */
class ResponseHeaderBag extends \_PhpScoper1600de59048a\Symfony\Component\HttpFoundation\HeaderBag
{
    ...
    public function set(string $key, $values, bool $replace = \true)
    {
        ...
        if ('set-cookie' === $uniqueKey) {
            ...
            foreach ((array) $values as $cookie) {
                $this->setCookie(\_PhpScoper1600de59048a\Symfony\Component\HttpFoundation\Cookie::fromString($cookie));
            }
    ...
    public function setCookie(\_PhpScoper1600de59048a\Symfony\Component\HttpFoundation\Cookie $cookie)
    {
    ...
    {
        $this->setCookie(new \_PhpScoper1600de59048a\Symfony\Component\HttpFoundation\Cookie($name, null, 1, $path, $domain, $secure, $httpOnly, \false, $sameSite));
    }
    /**
    ...
    {
        return \_PhpScoper1600de59048a\Symfony\Component\HttpFoundation\HeaderUtils::makeDisposition($disposition, $filename, $filenameFallback);
    }
    /**

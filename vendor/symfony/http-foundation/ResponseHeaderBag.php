 ...
 */
class ResponseHeaderBag extends \_PhpScopera42d72b2de70\Symfony\Component\HttpFoundation\HeaderBag
{
    ...
    public function set(string $key, $values, bool $replace = \true)
    {
        ...
        if ('set-cookie' === $uniqueKey) {
            ...
            foreach ((array) $values as $cookie) {
                $this->setCookie(\_PhpScopera42d72b2de70\Symfony\Component\HttpFoundation\Cookie::fromString($cookie));
            }
    ...
    public function setCookie(\_PhpScopera42d72b2de70\Symfony\Component\HttpFoundation\Cookie $cookie)
    {
    ...
    {
        $this->setCookie(new \_PhpScopera42d72b2de70\Symfony\Component\HttpFoundation\Cookie($name, null, 1, $path, $domain, $secure, $httpOnly, \false, $sameSite));
    }
    /**
    ...
    {
        return \_PhpScopera42d72b2de70\Symfony\Component\HttpFoundation\HeaderUtils::makeDisposition($disposition, $filename, $filenameFallback);
    }
    /**

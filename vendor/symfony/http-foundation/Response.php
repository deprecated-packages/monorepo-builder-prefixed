...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb56893078f23\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb56893078f23\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb56893078f23\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper80b6fe7627f7\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper80b6fe7627f7\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper80b6fe7627f7\Symfony\Component\HttpFoundation\Request $request) : void
    {

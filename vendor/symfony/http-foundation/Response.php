...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera1d8e0344ecf\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera1d8e0344ecf\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera1d8e0344ecf\Symfony\Component\HttpFoundation\Request $request) : void
    {

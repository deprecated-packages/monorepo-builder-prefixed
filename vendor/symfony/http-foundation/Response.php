...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperf78d2b40800e\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperf78d2b40800e\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperf78d2b40800e\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb1086ecf2bcb\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb1086ecf2bcb\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb1086ecf2bcb\Symfony\Component\HttpFoundation\Request $request) : void
    {

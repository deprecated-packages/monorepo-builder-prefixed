...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper61d2aa534566\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper61d2aa534566\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper61d2aa534566\Symfony\Component\HttpFoundation\Request $request) : void
    {

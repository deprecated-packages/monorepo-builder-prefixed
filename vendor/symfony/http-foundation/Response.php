...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper87c95ce1b4e5\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper87c95ce1b4e5\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper87c95ce1b4e5\Symfony\Component\HttpFoundation\Request $request) : void
    {

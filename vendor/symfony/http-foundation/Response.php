...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopere6fd569fd43f\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopere6fd569fd43f\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopere6fd569fd43f\Symfony\Component\HttpFoundation\Request $request) : void
    {

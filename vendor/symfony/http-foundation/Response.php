...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper3e1a86bff77f\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper3e1a86bff77f\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper3e1a86bff77f\Symfony\Component\HttpFoundation\Request $request) : void
    {

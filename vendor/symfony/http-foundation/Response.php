...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper59bf8deb8cc1\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper59bf8deb8cc1\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper59bf8deb8cc1\Symfony\Component\HttpFoundation\Request $request) : void
    {

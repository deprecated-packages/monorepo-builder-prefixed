...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper47d898182bf9\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper47d898182bf9\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper47d898182bf9\Symfony\Component\HttpFoundation\Request $request) : void
    {

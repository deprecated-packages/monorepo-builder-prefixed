...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper77ed23b49cd3\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper77ed23b49cd3\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper77ed23b49cd3\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperd0ff379dfdc7\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperd0ff379dfdc7\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperd0ff379dfdc7\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper0dbf6264e8b4\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper0dbf6264e8b4\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper0dbf6264e8b4\Symfony\Component\HttpFoundation\Request $request) : void
    {

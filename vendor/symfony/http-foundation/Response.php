...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb0229f14f861\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb0229f14f861\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb0229f14f861\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper9b7e9beaf949\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper9b7e9beaf949\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper9b7e9beaf949\Symfony\Component\HttpFoundation\Request $request) : void
    {

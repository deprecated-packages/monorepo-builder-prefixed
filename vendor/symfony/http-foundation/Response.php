...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper69b0f14b2eca\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper69b0f14b2eca\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper69b0f14b2eca\Symfony\Component\HttpFoundation\Request $request) : void
    {

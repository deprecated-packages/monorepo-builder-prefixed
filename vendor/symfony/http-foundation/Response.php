...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperd79f30a2f8be\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperd79f30a2f8be\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperd79f30a2f8be\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper650fbdd90fa0\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper650fbdd90fa0\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper650fbdd90fa0\Symfony\Component\HttpFoundation\Request $request) : void
    {

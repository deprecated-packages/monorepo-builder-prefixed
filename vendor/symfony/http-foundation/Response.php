...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperdfa889d8967a\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperdfa889d8967a\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperdfa889d8967a\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper8a4bdaafa6ec\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper8a4bdaafa6ec\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper8a4bdaafa6ec\Symfony\Component\HttpFoundation\Request $request) : void
    {

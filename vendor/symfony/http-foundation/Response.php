...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper1d3d21549513\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper1d3d21549513\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper1d3d21549513\Symfony\Component\HttpFoundation\Request $request) : void
    {

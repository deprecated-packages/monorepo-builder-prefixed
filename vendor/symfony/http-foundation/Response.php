...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper2a80719fd449\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper2a80719fd449\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper2a80719fd449\Symfony\Component\HttpFoundation\Request $request) : void
    {

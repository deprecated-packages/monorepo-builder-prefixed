...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper84ee03573073\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper84ee03573073\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper84ee03573073\Symfony\Component\HttpFoundation\Request $request) : void
    {

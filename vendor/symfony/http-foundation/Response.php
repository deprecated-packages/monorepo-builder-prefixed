...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperf237fc62366a\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperf237fc62366a\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperf237fc62366a\Symfony\Component\HttpFoundation\Request $request) : void
    {

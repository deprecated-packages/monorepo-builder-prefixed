...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper6b92aa0ec16f\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper6b92aa0ec16f\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper6b92aa0ec16f\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper9022b927643b\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper9022b927643b\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper9022b927643b\Symfony\Component\HttpFoundation\Request $request) : void
    {

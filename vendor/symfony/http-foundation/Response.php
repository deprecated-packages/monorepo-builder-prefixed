...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper5efd9ec7ae1e\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper5efd9ec7ae1e\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper5efd9ec7ae1e\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper36281e29f54f\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper36281e29f54f\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper36281e29f54f\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperedfa898a454f\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperedfa898a454f\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperedfa898a454f\Symfony\Component\HttpFoundation\Request $request) : void
    {

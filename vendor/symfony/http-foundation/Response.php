...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera8413c4aa124\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera8413c4aa124\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera8413c4aa124\Symfony\Component\HttpFoundation\Request $request) : void
    {

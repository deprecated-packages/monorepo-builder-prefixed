...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper22d98a58be40\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper22d98a58be40\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper22d98a58be40\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopereaa2cae8e093\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopereaa2cae8e093\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopereaa2cae8e093\Symfony\Component\HttpFoundation\Request $request) : void
    {

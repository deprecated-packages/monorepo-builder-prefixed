...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper8e5d8d76215d\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper8e5d8d76215d\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper8e5d8d76215d\Symfony\Component\HttpFoundation\Request $request) : void
    {

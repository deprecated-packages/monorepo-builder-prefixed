...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperf7284855206a\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperf7284855206a\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperf7284855206a\Symfony\Component\HttpFoundation\Request $request) : void
    {

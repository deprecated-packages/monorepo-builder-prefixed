...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper138e2990dbdb\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper138e2990dbdb\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper138e2990dbdb\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb154859e1be7\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb154859e1be7\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb154859e1be7\Symfony\Component\HttpFoundation\Request $request) : void
    {

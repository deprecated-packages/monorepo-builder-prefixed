...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper1ceaf4cbd5cb\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper1ceaf4cbd5cb\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper1ceaf4cbd5cb\Symfony\Component\HttpFoundation\Request $request) : void
    {

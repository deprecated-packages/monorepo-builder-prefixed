...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera42d72b2de70\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera42d72b2de70\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera42d72b2de70\Symfony\Component\HttpFoundation\Request $request) : void
    {

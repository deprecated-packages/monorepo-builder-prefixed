...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperd9ee792cdaf4\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperd9ee792cdaf4\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperd9ee792cdaf4\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper8068fe8d25a3\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper8068fe8d25a3\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper8068fe8d25a3\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper8d3e33bd2be8\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper8d3e33bd2be8\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper8d3e33bd2be8\Symfony\Component\HttpFoundation\Request $request) : void
    {

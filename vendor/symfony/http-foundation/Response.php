...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper1d5917c620d0\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper1d5917c620d0\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper1d5917c620d0\Symfony\Component\HttpFoundation\Request $request) : void
    {

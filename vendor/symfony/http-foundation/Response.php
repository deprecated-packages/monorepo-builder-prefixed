...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperd2185c67a4b4\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperd2185c67a4b4\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperd2185c67a4b4\Symfony\Component\HttpFoundation\Request $request) : void
    {

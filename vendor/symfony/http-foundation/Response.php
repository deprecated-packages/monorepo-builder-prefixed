...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb3d59f519671\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb3d59f519671\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb3d59f519671\Symfony\Component\HttpFoundation\Request $request) : void
    {

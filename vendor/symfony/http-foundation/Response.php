...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopere4e8aecb81b9\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopere4e8aecb81b9\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopere4e8aecb81b9\Symfony\Component\HttpFoundation\Request $request) : void
    {

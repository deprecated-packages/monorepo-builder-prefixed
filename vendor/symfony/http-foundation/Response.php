...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperf2e2fcfe7ee6\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperf2e2fcfe7ee6\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperf2e2fcfe7ee6\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper66a1b4bf441c\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper66a1b4bf441c\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper66a1b4bf441c\Symfony\Component\HttpFoundation\Request $request) : void
    {

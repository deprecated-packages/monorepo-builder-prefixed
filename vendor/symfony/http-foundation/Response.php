...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopereb7fcd8f999a\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopereb7fcd8f999a\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopereb7fcd8f999a\Symfony\Component\HttpFoundation\Request $request) : void
    {

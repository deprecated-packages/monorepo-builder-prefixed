...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperbecbc4cd500f\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperbecbc4cd500f\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperbecbc4cd500f\Symfony\Component\HttpFoundation\Request $request) : void
    {

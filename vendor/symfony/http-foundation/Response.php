...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb2067b9f36f8\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb2067b9f36f8\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb2067b9f36f8\Symfony\Component\HttpFoundation\Request $request) : void
    {

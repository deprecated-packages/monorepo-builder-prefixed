...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperec2b815193b4\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperec2b815193b4\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperec2b815193b4\Symfony\Component\HttpFoundation\Request $request) : void
    {

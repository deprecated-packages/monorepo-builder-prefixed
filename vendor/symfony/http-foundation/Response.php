...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb2257feafd7d\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb2257feafd7d\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb2257feafd7d\Symfony\Component\HttpFoundation\Request $request) : void
    {

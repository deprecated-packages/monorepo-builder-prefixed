...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperbe77f3b0e77d\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperbe77f3b0e77d\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperbe77f3b0e77d\Symfony\Component\HttpFoundation\Request $request) : void
    {

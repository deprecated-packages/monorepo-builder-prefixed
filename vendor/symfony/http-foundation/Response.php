...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera28be7b3fe51\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera28be7b3fe51\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera28be7b3fe51\Symfony\Component\HttpFoundation\Request $request) : void
    {

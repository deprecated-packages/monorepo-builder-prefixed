...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopere7b233920bf2\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopere7b233920bf2\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopere7b233920bf2\Symfony\Component\HttpFoundation\Request $request) : void
    {

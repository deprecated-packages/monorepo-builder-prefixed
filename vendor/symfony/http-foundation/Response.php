...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera85504f0ea7b\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera85504f0ea7b\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera85504f0ea7b\Symfony\Component\HttpFoundation\Request $request) : void
    {

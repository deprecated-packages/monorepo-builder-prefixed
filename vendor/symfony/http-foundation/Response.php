...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperfdd2db5e123d\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperfdd2db5e123d\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperfdd2db5e123d\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper6da0ff96db02\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper6da0ff96db02\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper6da0ff96db02\Symfony\Component\HttpFoundation\Request $request) : void
    {

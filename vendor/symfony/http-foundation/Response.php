...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperac0a9a33ae94\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperac0a9a33ae94\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperac0a9a33ae94\Symfony\Component\HttpFoundation\Request $request) : void
    {

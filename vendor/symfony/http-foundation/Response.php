...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper3b1a4d12ef28\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper3b1a4d12ef28\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper3b1a4d12ef28\Symfony\Component\HttpFoundation\Request $request) : void
    {

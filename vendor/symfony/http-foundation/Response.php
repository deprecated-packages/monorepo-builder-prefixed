...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopere57ee17947a3\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopere57ee17947a3\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopere57ee17947a3\Symfony\Component\HttpFoundation\Request $request) : void
    {

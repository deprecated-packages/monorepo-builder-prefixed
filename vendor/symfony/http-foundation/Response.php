...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb2110b0b3130\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb2110b0b3130\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb2110b0b3130\Symfony\Component\HttpFoundation\Request $request) : void
    {

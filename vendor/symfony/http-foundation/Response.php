...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper77bdbacdc821\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper77bdbacdc821\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper77bdbacdc821\Symfony\Component\HttpFoundation\Request $request) : void
    {

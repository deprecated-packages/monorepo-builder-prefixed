...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper323d4c178bee\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper323d4c178bee\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper323d4c178bee\Symfony\Component\HttpFoundation\Request $request) : void
    {

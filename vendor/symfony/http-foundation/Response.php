...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper84d68f9a1b63\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper84d68f9a1b63\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper84d68f9a1b63\Symfony\Component\HttpFoundation\Request $request) : void
    {

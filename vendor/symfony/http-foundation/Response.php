...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper621122bdc380\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper621122bdc380\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper621122bdc380\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper244a857c31f6\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper244a857c31f6\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper244a857c31f6\Symfony\Component\HttpFoundation\Request $request) : void
    {

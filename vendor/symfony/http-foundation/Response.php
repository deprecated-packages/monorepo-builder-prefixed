...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper6713430bfe3d\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper6713430bfe3d\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper6713430bfe3d\Symfony\Component\HttpFoundation\Request $request) : void
    {

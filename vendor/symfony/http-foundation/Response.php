...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper4cbad741edc5\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper4cbad741edc5\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper4cbad741edc5\Symfony\Component\HttpFoundation\Request $request) : void
    {

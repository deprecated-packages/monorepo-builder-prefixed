...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperb445cd48032c\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperb445cd48032c\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperb445cd48032c\Symfony\Component\HttpFoundation\Request $request) : void
    {

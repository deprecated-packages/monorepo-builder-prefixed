...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera763b4be90d0\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera763b4be90d0\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera763b4be90d0\Symfony\Component\HttpFoundation\Request $request) : void
    {

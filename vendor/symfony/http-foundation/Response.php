...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperd3e9cfbe9d90\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperd3e9cfbe9d90\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperd3e9cfbe9d90\Symfony\Component\HttpFoundation\Request $request) : void
    {

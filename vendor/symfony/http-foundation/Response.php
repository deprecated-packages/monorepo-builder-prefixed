...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper9a38f5ee6cbc\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper9a38f5ee6cbc\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper9a38f5ee6cbc\Symfony\Component\HttpFoundation\Request $request) : void
    {

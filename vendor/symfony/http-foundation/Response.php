...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperdfdcb3d4cca0\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperdfdcb3d4cca0\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperdfdcb3d4cca0\Symfony\Component\HttpFoundation\Request $request) : void
    {

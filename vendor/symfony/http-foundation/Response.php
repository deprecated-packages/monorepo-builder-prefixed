...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper963537526adf\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper963537526adf\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper963537526adf\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperfd1a6a0ee9af\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperfd1a6a0ee9af\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperfd1a6a0ee9af\Symfony\Component\HttpFoundation\Request $request) : void
    {

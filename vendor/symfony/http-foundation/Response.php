...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoperef4638f5d8b1\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoperef4638f5d8b1\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoperef4638f5d8b1\Symfony\Component\HttpFoundation\Request $request) : void
    {

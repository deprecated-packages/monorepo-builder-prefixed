...
class Response
{
    ...
    {
        $this->headers = new \_PhpScoper00f012948171\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScoper00f012948171\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScoper00f012948171\Symfony\Component\HttpFoundation\Request $request) : void
    {

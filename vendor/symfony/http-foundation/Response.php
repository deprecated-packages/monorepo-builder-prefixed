...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopere1b4619561f2\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopere1b4619561f2\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopere1b4619561f2\Symfony\Component\HttpFoundation\Request $request) : void
    {

...
class Response
{
    ...
    {
        $this->headers = new \_PhpScopera2ff5fd2b59c\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\_PhpScopera2ff5fd2b59c\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\_PhpScopera2ff5fd2b59c\Symfony\Component\HttpFoundation\Request $request) : void
    {

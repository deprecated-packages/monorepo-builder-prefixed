 ...
 */
class RequestMatcher implements \_PhpScoperb1086ecf2bcb\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\_PhpScoperb1086ecf2bcb\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\_PhpScoperb1086ecf2bcb\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }

 ...
 */
class RequestMatcher implements \_PhpScoper711ac919263f\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\_PhpScoper711ac919263f\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\_PhpScoper711ac919263f\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }

 ...
 */
class RequestMatcher implements \_PhpScoperbe77f3b0e77d\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\_PhpScoperbe77f3b0e77d\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\_PhpScoperbe77f3b0e77d\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }

...
class HeaderBag implements \IteratorAggregate, \Countable
{
    ...
    protected function getCacheControlHeader()
    {
        ...
        return \_PhpScopere4e8aecb81b9\Symfony\Component\HttpFoundation\HeaderUtils::toString($this->cacheControl, ',');
    }
    /**
    ...
    {
        $parts = \_PhpScopere4e8aecb81b9\Symfony\Component\HttpFoundation\HeaderUtils::split($header, ',=');
        return \_PhpScopere4e8aecb81b9\Symfony\Component\HttpFoundation\HeaderUtils::combine($parts);
    }
}

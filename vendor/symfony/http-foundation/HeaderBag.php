...
class HeaderBag implements \IteratorAggregate, \Countable
{
    ...
    protected function getCacheControlHeader()
    {
        ...
        return \_PhpScopera763b4be90d0\Symfony\Component\HttpFoundation\HeaderUtils::toString($this->cacheControl, ',');
    }
    /**
    ...
    {
        $parts = \_PhpScopera763b4be90d0\Symfony\Component\HttpFoundation\HeaderUtils::split($header, ',=');
        return \_PhpScopera763b4be90d0\Symfony\Component\HttpFoundation\HeaderUtils::combine($parts);
    }
}

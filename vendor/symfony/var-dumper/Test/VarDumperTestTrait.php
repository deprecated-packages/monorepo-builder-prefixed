 ...
 */
namespace _PhpScoperda849baa4a45\Symfony\Component\VarDumper\Test;
...
trait VarDumperTestTrait
{
    ...
    protected function getDump($data, $key = null, $filter = 0)
    {
        if (null === ($flags = $this->varDumperConfig['flags'])) {
            $flags = \getenv('DUMP_LIGHT_ARRAY') ? \_PhpScoperda849baa4a45\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_LIGHT_ARRAY : 0;
            $flags |= \getenv('DUMP_STRING_LENGTH') ? \_PhpScoperda849baa4a45\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_STRING_LENGTH : 0;
            $flags |= \getenv('DUMP_COMMA_SEPARATOR') ? \_PhpScoperda849baa4a45\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_COMMA_SEPARATOR : 0;
        }
        ...
        $dumper = new \_PhpScoperda849baa4a45\Symfony\Component\VarDumper\Dumper\CliDumper(null, null, $flags);

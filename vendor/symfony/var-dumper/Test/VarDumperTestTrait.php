 ...
 */
namespace _PhpScoperbc89827b806f\Symfony\Component\VarDumper\Test;
...
trait VarDumperTestTrait
{
    ...
    protected function getDump($data, $key = null, $filter = 0)
    {
        if (null === ($flags = $this->varDumperConfig['flags'])) {
            $flags = \getenv('DUMP_LIGHT_ARRAY') ? \_PhpScoperbc89827b806f\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_LIGHT_ARRAY : 0;
            $flags |= \getenv('DUMP_STRING_LENGTH') ? \_PhpScoperbc89827b806f\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_STRING_LENGTH : 0;
            $flags |= \getenv('DUMP_COMMA_SEPARATOR') ? \_PhpScoperbc89827b806f\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_COMMA_SEPARATOR : 0;
        }
        ...
        $dumper = new \_PhpScoperbc89827b806f\Symfony\Component\VarDumper\Dumper\CliDumper(null, null, $flags);

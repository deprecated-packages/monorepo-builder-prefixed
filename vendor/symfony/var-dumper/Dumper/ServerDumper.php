 ...
 */
class ServerDumper implements \_PhpScopercdfd316eda69\Symfony\Component\VarDumper\Dumper\DataDumperInterface
{
    private $connection;
     ...
     */
    public function __construct(string $host, \_PhpScopercdfd316eda69\Symfony\Component\VarDumper\Dumper\DataDumperInterface $wrappedDumper = null, array $contextProviders = [])
    {
        $this->connection = new \_PhpScopercdfd316eda69\Symfony\Component\VarDumper\Server\Connection($host, $contextProviders);

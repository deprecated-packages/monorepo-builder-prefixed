 ...
 */
class ServerDumper implements \_PhpScopereb7fcd8f999a\Symfony\Component\VarDumper\Dumper\DataDumperInterface
{
    private $connection;
     ...
     */
    public function __construct(string $host, \_PhpScopereb7fcd8f999a\Symfony\Component\VarDumper\Dumper\DataDumperInterface $wrappedDumper = null, array $contextProviders = [])
    {
        $this->connection = new \_PhpScopereb7fcd8f999a\Symfony\Component\VarDumper\Server\Connection($host, $contextProviders);

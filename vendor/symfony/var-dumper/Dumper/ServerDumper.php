 ...
 */
class ServerDumper implements \_PhpScoperfa13b4bfa005\Symfony\Component\VarDumper\Dumper\DataDumperInterface
{
    private $connection;
     ...
     */
    public function __construct(string $host, \_PhpScoperfa13b4bfa005\Symfony\Component\VarDumper\Dumper\DataDumperInterface $wrappedDumper = null, array $contextProviders = [])
    {
        $this->connection = new \_PhpScoperfa13b4bfa005\Symfony\Component\VarDumper\Server\Connection($host, $contextProviders);

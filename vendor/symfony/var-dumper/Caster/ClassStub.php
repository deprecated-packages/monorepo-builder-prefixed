 ...
 */
class ClassStub extends \_PhpScoper650fbdd90fa0\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \_PhpScoper650fbdd90fa0\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \_PhpScoper650fbdd90fa0\Symfony\Component\VarDumper\Cloner\Stub(), \true, \_PhpScoper650fbdd90fa0\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \_PhpScoper650fbdd90fa0\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);

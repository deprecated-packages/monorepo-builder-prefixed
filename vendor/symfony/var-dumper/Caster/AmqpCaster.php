...
class AmqpCaster
{
    ...
    public static function castConnection(\AMQPConnection $c, array $a, \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
    ...
    public static function castChannel(\AMQPChannel $c, array $a, \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        $prefix = \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
    ...
    public static function castQueue(\AMQPQueue $c, array $a, \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        $prefix = \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
    ...
    public static function castExchange(\AMQPExchange $c, array $a, \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested)
    {
        $prefix = \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
        $a += [$prefix . 'flags' => self::extractFlags($c->getFlags())];
        $type = isset(self::$exchangeTypes[$c->getType()]) ? new \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Caster\ConstStub(self::$exchangeTypes[$c->getType()], $c->getType()) : $c->getType();
        // Recent version of the extension already expose private properties
    ...
    public static function castEnvelope(\AMQPEnvelope $c, array $a, \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Cloner\Stub $stub, $isNested, $filter = 0)
    {
        $prefix = \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Caster\Caster::PREFIX_VIRTUAL;
        $deliveryMode = new \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Caster\ConstStub($c->getDeliveryMode() . (2 === $c->getDeliveryMode() ? ' (persistent)' : ' (non-persistent)'), $c->getDeliveryMode());
        // Recent version of the extension already expose private properties
    ...
    private static function extractFlags(int $flags) : \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Caster\ConstStub
    {
        $flagsArray = [];
        ...
        return new \_PhpScoperafeb7177e88e\Symfony\Component\VarDumper\Caster\ConstStub(\implode('|', $flagsArray), $flags);
    }
}

 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperfa13b4bfa005\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperfa13b4bfa005\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperfa13b4bfa005\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperfa13b4bfa005\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperfa13b4bfa005\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperfa13b4bfa005\Symfony\Component\Console\Input\ArrayInput([]), $output);

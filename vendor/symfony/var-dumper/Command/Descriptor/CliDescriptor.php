 ...
 * @final
 */
class CliDescriptor implements \_PhpScopere846b54512fc\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScopere846b54512fc\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScopere846b54512fc\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScopere846b54512fc\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScopere846b54512fc\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScopere846b54512fc\Symfony\Component\Console\Input\ArrayInput([]), $output);

 ...
 * @final
 */
class CliDescriptor implements \_PhpScoper323d4c178bee\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoper323d4c178bee\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoper323d4c178bee\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoper323d4c178bee\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoper323d4c178bee\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoper323d4c178bee\Symfony\Component\Console\Input\ArrayInput([]), $output);

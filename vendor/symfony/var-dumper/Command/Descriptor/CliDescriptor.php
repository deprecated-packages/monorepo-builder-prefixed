 ...
 * @final
 */
class CliDescriptor implements \_PhpScopereaa086e6f852\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScopereaa086e6f852\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScopereaa086e6f852\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScopereaa086e6f852\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScopereaa086e6f852\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScopereaa086e6f852\Symfony\Component\Console\Input\ArrayInput([]), $output);

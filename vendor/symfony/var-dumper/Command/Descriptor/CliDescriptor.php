 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperaf523e5605cc\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperaf523e5605cc\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperaf523e5605cc\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperaf523e5605cc\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperaf523e5605cc\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperaf523e5605cc\Symfony\Component\Console\Input\ArrayInput([]), $output);

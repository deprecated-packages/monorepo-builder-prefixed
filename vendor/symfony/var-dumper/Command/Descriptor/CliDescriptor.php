 ...
 * @final
 */
class CliDescriptor implements \_PhpScoper36281e29f54f\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoper36281e29f54f\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoper36281e29f54f\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoper36281e29f54f\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoper36281e29f54f\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoper36281e29f54f\Symfony\Component\Console\Input\ArrayInput([]), $output);

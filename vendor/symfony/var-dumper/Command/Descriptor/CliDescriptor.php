 ...
 * @final
 */
class CliDescriptor implements \_PhpScopera2ff5fd2b59c\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScopera2ff5fd2b59c\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScopera2ff5fd2b59c\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScopera2ff5fd2b59c\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScopera2ff5fd2b59c\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScopera2ff5fd2b59c\Symfony\Component\Console\Input\ArrayInput([]), $output);

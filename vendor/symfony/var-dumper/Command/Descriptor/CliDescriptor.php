 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperfdd2db5e123d\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperfdd2db5e123d\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperfdd2db5e123d\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperfdd2db5e123d\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperfdd2db5e123d\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperfdd2db5e123d\Symfony\Component\Console\Input\ArrayInput([]), $output);

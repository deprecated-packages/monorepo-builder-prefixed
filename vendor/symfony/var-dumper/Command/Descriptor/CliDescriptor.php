 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperce084f4275dd\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperce084f4275dd\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperce084f4275dd\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperce084f4275dd\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperce084f4275dd\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperce084f4275dd\Symfony\Component\Console\Input\ArrayInput([]), $output);

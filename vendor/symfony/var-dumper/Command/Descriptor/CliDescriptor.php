 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperdbf49b510e11\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperdbf49b510e11\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperdbf49b510e11\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperdbf49b510e11\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperdbf49b510e11\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperdbf49b510e11\Symfony\Component\Console\Input\ArrayInput([]), $output);

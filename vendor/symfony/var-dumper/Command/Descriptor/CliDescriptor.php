 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperee3ad0c2c096\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperee3ad0c2c096\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperee3ad0c2c096\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperee3ad0c2c096\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperee3ad0c2c096\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperee3ad0c2c096\Symfony\Component\Console\Input\ArrayInput([]), $output);

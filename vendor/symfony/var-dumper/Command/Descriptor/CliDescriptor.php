 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperda849baa4a45\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperda849baa4a45\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperda849baa4a45\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperda849baa4a45\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperda849baa4a45\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperda849baa4a45\Symfony\Component\Console\Input\ArrayInput([]), $output);

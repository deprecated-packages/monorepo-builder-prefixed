 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperb56893078f23\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperb56893078f23\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperb56893078f23\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperb56893078f23\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperb56893078f23\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperb56893078f23\Symfony\Component\Console\Input\ArrayInput([]), $output);

 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperbc89827b806f\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperbc89827b806f\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperbc89827b806f\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperbc89827b806f\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperbc89827b806f\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperbc89827b806f\Symfony\Component\Console\Input\ArrayInput([]), $output);

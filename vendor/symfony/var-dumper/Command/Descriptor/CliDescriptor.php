 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperf1163522a13e\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperf1163522a13e\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperf1163522a13e\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperf1163522a13e\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperf1163522a13e\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperf1163522a13e\Symfony\Component\Console\Input\ArrayInput([]), $output);

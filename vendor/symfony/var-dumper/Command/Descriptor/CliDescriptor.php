 ...
 * @final
 */
class CliDescriptor implements \_PhpScoperee8f03533f8b\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\_PhpScoperee8f03533f8b\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\_PhpScoperee8f03533f8b\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \_PhpScoperee8f03533f8b\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \_PhpScoperee8f03533f8b\Symfony\Component\Console\Style\SymfonyStyle(new \_PhpScoperee8f03533f8b\Symfony\Component\Console\Input\ArrayInput([]), $output);

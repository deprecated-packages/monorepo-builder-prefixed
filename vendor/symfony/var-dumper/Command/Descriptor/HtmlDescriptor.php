 ...
 * @final
 */
class HtmlDescriptor implements \_PhpScoper8d3e33bd2be8\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $initialized = \false;
    public function __construct(\_PhpScoper8d3e33bd2be8\Symfony\Component\VarDumper\Dumper\HtmlDumper $dumper)
    {
        $this->dumper = $dumper;
    }

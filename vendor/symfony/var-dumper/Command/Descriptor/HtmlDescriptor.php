 ...
 * @final
 */
class HtmlDescriptor implements \_PhpScoperf2e2fcfe7ee6\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $initialized = \false;
    public function __construct(\_PhpScoperf2e2fcfe7ee6\Symfony\Component\VarDumper\Dumper\HtmlDumper $dumper)
    {
        $this->dumper = $dumper;
    }

 ...
 */
class ProcessFailedException extends \_PhpScoperabb8c88e9df1\Symfony\Component\Process\Exception\RuntimeException
{
    private $process;
    public function __construct(\_PhpScoperabb8c88e9df1\Symfony\Component\Process\Process $process)
    {
        if ($process->isSuccessful()) {
            throw new \_PhpScoperabb8c88e9df1\Symfony\Component\Process\Exception\InvalidArgumentException('Expected a failed process, but the given process was successful.');
        }

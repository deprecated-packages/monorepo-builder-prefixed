 ...
 */
class ProcessFailedException extends \_PhpScopera3f2f7450f99\Symfony\Component\Process\Exception\RuntimeException
{
    private $process;
    public function __construct(\_PhpScopera3f2f7450f99\Symfony\Component\Process\Process $process)
    {
        if ($process->isSuccessful()) {
            throw new \_PhpScopera3f2f7450f99\Symfony\Component\Process\Exception\InvalidArgumentException('Expected a failed process, but the given process was successful.');
        }

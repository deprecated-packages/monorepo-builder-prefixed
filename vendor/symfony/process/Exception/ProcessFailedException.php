 ...
 */
class ProcessFailedException extends \_PhpScoperfdd2db5e123d\Symfony\Component\Process\Exception\RuntimeException
{
    private $process;
    public function __construct(\_PhpScoperfdd2db5e123d\Symfony\Component\Process\Process $process)
    {
        if ($process->isSuccessful()) {
            throw new \_PhpScoperfdd2db5e123d\Symfony\Component\Process\Exception\InvalidArgumentException('Expected a failed process, but the given process was successful.');
        }

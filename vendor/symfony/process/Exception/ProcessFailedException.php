 ...
 */
class ProcessFailedException extends \_PhpScoper87c95ce1b4e5\Symfony\Component\Process\Exception\RuntimeException
{
    private $process;
    public function __construct(\_PhpScoper87c95ce1b4e5\Symfony\Component\Process\Process $process)
    {
        if ($process->isSuccessful()) {
            throw new \_PhpScoper87c95ce1b4e5\Symfony\Component\Process\Exception\InvalidArgumentException('Expected a failed process, but the given process was successful.');
        }

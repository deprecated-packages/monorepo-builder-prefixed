 ...
 */
class ProcessTimedOutException extends \_PhpScopere6d124d1f7ba\Symfony\Component\Process\Exception\RuntimeException
{
    const TYPE_GENERAL = 1;
    const TYPE_IDLE = 2;
    private $process;
    private $timeoutType;
    public function __construct(\_PhpScopere6d124d1f7ba\Symfony\Component\Process\Process $process, int $timeoutType)
    {

 ...
 */
class ProcessTimedOutException extends \_PhpScoper87c95ce1b4e5\Symfony\Component\Process\Exception\RuntimeException
{
    const TYPE_GENERAL = 1;
    const TYPE_IDLE = 2;
    private $process;
    private $timeoutType;
    public function __construct(\_PhpScoper87c95ce1b4e5\Symfony\Component\Process\Process $process, int $timeoutType)
    {

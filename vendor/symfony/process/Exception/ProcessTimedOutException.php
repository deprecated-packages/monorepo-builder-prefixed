 ...
 */
class ProcessTimedOutException extends \_PhpScoper36281e29f54f\Symfony\Component\Process\Exception\RuntimeException
{
    const TYPE_GENERAL = 1;
    const TYPE_IDLE = 2;
    private $process;
    private $timeoutType;
    public function __construct(\_PhpScoper36281e29f54f\Symfony\Component\Process\Process $process, int $timeoutType)
    {

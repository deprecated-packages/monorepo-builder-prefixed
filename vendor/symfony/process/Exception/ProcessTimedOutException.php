 ...
 */
class ProcessTimedOutException extends \_PhpScoper462f168ef4cc\Symfony\Component\Process\Exception\RuntimeException
{
    const TYPE_GENERAL = 1;
    const TYPE_IDLE = 2;
    private $process;
    private $timeoutType;
    public function __construct(\_PhpScoper462f168ef4cc\Symfony\Component\Process\Process $process, int $timeoutType)
    {

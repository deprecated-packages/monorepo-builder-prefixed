 ...
 */
class ProcessTimedOutException extends \_PhpScoperfdd2db5e123d\Symfony\Component\Process\Exception\RuntimeException
{
    const TYPE_GENERAL = 1;
    const TYPE_IDLE = 2;
    private $process;
    private $timeoutType;
    public function __construct(\_PhpScoperfdd2db5e123d\Symfony\Component\Process\Process $process, int $timeoutType)
    {

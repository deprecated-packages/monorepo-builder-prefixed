 ...
 */
class PhpProcess extends \_PhpScoperb445cd48032c\Symfony\Component\Process\Process
{
    /**
    ...
    {
        if (null === $php) {
            $executableFinder = new \_PhpScoperb445cd48032c\Symfony\Component\Process\PhpExecutableFinder();
    ...
    public function start(callable $callback = null, array $env = [])
    {
        if (null === $this->getCommandLine()) {
            throw new \_PhpScoperb445cd48032c\Symfony\Component\Process\Exception\RuntimeException('Unable to find the PHP executable.');
        }

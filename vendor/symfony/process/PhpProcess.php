 ...
 */
class PhpProcess extends \_PhpScoperfd1a6a0ee9af\Symfony\Component\Process\Process
{
    /**
    ...
    {
        if (null === $php) {
            $executableFinder = new \_PhpScoperfd1a6a0ee9af\Symfony\Component\Process\PhpExecutableFinder();
    ...
    public function start(callable $callback = null, array $env = [])
    {
        if (null === $this->getCommandLine()) {
            throw new \_PhpScoperfd1a6a0ee9af\Symfony\Component\Process\Exception\RuntimeException('Unable to find the PHP executable.');
        }

 ...
 * @internal
 */
class UnixPipes extends \_PhpScoper227dea868235\Symfony\Component\Process\Pipes\AbstractPipes
{
    private $ttyMode;
    private $ptyMode;
    ...
    public function getDescriptors() : array
    {
        ...
        if ($this->ptyMode && \_PhpScoper227dea868235\Symfony\Component\Process\Process::isPtySupported()) {
            return [['pty'], ['pty'], ['pty']];
        }
        return [
            ['pipe', 'r'],
    ...
    public function readAndWrite(bool $blocking, bool $close = \false) : array
    {
        ...
        if (($r || $w) && \false === \stream_select($r, $w, $e, 0, $blocking ? \_PhpScoper227dea868235\Symfony\Component\Process\Process::TIMEOUT_PRECISION * 1000000.0 : 0)) {

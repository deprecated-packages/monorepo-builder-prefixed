...
use _PhpScopere0f28e6b9bde\Symfony\Component\HttpKernel\Log\Logger;
/**
 * Registers the default logger if necessary.
 *
 * @author Kévin Dunglas <dunglas@gmail.com>
 */
class LoggerPass implements \_PhpScopere0f28e6b9bde\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $container->setAlias(\_PhpScopere0f28e6b9bde\Psr\Log\LoggerInterface::class, 'logger')->setPublic(\false);
        if ($container->has('logger')) {
            return;
        }
        $container->register('logger', \_PhpScopere0f28e6b9bde\Symfony\Component\HttpKernel\Log\Logger::class)->setPublic(\false);
    }
}

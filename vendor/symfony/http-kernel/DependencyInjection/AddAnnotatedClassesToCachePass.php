 ...
 */
class AddAnnotatedClassesToCachePass implements \_PhpScopere4e8aecb81b9\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $kernel;
    public function __construct(\_PhpScopere4e8aecb81b9\Symfony\Component\HttpKernel\Kernel $kernel)
    {
        $this->kernel = $kernel;
    }
    /**
    ...
    public function process(\_PhpScopere4e8aecb81b9\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->getExtensions() as $extension) {
            if ($extension instanceof \_PhpScopere4e8aecb81b9\Symfony\Component\HttpKernel\DependencyInjection\Extension) {
    ...
    private function getClassesInComposerClassMaps() : array
    {
        ...
        foreach (\spl_autoload_functions() as $function) {
            ...
            if ($function[0] instanceof \_PhpScopere4e8aecb81b9\Symfony\Component\ErrorHandler\DebugClassLoader || $function[0] instanceof \_PhpScopere4e8aecb81b9\Symfony\Component\Debug\DebugClassLoader) {

 ...
 */
class AddAnnotatedClassesToCachePass implements \_PhpScoperab3ccffcffcd\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $kernel;
    public function __construct(\_PhpScoperab3ccffcffcd\Symfony\Component\HttpKernel\Kernel $kernel)
    {
        $this->kernel = $kernel;
    }
    /**
    ...
    public function process(\_PhpScoperab3ccffcffcd\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->getExtensions() as $extension) {
            if ($extension instanceof \_PhpScoperab3ccffcffcd\Symfony\Component\HttpKernel\DependencyInjection\Extension) {
    ...
    private function getClassesInComposerClassMaps() : array
    {
        ...
        foreach (\spl_autoload_functions() as $function) {
            ...
            if ($function[0] instanceof \_PhpScoperab3ccffcffcd\Symfony\Component\ErrorHandler\DebugClassLoader || $function[0] instanceof \_PhpScoperab3ccffcffcd\Symfony\Component\Debug\DebugClassLoader) {

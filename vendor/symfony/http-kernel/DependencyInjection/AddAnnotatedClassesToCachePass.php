 ...
 */
class AddAnnotatedClassesToCachePass implements \_PhpScopere6d124d1f7ba\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $kernel;
    public function __construct(\_PhpScopere6d124d1f7ba\Symfony\Component\HttpKernel\Kernel $kernel)
    {
        $this->kernel = $kernel;
    }
    /**
    ...
    public function process(\_PhpScopere6d124d1f7ba\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->getExtensions() as $extension) {
            if ($extension instanceof \_PhpScopere6d124d1f7ba\Symfony\Component\HttpKernel\DependencyInjection\Extension) {
    ...
    private function getClassesInComposerClassMaps() : array
    {
        ...
        foreach (\spl_autoload_functions() as $function) {
            ...
            if ($function[0] instanceof \_PhpScopere6d124d1f7ba\Symfony\Component\ErrorHandler\DebugClassLoader || $function[0] instanceof \_PhpScopere6d124d1f7ba\Symfony\Component\Debug\DebugClassLoader) {
                $function = $function[0]->getClassLoader();
            }
            if (\is_array($function) && $function[0] instanceof \_PhpScopere6d124d1f7ba\Composer\Autoload\ClassLoader) {

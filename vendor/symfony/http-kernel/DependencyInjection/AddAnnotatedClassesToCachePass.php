 ...
 */
class AddAnnotatedClassesToCachePass implements \_PhpScoperc9dee8f3b3e7\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $kernel;
    public function __construct(\_PhpScoperc9dee8f3b3e7\Symfony\Component\HttpKernel\Kernel $kernel)
    {
        $this->kernel = $kernel;
    }
    /**
    ...
    public function process(\_PhpScoperc9dee8f3b3e7\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->getExtensions() as $extension) {
            if ($extension instanceof \_PhpScoperc9dee8f3b3e7\Symfony\Component\HttpKernel\DependencyInjection\Extension) {
    ...
    private function getClassesInComposerClassMaps() : array
    {
        ...
        foreach (\spl_autoload_functions() as $function) {
            ...
            if ($function[0] instanceof \_PhpScoperc9dee8f3b3e7\Symfony\Component\ErrorHandler\DebugClassLoader || $function[0] instanceof \_PhpScoperc9dee8f3b3e7\Symfony\Component\Debug\DebugClassLoader) {
                $function = $function[0]->getClassLoader();
            }
            if (\is_array($function) && $function[0] instanceof \_PhpScoperc9dee8f3b3e7\Composer\Autoload\ClassLoader) {

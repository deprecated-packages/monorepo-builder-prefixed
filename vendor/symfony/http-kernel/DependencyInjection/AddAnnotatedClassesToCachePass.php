 ...
 */
class AddAnnotatedClassesToCachePass implements \_PhpScoperb3e4472dbe9b\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $kernel;
    public function __construct(\_PhpScoperb3e4472dbe9b\Symfony\Component\HttpKernel\Kernel $kernel)
    {
        $this->kernel = $kernel;
    }
    /**
    ...
    public function process(\_PhpScoperb3e4472dbe9b\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->getExtensions() as $extension) {
            if ($extension instanceof \_PhpScoperb3e4472dbe9b\Symfony\Component\HttpKernel\DependencyInjection\Extension) {
    ...
    private function getClassesInComposerClassMaps() : array
    {
        ...
        foreach (\spl_autoload_functions() as $function) {
            ...
            if ($function[0] instanceof \_PhpScoperb3e4472dbe9b\Symfony\Component\ErrorHandler\DebugClassLoader || $function[0] instanceof \_PhpScoperb3e4472dbe9b\Symfony\Component\Debug\DebugClassLoader) {

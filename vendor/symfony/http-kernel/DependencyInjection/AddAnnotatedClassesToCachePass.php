 ...
 */
class AddAnnotatedClassesToCachePass implements \_PhpScoperc00d4390f333\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $kernel;
    public function __construct(\_PhpScoperc00d4390f333\Symfony\Component\HttpKernel\Kernel $kernel)
    {
        $this->kernel = $kernel;
    }
    /**
    ...
    public function process(\_PhpScoperc00d4390f333\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->getExtensions() as $extension) {
            if ($extension instanceof \_PhpScoperc00d4390f333\Symfony\Component\HttpKernel\DependencyInjection\Extension) {
    ...
    private function getClassesInComposerClassMaps() : array
    {
        ...
        foreach (\spl_autoload_functions() as $function) {
            ...
            if ($function[0] instanceof \_PhpScoperc00d4390f333\Symfony\Component\ErrorHandler\DebugClassLoader || $function[0] instanceof \_PhpScoperc00d4390f333\Symfony\Component\Debug\DebugClassLoader) {

 ...
 */
namespace _PhpScoperda849baa4a45\Symfony\Component\HttpKernel\Event;
 ...
 */
class GetResponseForExceptionEvent extends \_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\Event\RequestEvent
{
    private $throwable;
    private $exception;
    private $allowCustomResponseCode = \false;
    public function __construct(\_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \_PhpScoperda849baa4a45\Symfony\Component\HttpFoundation\Request $request, int $requestType, \Throwable $e)
    {
    ...
    public function getException()
    {
        ...
        return $this->exception ?? ($this->exception = $this->throwable instanceof \Exception ? $this->throwable : new \_PhpScoperda849baa4a45\Symfony\Component\Debug\Exception\FatalThrowableError($this->throwable));
    }
    /**

 ...
 */
class GetResponseForExceptionEvent extends \_PhpScopera85504f0ea7b\Symfony\Component\HttpKernel\Event\RequestEvent
{
    private $throwable;
    private $exception;
    private $allowCustomResponseCode = \false;
    public function __construct(\_PhpScopera85504f0ea7b\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \_PhpScopera85504f0ea7b\Symfony\Component\HttpFoundation\Request $request, int $requestType, \Throwable $e)
    {
    ...
    public function getException()
    {
        ...
        return $this->exception ?? ($this->exception = $this->throwable instanceof \Exception ? $this->throwable : new \_PhpScopera85504f0ea7b\Symfony\Component\Debug\Exception\FatalThrowableError($this->throwable));
    }
    /**

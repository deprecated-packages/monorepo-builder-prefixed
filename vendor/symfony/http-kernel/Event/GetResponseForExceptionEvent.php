 ...
 */
class GetResponseForExceptionEvent extends \_PhpScopere3ed9f66440c\Symfony\Component\HttpKernel\Event\RequestEvent
{
    private $throwable;
    private $exception;
    private $allowCustomResponseCode = \false;
    public function __construct(\_PhpScopere3ed9f66440c\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \_PhpScopere3ed9f66440c\Symfony\Component\HttpFoundation\Request $request, int $requestType, \Throwable $e)
    {
    ...
    public function getException()
    {
        ...
        return $this->exception ?? ($this->exception = $this->throwable instanceof \Exception ? $this->throwable : new \_PhpScopere3ed9f66440c\Symfony\Component\Debug\Exception\FatalThrowableError($this->throwable));
    }
    /**

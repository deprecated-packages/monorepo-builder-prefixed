 ...
 */
namespace _PhpScopere846b54512fc\Symfony\Component\HttpKernel\Event;
 ...
 */
class GetResponseForExceptionEvent extends \_PhpScopere846b54512fc\Symfony\Component\HttpKernel\Event\RequestEvent
{
    private $throwable;
    private $exception;
    private $allowCustomResponseCode = \false;
    public function __construct(\_PhpScopere846b54512fc\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \_PhpScopere846b54512fc\Symfony\Component\HttpFoundation\Request $request, int $requestType, \Throwable $e)
    {
    ...
    public function getException()
    {
        ...
        return $this->exception ?? ($this->exception = $this->throwable instanceof \Exception ? $this->throwable : new \_PhpScopere846b54512fc\Symfony\Component\Debug\Exception\FatalThrowableError($this->throwable));
    }
    /**

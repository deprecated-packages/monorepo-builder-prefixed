 ...
 */
namespace _PhpScopere0f28e6b9bde\Symfony\Component\HttpKernel\Event;
 ...
 */
class GetResponseForExceptionEvent extends \_PhpScopere0f28e6b9bde\Symfony\Component\HttpKernel\Event\RequestEvent
{
    private $throwable;
    private $exception;
    private $allowCustomResponseCode = \false;
    public function __construct(\_PhpScopere0f28e6b9bde\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \_PhpScopere0f28e6b9bde\Symfony\Component\HttpFoundation\Request $request, int $requestType, \Throwable $e)
    {
    ...
    public function getException()
    {
        ...
        return $this->exception ?? ($this->exception = $this->throwable instanceof \Exception ? $this->throwable : new \_PhpScopere0f28e6b9bde\Symfony\Component\Debug\Exception\FatalThrowableError($this->throwable));
    }
    /**

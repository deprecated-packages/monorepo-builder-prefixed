 ...
 */
namespace _PhpScoperd79f30a2f8be\Symfony\Component\HttpKernel\Config;

use _PhpScoperd79f30a2f8be\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperd79f30a2f8be\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperd79f30a2f8be\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

 ...
 */
namespace _PhpScoperfa13b4bfa005\Symfony\Component\HttpKernel\Config;

use _PhpScoperfa13b4bfa005\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperfa13b4bfa005\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperfa13b4bfa005\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

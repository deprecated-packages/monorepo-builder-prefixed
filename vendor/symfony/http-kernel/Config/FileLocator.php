 ...
 */
namespace _PhpScoper09a4cc789a22\Symfony\Component\HttpKernel\Config;

use _PhpScoper09a4cc789a22\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper09a4cc789a22\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper09a4cc789a22\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

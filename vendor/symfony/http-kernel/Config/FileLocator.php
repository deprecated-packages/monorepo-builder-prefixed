 ...
 */
namespace _PhpScoper437fa56c88e1\Symfony\Component\HttpKernel\Config;

use _PhpScoper437fa56c88e1\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper437fa56c88e1\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper437fa56c88e1\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

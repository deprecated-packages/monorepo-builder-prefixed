 ...
 */
namespace _PhpScopercd844fca8af3\Symfony\Component\HttpKernel\Config;

use _PhpScopercd844fca8af3\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopercd844fca8af3\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopercd844fca8af3\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

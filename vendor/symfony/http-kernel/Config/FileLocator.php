 ...
 */
namespace _PhpScoper97d4f3c5628a\Symfony\Component\HttpKernel\Config;

use _PhpScoper97d4f3c5628a\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper97d4f3c5628a\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper97d4f3c5628a\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

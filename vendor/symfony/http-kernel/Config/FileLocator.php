 ...
 */
namespace _PhpScoperc9dee8f3b3e7\Symfony\Component\HttpKernel\Config;

use _PhpScoperc9dee8f3b3e7\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperc9dee8f3b3e7\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperc9dee8f3b3e7\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

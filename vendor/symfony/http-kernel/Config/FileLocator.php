 ...
 */
namespace _PhpScoperac0a9a33ae94\Symfony\Component\HttpKernel\Config;

use _PhpScoperac0a9a33ae94\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperac0a9a33ae94\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperac0a9a33ae94\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

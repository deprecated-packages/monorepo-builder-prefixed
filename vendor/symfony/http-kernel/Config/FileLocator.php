 ...
 */
namespace _PhpScopera3f2f7450f99\Symfony\Component\HttpKernel\Config;

use _PhpScopera3f2f7450f99\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopera3f2f7450f99\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopera3f2f7450f99\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

 ...
 */
namespace _PhpScopereaa086e6f852\Symfony\Component\HttpKernel\Config;

use _PhpScopereaa086e6f852\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopereaa086e6f852\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopereaa086e6f852\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

 ...
 */
namespace _PhpScoperdfdcb3d4cca0\Symfony\Component\HttpKernel\Config;

use _PhpScoperdfdcb3d4cca0\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperdfdcb3d4cca0\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperdfdcb3d4cca0\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

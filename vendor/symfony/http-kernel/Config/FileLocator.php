 ...
 */
namespace _PhpScopera31d0d6ff47a\Symfony\Component\HttpKernel\Config;

use _PhpScopera31d0d6ff47a\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopera31d0d6ff47a\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopera31d0d6ff47a\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

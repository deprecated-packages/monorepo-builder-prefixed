 ...
 */
namespace _PhpScoperee8f03533f8b\Symfony\Component\HttpKernel\Config;

use _PhpScoperee8f03533f8b\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperee8f03533f8b\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperee8f03533f8b\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

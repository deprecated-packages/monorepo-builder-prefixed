 ...
 */
namespace _PhpScopere691b6ebfa72\Symfony\Component\HttpKernel\Config;

use _PhpScopere691b6ebfa72\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopere691b6ebfa72\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopere691b6ebfa72\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

 ...
 */
namespace _PhpScoperaf523e5605cc\Symfony\Component\HttpKernel\Config;

use _PhpScoperaf523e5605cc\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperaf523e5605cc\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperaf523e5605cc\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

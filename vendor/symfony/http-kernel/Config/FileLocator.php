 ...
 */
namespace _PhpScoperad3f32c1b87c\Symfony\Component\HttpKernel\Config;

use _PhpScoperad3f32c1b87c\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperad3f32c1b87c\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperad3f32c1b87c\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

 ...
 */
namespace _PhpScoper68e56c1b5bd9\Symfony\Component\HttpKernel\Config;

use _PhpScoper68e56c1b5bd9\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper68e56c1b5bd9\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper68e56c1b5bd9\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

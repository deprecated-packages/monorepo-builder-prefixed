 ...
 */
namespace _PhpScopercd5c1af09a49\Symfony\Component\HttpKernel\Config;

use _PhpScopercd5c1af09a49\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopercd5c1af09a49\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopercd5c1af09a49\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

 ...
 */
namespace _PhpScoperd1c9c8ec01a8\Symfony\Component\HttpKernel\Config;

use _PhpScoperd1c9c8ec01a8\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperd1c9c8ec01a8\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperd1c9c8ec01a8\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

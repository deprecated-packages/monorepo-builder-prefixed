 ...
 */
namespace _PhpScopera5e5d165d78c\Symfony\Component\HttpKernel\Config;

use _PhpScopera5e5d165d78c\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopera5e5d165d78c\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopera5e5d165d78c\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

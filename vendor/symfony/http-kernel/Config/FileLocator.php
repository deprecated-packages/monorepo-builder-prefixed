 ...
 */
namespace _PhpScoperf4d251e01a80\Symfony\Component\HttpKernel\Config;

use _PhpScoperf4d251e01a80\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperf4d251e01a80\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperf4d251e01a80\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

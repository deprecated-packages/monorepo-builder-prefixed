 ...
 */
namespace _PhpScoperbd03d493ccc6\Symfony\Component\HttpKernel\Config;

use _PhpScoperbd03d493ccc6\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperbd03d493ccc6\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperbd03d493ccc6\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

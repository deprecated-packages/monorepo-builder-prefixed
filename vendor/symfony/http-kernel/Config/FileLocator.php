 ...
 */
namespace _PhpScoper654dfdb702e5\Symfony\Component\HttpKernel\Config;

use _PhpScoper654dfdb702e5\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper654dfdb702e5\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper654dfdb702e5\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

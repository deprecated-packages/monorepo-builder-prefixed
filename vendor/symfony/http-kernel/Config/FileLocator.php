 ...
 */
namespace _PhpScoper9aac61c94bdb\Symfony\Component\HttpKernel\Config;

use _PhpScoper9aac61c94bdb\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper9aac61c94bdb\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper9aac61c94bdb\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

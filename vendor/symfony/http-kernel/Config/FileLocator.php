 ...
 */
namespace _PhpScoper018f70acf6cc\Symfony\Component\HttpKernel\Config;

use _PhpScoper018f70acf6cc\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper018f70acf6cc\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper018f70acf6cc\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

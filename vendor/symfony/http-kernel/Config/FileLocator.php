 ...
 */
namespace _PhpScoperddf2171d3d2c\Symfony\Component\HttpKernel\Config;

use _PhpScoperddf2171d3d2c\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperddf2171d3d2c\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperddf2171d3d2c\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

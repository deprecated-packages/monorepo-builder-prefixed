 ...
 */
namespace _PhpScoperb15c77d6bb3b\Symfony\Component\HttpKernel\Config;

use _PhpScoperb15c77d6bb3b\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperb15c77d6bb3b\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperb15c77d6bb3b\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

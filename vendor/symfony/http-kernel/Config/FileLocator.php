 ...
 */
namespace _PhpScoperb25e75e9febe\Symfony\Component\HttpKernel\Config;

use _PhpScoperb25e75e9febe\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperb25e75e9febe\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperb25e75e9febe\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

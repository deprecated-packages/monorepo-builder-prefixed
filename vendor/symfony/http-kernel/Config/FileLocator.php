 ...
 */
namespace _PhpScoper66a1b4bf441c\Symfony\Component\HttpKernel\Config;

use _PhpScoper66a1b4bf441c\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper66a1b4bf441c\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper66a1b4bf441c\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

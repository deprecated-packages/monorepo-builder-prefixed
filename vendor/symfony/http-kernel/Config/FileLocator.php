 ...
 */
namespace _PhpScoper0f23ef1f1d10\Symfony\Component\HttpKernel\Config;

use _PhpScoper0f23ef1f1d10\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper0f23ef1f1d10\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper0f23ef1f1d10\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

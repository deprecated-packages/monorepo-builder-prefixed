 ...
 */
namespace _PhpScopere0f28e6b9bde\Symfony\Component\HttpKernel\Config;

use _PhpScopere0f28e6b9bde\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScopere0f28e6b9bde\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScopere0f28e6b9bde\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

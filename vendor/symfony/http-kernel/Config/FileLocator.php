 ...
 */
namespace _PhpScoperdab52924cf3e\Symfony\Component\HttpKernel\Config;

use _PhpScoperdab52924cf3e\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoperdab52924cf3e\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoperdab52924cf3e\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

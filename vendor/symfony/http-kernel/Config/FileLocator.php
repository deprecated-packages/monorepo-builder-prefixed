 ...
 */
namespace _PhpScoper9e0a2007d758\Symfony\Component\HttpKernel\Config;

use _PhpScoper9e0a2007d758\Symfony\Component\Config\FileLocator as BaseFileLocator;
 ...
 */
class FileLocator extends \_PhpScoper9e0a2007d758\Symfony\Component\Config\FileLocator
{
    private $kernel;
    /**
     ...
     */
    private $path;
    public function __construct(\_PhpScoper9e0a2007d758\Symfony\Component\HttpKernel\KernelInterface $kernel)
    {
        $this->kernel = $kernel;
        if (2 <= \func_num_args()) {

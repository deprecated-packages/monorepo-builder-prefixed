...
use _PhpScoperd79f30a2f8be\Symfony\Component\VarDumper\Caster\CutStub;
 ...
 */
abstract class DataCollector implements \_PhpScoperd79f30a2f8be\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface
{
    /**
     * @var array|Data
     */
    ...
    {
        if ($var instanceof \_PhpScoperd79f30a2f8be\Symfony\Component\VarDumper\Cloner\Data) {
            return $var;
        }
        if (null === $this->cloner) {
    ...
    {
        $casters = ['*' => function ($v, array $a, \_PhpScoperd79f30a2f8be\Symfony\Component\VarDumper\Cloner\Stub $s, $isNested) {
            if (!$v instanceof \_PhpScoperd79f30a2f8be\Symfony\Component\VarDumper\Cloner\Stub) {
                foreach ($a as $k => $v) {
                    if (\is_object($v) && !$v instanceof \DateTimeInterface && !$v instanceof \_PhpScoperd79f30a2f8be\Symfony\Component\VarDumper\Cloner\Stub) {
                        $a[$k] = new \_PhpScoperd79f30a2f8be\Symfony\Component\VarDumper\Caster\CutStub($v);
                    }
                }
            }
            return $a;
        }] + \_PhpScoperd79f30a2f8be\Symfony\Component\VarDumper\Caster\ReflectionCaster::UNSET_CLOSURE_FILE_INFO;
        return $casters;
    }
    /**
     * @return array

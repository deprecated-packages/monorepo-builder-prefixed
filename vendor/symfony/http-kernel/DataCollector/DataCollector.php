...
use _PhpScoperdd624bbcb4e5\Symfony\Component\VarDumper\Caster\CutStub;
 ...
 */
abstract class DataCollector implements \_PhpScoperdd624bbcb4e5\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface
{
    /**
     * @var array|Data
     */
    ...
    {
        if ($var instanceof \_PhpScoperdd624bbcb4e5\Symfony\Component\VarDumper\Cloner\Data) {
            return $var;
        }
        if (null === $this->cloner) {
            $this->cloner = new \_PhpScoperdd624bbcb4e5\Symfony\Component\VarDumper\Cloner\VarCloner();
    ...
    {
        $casters = ['*' => function ($v, array $a, \_PhpScoperdd624bbcb4e5\Symfony\Component\VarDumper\Cloner\Stub $s, $isNested) {
            if (!$v instanceof \_PhpScoperdd624bbcb4e5\Symfony\Component\VarDumper\Cloner\Stub) {
                foreach ($a as $k => $v) {
                    if (\is_object($v) && !$v instanceof \DateTimeInterface && !$v instanceof \_PhpScoperdd624bbcb4e5\Symfony\Component\VarDumper\Cloner\Stub) {
                        $a[$k] = new \_PhpScoperdd624bbcb4e5\Symfony\Component\VarDumper\Caster\CutStub($v);
                    }
                }
            }
            return $a;
        }] + \_PhpScoperdd624bbcb4e5\Symfony\Component\VarDumper\Caster\ReflectionCaster::UNSET_CLOSURE_FILE_INFO;
        return $casters;
    }
    /**
     * @return array

...
use _PhpScoperd6a443964d04\Symfony\Component\HttpFoundation\RedirectResponse;
 ...
 */
class RouterDataCollector extends \_PhpScoperd6a443964d04\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
    ...
    {
        if ($response instanceof \_PhpScoperd6a443964d04\Symfony\Component\HttpFoundation\RedirectResponse) {
    ...
    protected function guessRoute(\_PhpScoperd6a443964d04\Symfony\Component\HttpFoundation\Request $request, $controller)
    {
        return 'n/a';
    }
    /**

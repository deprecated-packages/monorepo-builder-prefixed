...
use _PhpScoperdd9048e10aae\Symfony\Component\Stopwatch\StopwatchEvent;
/**
 * @author Fabien Potencier <fabien@symfony.com>
 *
 * @final
 */
class TimeDataCollector extends \_PhpScoperdd9048e10aae\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \_PhpScoperdd9048e10aae\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    protected $kernel;
    protected $stopwatch;
    public function __construct(\_PhpScoperdd9048e10aae\Symfony\Component\HttpKernel\KernelInterface $kernel = null, \_PhpScoperdd9048e10aae\Symfony\Component\Stopwatch\Stopwatch $stopwatch = null)
    {
        $this->kernel = $kernel;
    ...
    public function collect(\_PhpScoperdd9048e10aae\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperdd9048e10aae\Symfony\Component\HttpFoundation\Response $response, \Throwable $exception = null)
    {
        ...
        $this->data = ['token' => $response->headers->get('X-Debug-Token'), 'start_time' => $startTime * 1000, 'events' => [], 'stopwatch_installed' => \class_exists(\_PhpScoperdd9048e10aae\Symfony\Component\Stopwatch\Stopwatch::class, \false)];
    }
    /**
     * {@inheritdoc}
     */

 ...
 */
class ExceptionDataCollector extends \_PhpScopera28be7b3fe51\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScopera28be7b3fe51\Symfony\Component\HttpFoundation\Request $request, \_PhpScopera28be7b3fe51\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScopera28be7b3fe51\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

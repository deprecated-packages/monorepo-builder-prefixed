 ...
 */
class ExceptionDataCollector extends \_PhpScopera00544d51e07\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScopera00544d51e07\Symfony\Component\HttpFoundation\Request $request, \_PhpScopera00544d51e07\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScopera00544d51e07\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

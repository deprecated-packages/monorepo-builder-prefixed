 ...
 */
class ExceptionDataCollector extends \_PhpScoperedfa898a454f\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScoperedfa898a454f\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperedfa898a454f\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoperedfa898a454f\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

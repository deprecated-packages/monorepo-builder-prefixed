 ...
 * @final
 */
class ExceptionDataCollector extends \_PhpScoper227dea868235\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoper227dea868235\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

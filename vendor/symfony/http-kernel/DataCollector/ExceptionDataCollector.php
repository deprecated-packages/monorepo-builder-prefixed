 ...
 */
class ExceptionDataCollector extends \_PhpScopera5e5d165d78c\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScopera5e5d165d78c\Symfony\Component\HttpFoundation\Request $request, \_PhpScopera5e5d165d78c\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScopera5e5d165d78c\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

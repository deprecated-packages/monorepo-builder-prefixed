 ...
 * @final
 */
class ExceptionDataCollector extends \_PhpScoper138e2990dbdb\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoper138e2990dbdb\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

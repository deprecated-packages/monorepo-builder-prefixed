 ...
 * @final
 */
class ExceptionDataCollector extends \_PhpScoper95efb8ddea2f\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoper95efb8ddea2f\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

 ...
 */
class ExceptionDataCollector extends \_PhpScopere9939b84e968\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScopere9939b84e968\Symfony\Component\HttpFoundation\Request $request, \_PhpScopere9939b84e968\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScopere9939b84e968\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

 ...
 */
class ExceptionDataCollector extends \_PhpScopere846b54512fc\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScopere846b54512fc\Symfony\Component\HttpFoundation\Request $request, \_PhpScopere846b54512fc\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScopere846b54512fc\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

 ...
 * @final
 */
class ExceptionDataCollector extends \_PhpScoperab3ccffcffcd\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoperab3ccffcffcd\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

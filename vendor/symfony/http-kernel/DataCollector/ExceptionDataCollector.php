 ...
 */
class ExceptionDataCollector extends \_PhpScopera2f1d1d42b88\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScopera2f1d1d42b88\Symfony\Component\HttpFoundation\Request $request, \_PhpScopera2f1d1d42b88\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScopera2f1d1d42b88\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

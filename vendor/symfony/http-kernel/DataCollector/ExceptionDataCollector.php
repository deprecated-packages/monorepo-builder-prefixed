 ...
 */
class ExceptionDataCollector extends \_PhpScoperf78d2b40800e\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
     *
    ...
    public function collect(\_PhpScoperf78d2b40800e\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperf78d2b40800e\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if (null !== $exception) {
            $this->data = ['exception' => \_PhpScoperf78d2b40800e\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}

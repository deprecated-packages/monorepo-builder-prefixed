...
use _PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\Cookie;
use _PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag;
...
use _PhpScoperc9dc9dec1b4a\Symfony\Component\HttpKernel\Event\FilterControllerEvent;
 ...
 */
class RequestDataCollector extends \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \_PhpScoperc9dc9dec1b4a\Symfony\Component\EventDispatcher\EventSubscriberInterface, \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    ...
    public function collect(\_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\Response $response)
    {
        ...
        if ($response->isRedirect()) {
            $response->headers->setCookie(new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\Cookie('sf_redirect', \json_encode(['token' => $response->headers->get('x-debug-token'), 'route' => $request->attributes->get('_route', 'n/a'), 'method' => $request->getMethod(), 'controller' => $this->parseController($request->attributes->get('_controller')), 'status_code' => $statusCode, 'status_text' => \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\Response::$statusTexts[(int) $statusCode]]), 0, '/', null, $request->isSecure(), \true, \false, 'lax'));
        }
    ...
    {
        return new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_request']->getValue());
    }
    public function getRequestQuery()
    {
        return new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_query']->getValue());
    }
    public function getRequestFiles()
    {
        return new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_files']->getValue());
    }
    public function getRequestHeaders()
    {
        return new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_headers']->getValue());
    }
    public function getRequestServer($raw = \false)
    {
        return new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_server']->getValue($raw));
    }
    public function getRequestCookies($raw = \false)
    {
        return new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_cookies']->getValue($raw));
    }
    public function getRequestAttributes()
    {
        return new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_attributes']->getValue());
    }
    public function getResponseHeaders()
    {
        return new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_headers']->getValue());
    }
    public function getResponseCookies()
    {
        return new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_cookies']->getValue());
    }
    ...
    {
        return new \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpFoundation\ParameterBag($this->data['dotenv_vars']->getValue());
    }
    /**
     * Gets the route name.
     *
     ...
     */
    public function onKernelController(\_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpKernel\Event\FilterControllerEvent $event)
    {
    ...
    {
        return [\_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER => 'onKernelController', \_PhpScoperc9dc9dec1b4a\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
    /**
     * {@inheritdoc}
     */

...
use _PhpScopera763b4be90d0\Symfony\Component\HttpKernel\HttpCache\HttpCache;
 ...
 * @final
 */
class SurrogateListener implements \_PhpScopera763b4be90d0\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $surrogate;
    public function __construct(\_PhpScopera763b4be90d0\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\_PhpScopera763b4be90d0\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
        ...
        if ($kernel instanceof \_PhpScopera763b4be90d0\Symfony\Component\HttpKernel\HttpCache\HttpCache) {

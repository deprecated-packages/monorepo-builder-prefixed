...
use _PhpScoper462f168ef4cc\Symfony\Component\HttpKernel\HttpCache\HttpCache;
 ...
 * @final
 */
class SurrogateListener implements \_PhpScoper462f168ef4cc\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $surrogate;
    public function __construct(\_PhpScoper462f168ef4cc\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\_PhpScoper462f168ef4cc\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
        ...
        if ($kernel instanceof \_PhpScoper462f168ef4cc\Symfony\Component\HttpKernel\HttpCache\HttpCache) {

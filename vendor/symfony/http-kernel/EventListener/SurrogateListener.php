...
use _PhpScoper36281e29f54f\Symfony\Component\HttpKernel\HttpCache\HttpCache;
 ...
 */
class SurrogateListener implements \_PhpScoper36281e29f54f\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $surrogate;
    public function __construct(\_PhpScoper36281e29f54f\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\_PhpScoper36281e29f54f\Symfony\Component\HttpKernel\Event\FilterResponseEvent $event)
    {
        ...
        if ($kernel instanceof \_PhpScoper36281e29f54f\Symfony\Component\HttpKernel\HttpCache\HttpCache) {

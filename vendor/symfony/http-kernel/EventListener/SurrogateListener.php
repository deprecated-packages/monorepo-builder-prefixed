...
use _PhpScopera28be7b3fe51\Symfony\Component\HttpKernel\HttpCache\HttpCache;
 ...
 */
class SurrogateListener implements \_PhpScopera28be7b3fe51\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $surrogate;
    public function __construct(\_PhpScopera28be7b3fe51\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\_PhpScopera28be7b3fe51\Symfony\Component\HttpKernel\Event\FilterResponseEvent $event)
    {
        ...
        if ($kernel instanceof \_PhpScopera28be7b3fe51\Symfony\Component\HttpKernel\HttpCache\HttpCache) {

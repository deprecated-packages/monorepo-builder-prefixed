...
use _PhpScoperc53cafc6ca57\Symfony\Component\HttpKernel\HttpCache\HttpCache;
 ...
 */
class SurrogateListener implements \_PhpScoperc53cafc6ca57\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $surrogate;
    public function __construct(\_PhpScoperc53cafc6ca57\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\_PhpScoperc53cafc6ca57\Symfony\Component\HttpKernel\Event\FilterResponseEvent $event)
    {
        ...
        if ($kernel instanceof \_PhpScoperc53cafc6ca57\Symfony\Component\HttpKernel\HttpCache\HttpCache) {

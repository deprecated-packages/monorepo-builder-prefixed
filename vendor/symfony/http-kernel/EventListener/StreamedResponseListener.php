...
use _PhpScoperdd624bbcb4e5\Symfony\Component\HttpFoundation\StreamedResponse;
 ...
 */
class StreamedResponseListener implements \_PhpScoperdd624bbcb4e5\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    public function onKernelResponse(\_PhpScoperdd624bbcb4e5\Symfony\Component\HttpKernel\Event\FilterResponseEvent $event)
    {
        ...
        if ($response instanceof \_PhpScoperdd624bbcb4e5\Symfony\Component\HttpFoundation\StreamedResponse) {
            $response->send();
        }
    }
    public static function getSubscribedEvents()
    {
        return [\_PhpScoperdd624bbcb4e5\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -1024]];
    }
}

 ...
 * @final
 */
class TestSessionListener extends \_PhpScoperef4638f5d8b1\Symfony\Component\HttpKernel\EventListener\AbstractTestSessionListener
{
    private $container;
    public function __construct(\_PhpScoperef4638f5d8b1\Psr\Container\ContainerInterface $container, array $sessionOptions = [])
    {

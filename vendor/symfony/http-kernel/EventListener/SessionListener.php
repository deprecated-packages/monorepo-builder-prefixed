 ...
 * @final
 */
class SessionListener extends \_PhpScoperce084f4275dd\Symfony\Component\HttpKernel\EventListener\AbstractSessionListener
{
    ...
    protected function getSession() : ?\_PhpScoperce084f4275dd\Symfony\Component\HttpFoundation\Session\SessionInterface
    {
        ...
        if ($this->container->has('session_storage') && ($storage = $this->container->get('session_storage')) instanceof \_PhpScoperce084f4275dd\Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage && ($masterRequest = $this->container->get('request_stack')->getMasterRequest()) && $masterRequest->isSecure()) {

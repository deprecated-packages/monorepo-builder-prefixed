 ...
 */
class ErrorListener implements \_PhpScoper9a721f934eeb\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function logKernelException(\_PhpScoper9a721f934eeb\Symfony\Component\HttpKernel\Event\ExceptionEvent $event)
    {
        $e = \_PhpScoper9a721f934eeb\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($event->getThrowable());
        $this->logException($event->getThrowable(), \sprintf('Uncaught PHP Exception %s: "%s" at %s line %s', $e->getClass(), $e->getMessage(), $e->getFile(), $e->getLine()));
    }
    public function onKernelException(\_PhpScoper9a721f934eeb\Symfony\Component\HttpKernel\Event\ExceptionEvent $event, string $eventName = null, \_PhpScoper9a721f934eeb\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null)
    {
    ...
    public function onControllerArguments(\_PhpScoper9a721f934eeb\Symfony\Component\HttpKernel\Event\ControllerArgumentsEvent $event)
    {
        ...
        if ($r && (!$r->hasType() || \_PhpScoper9a721f934eeb\Symfony\Component\ErrorHandler\Exception\FlattenException::class === $r->getType()->getName())) {
            $arguments = $event->getArguments();
            $arguments[$k] = \_PhpScoper9a721f934eeb\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($e);
            $event->setArguments($arguments);
        }
    }
    public static function getSubscribedEvents() : array
    {
        return [\_PhpScoper9a721f934eeb\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER_ARGUMENTS => 'onControllerArguments', \_PhpScoper9a721f934eeb\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => [['logKernelException', 0], ['onKernelException', -128]]];
    }
    /**
     * Logs an exception.
     */
     ...
     */
    protected function duplicateRequest(\Throwable $exception, \_PhpScoper9a721f934eeb\Symfony\Component\HttpFoundation\Request $request) : \_PhpScoper9a721f934eeb\Symfony\Component\HttpFoundation\Request
    {
        $attributes = ['_controller' => $this->controller, 'exception' => $exception, 'logger' => $this->logger instanceof \_PhpScoper9a721f934eeb\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null];

 ...
 */
class ErrorListener implements \_PhpScoperda849baa4a45\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function logKernelException(\_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\Event\ExceptionEvent $event)
    {
        $e = \_PhpScoperda849baa4a45\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($event->getThrowable());
        $this->logException($event->getThrowable(), \sprintf('Uncaught PHP Exception %s: "%s" at %s line %s', $e->getClass(), $e->getMessage(), $e->getFile(), $e->getLine()));
    }
    public function onKernelException(\_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\Event\ExceptionEvent $event, string $eventName = null, \_PhpScoperda849baa4a45\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null)
    {
    ...
    public function onControllerArguments(\_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\Event\ControllerArgumentsEvent $event)
    {
        ...
        if ($r && (!$r->hasType() || \_PhpScoperda849baa4a45\Symfony\Component\ErrorHandler\Exception\FlattenException::class === $r->getType()->getName())) {
            $arguments = $event->getArguments();
            $arguments[$k] = \_PhpScoperda849baa4a45\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($e);
            $event->setArguments($arguments);
        }
    }
    public static function getSubscribedEvents() : array
    {
        return [\_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER_ARGUMENTS => 'onControllerArguments', \_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => [['logKernelException', 0], ['onKernelException', -128]]];
    }
    /**
     * Logs an exception.
     */
     ...
     */
    protected function duplicateRequest(\Throwable $exception, \_PhpScoperda849baa4a45\Symfony\Component\HttpFoundation\Request $request) : \_PhpScoperda849baa4a45\Symfony\Component\HttpFoundation\Request
    {
        $attributes = ['_controller' => $this->controller, 'exception' => $exception, 'logger' => $this->logger instanceof \_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null];

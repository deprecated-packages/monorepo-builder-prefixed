 ...
 */
class ErrorListener implements \_PhpScoperad3f32c1b87c\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function logKernelException(\_PhpScoperad3f32c1b87c\Symfony\Component\HttpKernel\Event\ExceptionEvent $event)
    {
        $e = \_PhpScoperad3f32c1b87c\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($event->getThrowable());
        $this->logException($event->getThrowable(), \sprintf('Uncaught PHP Exception %s: "%s" at %s line %s', $e->getClass(), $e->getMessage(), $e->getFile(), $e->getLine()));
    }
    public function onKernelException(\_PhpScoperad3f32c1b87c\Symfony\Component\HttpKernel\Event\ExceptionEvent $event, string $eventName = null, \_PhpScoperad3f32c1b87c\Symfony\Component\EventDispatcher\EventDispatcherInterface $eventDispatcher = null)
    {
    ...
    public function onControllerArguments(\_PhpScoperad3f32c1b87c\Symfony\Component\HttpKernel\Event\ControllerArgumentsEvent $event)
    {
        ...
        if ($r && (!$r->hasType() || \_PhpScoperad3f32c1b87c\Symfony\Component\ErrorHandler\Exception\FlattenException::class === $r->getType()->getName())) {
            $arguments = $event->getArguments();
            $arguments[$k] = \_PhpScoperad3f32c1b87c\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($e);
            $event->setArguments($arguments);
        }
    }
    public static function getSubscribedEvents() : array
    {
        return [\_PhpScoperad3f32c1b87c\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER_ARGUMENTS => 'onControllerArguments', \_PhpScoperad3f32c1b87c\Symfony\Component\HttpKernel\KernelEvents::EXCEPTION => [['logKernelException', 0], ['onKernelException', -128]]];
    }
    /**
     * Logs an exception.
     */
     ...
     */
    protected function duplicateRequest(\Throwable $exception, \_PhpScoperad3f32c1b87c\Symfony\Component\HttpFoundation\Request $request) : \_PhpScoperad3f32c1b87c\Symfony\Component\HttpFoundation\Request
    {
        $attributes = ['_controller' => $this->controller, 'exception' => $exception, 'logger' => $this->logger instanceof \_PhpScoperad3f32c1b87c\Symfony\Component\HttpKernel\Log\DebugLoggerInterface ? $this->logger : null];

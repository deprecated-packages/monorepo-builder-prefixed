 ...
 * @final
 */
class AddRequestFormatsListener implements \_PhpScoperb154859e1be7\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\_PhpScoperb154859e1be7\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}

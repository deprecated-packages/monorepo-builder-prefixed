 ...
 * @final
 */
class AddRequestFormatsListener implements \_PhpScoperf701e46e48a5\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\_PhpScoperf701e46e48a5\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}

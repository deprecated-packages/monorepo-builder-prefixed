 ...
 * @final
 */
class AddRequestFormatsListener implements \_PhpScoperab3ccffcffcd\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\_PhpScoperab3ccffcffcd\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}

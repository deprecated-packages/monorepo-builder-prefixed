 ...
 * @final
 */
class AddRequestFormatsListener implements \_PhpScoperb3e4472dbe9b\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\_PhpScoperb3e4472dbe9b\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}

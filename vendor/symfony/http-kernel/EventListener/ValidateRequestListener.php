 ...
 * @final
 */
class ValidateRequestListener implements \_PhpScoper1d3d21549513\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\_PhpScoper1d3d21549513\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}

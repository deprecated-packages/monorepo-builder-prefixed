 ...
 */
final class RequestValueResolver implements \_PhpScoperfd1a6a0ee9af\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \_PhpScoperfd1a6a0ee9af\Symfony\Component\HttpFoundation\Request::class === $argument->getType() || \is_subclass_of($argument->getType(), \_PhpScoperfd1a6a0ee9af\Symfony\Component\HttpFoundation\Request::class);
    }
    /**
     * {@inheritdoc}
     */

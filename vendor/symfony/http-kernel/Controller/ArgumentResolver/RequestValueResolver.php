 ...
 */
final class RequestValueResolver implements \_PhpScoperabb8c88e9df1\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \_PhpScoperabb8c88e9df1\Symfony\Component\HttpFoundation\Request::class === $argument->getType() || \is_subclass_of($argument->getType(), \_PhpScoperabb8c88e9df1\Symfony\Component\HttpFoundation\Request::class);
    }
    /**
     * {@inheritdoc}
     */

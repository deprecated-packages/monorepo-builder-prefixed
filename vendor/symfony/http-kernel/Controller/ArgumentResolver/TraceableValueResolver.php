 ...
 */
final class TraceableValueResolver implements \_PhpScopere846b54512fc\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopere846b54512fc\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopere846b54512fc\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;

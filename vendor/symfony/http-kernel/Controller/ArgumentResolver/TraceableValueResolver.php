 ...
 */
final class TraceableValueResolver implements \_PhpScopere691b6ebfa72\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopere691b6ebfa72\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopere691b6ebfa72\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;

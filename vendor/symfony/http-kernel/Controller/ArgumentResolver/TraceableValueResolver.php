 ...
 */
final class TraceableValueResolver implements \_PhpScopera42d72b2de70\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopera42d72b2de70\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopera42d72b2de70\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;

 ...
 */
final class TraceableValueResolver implements \_PhpScopercd844fca8af3\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopercd844fca8af3\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopercd844fca8af3\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;

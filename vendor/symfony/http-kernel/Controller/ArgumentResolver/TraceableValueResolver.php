 ...
 */
final class TraceableValueResolver implements \_PhpScopereaa2cae8e093\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\_PhpScopereaa2cae8e093\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \_PhpScopereaa2cae8e093\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;

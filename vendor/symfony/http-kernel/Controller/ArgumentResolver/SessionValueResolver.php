 ...
 */
final class SessionValueResolver implements \_PhpScopere691b6ebfa72\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScopere691b6ebfa72\Symfony\Component\HttpFoundation\Request $request, \_PhpScopere691b6ebfa72\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScopere691b6ebfa72\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScopere691b6ebfa72\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }

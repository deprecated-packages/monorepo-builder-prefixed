 ...
 */
final class SessionValueResolver implements \_PhpScoperb25e75e9febe\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScoperb25e75e9febe\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperb25e75e9febe\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScoperb25e75e9febe\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScoperb25e75e9febe\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }

 ...
 */
final class SessionValueResolver implements \_PhpScopera2bd9a9af620\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScopera2bd9a9af620\Symfony\Component\HttpFoundation\Request $request, \_PhpScopera2bd9a9af620\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScopera2bd9a9af620\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScopera2bd9a9af620\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }

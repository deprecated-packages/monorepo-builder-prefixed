 ...
 */
final class SessionValueResolver implements \_PhpScopera8413c4aa124\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScopera8413c4aa124\Symfony\Component\HttpFoundation\Request $request, \_PhpScopera8413c4aa124\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScopera8413c4aa124\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScopera8413c4aa124\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }

 ...
 */
final class SessionValueResolver implements \_PhpScopercd844fca8af3\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScopercd844fca8af3\Symfony\Component\HttpFoundation\Request $request, \_PhpScopercd844fca8af3\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScopercd844fca8af3\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScopercd844fca8af3\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }

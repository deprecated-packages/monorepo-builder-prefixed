 ...
 */
final class SessionValueResolver implements \_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
     */
    public function supports(\_PhpScoperda849baa4a45\Symfony\Component\HttpFoundation\Request $request, \_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : bool
    {
        ...
        if (\_PhpScoperda849baa4a45\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \_PhpScoperda849baa4a45\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }

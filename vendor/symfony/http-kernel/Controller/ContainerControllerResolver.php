 ...
 */
class ContainerControllerResolver extends \_PhpScopera42d72b2de70\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera42d72b2de70\Psr\Container\ContainerInterface $container, \_PhpScopera42d72b2de70\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera42d72b2de70\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoperab3ccffcffcd\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperab3ccffcffcd\Psr\Container\ContainerInterface $container, \_PhpScoperab3ccffcffcd\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperab3ccffcffcd\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

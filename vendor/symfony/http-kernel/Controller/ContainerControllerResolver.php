 ...
 */
class ContainerControllerResolver extends \_PhpScoperc00d4390f333\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperc00d4390f333\Psr\Container\ContainerInterface $container, \_PhpScoperc00d4390f333\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperc00d4390f333\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoperdd9048e10aae\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperdd9048e10aae\Psr\Container\ContainerInterface $container, \_PhpScoperdd9048e10aae\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperdd9048e10aae\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

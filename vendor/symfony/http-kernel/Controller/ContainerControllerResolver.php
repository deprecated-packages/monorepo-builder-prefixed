 ...
 */
class ContainerControllerResolver extends \_PhpScoper8e7700b08cb9\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper8e7700b08cb9\Psr\Container\ContainerInterface $container, \_PhpScoper8e7700b08cb9\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper8e7700b08cb9\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

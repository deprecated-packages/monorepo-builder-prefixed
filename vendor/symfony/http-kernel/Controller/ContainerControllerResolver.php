 ...
 */
class ContainerControllerResolver extends \_PhpScoper84ee03573073\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper84ee03573073\Psr\Container\ContainerInterface $container, \_PhpScoper84ee03573073\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper84ee03573073\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

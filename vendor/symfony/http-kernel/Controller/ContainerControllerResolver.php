 ...
 */
class ContainerControllerResolver extends \_PhpScoperf4d251e01a80\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperf4d251e01a80\Psr\Container\ContainerInterface $container, \_PhpScoperf4d251e01a80\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperf4d251e01a80\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

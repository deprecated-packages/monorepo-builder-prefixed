 ...
 */
class ContainerControllerResolver extends \_PhpScoper1d3d21549513\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper1d3d21549513\Psr\Container\ContainerInterface $container, \_PhpScoper1d3d21549513\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper1d3d21549513\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

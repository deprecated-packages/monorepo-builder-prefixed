 ...
 */
class ContainerControllerResolver extends \_PhpScoper931cda798d50\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper931cda798d50\Psr\Container\ContainerInterface $container, \_PhpScoper931cda798d50\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper931cda798d50\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

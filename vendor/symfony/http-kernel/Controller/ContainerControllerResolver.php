 ...
 */
class ContainerControllerResolver extends \_PhpScoper53a6895b9c5b\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper53a6895b9c5b\Psr\Container\ContainerInterface $container, \_PhpScoper53a6895b9c5b\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper53a6895b9c5b\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoperaf523e5605cc\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperaf523e5605cc\Psr\Container\ContainerInterface $container, \_PhpScoperaf523e5605cc\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperaf523e5605cc\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

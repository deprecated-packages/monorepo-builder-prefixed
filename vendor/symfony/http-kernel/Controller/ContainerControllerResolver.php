 ...
 */
class ContainerControllerResolver extends \_PhpScoper3c4d71e1434d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper3c4d71e1434d\Psr\Container\ContainerInterface $container, \_PhpScoper3c4d71e1434d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper3c4d71e1434d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperda849baa4a45\Psr\Container\ContainerInterface $container, \_PhpScoperda849baa4a45\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperda849baa4a45\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

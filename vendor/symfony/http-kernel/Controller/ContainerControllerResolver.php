 ...
 */
class ContainerControllerResolver extends \_PhpScoper056b892061ac\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper056b892061ac\Psr\Container\ContainerInterface $container, \_PhpScoper056b892061ac\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper056b892061ac\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoper462f168ef4cc\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper462f168ef4cc\Psr\Container\ContainerInterface $container, \_PhpScoper462f168ef4cc\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper462f168ef4cc\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

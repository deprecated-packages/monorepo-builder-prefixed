 ...
 */
class ContainerControllerResolver extends \_PhpScoper204b3b8f3e0d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper204b3b8f3e0d\Psr\Container\ContainerInterface $container, \_PhpScoper204b3b8f3e0d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper204b3b8f3e0d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

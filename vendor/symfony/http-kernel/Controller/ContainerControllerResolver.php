 ...
 */
class ContainerControllerResolver extends \_PhpScoperf8eaec7affbd\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperf8eaec7affbd\Psr\Container\ContainerInterface $container, \_PhpScoperf8eaec7affbd\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperf8eaec7affbd\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

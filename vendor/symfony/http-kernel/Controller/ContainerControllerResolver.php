 ...
 */
class ContainerControllerResolver extends \_PhpScoperdfdcb3d4cca0\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperdfdcb3d4cca0\Psr\Container\ContainerInterface $container, \_PhpScoperdfdcb3d4cca0\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperdfdcb3d4cca0\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

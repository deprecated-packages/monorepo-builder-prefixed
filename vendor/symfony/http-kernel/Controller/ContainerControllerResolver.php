 ...
 */
class ContainerControllerResolver extends \_PhpScoper4c089bfbbc1b\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper4c089bfbbc1b\Psr\Container\ContainerInterface $container, \_PhpScoper4c089bfbbc1b\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper4c089bfbbc1b\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

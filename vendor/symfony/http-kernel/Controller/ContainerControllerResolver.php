 ...
 */
class ContainerControllerResolver extends \_PhpScoperd6a443964d04\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperd6a443964d04\Psr\Container\ContainerInterface $container, \_PhpScoperd6a443964d04\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperd6a443964d04\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

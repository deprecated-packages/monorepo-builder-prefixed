 ...
 */
class ContainerControllerResolver extends \_PhpScoperfdd2db5e123d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperfdd2db5e123d\Psr\Container\ContainerInterface $container, \_PhpScoperfdd2db5e123d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperfdd2db5e123d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

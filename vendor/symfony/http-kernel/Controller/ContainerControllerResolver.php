 ...
 */
class ContainerControllerResolver extends \_PhpScoperbb737891eded\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperbb737891eded\Psr\Container\ContainerInterface $container, \_PhpScoperbb737891eded\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperbb737891eded\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

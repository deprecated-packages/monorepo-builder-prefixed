 ...
 */
class ContainerControllerResolver extends \_PhpScoper87c95ce1b4e5\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper87c95ce1b4e5\Psr\Container\ContainerInterface $container, \_PhpScoper87c95ce1b4e5\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper87c95ce1b4e5\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

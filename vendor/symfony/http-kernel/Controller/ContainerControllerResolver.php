 ...
 */
class ContainerControllerResolver extends \_PhpScoper472361b15529\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper472361b15529\Psr\Container\ContainerInterface $container, \_PhpScoper472361b15529\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper472361b15529\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

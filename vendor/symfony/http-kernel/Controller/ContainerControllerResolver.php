 ...
 */
class ContainerControllerResolver extends \_PhpScoperce084f4275dd\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperce084f4275dd\Psr\Container\ContainerInterface $container, \_PhpScoperce084f4275dd\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperce084f4275dd\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoperd79f30a2f8be\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperd79f30a2f8be\Psr\Container\ContainerInterface $container, \_PhpScoperd79f30a2f8be\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperd79f30a2f8be\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScopera2bd9a9af620\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera2bd9a9af620\Psr\Container\ContainerInterface $container, \_PhpScopera2bd9a9af620\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera2bd9a9af620\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

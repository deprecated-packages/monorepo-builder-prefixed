 ...
 */
class ContainerControllerResolver extends \_PhpScoperb56893078f23\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperb56893078f23\Psr\Container\ContainerInterface $container, \_PhpScoperb56893078f23\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperb56893078f23\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

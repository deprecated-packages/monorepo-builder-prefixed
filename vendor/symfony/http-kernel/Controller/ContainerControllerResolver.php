 ...
 */
class ContainerControllerResolver extends \_PhpScoper503cab241f82\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper503cab241f82\Psr\Container\ContainerInterface $container, \_PhpScoper503cab241f82\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper503cab241f82\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

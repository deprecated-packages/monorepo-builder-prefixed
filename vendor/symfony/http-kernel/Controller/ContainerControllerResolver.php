 ...
 */
class ContainerControllerResolver extends \_PhpScoperc41e8050ff3f\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperc41e8050ff3f\Psr\Container\ContainerInterface $container, \_PhpScoperc41e8050ff3f\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperc41e8050ff3f\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoperdfa889d8967a\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperdfa889d8967a\Psr\Container\ContainerInterface $container, \_PhpScoperdfa889d8967a\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperdfa889d8967a\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

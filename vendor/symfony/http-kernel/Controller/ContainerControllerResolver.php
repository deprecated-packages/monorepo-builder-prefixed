 ...
 */
class ContainerControllerResolver extends \_PhpScoperb154859e1be7\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperb154859e1be7\Psr\Container\ContainerInterface $container, \_PhpScoperb154859e1be7\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperb154859e1be7\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

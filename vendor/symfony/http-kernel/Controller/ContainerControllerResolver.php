 ...
 */
class ContainerControllerResolver extends \_PhpScoper485f3a9238ad\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper485f3a9238ad\Psr\Container\ContainerInterface $container, \_PhpScoper485f3a9238ad\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper485f3a9238ad\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

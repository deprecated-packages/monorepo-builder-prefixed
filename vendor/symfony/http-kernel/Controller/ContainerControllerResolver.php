 ...
 */
class ContainerControllerResolver extends \_PhpScoperb1086ecf2bcb\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperb1086ecf2bcb\Psr\Container\ContainerInterface $container, \_PhpScoperb1086ecf2bcb\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperb1086ecf2bcb\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

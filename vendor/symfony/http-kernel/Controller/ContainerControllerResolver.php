 ...
 */
class ContainerControllerResolver extends \_PhpScoperf1163522a13e\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperf1163522a13e\Psr\Container\ContainerInterface $container, \_PhpScoperf1163522a13e\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperf1163522a13e\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScopere6d124d1f7ba\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopere6d124d1f7ba\Psr\Container\ContainerInterface $container, \_PhpScopere6d124d1f7ba\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopere6d124d1f7ba\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

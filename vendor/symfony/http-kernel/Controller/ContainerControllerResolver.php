 ...
 */
class ContainerControllerResolver extends \_PhpScoper7b254e6a7108\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper7b254e6a7108\Psr\Container\ContainerInterface $container, \_PhpScoper7b254e6a7108\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper7b254e6a7108\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

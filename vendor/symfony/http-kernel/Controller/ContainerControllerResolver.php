 ...
 */
class ContainerControllerResolver extends \_PhpScopere97aad8070b4\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopere97aad8070b4\Psr\Container\ContainerInterface $container, \_PhpScopere97aad8070b4\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopere97aad8070b4\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

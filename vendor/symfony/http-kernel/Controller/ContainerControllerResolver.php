 ...
 */
class ContainerControllerResolver extends \_PhpScoperedfa898a454f\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperedfa898a454f\Psr\Container\ContainerInterface $container, \_PhpScoperedfa898a454f\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperedfa898a454f\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

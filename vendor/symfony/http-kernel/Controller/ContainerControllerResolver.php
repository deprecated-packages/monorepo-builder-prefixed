 ...
 */
class ContainerControllerResolver extends \_PhpScoperaff2103cee1d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperaff2103cee1d\Psr\Container\ContainerInterface $container, \_PhpScoperaff2103cee1d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperaff2103cee1d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoperc693a7d83f11\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperc693a7d83f11\Psr\Container\ContainerInterface $container, \_PhpScoperc693a7d83f11\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperc693a7d83f11\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

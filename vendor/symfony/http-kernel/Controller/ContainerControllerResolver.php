 ...
 */
class ContainerControllerResolver extends \_PhpScopercd844fca8af3\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopercd844fca8af3\Psr\Container\ContainerInterface $container, \_PhpScopercd844fca8af3\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopercd844fca8af3\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScopere0f28e6b9bde\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopere0f28e6b9bde\Psr\Container\ContainerInterface $container, \_PhpScopere0f28e6b9bde\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopere0f28e6b9bde\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

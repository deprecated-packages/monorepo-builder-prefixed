 ...
 */
class ContainerControllerResolver extends \_PhpScoper43a95e2f69bc\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper43a95e2f69bc\Psr\Container\ContainerInterface $container, \_PhpScoper43a95e2f69bc\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper43a95e2f69bc\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScopercd5c1af09a49\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopercd5c1af09a49\Psr\Container\ContainerInterface $container, \_PhpScopercd5c1af09a49\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopercd5c1af09a49\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

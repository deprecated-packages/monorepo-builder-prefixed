 ...
 */
class ContainerControllerResolver extends \_PhpScoperd1c9c8ec01a8\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperd1c9c8ec01a8\Psr\Container\ContainerInterface $container, \_PhpScoperd1c9c8ec01a8\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperd1c9c8ec01a8\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScopere691b6ebfa72\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopere691b6ebfa72\Psr\Container\ContainerInterface $container, \_PhpScopere691b6ebfa72\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopere691b6ebfa72\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

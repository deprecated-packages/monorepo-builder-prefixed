 ...
 */
class ContainerControllerResolver extends \_PhpScoper31b05558ad5c\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper31b05558ad5c\Psr\Container\ContainerInterface $container, \_PhpScoper31b05558ad5c\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper31b05558ad5c\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

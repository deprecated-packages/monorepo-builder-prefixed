 ...
 */
class ContainerControllerResolver extends \_PhpScopere7b233920bf2\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopere7b233920bf2\Psr\Container\ContainerInterface $container, \_PhpScopere7b233920bf2\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopere7b233920bf2\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

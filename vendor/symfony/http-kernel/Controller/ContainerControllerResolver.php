 ...
 */
class ContainerControllerResolver extends \_PhpScopera763b4be90d0\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera763b4be90d0\Psr\Container\ContainerInterface $container, \_PhpScopera763b4be90d0\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera763b4be90d0\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

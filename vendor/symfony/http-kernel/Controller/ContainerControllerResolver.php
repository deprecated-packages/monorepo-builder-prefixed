 ...
 */
class ContainerControllerResolver extends \_PhpScopere4e8aecb81b9\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopere4e8aecb81b9\Psr\Container\ContainerInterface $container, \_PhpScopere4e8aecb81b9\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopere4e8aecb81b9\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScopereaa2cae8e093\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopereaa2cae8e093\Psr\Container\ContainerInterface $container, \_PhpScopereaa2cae8e093\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopereaa2cae8e093\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

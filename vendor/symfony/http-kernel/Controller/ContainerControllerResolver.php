 ...
 */
class ContainerControllerResolver extends \_PhpScoperf2e2fcfe7ee6\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperf2e2fcfe7ee6\Psr\Container\ContainerInterface $container, \_PhpScoperf2e2fcfe7ee6\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperf2e2fcfe7ee6\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

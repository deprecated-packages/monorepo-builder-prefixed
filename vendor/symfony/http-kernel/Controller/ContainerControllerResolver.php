 ...
 */
class ContainerControllerResolver extends \_PhpScoperfd1a6a0ee9af\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperfd1a6a0ee9af\Psr\Container\ContainerInterface $container, \_PhpScoperfd1a6a0ee9af\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperfd1a6a0ee9af\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

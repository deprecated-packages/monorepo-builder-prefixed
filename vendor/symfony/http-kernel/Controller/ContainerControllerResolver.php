 ...
 */
class ContainerControllerResolver extends \_PhpScoperec2b815193b4\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperec2b815193b4\Psr\Container\ContainerInterface $container, \_PhpScoperec2b815193b4\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperec2b815193b4\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

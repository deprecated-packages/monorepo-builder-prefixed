 ...
 */
class ContainerControllerResolver extends \_PhpScoper9b905ab040d4\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper9b905ab040d4\Psr\Container\ContainerInterface $container, \_PhpScoper9b905ab040d4\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper9b905ab040d4\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoper2a80719fd449\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper2a80719fd449\Psr\Container\ContainerInterface $container, \_PhpScoper2a80719fd449\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper2a80719fd449\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoperbe77f3b0e77d\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperbe77f3b0e77d\Psr\Container\ContainerInterface $container, \_PhpScoperbe77f3b0e77d\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperbe77f3b0e77d\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

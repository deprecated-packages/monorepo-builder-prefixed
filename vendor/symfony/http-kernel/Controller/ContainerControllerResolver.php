 ...
 */
class ContainerControllerResolver extends \_PhpScoperf7284855206a\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperf7284855206a\Psr\Container\ContainerInterface $container, \_PhpScoperf7284855206a\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperf7284855206a\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

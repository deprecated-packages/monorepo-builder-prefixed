 ...
 */
class ContainerControllerResolver extends \_PhpScoper138e2990dbdb\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper138e2990dbdb\Psr\Container\ContainerInterface $container, \_PhpScoper138e2990dbdb\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper138e2990dbdb\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

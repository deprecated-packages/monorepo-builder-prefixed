 ...
 */
class ContainerControllerResolver extends \_PhpScoperf237fc62366a\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperf237fc62366a\Psr\Container\ContainerInterface $container, \_PhpScoperf237fc62366a\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperf237fc62366a\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoperabca9a64438b\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperabca9a64438b\Psr\Container\ContainerInterface $container, \_PhpScoperabca9a64438b\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperabca9a64438b\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

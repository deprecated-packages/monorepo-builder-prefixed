 ...
 */
class ContainerControllerResolver extends \_PhpScoperb25e75e9febe\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperb25e75e9febe\Psr\Container\ContainerInterface $container, \_PhpScoperb25e75e9febe\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperb25e75e9febe\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoperf48ea5df9e9b\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperf48ea5df9e9b\Psr\Container\ContainerInterface $container, \_PhpScoperf48ea5df9e9b\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperf48ea5df9e9b\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

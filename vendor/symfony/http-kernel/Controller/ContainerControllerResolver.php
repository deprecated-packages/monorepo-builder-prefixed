 ...
 */
class ContainerControllerResolver extends \_PhpScoperddf2171d3d2c\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperddf2171d3d2c\Psr\Container\ContainerInterface $container, \_PhpScoperddf2171d3d2c\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperddf2171d3d2c\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

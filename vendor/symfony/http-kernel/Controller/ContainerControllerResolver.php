 ...
 */
class ContainerControllerResolver extends \_PhpScoperef96225926e2\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperef96225926e2\Psr\Container\ContainerInterface $container, \_PhpScoperef96225926e2\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperef96225926e2\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

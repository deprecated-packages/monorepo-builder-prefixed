 ...
 */
class ContainerControllerResolver extends \_PhpScopera28be7b3fe51\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopera28be7b3fe51\Psr\Container\ContainerInterface $container, \_PhpScopera28be7b3fe51\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopera28be7b3fe51\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

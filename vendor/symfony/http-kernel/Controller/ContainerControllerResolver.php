 ...
 */
class ContainerControllerResolver extends \_PhpScopere3ed9f66440c\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScopere3ed9f66440c\Psr\Container\ContainerInterface $container, \_PhpScopere3ed9f66440c\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScopere3ed9f66440c\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

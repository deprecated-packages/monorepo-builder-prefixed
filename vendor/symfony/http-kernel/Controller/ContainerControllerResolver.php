 ...
 */
class ContainerControllerResolver extends \_PhpScoper95efb8ddea2f\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper95efb8ddea2f\Psr\Container\ContainerInterface $container, \_PhpScoper95efb8ddea2f\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper95efb8ddea2f\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

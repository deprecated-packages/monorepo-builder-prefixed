 ...
 */
class ContainerControllerResolver extends \_PhpScoperbecbc4cd500f\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoperbecbc4cd500f\Psr\Container\ContainerInterface $container, \_PhpScoperbecbc4cd500f\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoperbecbc4cd500f\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

 ...
 */
class ContainerControllerResolver extends \_PhpScoper1600de59048a\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\_PhpScoper1600de59048a\Psr\Container\ContainerInterface $container, \_PhpScoper1600de59048a\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \_PhpScoper1600de59048a\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {

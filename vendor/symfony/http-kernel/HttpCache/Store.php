 ...
 */
class Store implements \_PhpScopere97aad8070b4\Symfony\Component\HttpKernel\HttpCache\StoreInterface
{
    protected $root;
    private $keyCache;
    private $locks;
     ...
     * @return string
     */
    protected function generateContentDigest(\_PhpScopere97aad8070b4\Symfony\Component\HttpFoundation\Response $response)
    {
    ...
    {
        $key = $this->getCacheKey(\_PhpScopere97aad8070b4\Symfony\Component\HttpFoundation\Request::create($url));
        if (isset($this->locks[$key])) {
            \flock($this->locks[$key], \LOCK_UN);
            \fclose($this->locks[$key]);
            unset($this->locks[$key]);
     ...
     */
    protected function generateCacheKey(\_PhpScopere97aad8070b4\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     */
    private function getCacheKey(\_PhpScopere97aad8070b4\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function persistRequest(\_PhpScopere97aad8070b4\Symfony\Component\HttpFoundation\Request $request) : array
    {
     ...
     */
    private function persistResponse(\_PhpScopere97aad8070b4\Symfony\Component\HttpFoundation\Response $response) : array
    {
     ...
     */
    private function restoreResponse(array $headers, string $body = null) : \_PhpScopere97aad8070b4\Symfony\Component\HttpFoundation\Response
    {
        ...
        return new \_PhpScopere97aad8070b4\Symfony\Component\HttpFoundation\Response($body, $status, $headers);
    }
}

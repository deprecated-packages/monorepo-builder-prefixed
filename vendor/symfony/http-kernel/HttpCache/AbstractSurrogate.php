 ...
 */
abstract class AbstractSurrogate implements \_PhpScopereaa2cae8e093\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScopereaa2cae8e093\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    public function hasSurrogateCapability(\_PhpScopereaa2cae8e093\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function addSurrogateCapability(\_PhpScopereaa2cae8e093\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function needsParsing(\_PhpScopereaa2cae8e093\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    public function handle(\_PhpScopereaa2cae8e093\Symfony\Component\HttpKernel\HttpCache\HttpCache $cache, $uri, $alt, $ignoreErrors)
    {
        $subRequest = \_PhpScopereaa2cae8e093\Symfony\Component\HttpFoundation\Request::create($uri, \_PhpScopereaa2cae8e093\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \_PhpScopereaa2cae8e093\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\_PhpScopereaa2cae8e093\Symfony\Component\HttpFoundation\Response $response)
    {

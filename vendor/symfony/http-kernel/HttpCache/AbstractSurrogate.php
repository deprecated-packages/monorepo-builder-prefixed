 ...
 */
abstract class AbstractSurrogate implements \_PhpScoperbe77f3b0e77d\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScoperbe77f3b0e77d\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        $subRequest = \_PhpScoperbe77f3b0e77d\Symfony\Component\HttpFoundation\Request::create($uri, \_PhpScoperbe77f3b0e77d\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \_PhpScoperbe77f3b0e77d\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\_PhpScoperbe77f3b0e77d\Symfony\Component\HttpFoundation\Response $response)
    {

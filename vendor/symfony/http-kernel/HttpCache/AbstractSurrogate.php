 ...
 */
abstract class AbstractSurrogate implements \_PhpScoper5e83c3f77e04\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScoper5e83c3f77e04\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    public function hasSurrogateCapability(\_PhpScoper5e83c3f77e04\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function addSurrogateCapability(\_PhpScoper5e83c3f77e04\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function needsParsing(\_PhpScoper5e83c3f77e04\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    public function handle(\_PhpScoper5e83c3f77e04\Symfony\Component\HttpKernel\HttpCache\HttpCache $cache, $uri, $alt, $ignoreErrors)
    {
        $subRequest = \_PhpScoper5e83c3f77e04\Symfony\Component\HttpFoundation\Request::create($uri, \_PhpScoper5e83c3f77e04\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \_PhpScoper5e83c3f77e04\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\_PhpScoper5e83c3f77e04\Symfony\Component\HttpFoundation\Response $response)
    {

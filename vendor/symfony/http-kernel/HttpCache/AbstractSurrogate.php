 ...
 */
abstract class AbstractSurrogate implements \_PhpScoperce084f4275dd\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScoperce084f4275dd\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    public function hasSurrogateCapability(\_PhpScoperce084f4275dd\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function addSurrogateCapability(\_PhpScoperce084f4275dd\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function needsParsing(\_PhpScoperce084f4275dd\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    public function handle(\_PhpScoperce084f4275dd\Symfony\Component\HttpKernel\HttpCache\HttpCache $cache, $uri, $alt, $ignoreErrors)
    {
        $subRequest = \_PhpScoperce084f4275dd\Symfony\Component\HttpFoundation\Request::create($uri, \_PhpScoperce084f4275dd\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \_PhpScoperce084f4275dd\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\_PhpScoperce084f4275dd\Symfony\Component\HttpFoundation\Response $response)
    {

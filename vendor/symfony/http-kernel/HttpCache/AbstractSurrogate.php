 ...
 */
abstract class AbstractSurrogate implements \_PhpScoperbd03d493ccc6\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \_PhpScoperbd03d493ccc6\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    public function hasSurrogateCapability(\_PhpScoperbd03d493ccc6\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function addSurrogateCapability(\_PhpScoperbd03d493ccc6\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function needsParsing(\_PhpScoperbd03d493ccc6\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    public function handle(\_PhpScoperbd03d493ccc6\Symfony\Component\HttpKernel\HttpCache\HttpCache $cache, $uri, $alt, $ignoreErrors)
    {
        $subRequest = \_PhpScoperbd03d493ccc6\Symfony\Component\HttpFoundation\Request::create($uri, \_PhpScoperbd03d493ccc6\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \_PhpScoperbd03d493ccc6\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\_PhpScoperbd03d493ccc6\Symfony\Component\HttpFoundation\Response $response)
    {

 ...
 */
namespace _PhpScopercdfd316eda69\Symfony\Component\HttpKernel\HttpCache;
...
use _PhpScopercdfd316eda69\Symfony\Component\HttpKernel\HttpKernelInterface;
use _PhpScopercdfd316eda69\Symfony\Component\HttpKernel\TerminableInterface;
/**
 * Cache provides HTTP caching.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HttpCache implements \_PhpScopercdfd316eda69\Symfony\Component\HttpKernel\HttpKernelInterface, \_PhpScopercdfd316eda69\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\_PhpScopercdfd316eda69\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \_PhpScopercdfd316eda69\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \_PhpScopercdfd316eda69\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
    ...
    private function addTraces(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Response $response)
    {
        $traceString = null;
    ...
    public function handle(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, int $type = \_PhpScopercdfd316eda69\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, bool $catch = \true)
    {
        ...
        if (\_PhpScopercdfd316eda69\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST === $type) {
            $this->traces = [];
    ...
    {
        if ($this->getKernel() instanceof \_PhpScopercdfd316eda69\Symfony\Component\HttpKernel\TerminableInterface) {
     ...
     */
    protected function pass(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
     ...
     * @see RFC2616 13.10
     */
    protected function invalidate(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        $response = $this->pass($request, $catch);
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
     ...
     * @throws \Exception
     */
    protected function lookup(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        try {
     ...
     * @return Response A Response instance
     */
    protected function validate(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, \_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Response $entry, bool $catch = \false)
    {
     ...
     * @return Response A Response instance
     */
    protected function fetch(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        $subRequest = clone $request;
        // send no head requests because we want content
        if ('HEAD' === $request->getMethod()) {
     ...
     * @return Response A Response instance
     */
    protected function forward(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false, \_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Response $entry = null)
    {
        if ($this->surrogate) {
            $this->surrogate->addSurrogateCapability($request);
        }
        // always a "master" request (as the real master request can be in cache)
        $response = \_PhpScopercdfd316eda69\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \_PhpScopercdfd316eda69\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $catch);
        /*
     ...
     */
    protected function isFreshEnough(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, \_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Response $entry)
    {
        if (!$entry->isFresh()) {
     ...
     */
    protected function lock(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, \_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Response $entry)
    {
     ...
     * @throws \Exception
     */
    protected function store(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, \_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Response $response)
    {
        try {
     ...
     */
    private function restoreResponseBody(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, \_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Response $response)
    {
    ...
    protected function processResponseBody(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, \_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     */
    private function record(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request, string $event)
    {
     ...
     */
    private function getTraceKey(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Response $entry) : bool
    {
     ...
     */
    private function waitForLock(\_PhpScopercdfd316eda69\Symfony\Component\HttpFoundation\Request $request) : bool
    {
        $wait = 0;

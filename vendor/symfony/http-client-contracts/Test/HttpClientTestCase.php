 ...
 */
namespace _PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Test;

use _PhpScoper4c089bfbbc1b\PHPUnit\Framework\TestCase;
use _PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface;
use _PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface;
use _PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface;
use _PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface;
 ...
 */
abstract class HttpClientTestCase extends \_PhpScoper4c089bfbbc1b\PHPUnit\Framework\TestCase
{
    public static function setUpBeforeClass() : void
    {
        \_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Test\TestHttpServer::start();
    }
    protected abstract function getHttpClient(string $testCase) : \_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\HttpClientInterface;
    public function testGetRequest()
    {
        ...
        $this->expectException(\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class);
        $response->getContent();
    }
    ...
    public function testClientError()
    {
        ...
        try {
            $response->getHeaders();
            $this->fail(\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface::class . ' expected');
        } catch (\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface $e) {
        }
        try {
            $response->getContent();
            $this->fail(\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface::class . ' expected');
    ...
    public function testDnsError()
    {
        ...
        try {
            ...
            $this->fail(\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class . ' expected');
        } catch (\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface $e) {
            $this->addToAssertionCount(1);
        }
        try {
            $response->getStatusCode();
            $this->fail(\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class . ' still expected');
        } catch (\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface $e) {
            $this->addToAssertionCount(1);
        }
        $response = $client->request('GET', 'http://localhost:8057/301/bad-tld');
    ...
    public function testInvalidRedirect()
    {
        ...
        $this->assertNull($response->getInfo('redirect_url'));
        $this->expectException(\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface::class);
        $response->getHeaders();
    }
    ...
    public function testMaxRedirects()
    {
        ...
        try {
            $response->getHeaders();
            $this->fail(\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface::class . ' expected');
        } catch (\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface $e) {
        }
        $this->assertSame(302, $response->getStatusCode());
    ...
    public function testTimeoutIsNotAFatalError()
    {
        ...
        try {
            $response->getContent();
            $this->fail(\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface::class . ' expected');
        } catch (\_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface $e) {
        }
        for ($i = 0; $i < 10; ++$i) {
            try {
    ...
    {
        $p1 = \_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8067);
        $p2 = \_PhpScoper4c089bfbbc1b\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8077);
        $client = $this->getHttpClient(__FUNCTION__);

...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', \_PhpScoperf2e2fcfe7ee6\Symfony\Component\Debug\DebugClassLoader::class, \_PhpScoperf2e2fcfe7ee6\Symfony\Component\ErrorHandler\DebugClassLoader::class), \E_USER_DEPRECATED);
/**
...
class DebugClassLoader
{
    ...
    public static function enable()
    {
        ...
        \class_exists('_PhpScoperf2e2fcfe7ee6\\Symfony\\Component\\Debug\\ErrorHandler');

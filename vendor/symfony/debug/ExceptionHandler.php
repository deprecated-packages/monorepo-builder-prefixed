...
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', \_PhpScopere71835ca1415\Symfony\Component\Debug\ExceptionHandler::class, \_PhpScopere71835ca1415\Symfony\Component\ErrorHandler\ErrorHandler::class), \E_USER_DEPRECATED);
/**
...
class ExceptionHandler
{
    ...
    public static function register($debug = \true, $charset = null, $fileLinkFormat = null)
    {
        ...
        if (\is_array($prev) && $prev[0] instanceof \_PhpScopere71835ca1415\Symfony\Component\Debug\ErrorHandler) {
    ...
    {
        if (null === $this->handler || $exception instanceof \_PhpScopere71835ca1415\Symfony\Component\Debug\Exception\OutOfMemoryException) {
    ...
    public function sendPhpResponse($exception)
    {
        if ($exception instanceof \Throwable) {
            $exception = \_PhpScopere71835ca1415\Symfony\Component\Debug\Exception\FlattenException::createFromThrowable($exception);
        }
        if (!\headers_sent()) {
    ...
    {
        if (!$exception instanceof \_PhpScopere71835ca1415\Symfony\Component\Debug\Exception\FlattenException) {
            $exception = \_PhpScopere71835ca1415\Symfony\Component\Debug\Exception\FlattenException::create($exception);
        }
     ...
     */
    public function getContent(\_PhpScopere71835ca1415\Symfony\Component\Debug\Exception\FlattenException $exception)
    {
...
, $ind, $total, $class, $message);
            ...
            if ($this->debug) {
                $e = \_PhpScopere71835ca1415\Symfony\Component\Debug\Exception\FlattenException::create($e);
...
EOF;
     ...
     */
    public function getStylesheet(\_PhpScopere71835ca1415\Symfony\Component\Debug\Exception\FlattenException $exception)
    {
        if (!$this->debug) {
            return <<<'EOF'

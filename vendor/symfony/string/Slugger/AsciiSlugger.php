...
use _PhpScoperd6a443964d04\Symfony\Component\String\UnicodeString;
use _PhpScoperd6a443964d04\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\_PhpScoperd6a443964d04\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \_PhpScoperd6a443964d04\Symfony\Component\String\Slugger\SluggerInterface, \_PhpScoperd6a443964d04\Symfony\Contracts\Translation\LocaleAwareInterface
{
    ...
    public function slug(string $string, string $separator = '-', string $locale = null) : \_PhpScoperd6a443964d04\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \_PhpScoperd6a443964d04\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);

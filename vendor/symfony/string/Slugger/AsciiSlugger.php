...
use _PhpScoperf701e46e48a5\Symfony\Component\String\UnicodeString;
use _PhpScoperf701e46e48a5\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\_PhpScoperf701e46e48a5\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \_PhpScoperf701e46e48a5\Symfony\Component\String\Slugger\SluggerInterface, \_PhpScoperf701e46e48a5\Symfony\Contracts\Translation\LocaleAwareInterface
{
    ...
    public function slug(string $string, string $separator = '-', string $locale = null) : \_PhpScoperf701e46e48a5\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \_PhpScoperf701e46e48a5\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);

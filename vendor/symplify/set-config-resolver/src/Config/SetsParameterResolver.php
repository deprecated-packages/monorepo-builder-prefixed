...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper47ce95ac3375\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper47ce95ac3375\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper47ce95ac3375\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper47ce95ac3375\Symfony\Component\Config\FileLocator());

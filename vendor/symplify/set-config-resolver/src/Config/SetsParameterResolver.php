...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper621122bdc380\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper621122bdc380\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper621122bdc380\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper621122bdc380\Symfony\Component\Config\FileLocator());

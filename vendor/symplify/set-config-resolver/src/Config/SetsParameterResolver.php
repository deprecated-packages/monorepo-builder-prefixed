...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper96a284484937\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper96a284484937\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper96a284484937\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper96a284484937\Symfony\Component\Config\FileLocator());

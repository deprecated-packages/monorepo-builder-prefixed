...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper437fa56c88e1\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper437fa56c88e1\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper437fa56c88e1\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper437fa56c88e1\Symfony\Component\Config\FileLocator());

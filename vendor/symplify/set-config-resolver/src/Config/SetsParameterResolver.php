...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperb445cd48032c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperb445cd48032c\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperb445cd48032c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperb445cd48032c\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper9e0a2007d758\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper9e0a2007d758\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper9e0a2007d758\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper9e0a2007d758\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper7d1be3c5de07\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper7d1be3c5de07\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper7d1be3c5de07\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper7d1be3c5de07\Symfony\Component\Config\FileLocator());

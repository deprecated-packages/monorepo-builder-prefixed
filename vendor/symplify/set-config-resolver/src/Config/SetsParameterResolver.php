...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper6d6e02e9c455\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper6d6e02e9c455\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper6d6e02e9c455\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper6d6e02e9c455\Symfony\Component\Config\FileLocator());

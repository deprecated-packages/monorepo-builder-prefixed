...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper09a4cc789a22\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper09a4cc789a22\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper09a4cc789a22\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper09a4cc789a22\Symfony\Component\Config\FileLocator());

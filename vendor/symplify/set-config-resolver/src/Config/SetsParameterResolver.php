...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper503cab241f82\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper503cab241f82\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper503cab241f82\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper503cab241f82\Symfony\Component\Config\FileLocator());

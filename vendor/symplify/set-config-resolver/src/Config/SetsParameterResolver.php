...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper912e6d747d7e\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper912e6d747d7e\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper912e6d747d7e\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper912e6d747d7e\Symfony\Component\Config\FileLocator());

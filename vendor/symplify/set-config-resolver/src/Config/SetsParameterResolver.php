...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper5818bcaf1010\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper5818bcaf1010\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper5818bcaf1010\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper5818bcaf1010\Symfony\Component\Config\FileLocator());

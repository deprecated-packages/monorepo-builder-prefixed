...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper8a1d608a1a7e\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper8a1d608a1a7e\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper8a1d608a1a7e\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper8a1d608a1a7e\Symfony\Component\Config\FileLocator());

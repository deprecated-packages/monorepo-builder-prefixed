...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper37887d2f9246\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper37887d2f9246\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper37887d2f9246\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper37887d2f9246\Symfony\Component\Config\FileLocator());

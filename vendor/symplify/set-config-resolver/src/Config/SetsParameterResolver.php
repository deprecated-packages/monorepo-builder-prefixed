...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper354754c20063\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper354754c20063\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper354754c20063\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper354754c20063\Symfony\Component\Config\FileLocator());

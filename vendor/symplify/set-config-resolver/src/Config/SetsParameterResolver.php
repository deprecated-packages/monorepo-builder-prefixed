...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperac0a9a33ae94\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperac0a9a33ae94\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperac0a9a33ae94\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperac0a9a33ae94\Symfony\Component\Config\FileLocator());

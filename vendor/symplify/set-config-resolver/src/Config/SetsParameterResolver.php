...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper77bdbacdc821\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper77bdbacdc821\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper77bdbacdc821\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper77bdbacdc821\Symfony\Component\Config\FileLocator());

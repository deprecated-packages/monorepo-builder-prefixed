...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper9e91fe07dbdd\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper9e91fe07dbdd\Symfony\Component\Config\FileLocator());

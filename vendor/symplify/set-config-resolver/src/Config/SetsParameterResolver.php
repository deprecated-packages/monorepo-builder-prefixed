...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperad5317739bda\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperad5317739bda\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperad5317739bda\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperad5317739bda\Symfony\Component\Config\FileLocator());

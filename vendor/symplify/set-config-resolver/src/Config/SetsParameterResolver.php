...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopere97aad8070b4\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScopere97aad8070b4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScopere97aad8070b4\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopere97aad8070b4\Symfony\Component\Config\FileLocator());

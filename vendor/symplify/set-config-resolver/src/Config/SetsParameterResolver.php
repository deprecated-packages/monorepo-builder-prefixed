...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperf968abd60cb0\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperf968abd60cb0\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperf968abd60cb0\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperf968abd60cb0\Symfony\Component\Config\FileLocator());

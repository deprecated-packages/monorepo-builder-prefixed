...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera5e5d165d78c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScopera5e5d165d78c\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScopera5e5d165d78c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera5e5d165d78c\Symfony\Component\Config\FileLocator());

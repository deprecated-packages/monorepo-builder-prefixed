...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperc693a7d83f11\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperc693a7d83f11\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperc693a7d83f11\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperc693a7d83f11\Symfony\Component\Config\FileLocator());

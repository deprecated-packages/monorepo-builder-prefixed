...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperbb737891eded\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperbb737891eded\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperbb737891eded\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperbb737891eded\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3b1a4d12ef28\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper3b1a4d12ef28\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper3b1a4d12ef28\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3b1a4d12ef28\Symfony\Component\Config\FileLocator());

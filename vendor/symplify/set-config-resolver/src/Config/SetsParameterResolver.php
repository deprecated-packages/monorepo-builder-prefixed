...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperce084f4275dd\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperce084f4275dd\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperce084f4275dd\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperce084f4275dd\Symfony\Component\Config\FileLocator());

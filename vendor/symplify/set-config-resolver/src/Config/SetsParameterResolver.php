...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper131024327b3f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper131024327b3f\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper131024327b3f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper131024327b3f\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopercdfd316eda69\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScopercdfd316eda69\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScopercdfd316eda69\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopercdfd316eda69\Symfony\Component\Config\FileLocator());

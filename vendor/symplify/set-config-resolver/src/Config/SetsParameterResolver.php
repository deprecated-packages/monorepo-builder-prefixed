...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperf4d251e01a80\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperf4d251e01a80\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperf4d251e01a80\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperf4d251e01a80\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper1ff8e175c295\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper1ff8e175c295\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper1ff8e175c295\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper1ff8e175c295\Symfony\Component\Config\FileLocator());

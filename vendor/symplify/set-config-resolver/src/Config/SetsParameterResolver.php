...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper8f797d20934a\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper8f797d20934a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper8f797d20934a\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper8f797d20934a\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper30f4a2553084\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper30f4a2553084\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper30f4a2553084\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper30f4a2553084\Symfony\Component\Config\FileLocator());

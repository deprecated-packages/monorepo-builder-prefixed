...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper462f168ef4cc\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper462f168ef4cc\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper462f168ef4cc\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper462f168ef4cc\Symfony\Component\Config\FileLocator());

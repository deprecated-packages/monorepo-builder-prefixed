...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper79999b045682\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper79999b045682\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper79999b045682\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper79999b045682\Symfony\Component\Config\FileLocator());

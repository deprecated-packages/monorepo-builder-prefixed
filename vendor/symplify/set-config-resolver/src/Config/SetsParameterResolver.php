...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper66a1b4bf441c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper66a1b4bf441c\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper66a1b4bf441c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper66a1b4bf441c\Symfony\Component\Config\FileLocator());

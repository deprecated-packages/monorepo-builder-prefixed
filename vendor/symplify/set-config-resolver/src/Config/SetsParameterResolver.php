...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3c875050d97b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper3c875050d97b\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper3c875050d97b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3c875050d97b\Symfony\Component\Config\FileLocator());

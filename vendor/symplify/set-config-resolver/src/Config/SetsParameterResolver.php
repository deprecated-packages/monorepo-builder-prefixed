...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper0217ecc5969a\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper0217ecc5969a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper0217ecc5969a\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper0217ecc5969a\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper130e101f3ca6\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper130e101f3ca6\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper130e101f3ca6\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper130e101f3ca6\Symfony\Component\Config\FileLocator());

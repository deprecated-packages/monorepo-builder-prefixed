...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper860bc98a0f96\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper860bc98a0f96\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper860bc98a0f96\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper860bc98a0f96\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper416e75c46c6e\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper416e75c46c6e\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper416e75c46c6e\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper416e75c46c6e\Symfony\Component\Config\FileLocator());

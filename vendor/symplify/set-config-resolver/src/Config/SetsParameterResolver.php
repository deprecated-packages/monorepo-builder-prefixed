...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopercd844fca8af3\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScopercd844fca8af3\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScopercd844fca8af3\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopercd844fca8af3\Symfony\Component\Config\FileLocator());

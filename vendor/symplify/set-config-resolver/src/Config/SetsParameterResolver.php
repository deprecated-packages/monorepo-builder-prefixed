...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper6da0ff96db02\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper6da0ff96db02\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper6da0ff96db02\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper6da0ff96db02\Symfony\Component\Config\FileLocator());

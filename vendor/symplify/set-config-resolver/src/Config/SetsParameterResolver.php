...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper88e2bb777a57\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper88e2bb777a57\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper88e2bb777a57\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper88e2bb777a57\Symfony\Component\Config\FileLocator());

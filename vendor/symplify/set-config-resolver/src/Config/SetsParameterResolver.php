...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper9b3b288e828e\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper9b3b288e828e\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper9b3b288e828e\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper9b3b288e828e\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper4cbad741edc5\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper4cbad741edc5\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper4cbad741edc5\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper4cbad741edc5\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper722a1d9fee2c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper722a1d9fee2c\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper722a1d9fee2c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper722a1d9fee2c\Symfony\Component\Config\FileLocator());

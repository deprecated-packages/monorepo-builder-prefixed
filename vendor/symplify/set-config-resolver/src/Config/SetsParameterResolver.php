...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper6bfbe5ea8949\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper6bfbe5ea8949\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper6bfbe5ea8949\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper6bfbe5ea8949\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper621af75be782\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper621af75be782\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper621af75be782\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper621af75be782\Symfony\Component\Config\FileLocator());

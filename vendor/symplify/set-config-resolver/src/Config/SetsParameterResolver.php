...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper1ceaf4cbd5cb\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper1ceaf4cbd5cb\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper1ceaf4cbd5cb\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper1ceaf4cbd5cb\Symfony\Component\Config\FileLocator());

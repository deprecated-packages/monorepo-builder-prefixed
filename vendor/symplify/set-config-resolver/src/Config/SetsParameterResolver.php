...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopereb7fcd8f999a\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScopereb7fcd8f999a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScopereb7fcd8f999a\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopereb7fcd8f999a\Symfony\Component\Config\FileLocator());

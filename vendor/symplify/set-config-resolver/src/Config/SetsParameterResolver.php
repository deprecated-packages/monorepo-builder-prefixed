...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper7cc068f3f5d1\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper7cc068f3f5d1\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper7cc068f3f5d1\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper7cc068f3f5d1\Symfony\Component\Config\FileLocator());

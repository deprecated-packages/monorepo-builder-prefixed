...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera763b4be90d0\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScopera763b4be90d0\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScopera763b4be90d0\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera763b4be90d0\Symfony\Component\Config\FileLocator());

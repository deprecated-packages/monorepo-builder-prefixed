...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper2f9b0ac741dd\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper2f9b0ac741dd\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper2f9b0ac741dd\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper2f9b0ac741dd\Symfony\Component\Config\FileLocator());

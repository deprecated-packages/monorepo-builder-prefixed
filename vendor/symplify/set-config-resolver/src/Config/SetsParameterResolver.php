...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScopera42d72b2de70\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScopera42d72b2de70\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScopera42d72b2de70\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScopera42d72b2de70\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperedfa898a454f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperedfa898a454f\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperedfa898a454f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperedfa898a454f\Symfony\Component\Config\FileLocator());

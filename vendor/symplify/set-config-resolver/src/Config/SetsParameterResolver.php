...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper7334003ee560\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper7334003ee560\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper7334003ee560\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper7334003ee560\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper244a857c31f6\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper244a857c31f6\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper244a857c31f6\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper244a857c31f6\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3c46f40844ed\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper3c46f40844ed\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper3c46f40844ed\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3c46f40844ed\Symfony\Component\Config\FileLocator());

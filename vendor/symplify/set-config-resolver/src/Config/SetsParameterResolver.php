...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper31b05558ad5c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper31b05558ad5c\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper31b05558ad5c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper31b05558ad5c\Symfony\Component\Config\FileLocator());

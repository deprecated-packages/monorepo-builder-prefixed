...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper8a4bdaafa6ec\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper8a4bdaafa6ec\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper8a4bdaafa6ec\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper8a4bdaafa6ec\Symfony\Component\Config\FileLocator());

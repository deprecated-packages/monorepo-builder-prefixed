...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper674f850a9604\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper674f850a9604\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper674f850a9604\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper674f850a9604\Symfony\Component\Config\FileLocator());

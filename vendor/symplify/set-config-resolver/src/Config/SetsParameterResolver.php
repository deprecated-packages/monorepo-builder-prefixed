...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper1600de59048a\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper1600de59048a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper1600de59048a\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper1600de59048a\Symfony\Component\Config\FileLocator());

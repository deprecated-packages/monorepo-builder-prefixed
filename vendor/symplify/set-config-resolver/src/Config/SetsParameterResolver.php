...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper227dea868235\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper227dea868235\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper227dea868235\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper227dea868235\Symfony\Component\Config\FileLocator());

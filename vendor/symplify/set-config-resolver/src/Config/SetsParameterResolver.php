...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper7609e473a4cb\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper7609e473a4cb\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper7609e473a4cb\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper7609e473a4cb\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper36281e29f54f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper36281e29f54f\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper36281e29f54f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper36281e29f54f\Symfony\Component\Config\FileLocator());

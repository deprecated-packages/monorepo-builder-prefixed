...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper717b2838a41b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper717b2838a41b\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper717b2838a41b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper717b2838a41b\Symfony\Component\Config\FileLocator());

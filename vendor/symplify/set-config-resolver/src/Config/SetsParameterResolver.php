...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper5f41da07187c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper5f41da07187c\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper5f41da07187c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper5f41da07187c\Symfony\Component\Config\FileLocator());

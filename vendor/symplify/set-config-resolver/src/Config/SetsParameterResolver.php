...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper204b3b8f3e0d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper204b3b8f3e0d\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper204b3b8f3e0d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper204b3b8f3e0d\Symfony\Component\Config\FileLocator());

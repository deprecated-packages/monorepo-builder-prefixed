...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper2e873f93a162\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper2e873f93a162\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper2e873f93a162\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper2e873f93a162\Symfony\Component\Config\FileLocator());

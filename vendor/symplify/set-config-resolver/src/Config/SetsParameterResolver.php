...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper31a2d0e8f655\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper31a2d0e8f655\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper31a2d0e8f655\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper31a2d0e8f655\Symfony\Component\Config\FileLocator());

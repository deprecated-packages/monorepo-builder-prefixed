...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperd79f30a2f8be\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperd79f30a2f8be\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperd79f30a2f8be\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperd79f30a2f8be\Symfony\Component\Config\FileLocator());

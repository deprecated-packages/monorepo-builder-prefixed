...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper9a721f934eeb\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper9a721f934eeb\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper9a721f934eeb\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper9a721f934eeb\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper43a95e2f69bc\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper43a95e2f69bc\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper43a95e2f69bc\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper43a95e2f69bc\Symfony\Component\Config\FileLocator());

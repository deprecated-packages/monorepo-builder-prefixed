...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper2f1e52375c65\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper2f1e52375c65\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper2f1e52375c65\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper2f1e52375c65\Symfony\Component\Config\FileLocator());

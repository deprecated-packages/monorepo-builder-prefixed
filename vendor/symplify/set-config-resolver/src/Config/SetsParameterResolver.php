...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper450cfab1c22b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper450cfab1c22b\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper450cfab1c22b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper450cfab1c22b\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper5e83c3f77e04\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper5e83c3f77e04\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper5e83c3f77e04\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper5e83c3f77e04\Symfony\Component\Config\FileLocator());

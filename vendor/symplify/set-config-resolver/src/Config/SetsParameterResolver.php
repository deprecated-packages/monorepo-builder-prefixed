...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper2a80719fd449\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper2a80719fd449\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper2a80719fd449\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper2a80719fd449\Symfony\Component\Config\FileLocator());

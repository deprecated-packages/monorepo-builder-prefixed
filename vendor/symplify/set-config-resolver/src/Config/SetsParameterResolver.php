...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper8a421ef9d4c6\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper8a421ef9d4c6\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper8a421ef9d4c6\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper8a421ef9d4c6\Symfony\Component\Config\FileLocator());

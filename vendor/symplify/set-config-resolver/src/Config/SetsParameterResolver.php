...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper0c743797b8e7\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper0c743797b8e7\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper0c743797b8e7\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper0c743797b8e7\Symfony\Component\Config\FileLocator());

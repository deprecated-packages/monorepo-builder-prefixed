...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper22d98a58be40\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper22d98a58be40\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper22d98a58be40\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper22d98a58be40\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper82732e472d5e\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper82732e472d5e\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper82732e472d5e\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper82732e472d5e\Symfony\Component\Config\FileLocator());

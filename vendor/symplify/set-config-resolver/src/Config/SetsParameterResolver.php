...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper963537526adf\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper963537526adf\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper963537526adf\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper963537526adf\Symfony\Component\Config\FileLocator());

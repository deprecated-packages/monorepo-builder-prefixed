...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper14531b498d75\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper14531b498d75\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper14531b498d75\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper14531b498d75\Symfony\Component\Config\FileLocator());

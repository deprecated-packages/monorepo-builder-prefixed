...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper36654c852ab2\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper36654c852ab2\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper36654c852ab2\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper36654c852ab2\Symfony\Component\Config\FileLocator());

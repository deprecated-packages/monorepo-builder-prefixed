...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper03a47c44ad4f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper03a47c44ad4f\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper03a47c44ad4f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper03a47c44ad4f\Symfony\Component\Config\FileLocator());

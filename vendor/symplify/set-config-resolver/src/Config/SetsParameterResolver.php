...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper80b6fe7627f7\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper80b6fe7627f7\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper80b6fe7627f7\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper80b6fe7627f7\Symfony\Component\Config\FileLocator());

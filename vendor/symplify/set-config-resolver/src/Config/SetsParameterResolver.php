...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper59bf8deb8cc1\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper59bf8deb8cc1\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper59bf8deb8cc1\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper59bf8deb8cc1\Symfony\Component\Config\FileLocator());

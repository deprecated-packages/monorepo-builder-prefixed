...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper9693ff52999d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper9693ff52999d\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper9693ff52999d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper9693ff52999d\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper68e56c1b5bd9\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper68e56c1b5bd9\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper68e56c1b5bd9\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper68e56c1b5bd9\Symfony\Component\Config\FileLocator());

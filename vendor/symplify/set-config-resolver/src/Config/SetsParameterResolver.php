...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper95efb8ddea2f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper95efb8ddea2f\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper95efb8ddea2f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper95efb8ddea2f\Symfony\Component\Config\FileLocator());

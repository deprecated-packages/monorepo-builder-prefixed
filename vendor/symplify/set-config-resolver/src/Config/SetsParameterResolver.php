...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper600b802aef08\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper600b802aef08\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper600b802aef08\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper600b802aef08\Symfony\Component\Config\FileLocator());

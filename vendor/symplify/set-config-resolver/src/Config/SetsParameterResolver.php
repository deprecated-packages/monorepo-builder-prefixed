...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper472361b15529\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper472361b15529\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper472361b15529\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper472361b15529\Symfony\Component\Config\FileLocator());

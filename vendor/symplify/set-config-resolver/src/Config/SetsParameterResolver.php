...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3ac0b040c6af\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper3ac0b040c6af\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper3ac0b040c6af\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3ac0b040c6af\Symfony\Component\Config\FileLocator());

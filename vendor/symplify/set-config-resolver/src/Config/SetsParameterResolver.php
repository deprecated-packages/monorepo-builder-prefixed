...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperda849baa4a45\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperda849baa4a45\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperda849baa4a45\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperda849baa4a45\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3c4d71e1434d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper3c4d71e1434d\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper3c4d71e1434d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3c4d71e1434d\Symfony\Component\Config\FileLocator());

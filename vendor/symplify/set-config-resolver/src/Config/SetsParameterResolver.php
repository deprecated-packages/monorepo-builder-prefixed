...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper7aa910bab0da\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper7aa910bab0da\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper7aa910bab0da\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper7aa910bab0da\Symfony\Component\Config\FileLocator());

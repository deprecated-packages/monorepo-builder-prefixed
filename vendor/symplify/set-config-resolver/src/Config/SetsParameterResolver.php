...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper0677321b414b\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper0677321b414b\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper0677321b414b\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper0677321b414b\Symfony\Component\Config\FileLocator());

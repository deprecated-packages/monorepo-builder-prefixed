...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper931cda798d50\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper931cda798d50\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper931cda798d50\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper931cda798d50\Symfony\Component\Config\FileLocator());

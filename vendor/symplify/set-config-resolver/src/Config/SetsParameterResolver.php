...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper905a278e297d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper905a278e297d\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper905a278e297d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper905a278e297d\Symfony\Component\Config\FileLocator());

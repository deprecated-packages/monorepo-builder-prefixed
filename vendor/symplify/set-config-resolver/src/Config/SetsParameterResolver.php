...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper8e5d8d76215d\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper8e5d8d76215d\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper8e5d8d76215d\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper8e5d8d76215d\Symfony\Component\Config\FileLocator());

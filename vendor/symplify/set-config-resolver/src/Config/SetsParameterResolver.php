...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper0ad68a106f23\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper0ad68a106f23\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper0ad68a106f23\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper0ad68a106f23\Symfony\Component\Config\FileLocator());

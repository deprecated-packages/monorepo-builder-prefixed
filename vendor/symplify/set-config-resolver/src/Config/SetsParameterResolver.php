...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper650fbdd90fa0\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper650fbdd90fa0\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper650fbdd90fa0\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper650fbdd90fa0\Symfony\Component\Config\FileLocator());

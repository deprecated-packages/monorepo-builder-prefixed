...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper3bda9af7e0fd\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper3bda9af7e0fd\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper3bda9af7e0fd\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper3bda9af7e0fd\Symfony\Component\Config\FileLocator());

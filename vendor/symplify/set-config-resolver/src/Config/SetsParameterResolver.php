...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperdfa889d8967a\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperdfa889d8967a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperdfa889d8967a\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperdfa889d8967a\Symfony\Component\Config\FileLocator());

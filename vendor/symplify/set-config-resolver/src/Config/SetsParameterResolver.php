...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper711ac919263f\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper711ac919263f\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper711ac919263f\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper711ac919263f\Symfony\Component\Config\FileLocator());

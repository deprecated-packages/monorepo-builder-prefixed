...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper34ecf47f3155\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper34ecf47f3155\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper34ecf47f3155\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper34ecf47f3155\Symfony\Component\Config\FileLocator());

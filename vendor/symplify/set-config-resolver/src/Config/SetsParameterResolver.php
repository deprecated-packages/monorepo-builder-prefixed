...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper1411c9dba342\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper1411c9dba342\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper1411c9dba342\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper1411c9dba342\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper61d2aa534566\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper61d2aa534566\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper61d2aa534566\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper61d2aa534566\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper32df52184457\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper32df52184457\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper32df52184457\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper32df52184457\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper4a734d287afc\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper4a734d287afc\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper4a734d287afc\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper4a734d287afc\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperdd624bbcb4e5\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperdd624bbcb4e5\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperdd624bbcb4e5\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperdd624bbcb4e5\Symfony\Component\Config\FileLocator());

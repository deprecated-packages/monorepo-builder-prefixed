...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper018f70acf6cc\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper018f70acf6cc\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper018f70acf6cc\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper018f70acf6cc\Symfony\Component\Config\FileLocator());

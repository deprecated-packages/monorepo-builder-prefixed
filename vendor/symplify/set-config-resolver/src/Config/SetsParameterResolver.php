...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper120e1a259c7c\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper120e1a259c7c\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper120e1a259c7c\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper120e1a259c7c\Symfony\Component\Config\FileLocator());

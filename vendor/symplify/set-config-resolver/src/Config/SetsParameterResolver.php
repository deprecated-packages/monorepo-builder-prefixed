...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoper9ea409d355af\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoper9ea409d355af\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoper9ea409d355af\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoper9ea409d355af\Symfony\Component\Config\FileLocator());

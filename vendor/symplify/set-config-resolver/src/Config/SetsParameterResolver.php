...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperaf523e5605cc\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperaf523e5605cc\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperaf523e5605cc\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperaf523e5605cc\Symfony\Component\Config\FileLocator());

...
final class SetsParameterResolver
{
    ...
    {
        $configContent = \_PhpScoperdfdcb3d4cca0\Symfony\Component\Yaml\Yaml::parse($configFileInfo->getContents());
    ...
    {
        // php file loader
        $containerBuilder = new \_PhpScoperdfdcb3d4cca0\Symfony\Component\DependencyInjection\ContainerBuilder();
        $phpFileLoader = new \_PhpScoperdfdcb3d4cca0\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($containerBuilder, new \_PhpScoperdfdcb3d4cca0\Symfony\Component\Config\FileLocator());

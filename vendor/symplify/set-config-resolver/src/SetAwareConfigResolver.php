...
final class SetAwareConfigResolver extends \Symplify\SetConfigResolver\AbstractConfigResolver
{
    ...
    public function resolveSetFromInput(\_PhpScoper8d3e33bd2be8\Symfony\Component\Console\Input\InputInterface $input) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {

...
final class SetAwareConfigResolver extends \Symplify\SetConfigResolver\AbstractConfigResolver
{
    ...
    public function resolveSetFromInput(\_PhpScoper6b92aa0ec16f\Symfony\Component\Console\Input\InputInterface $input) : ?\Symplify\SmartFileSystem\SmartFileInfo
    {

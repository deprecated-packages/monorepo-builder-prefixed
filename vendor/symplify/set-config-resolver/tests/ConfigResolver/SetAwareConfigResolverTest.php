...
final class SetAwareConfigResolverTest extends \_PhpScoperf6f8e31183c3\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf6f8e31183c3\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf6f8e31183c3\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

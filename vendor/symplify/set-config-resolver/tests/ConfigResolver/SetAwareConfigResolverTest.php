...
final class SetAwareConfigResolverTest extends \_PhpScoper6da0ff96db02\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper6da0ff96db02\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper6da0ff96db02\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoperaa2560a8a931\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperaa2560a8a931\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperaa2560a8a931\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

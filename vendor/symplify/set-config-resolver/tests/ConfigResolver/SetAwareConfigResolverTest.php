...
final class SetAwareConfigResolverTest extends \_PhpScoper621af75be782\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper621af75be782\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper621af75be782\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

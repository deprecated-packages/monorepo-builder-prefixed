...
final class SetAwareConfigResolverTest extends \_PhpScoper12b9214dc5a9\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper12b9214dc5a9\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper12b9214dc5a9\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

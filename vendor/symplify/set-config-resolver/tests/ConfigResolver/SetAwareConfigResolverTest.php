...
final class SetAwareConfigResolverTest extends \_PhpScoperfec5e512f2f8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperfec5e512f2f8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperfec5e512f2f8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

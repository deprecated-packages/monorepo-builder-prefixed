...
final class SetAwareConfigResolverTest extends \_PhpScoper96a284484937\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper96a284484937\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper96a284484937\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

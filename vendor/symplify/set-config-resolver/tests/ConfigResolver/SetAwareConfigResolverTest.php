...
final class SetAwareConfigResolverTest extends \_PhpScoper130e101f3ca6\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper130e101f3ca6\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper130e101f3ca6\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

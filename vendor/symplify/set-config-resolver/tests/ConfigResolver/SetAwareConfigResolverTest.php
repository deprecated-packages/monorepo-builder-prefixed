...
final class SetAwareConfigResolverTest extends \_PhpScoperec2b815193b4\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperec2b815193b4\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperec2b815193b4\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

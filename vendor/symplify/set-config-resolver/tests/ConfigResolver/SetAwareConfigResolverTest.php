...
final class SetAwareConfigResolverTest extends \_PhpScoper59bf8deb8cc1\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper59bf8deb8cc1\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper59bf8deb8cc1\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

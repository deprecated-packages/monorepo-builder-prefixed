...
final class SetAwareConfigResolverTest extends \_PhpScoper8db311958ad1\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper8db311958ad1\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper8db311958ad1\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

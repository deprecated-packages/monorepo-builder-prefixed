...
final class SetAwareConfigResolverTest extends \_PhpScoper9aac61c94bdb\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper9aac61c94bdb\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper9aac61c94bdb\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

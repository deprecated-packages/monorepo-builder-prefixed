...
final class SetAwareConfigResolverTest extends \_PhpScoper1d5917c620d0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper1d5917c620d0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper1d5917c620d0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

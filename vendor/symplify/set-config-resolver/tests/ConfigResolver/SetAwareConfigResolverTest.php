...
final class SetAwareConfigResolverTest extends \_PhpScopere57ee17947a3\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopere57ee17947a3\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopere57ee17947a3\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper0d74dc701629\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0d74dc701629\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0d74dc701629\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper9ea409d355af\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper9ea409d355af\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper9ea409d355af\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

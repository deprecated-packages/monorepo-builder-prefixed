...
final class SetAwareConfigResolverTest extends \_PhpScoper138e2990dbdb\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper138e2990dbdb\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper138e2990dbdb\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

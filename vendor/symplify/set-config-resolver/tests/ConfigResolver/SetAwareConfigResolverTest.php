...
final class SetAwareConfigResolverTest extends \_PhpScoperf9ff1c3447b1\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf9ff1c3447b1\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf9ff1c3447b1\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

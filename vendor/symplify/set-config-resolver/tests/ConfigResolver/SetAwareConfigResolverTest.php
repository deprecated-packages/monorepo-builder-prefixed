...
final class SetAwareConfigResolverTest extends \_PhpScoperedfa898a454f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperedfa898a454f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperedfa898a454f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

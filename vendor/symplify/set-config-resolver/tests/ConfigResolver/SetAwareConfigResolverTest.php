...
final class SetAwareConfigResolverTest extends \_PhpScoper88e2bb777a57\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper88e2bb777a57\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper88e2bb777a57\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

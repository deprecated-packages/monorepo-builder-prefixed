...
final class SetAwareConfigResolverTest extends \_PhpScoper2f9b0ac741dd\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper2f9b0ac741dd\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper2f9b0ac741dd\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoperddf2171d3d2c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperddf2171d3d2c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperddf2171d3d2c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

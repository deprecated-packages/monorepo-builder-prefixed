...
final class SetAwareConfigResolverTest extends \_PhpScoper1ceaf4cbd5cb\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper1ceaf4cbd5cb\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper1ceaf4cbd5cb\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

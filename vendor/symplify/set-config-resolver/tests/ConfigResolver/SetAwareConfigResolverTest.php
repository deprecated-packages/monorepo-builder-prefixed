...
final class SetAwareConfigResolverTest extends \_PhpScoperda849baa4a45\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperda849baa4a45\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperda849baa4a45\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

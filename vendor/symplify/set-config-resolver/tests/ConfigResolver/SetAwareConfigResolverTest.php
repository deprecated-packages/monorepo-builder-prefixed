...
final class SetAwareConfigResolverTest extends \_PhpScoper09a4cc789a22\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper09a4cc789a22\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper09a4cc789a22\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScopere97aad8070b4\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopere97aad8070b4\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopere97aad8070b4\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper31b05558ad5c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper31b05558ad5c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper31b05558ad5c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

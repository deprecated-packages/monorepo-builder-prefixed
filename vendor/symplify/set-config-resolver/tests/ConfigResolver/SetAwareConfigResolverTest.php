...
final class SetAwareConfigResolverTest extends \_PhpScoper7609e473a4cb\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper7609e473a4cb\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper7609e473a4cb\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScopercdfd316eda69\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopercdfd316eda69\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopercdfd316eda69\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

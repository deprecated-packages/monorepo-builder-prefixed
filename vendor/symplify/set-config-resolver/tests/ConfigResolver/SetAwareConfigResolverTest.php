...
final class SetAwareConfigResolverTest extends \_PhpScoper22d98a58be40\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper22d98a58be40\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper22d98a58be40\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

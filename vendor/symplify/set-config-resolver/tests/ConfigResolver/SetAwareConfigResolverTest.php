...
final class SetAwareConfigResolverTest extends \_PhpScoper777981beaf84\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper777981beaf84\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper777981beaf84\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

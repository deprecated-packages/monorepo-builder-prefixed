...
final class SetAwareConfigResolverTest extends \_PhpScoper66a1b4bf441c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper66a1b4bf441c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper66a1b4bf441c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

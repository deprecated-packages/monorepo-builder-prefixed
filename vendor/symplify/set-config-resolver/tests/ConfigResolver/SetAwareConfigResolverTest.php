...
final class SetAwareConfigResolverTest extends \_PhpScoper8a421ef9d4c6\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper8a421ef9d4c6\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper8a421ef9d4c6\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

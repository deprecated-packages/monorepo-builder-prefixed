...
final class SetAwareConfigResolverTest extends \_PhpScoper716f383f1097\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper716f383f1097\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper716f383f1097\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoperf237fc62366a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf237fc62366a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf237fc62366a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper674f850a9604\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper674f850a9604\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper674f850a9604\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

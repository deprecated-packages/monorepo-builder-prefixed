...
final class SetAwareConfigResolverTest extends \_PhpScoperd659a053ca1c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperd659a053ca1c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperd659a053ca1c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

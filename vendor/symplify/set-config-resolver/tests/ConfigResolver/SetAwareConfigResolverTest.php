...
final class SetAwareConfigResolverTest extends \_PhpScoper37887d2f9246\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper37887d2f9246\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper37887d2f9246\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

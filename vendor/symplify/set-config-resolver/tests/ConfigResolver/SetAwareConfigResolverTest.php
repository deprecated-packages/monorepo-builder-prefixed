...
final class SetAwareConfigResolverTest extends \_PhpScoper621122bdc380\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper621122bdc380\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper621122bdc380\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

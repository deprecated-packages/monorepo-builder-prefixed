...
final class SetAwareConfigResolverTest extends \_PhpScoper3c46f40844ed\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper3c46f40844ed\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper3c46f40844ed\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

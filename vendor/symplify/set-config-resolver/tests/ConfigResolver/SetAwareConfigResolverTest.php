...
final class SetAwareConfigResolverTest extends \_PhpScoper897dcdb71069\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper897dcdb71069\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper897dcdb71069\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

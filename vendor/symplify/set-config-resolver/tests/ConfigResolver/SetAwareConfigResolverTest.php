...
final class SetAwareConfigResolverTest extends \_PhpScopera2bd9a9af620\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera2bd9a9af620\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera2bd9a9af620\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

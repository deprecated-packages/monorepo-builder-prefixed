...
final class SetAwareConfigResolverTest extends \_PhpScoper120e1a259c7c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper120e1a259c7c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper120e1a259c7c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

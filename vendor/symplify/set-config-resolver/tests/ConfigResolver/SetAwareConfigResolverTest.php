...
final class SetAwareConfigResolverTest extends \_PhpScoper31a2d0e8f655\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper31a2d0e8f655\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper31a2d0e8f655\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper6786b40fc02e\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper6786b40fc02e\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper6786b40fc02e\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

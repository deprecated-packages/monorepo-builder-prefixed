...
final class SetAwareConfigResolverTest extends \_PhpScoperf2e2fcfe7ee6\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf2e2fcfe7ee6\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf2e2fcfe7ee6\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

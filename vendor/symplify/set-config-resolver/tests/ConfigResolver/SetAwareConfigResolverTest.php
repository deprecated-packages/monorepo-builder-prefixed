...
final class SetAwareConfigResolverTest extends \_PhpScoperf4d251e01a80\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf4d251e01a80\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf4d251e01a80\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

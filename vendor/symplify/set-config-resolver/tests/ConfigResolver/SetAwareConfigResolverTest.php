...
final class SetAwareConfigResolverTest extends \_PhpScoper57793da194f3\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper57793da194f3\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper57793da194f3\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

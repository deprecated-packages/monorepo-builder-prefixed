...
final class SetAwareConfigResolverTest extends \_PhpScoper68e56c1b5bd9\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper68e56c1b5bd9\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper68e56c1b5bd9\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

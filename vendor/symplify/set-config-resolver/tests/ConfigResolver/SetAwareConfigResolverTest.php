...
final class SetAwareConfigResolverTest extends \_PhpScoper9175a5176ce9\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper9175a5176ce9\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper9175a5176ce9\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

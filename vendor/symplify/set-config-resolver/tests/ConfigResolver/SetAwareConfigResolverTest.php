...
final class SetAwareConfigResolverTest extends \_PhpScoper1600de59048a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper1600de59048a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper1600de59048a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper674b08d66902\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper674b08d66902\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper674b08d66902\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

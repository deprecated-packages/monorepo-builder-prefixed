...
final class SetAwareConfigResolverTest extends \_PhpScoper1411c9dba342\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper1411c9dba342\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper1411c9dba342\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

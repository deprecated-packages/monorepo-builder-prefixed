...
final class SetAwareConfigResolverTest extends \_PhpScoperabca9a64438b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperabca9a64438b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperabca9a64438b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

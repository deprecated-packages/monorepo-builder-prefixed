...
final class SetAwareConfigResolverTest extends \_PhpScoper9e91fe07dbdd\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper9e91fe07dbdd\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper9e91fe07dbdd\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper7d1be3c5de07\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper7d1be3c5de07\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper7d1be3c5de07\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper44d485ef56a2\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper44d485ef56a2\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper44d485ef56a2\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

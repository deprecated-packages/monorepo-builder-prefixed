...
final class SetAwareConfigResolverTest extends \_PhpScoper15dc67236b17\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper15dc67236b17\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper15dc67236b17\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

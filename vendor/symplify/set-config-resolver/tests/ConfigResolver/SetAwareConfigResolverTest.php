...
final class SetAwareConfigResolverTest extends \_PhpScoperd2185c67a4b4\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperd2185c67a4b4\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperd2185c67a4b4\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

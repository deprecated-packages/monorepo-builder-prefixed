...
final class SetAwareConfigResolverTest extends \_PhpScoper79999b045682\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper79999b045682\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper79999b045682\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

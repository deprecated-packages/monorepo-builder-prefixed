...
final class SetAwareConfigResolverTest extends \_PhpScoper6f057cf7ca7c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper6f057cf7ca7c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper6f057cf7ca7c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

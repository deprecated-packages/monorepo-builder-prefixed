...
final class SetAwareConfigResolverTest extends \_PhpScoperaff2103cee1d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperaff2103cee1d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperaff2103cee1d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper6c30e6f631ea\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper6c30e6f631ea\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper6c30e6f631ea\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

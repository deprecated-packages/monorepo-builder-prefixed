...
final class SetAwareConfigResolverTest extends \_PhpScoperf8eaec7affbd\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf8eaec7affbd\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf8eaec7affbd\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

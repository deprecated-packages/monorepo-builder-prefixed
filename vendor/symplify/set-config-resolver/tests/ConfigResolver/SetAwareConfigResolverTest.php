...
final class SetAwareConfigResolverTest extends \_PhpScoper0f23ef1f1d10\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0f23ef1f1d10\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0f23ef1f1d10\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

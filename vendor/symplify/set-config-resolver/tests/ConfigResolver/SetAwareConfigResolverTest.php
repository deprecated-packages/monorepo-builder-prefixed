...
final class SetAwareConfigResolverTest extends \_PhpScoper30f4a2553084\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper30f4a2553084\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper30f4a2553084\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

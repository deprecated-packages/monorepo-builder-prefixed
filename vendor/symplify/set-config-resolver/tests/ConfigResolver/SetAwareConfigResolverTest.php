...
final class SetAwareConfigResolverTest extends \_PhpScoper0fa0b2363a34\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0fa0b2363a34\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0fa0b2363a34\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

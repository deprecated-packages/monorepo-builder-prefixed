...
final class SetAwareConfigResolverTest extends \_PhpScoper47e141fb470a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper47e141fb470a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper47e141fb470a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

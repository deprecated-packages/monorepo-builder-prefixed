...
final class SetAwareConfigResolverTest extends \_PhpScoper4cbad741edc5\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper4cbad741edc5\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper4cbad741edc5\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

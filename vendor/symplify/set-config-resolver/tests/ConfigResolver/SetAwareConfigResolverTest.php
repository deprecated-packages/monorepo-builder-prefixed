...
final class SetAwareConfigResolverTest extends \_PhpScoper3a64dbb4e14f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper3a64dbb4e14f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper3a64dbb4e14f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

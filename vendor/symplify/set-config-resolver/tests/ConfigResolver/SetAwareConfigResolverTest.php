...
final class SetAwareConfigResolverTest extends \_PhpScoper931cda798d50\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper931cda798d50\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper931cda798d50\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

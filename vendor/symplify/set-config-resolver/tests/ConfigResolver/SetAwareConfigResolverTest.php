...
final class SetAwareConfigResolverTest extends \_PhpScoper450cfab1c22b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper450cfab1c22b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper450cfab1c22b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

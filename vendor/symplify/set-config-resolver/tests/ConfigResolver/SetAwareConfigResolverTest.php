...
final class SetAwareConfigResolverTest extends \_PhpScoper1c1f12bbe5a7\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper1c1f12bbe5a7\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper1c1f12bbe5a7\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

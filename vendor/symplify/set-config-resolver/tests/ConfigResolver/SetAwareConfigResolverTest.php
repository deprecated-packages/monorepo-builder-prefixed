...
final class SetAwareConfigResolverTest extends \_PhpScoper46d05083fbc3\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper46d05083fbc3\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper46d05083fbc3\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

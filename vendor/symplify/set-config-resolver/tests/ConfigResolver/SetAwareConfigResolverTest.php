...
final class SetAwareConfigResolverTest extends \_PhpScoper722a1d9fee2c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper722a1d9fee2c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper722a1d9fee2c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

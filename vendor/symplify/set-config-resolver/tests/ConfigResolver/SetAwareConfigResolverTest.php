...
final class SetAwareConfigResolverTest extends \_PhpScoper2e873f93a162\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper2e873f93a162\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper2e873f93a162\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

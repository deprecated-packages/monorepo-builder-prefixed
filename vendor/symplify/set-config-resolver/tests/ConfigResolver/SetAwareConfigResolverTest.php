...
final class SetAwareConfigResolverTest extends \_PhpScoperbb737891eded\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperbb737891eded\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperbb737891eded\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

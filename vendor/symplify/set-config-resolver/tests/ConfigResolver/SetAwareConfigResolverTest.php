...
final class SetAwareConfigResolverTest extends \_PhpScoperd410cf9baa15\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperd410cf9baa15\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperd410cf9baa15\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

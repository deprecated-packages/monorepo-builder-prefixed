...
final class SetAwareConfigResolverTest extends \_PhpScoper7b254e6a7108\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper7b254e6a7108\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper7b254e6a7108\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

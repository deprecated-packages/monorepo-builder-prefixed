...
final class SetAwareConfigResolverTest extends \_PhpScoper39d95f01712b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper39d95f01712b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper39d95f01712b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper62cf10e7b378\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper62cf10e7b378\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper62cf10e7b378\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

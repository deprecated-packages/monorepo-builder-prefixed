...
final class SetAwareConfigResolverTest extends \_PhpScoperab3ccffcffcd\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperab3ccffcffcd\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperab3ccffcffcd\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

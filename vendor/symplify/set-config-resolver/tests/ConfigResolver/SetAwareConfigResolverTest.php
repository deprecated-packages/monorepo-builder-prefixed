...
final class SetAwareConfigResolverTest extends \_PhpScoper018f70acf6cc\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper018f70acf6cc\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper018f70acf6cc\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

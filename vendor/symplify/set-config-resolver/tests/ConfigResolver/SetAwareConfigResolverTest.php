...
final class SetAwareConfigResolverTest extends \_PhpScoper6d6e02e9c455\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper6d6e02e9c455\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper6d6e02e9c455\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScopereb7fcd8f999a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopereb7fcd8f999a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopereb7fcd8f999a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

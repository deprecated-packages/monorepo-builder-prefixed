...
final class SetAwareConfigResolverTest extends \_PhpScoperdfa889d8967a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperdfa889d8967a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperdfa889d8967a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

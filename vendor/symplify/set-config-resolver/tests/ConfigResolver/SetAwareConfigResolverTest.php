...
final class SetAwareConfigResolverTest extends \_PhpScopercd5c1af09a49\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopercd5c1af09a49\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopercd5c1af09a49\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

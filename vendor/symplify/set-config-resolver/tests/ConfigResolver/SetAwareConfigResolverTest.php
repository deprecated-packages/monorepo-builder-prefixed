...
final class SetAwareConfigResolverTest extends \_PhpScoperfa7966ff486f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperfa7966ff486f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperfa7966ff486f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

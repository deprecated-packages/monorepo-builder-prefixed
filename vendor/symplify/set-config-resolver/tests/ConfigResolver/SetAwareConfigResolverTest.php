...
final class SetAwareConfigResolverTest extends \_PhpScoper8a1d608a1a7e\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper8a1d608a1a7e\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper8a1d608a1a7e\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

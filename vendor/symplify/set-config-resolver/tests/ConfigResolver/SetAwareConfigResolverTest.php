...
final class SetAwareConfigResolverTest extends \_PhpScoper416e75c46c6e\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper416e75c46c6e\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper416e75c46c6e\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper9e0a2007d758\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper9e0a2007d758\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper9e0a2007d758\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper55b61aca61e8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper55b61aca61e8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper55b61aca61e8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoperc693a7d83f11\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperc693a7d83f11\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperc693a7d83f11\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

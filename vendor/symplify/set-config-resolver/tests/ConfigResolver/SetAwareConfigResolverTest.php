...
final class SetAwareConfigResolverTest extends \_PhpScoperce084f4275dd\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperce084f4275dd\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperce084f4275dd\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoperfd1a6a0ee9af\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperfd1a6a0ee9af\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperfd1a6a0ee9af\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

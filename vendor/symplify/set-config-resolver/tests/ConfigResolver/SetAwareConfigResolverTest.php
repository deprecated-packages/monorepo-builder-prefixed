...
final class SetAwareConfigResolverTest extends \_PhpScopereaa2cae8e093\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopereaa2cae8e093\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopereaa2cae8e093\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper84d68f9a1b63\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper84d68f9a1b63\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper84d68f9a1b63\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

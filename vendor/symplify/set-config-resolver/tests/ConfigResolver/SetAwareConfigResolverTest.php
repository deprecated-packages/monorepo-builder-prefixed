...
final class SetAwareConfigResolverTest extends \_PhpScoper12f30d5eda15\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper12f30d5eda15\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper12f30d5eda15\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

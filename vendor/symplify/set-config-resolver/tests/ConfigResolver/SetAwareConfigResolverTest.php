...
final class SetAwareConfigResolverTest extends \_PhpScoper6bfbe5ea8949\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper6bfbe5ea8949\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper6bfbe5ea8949\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

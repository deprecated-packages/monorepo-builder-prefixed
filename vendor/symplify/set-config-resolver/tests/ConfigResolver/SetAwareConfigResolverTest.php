...
final class SetAwareConfigResolverTest extends \_PhpScoper36654c852ab2\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper36654c852ab2\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper36654c852ab2\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

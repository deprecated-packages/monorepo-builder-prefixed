...
final class SetAwareConfigResolverTest extends \_PhpScoper131024327b3f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper131024327b3f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper131024327b3f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper204b3b8f3e0d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper204b3b8f3e0d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper204b3b8f3e0d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

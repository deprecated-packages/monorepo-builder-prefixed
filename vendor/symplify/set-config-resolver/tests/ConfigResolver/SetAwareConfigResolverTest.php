...
final class SetAwareConfigResolverTest extends \_PhpScoper3ac0b040c6af\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper3ac0b040c6af\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper3ac0b040c6af\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

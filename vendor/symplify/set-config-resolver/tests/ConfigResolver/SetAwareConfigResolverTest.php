...
final class SetAwareConfigResolverTest extends \_PhpScoper7cc068f3f5d1\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper7cc068f3f5d1\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper7cc068f3f5d1\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

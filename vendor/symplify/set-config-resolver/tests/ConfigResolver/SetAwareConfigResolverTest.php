...
final class SetAwareConfigResolverTest extends \_PhpScoperb0f70d760c3d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperb0f70d760c3d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperb0f70d760c3d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

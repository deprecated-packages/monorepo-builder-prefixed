...
final class SetAwareConfigResolverTest extends \_PhpScoperc41e8050ff3f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperc41e8050ff3f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperc41e8050ff3f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

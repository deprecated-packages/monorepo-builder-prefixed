...
final class SetAwareConfigResolverTest extends \_PhpScoper711ac919263f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper711ac919263f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper711ac919263f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

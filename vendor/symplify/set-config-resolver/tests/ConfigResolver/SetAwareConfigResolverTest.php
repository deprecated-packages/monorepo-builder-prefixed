...
final class SetAwareConfigResolverTest extends \_PhpScoper14531b498d75\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper14531b498d75\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper14531b498d75\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

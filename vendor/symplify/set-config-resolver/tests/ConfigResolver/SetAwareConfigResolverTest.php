...
final class SetAwareConfigResolverTest extends \_PhpScoperf968abd60cb0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf968abd60cb0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf968abd60cb0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

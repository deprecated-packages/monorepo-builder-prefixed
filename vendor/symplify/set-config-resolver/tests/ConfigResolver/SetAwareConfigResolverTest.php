...
final class SetAwareConfigResolverTest extends \_PhpScoper227dea868235\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper227dea868235\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper227dea868235\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

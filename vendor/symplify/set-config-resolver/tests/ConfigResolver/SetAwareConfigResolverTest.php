...
final class SetAwareConfigResolverTest extends \_PhpScoper503cab241f82\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper503cab241f82\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper503cab241f82\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

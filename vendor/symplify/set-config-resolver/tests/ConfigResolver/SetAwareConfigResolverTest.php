...
final class SetAwareConfigResolverTest extends \_PhpScoper87c95ce1b4e5\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper87c95ce1b4e5\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper87c95ce1b4e5\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

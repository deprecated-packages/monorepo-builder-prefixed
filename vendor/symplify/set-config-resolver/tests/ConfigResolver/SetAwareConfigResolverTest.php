...
final class SetAwareConfigResolverTest extends \_PhpScoperc00d4390f333\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperc00d4390f333\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperc00d4390f333\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper0217ecc5969a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0217ecc5969a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0217ecc5969a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper34ecf47f3155\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper34ecf47f3155\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper34ecf47f3155\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoperaf523e5605cc\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperaf523e5605cc\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperaf523e5605cc\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

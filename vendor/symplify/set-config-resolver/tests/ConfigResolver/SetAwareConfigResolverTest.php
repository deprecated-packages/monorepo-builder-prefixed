...
final class SetAwareConfigResolverTest extends \_PhpScoper61d2aa534566\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper61d2aa534566\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper61d2aa534566\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

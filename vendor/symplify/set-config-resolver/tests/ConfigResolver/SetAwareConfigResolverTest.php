...
final class SetAwareConfigResolverTest extends \_PhpScoperf4997c409394\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf4997c409394\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf4997c409394\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

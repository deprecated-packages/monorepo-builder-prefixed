...
final class SetAwareConfigResolverTest extends \_PhpScoperdd624bbcb4e5\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperdd624bbcb4e5\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperdd624bbcb4e5\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

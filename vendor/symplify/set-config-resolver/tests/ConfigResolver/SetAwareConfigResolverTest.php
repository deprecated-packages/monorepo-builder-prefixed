...
final class SetAwareConfigResolverTest extends \_PhpScoperad5317739bda\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperad5317739bda\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperad5317739bda\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

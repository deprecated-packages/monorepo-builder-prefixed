...
final class SetAwareConfigResolverTest extends \_PhpScoper1c9ce01e7be6\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper1c9ce01e7be6\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper1c9ce01e7be6\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

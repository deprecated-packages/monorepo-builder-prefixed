...
final class SetAwareConfigResolverTest extends \_PhpScoper4c089bfbbc1b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper4c089bfbbc1b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper4c089bfbbc1b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

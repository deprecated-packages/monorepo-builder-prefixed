...
final class SetAwareConfigResolverTest extends \_PhpScoper3c875050d97b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper3c875050d97b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper3c875050d97b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScopere10afbb60721\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopere10afbb60721\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopere10afbb60721\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScopercdc90a6628b6\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopercdc90a6628b6\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopercdc90a6628b6\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper8e7700b08cb9\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper8e7700b08cb9\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper8e7700b08cb9\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

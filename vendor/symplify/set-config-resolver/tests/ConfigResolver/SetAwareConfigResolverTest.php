...
final class SetAwareConfigResolverTest extends \_PhpScoper058a557299a1\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper058a557299a1\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper058a557299a1\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

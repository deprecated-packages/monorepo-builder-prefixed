...
final class SetAwareConfigResolverTest extends \_PhpScopera1d8e0344ecf\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera1d8e0344ecf\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera1d8e0344ecf\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

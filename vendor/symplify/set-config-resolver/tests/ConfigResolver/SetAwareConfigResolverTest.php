...
final class SetAwareConfigResolverTest extends \_PhpScoper0dbf6264e8b4\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0dbf6264e8b4\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0dbf6264e8b4\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

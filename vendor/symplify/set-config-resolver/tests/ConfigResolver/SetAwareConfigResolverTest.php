...
final class SetAwareConfigResolverTest extends \_PhpScoper860bc98a0f96\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper860bc98a0f96\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper860bc98a0f96\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

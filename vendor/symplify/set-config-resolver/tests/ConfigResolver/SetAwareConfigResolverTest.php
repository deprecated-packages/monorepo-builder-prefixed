...
final class SetAwareConfigResolverTest extends \_PhpScoper905a278e297d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper905a278e297d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper905a278e297d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

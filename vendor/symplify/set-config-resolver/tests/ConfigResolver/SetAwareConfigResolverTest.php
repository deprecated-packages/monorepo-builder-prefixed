...
final class SetAwareConfigResolverTest extends \_PhpScoper3bda9af7e0fd\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper3bda9af7e0fd\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper3bda9af7e0fd\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

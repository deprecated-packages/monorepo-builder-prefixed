...
final class SetAwareConfigResolverTest extends \_PhpScopera85504f0ea7b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera85504f0ea7b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera85504f0ea7b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper47ce95ac3375\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper47ce95ac3375\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper47ce95ac3375\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

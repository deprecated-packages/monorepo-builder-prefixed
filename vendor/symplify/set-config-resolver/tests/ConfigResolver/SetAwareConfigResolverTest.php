...
final class SetAwareConfigResolverTest extends \_PhpScoper5e83c3f77e04\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper5e83c3f77e04\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper5e83c3f77e04\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

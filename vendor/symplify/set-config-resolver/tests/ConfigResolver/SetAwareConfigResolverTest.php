...
final class SetAwareConfigResolverTest extends \_PhpScoper8068fe8d25a3\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper8068fe8d25a3\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper8068fe8d25a3\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

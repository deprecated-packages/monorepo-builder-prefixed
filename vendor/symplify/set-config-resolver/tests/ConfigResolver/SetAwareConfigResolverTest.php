...
final class SetAwareConfigResolverTest extends \_PhpScoper1ff8e175c295\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper1ff8e175c295\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper1ff8e175c295\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

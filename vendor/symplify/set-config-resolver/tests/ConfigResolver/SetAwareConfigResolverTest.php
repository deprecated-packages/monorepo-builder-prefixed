...
final class SetAwareConfigResolverTest extends \_PhpScoper0087e037e0f7\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0087e037e0f7\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0087e037e0f7\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

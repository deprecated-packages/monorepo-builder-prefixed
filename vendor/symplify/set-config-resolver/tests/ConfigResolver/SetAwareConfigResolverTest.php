...
final class SetAwareConfigResolverTest extends \_PhpScoperb25e75e9febe\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperb25e75e9febe\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperb25e75e9febe\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

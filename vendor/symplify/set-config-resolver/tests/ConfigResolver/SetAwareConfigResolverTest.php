...
final class SetAwareConfigResolverTest extends \_PhpScoper654dfdb702e5\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper654dfdb702e5\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper654dfdb702e5\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper8f797d20934a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper8f797d20934a\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper8f797d20934a\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper9dd242015966\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper9dd242015966\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper9dd242015966\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

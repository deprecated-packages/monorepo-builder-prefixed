...
final class SetAwareConfigResolverTest extends \_PhpScopera2f1d1d42b88\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera2f1d1d42b88\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera2f1d1d42b88\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

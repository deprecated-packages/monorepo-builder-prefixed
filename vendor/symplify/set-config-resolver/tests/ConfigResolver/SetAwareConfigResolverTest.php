...
final class SetAwareConfigResolverTest extends \_PhpScoper80b6fe7627f7\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper80b6fe7627f7\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper80b6fe7627f7\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper0773dc025ec9\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0773dc025ec9\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0773dc025ec9\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

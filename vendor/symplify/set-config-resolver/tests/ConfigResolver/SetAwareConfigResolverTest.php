...
final class SetAwareConfigResolverTest extends \_PhpScoper50e98fdc5bc0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper50e98fdc5bc0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper50e98fdc5bc0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoperd4e30d8318e8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperd4e30d8318e8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperd4e30d8318e8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

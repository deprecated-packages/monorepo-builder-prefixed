...
final class SetAwareConfigResolverTest extends \_PhpScoper6b92aa0ec16f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper6b92aa0ec16f\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper6b92aa0ec16f\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

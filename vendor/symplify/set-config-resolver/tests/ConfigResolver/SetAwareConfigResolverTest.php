...
final class SetAwareConfigResolverTest extends \_PhpScoper437fa56c88e1\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper437fa56c88e1\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper437fa56c88e1\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

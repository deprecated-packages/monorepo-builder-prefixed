...
final class SetAwareConfigResolverTest extends \_PhpScoper0ad68a106f23\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper0ad68a106f23\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper0ad68a106f23\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

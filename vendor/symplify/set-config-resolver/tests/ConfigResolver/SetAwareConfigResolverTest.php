...
final class SetAwareConfigResolverTest extends \_PhpScoper600b802aef08\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper600b802aef08\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper600b802aef08\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

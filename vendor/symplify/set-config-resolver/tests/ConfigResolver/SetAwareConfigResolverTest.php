...
final class SetAwareConfigResolverTest extends \_PhpScoper323d4c178bee\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper323d4c178bee\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper323d4c178bee\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper4a734d287afc\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper4a734d287afc\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper4a734d287afc\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoperdfdcb3d4cca0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperdfdcb3d4cca0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperdfdcb3d4cca0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

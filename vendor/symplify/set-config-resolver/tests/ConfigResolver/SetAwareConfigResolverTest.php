...
final class SetAwareConfigResolverTest extends \_PhpScoper27e2e7523871\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper27e2e7523871\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper27e2e7523871\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

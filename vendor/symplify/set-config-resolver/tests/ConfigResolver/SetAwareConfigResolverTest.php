...
final class SetAwareConfigResolverTest extends \_PhpScoper95e170f0b4ac\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper95e170f0b4ac\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper95e170f0b4ac\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

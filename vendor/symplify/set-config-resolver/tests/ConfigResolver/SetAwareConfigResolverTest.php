...
final class SetAwareConfigResolverTest extends \_PhpScoperd79f30a2f8be\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperd79f30a2f8be\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperd79f30a2f8be\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

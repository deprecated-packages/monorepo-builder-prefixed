...
final class SetAwareConfigResolverTest extends \_PhpScoperc0b8351d879b\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperc0b8351d879b\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperc0b8351d879b\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

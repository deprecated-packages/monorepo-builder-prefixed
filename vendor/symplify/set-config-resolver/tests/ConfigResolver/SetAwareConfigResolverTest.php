...
final class SetAwareConfigResolverTest extends \_PhpScopera5e5d165d78c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopera5e5d165d78c\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopera5e5d165d78c\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper8d3e33bd2be8\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper8d3e33bd2be8\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper8d3e33bd2be8\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper3c4d71e1434d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper3c4d71e1434d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper3c4d71e1434d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScopercd844fca8af3\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScopercd844fca8af3\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScopercd844fca8af3\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

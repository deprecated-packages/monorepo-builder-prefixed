...
final class SetAwareConfigResolverTest extends \_PhpScoper68683f91c63d\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper68683f91c63d\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper68683f91c63d\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

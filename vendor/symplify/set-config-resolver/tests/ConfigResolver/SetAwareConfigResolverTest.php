...
final class SetAwareConfigResolverTest extends \_PhpScoper650fbdd90fa0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper650fbdd90fa0\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper650fbdd90fa0\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper3c696cbcc510\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper3c696cbcc510\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper3c696cbcc510\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

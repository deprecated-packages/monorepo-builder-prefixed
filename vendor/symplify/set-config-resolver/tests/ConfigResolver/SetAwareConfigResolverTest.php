...
final class SetAwareConfigResolverTest extends \_PhpScoper43a95e2f69bc\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper43a95e2f69bc\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper43a95e2f69bc\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

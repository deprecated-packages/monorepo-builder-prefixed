...
final class SetAwareConfigResolverTest extends \_PhpScoper00f012948171\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper00f012948171\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper00f012948171\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

...
final class SetAwareConfigResolverTest extends \_PhpScoper7371f586a1d2\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoper7371f586a1d2\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoper7371f586a1d2\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

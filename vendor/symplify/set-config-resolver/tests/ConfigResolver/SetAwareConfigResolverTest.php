...
final class SetAwareConfigResolverTest extends \_PhpScoperf78d2b40800e\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $resolvedConfigFileInfo = $this->setAwareConfigResolver->resolveFromInput(new \_PhpScoperf78d2b40800e\Symfony\Component\Console\Input\ArrayInput($options));
    ...
    public function testMissingFileInInput() : void
    {
        ...
        $arrayInput = new \_PhpScoperf78d2b40800e\Symfony\Component\Console\Input\ArrayInput(['--config' => 'someFile.yml']);

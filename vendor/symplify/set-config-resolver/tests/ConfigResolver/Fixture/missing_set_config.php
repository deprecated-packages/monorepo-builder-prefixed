...
use _PhpScoper0677321b414b\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer;
...
return static function (\_PhpScoper0677321b414b\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper0677321b414b\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer::class)->call('configure', [['syntax' => 'short']]);
};

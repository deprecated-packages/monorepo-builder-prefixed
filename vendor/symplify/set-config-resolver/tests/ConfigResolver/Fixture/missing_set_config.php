...
use _PhpScoper50e98fdc5bc0\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer;
...
return static function (\_PhpScoper50e98fdc5bc0\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper50e98fdc5bc0\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer::class)->call('configure', [['syntax' => 'short']]);
};

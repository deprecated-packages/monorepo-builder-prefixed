...
use _PhpScoper9aac61c94bdb\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer;
...
return static function (\_PhpScoper9aac61c94bdb\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper9aac61c94bdb\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer::class)->call('configure', [['syntax' => 'short']]);
};

...
use _PhpScoper29aa9f1ba53d\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer;
...
return static function (\_PhpScoper29aa9f1ba53d\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper29aa9f1ba53d\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer::class)->call('configure', [['syntax' => 'short']]);
};

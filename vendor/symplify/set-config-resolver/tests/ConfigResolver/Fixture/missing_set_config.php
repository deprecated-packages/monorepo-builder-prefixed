...
use _PhpScoper1e8bd38a2146\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer;
...
return static function (\_PhpScoper1e8bd38a2146\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper1e8bd38a2146\PhpCsFixer\Fixer\ArrayNotation\ArraySyntaxFixer::class)->call('configure', [['syntax' => 'short']]);
};

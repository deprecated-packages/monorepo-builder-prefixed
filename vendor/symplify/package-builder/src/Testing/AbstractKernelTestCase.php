 ...
 */
abstract class AbstractKernelTestCase extends \_PhpScoper485f3a9238ad\PHPUnit\Framework\TestCase
{
    /**
     * @var KernelInterface
     */
     ...
     */
    protected function bootKernelWithConfigs(string $kernelClass, array $configs) : \_PhpScoper485f3a9238ad\Symfony\Component\HttpKernel\KernelInterface
    {
        ...
        if (!$kernel instanceof \_PhpScoper485f3a9238ad\Symfony\Component\HttpKernel\KernelInterface) {
    ...
    protected function ensureKernelShutdown() : void
    {
        if (static::$kernel !== null) {
            ...
            if ($kernel !== null) {
                ...
                if ($container instanceof \_PhpScoper485f3a9238ad\Symfony\Contracts\Service\ResetInterface) {
                    $container->reset();
                }
            }
        }
    ...
    private function ensureIsConfigAwareKernel(\_PhpScoper485f3a9238ad\Symfony\Component\HttpKernel\KernelInterface $kernel) : void
    {
    ...
    private function bootAndReturnKernel(\_PhpScoper485f3a9238ad\Symfony\Component\HttpKernel\KernelInterface $kernel) : \_PhpScoper485f3a9238ad\Symfony\Component\HttpKernel\KernelInterface
    {
        $kernel->boot();
        ...
        if (!$container instanceof \_PhpScoper485f3a9238ad\Symfony\Component\DependencyInjection\ContainerInterface) {
            throw new \Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
        // has output? keep it silent out of tests
        if ($container->has(\_PhpScoper485f3a9238ad\Symfony\Component\Console\Style\SymfonyStyle::class)) {
            $symfonyStyle = $container->get(\_PhpScoper485f3a9238ad\Symfony\Component\Console\Style\SymfonyStyle::class);
            $symfonyStyle->setVerbosity(\_PhpScoper485f3a9238ad\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET);
        }

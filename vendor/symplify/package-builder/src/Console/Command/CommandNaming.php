...
final class CommandNaming
{
     ...
     *  "SomeClass\SOMESuperCommand" → "some-super"
     */
    public function resolveFromCommand(\_PhpScoper437fa56c88e1\Symfony\Component\Console\Command\Command $command) : string
    {
    ...
    public static function classToName(string $class) : string
    {
        ...
        $rawCommandName = \_PhpScoper437fa56c88e1\Nette\Utils\Strings::substring($shortClassName, 0, -\strlen('Command'));
        // ECSCommand => ecs
        ...
        return \_PhpScoper437fa56c88e1\Nette\Utils\Strings::replace($rawCommandName, self::BIG_LETTER_REGEX, function (array $matches) : string {

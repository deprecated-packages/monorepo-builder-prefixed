...
final class CommandNaming
{
     ...
     *  "SomeClass\SOMESuperCommand" → "some-super"
     */
    public function resolveFromCommand(\_PhpScoperaf523e5605cc\Symfony\Component\Console\Command\Command $command) : string
    {
    ...
    public static function classToName(string $class) : string
    {
        ...
        $rawCommandName = \_PhpScoperaf523e5605cc\Nette\Utils\Strings::substring($shortClassName, 0, -\strlen('Command'));
        // ECSCommand => ecs
        ...
        return \_PhpScoperaf523e5605cc\Nette\Utils\Strings::replace($rawCommandName, self::BIG_LETTER_REGEX, function (array $matches) : string {

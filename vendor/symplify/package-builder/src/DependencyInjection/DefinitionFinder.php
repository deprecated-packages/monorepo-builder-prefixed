...
final class DefinitionFinder
{
     ...
     * @return Definition[]
     */
    public function findAllByType(\_PhpScoperb3d59f519671\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : array
    {
        $definitions = [];
    ...
    public function getByType(\_PhpScoperb3d59f519671\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : \_PhpScoperb3d59f519671\Symfony\Component\DependencyInjection\Definition
    {
    ...
    public function getByTypeIfExists(\_PhpScoperb3d59f519671\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : ?\_PhpScoperb3d59f519671\Symfony\Component\DependencyInjection\Definition
    {
        $containerBuilderDefinitions = $containerBuilder->getDefinitions();
        foreach ($containerBuilderDefinitions as $name => $definition) {
            $class = $definition->getClass() ?: $name;

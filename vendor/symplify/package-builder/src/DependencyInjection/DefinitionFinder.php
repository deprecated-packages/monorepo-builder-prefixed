...
final class DefinitionFinder
{
     ...
     * @return Definition[]
     */
    public function findAllByType(\_PhpScoper3c875050d97b\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : array
    {
        $definitions = [];
    ...
    public function getByType(\_PhpScoper3c875050d97b\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : \_PhpScoper3c875050d97b\Symfony\Component\DependencyInjection\Definition
    {
    ...
    public function getByTypeIfExists(\_PhpScoper3c875050d97b\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : ?\_PhpScoper3c875050d97b\Symfony\Component\DependencyInjection\Definition
    {
        $containerBuilderDefinitions = $containerBuilder->getDefinitions();
        foreach ($containerBuilderDefinitions as $name => $definition) {
            $class = $definition->getClass() ?: $name;

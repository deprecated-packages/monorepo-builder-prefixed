...
final class DefinitionFinder
{
     ...
     * @return Definition[]
     */
    public function findAllByType(\_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : array
    {
        $definitions = [];
    ...
    public function getByType(\_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : \_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\Definition
    {
    ...
    public function getByTypeIfExists(\_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, string $type) : ?\_PhpScoper9e91fe07dbdd\Symfony\Component\DependencyInjection\Definition
    {
        $containerBuilderDefinitions = $containerBuilder->getDefinitions();
        foreach ($containerBuilderDefinitions as $name => $definition) {
            $class = $definition->getClass() ?: $name;

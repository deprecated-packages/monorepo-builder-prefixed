...
use _PhpScoperf237fc62366a\Nette\Neon\Encoder;
use _PhpScoperf237fc62366a\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperf237fc62366a\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperf237fc62366a\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperf237fc62366a\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperf237fc62366a\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperf237fc62366a\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

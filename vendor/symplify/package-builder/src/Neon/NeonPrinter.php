...
use _PhpScopera5e5d165d78c\Nette\Neon\Encoder;
use _PhpScopera5e5d165d78c\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScopera5e5d165d78c\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScopera5e5d165d78c\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScopera5e5d165d78c\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScopera5e5d165d78c\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScopera5e5d165d78c\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

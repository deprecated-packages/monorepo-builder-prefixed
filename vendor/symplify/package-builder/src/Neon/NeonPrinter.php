...
use _PhpScoperaf523e5605cc\Nette\Neon\Encoder;
use _PhpScoperaf523e5605cc\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperaf523e5605cc\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperaf523e5605cc\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperaf523e5605cc\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperaf523e5605cc\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperaf523e5605cc\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

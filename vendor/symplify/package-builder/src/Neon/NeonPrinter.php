...
use _PhpScoperbb737891eded\Nette\Neon\Encoder;
use _PhpScoperbb737891eded\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperbb737891eded\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperbb737891eded\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperbb737891eded\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperbb737891eded\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperbb737891eded\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

...
use _PhpScoper416e75c46c6e\Nette\Neon\Encoder;
use _PhpScoper416e75c46c6e\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper416e75c46c6e\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper416e75c46c6e\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper416e75c46c6e\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper416e75c46c6e\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper416e75c46c6e\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

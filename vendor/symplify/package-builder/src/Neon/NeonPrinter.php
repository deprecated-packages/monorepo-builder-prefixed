...
use _PhpScoper204b3b8f3e0d\Nette\Neon\Encoder;
use _PhpScoper204b3b8f3e0d\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper204b3b8f3e0d\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper204b3b8f3e0d\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper204b3b8f3e0d\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper204b3b8f3e0d\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper204b3b8f3e0d\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

...
use _PhpScopera2ff5fd2b59c\Nette\Neon\Encoder;
use _PhpScopera2ff5fd2b59c\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScopera2ff5fd2b59c\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScopera2ff5fd2b59c\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScopera2ff5fd2b59c\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScopera2ff5fd2b59c\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScopera2ff5fd2b59c\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

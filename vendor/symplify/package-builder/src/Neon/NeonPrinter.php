...
use _PhpScoper4a734d287afc\Nette\Neon\Encoder;
use _PhpScoper4a734d287afc\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper4a734d287afc\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper4a734d287afc\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper4a734d287afc\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper4a734d287afc\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper4a734d287afc\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

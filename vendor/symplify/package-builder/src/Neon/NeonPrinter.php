...
use _PhpScoper03a47c44ad4f\Nette\Neon\Encoder;
use _PhpScoper03a47c44ad4f\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper03a47c44ad4f\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper03a47c44ad4f\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper03a47c44ad4f\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper03a47c44ad4f\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper03a47c44ad4f\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

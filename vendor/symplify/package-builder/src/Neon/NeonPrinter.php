...
use _PhpScoper600b802aef08\Nette\Neon\Encoder;
use _PhpScoper600b802aef08\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper600b802aef08\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper600b802aef08\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper600b802aef08\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper600b802aef08\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper600b802aef08\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

...
use _PhpScoper31b05558ad5c\Nette\Neon\Encoder;
use _PhpScoper31b05558ad5c\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoper31b05558ad5c\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoper31b05558ad5c\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoper31b05558ad5c\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoper31b05558ad5c\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoper31b05558ad5c\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

...
use _PhpScoperdfa889d8967a\Nette\Neon\Encoder;
use _PhpScoperdfa889d8967a\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \_PhpScoperdfa889d8967a\Nette\Neon\Neon::encode($phpStanNeon, \_PhpScoperdfa889d8967a\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \_PhpScoperdfa889d8967a\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \_PhpScoperdfa889d8967a\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \_PhpScoperdfa889d8967a\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}

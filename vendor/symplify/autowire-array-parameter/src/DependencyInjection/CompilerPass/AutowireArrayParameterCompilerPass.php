...
use _PhpScoperd8a347ec1761\Nette\Utils\Reflection;
use _PhpScoperd8a347ec1761\Nette\Utils\Strings;
use ReflectionClass;
 ...
 */
final class AutowireArrayParameterCompilerPass implements \_PhpScoperd8a347ec1761\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['_PhpScoperd8a347ec1761\\Symfony\\Component\\Form\\FormExtensionInterface', '_PhpScoperd8a347ec1761\\Symfony\\Component\\Asset\\PackageInterface', '_PhpScoperd8a347ec1761\\Symfony\\Component\\Config\\Loader\\LoaderInterface', '_PhpScoperd8a347ec1761\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', '_PhpScoperd8a347ec1761\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', '_PhpScoperd8a347ec1761\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', '_PhpScoperd8a347ec1761\\Sonata\\Doctrine\\Adapter\\AdapterChain', '_PhpScoperd8a347ec1761\\Sonata\\Twig\\Extension\\TemplateExtension'];
    /**
    ...
    public function process(\_PhpScoperd8a347ec1761\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
    ...
    private function shouldSkipDefinition(\_PhpScoperd8a347ec1761\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \_PhpScoperd8a347ec1761\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ((bool) \_PhpScoperd8a347ec1761\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\_PhpScoperd8a347ec1761\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \_PhpScoperd8a347ec1761\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function shouldSkipParameter(\ReflectionMethod $reflectionMethod, \_PhpScoperd8a347ec1761\Symfony\Component\DependencyInjection\Definition $definition, \ReflectionParameter $reflectionParameter) : bool
    {
    ...
    private function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $result = \_PhpScoperd8a347ec1761\Nette\Utils\Strings::match((string) $reflectionMethod->getDocComment(), $parameterDocTypeRegex);
        if ($result === null) {
            return null;
        }
        ...
        return \_PhpScoperd8a347ec1761\Nette\Utils\Reflection::expandClassName($result['type'], $reflectionMethod->getDeclaringClass());
    }
    /**
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \_PhpScoperd8a347ec1761\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }

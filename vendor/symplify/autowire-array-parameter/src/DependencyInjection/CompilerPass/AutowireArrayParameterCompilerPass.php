...
use _PhpScoperf701e46e48a5\Nette\Utils\Reflection;
 ...
 */
final class AutowireArrayParameterCompilerPass implements \_PhpScoperf701e46e48a5\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['_PhpScoperf701e46e48a5\\Symfony\\Component\\Form\\FormExtensionInterface', '_PhpScoperf701e46e48a5\\Symfony\\Component\\Asset\\PackageInterface', '_PhpScoperf701e46e48a5\\Symfony\\Component\\Config\\Loader\\LoaderInterface', '_PhpScoperf701e46e48a5\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', '_PhpScoperf701e46e48a5\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', '_PhpScoperf701e46e48a5\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', '_PhpScoperf701e46e48a5\\Sonata\\Doctrine\\Adapter\\AdapterChain', '_PhpScoperf701e46e48a5\\Sonata\\Twig\\Extension\\TemplateExtension'];
    /**
    ...
    private function shouldSkipDefinition(\_PhpScoperf701e46e48a5\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \_PhpScoperf701e46e48a5\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if (\_PhpScoperf701e46e48a5\Nette\Utils\Strings::match($resolvedClassName, '#^(' . \implode('|', self::EXCLUDED_NAMESPACES) . ')\\\\#')) {
            return \true;
        }
    ...
    private function processParameters(\_PhpScoperf701e46e48a5\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \_PhpScoperf701e46e48a5\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function shouldSkipParameter(\ReflectionMethod $reflectionMethod, \_PhpScoperf701e46e48a5\Symfony\Component\DependencyInjection\Definition $definition, \ReflectionParameter $reflectionParameter) : bool
    {
    ...
    private function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $result = \_PhpScoperf701e46e48a5\Nette\Utils\Strings::match((string) $reflectionMethod->getDocComment(), $parameterDocTypeRegex);
        if ($result === null) {
            return null;
        }
        ...
        return \_PhpScoperf701e46e48a5\Nette\Utils\Reflection::expandClassName($result['type'], $reflectionMethod->getDeclaringClass());
    }
    /**
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \_PhpScoperf701e46e48a5\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
}

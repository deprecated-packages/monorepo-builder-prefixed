...
use _PhpScoper416e75c46c6e\Nette\Utils\Reflection;
use _PhpScoper416e75c46c6e\Nette\Utils\Strings;
use ReflectionClass;
 ...
 */
final class AutowireArrayParameterCompilerPass implements \_PhpScoper416e75c46c6e\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['_PhpScoper416e75c46c6e\\Symfony\\Component\\Form\\FormExtensionInterface', '_PhpScoper416e75c46c6e\\Symfony\\Component\\Asset\\PackageInterface', '_PhpScoper416e75c46c6e\\Symfony\\Component\\Config\\Loader\\LoaderInterface', '_PhpScoper416e75c46c6e\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', '_PhpScoper416e75c46c6e\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', '_PhpScoper416e75c46c6e\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', '_PhpScoper416e75c46c6e\\Sonata\\Doctrine\\Adapter\\AdapterChain', '_PhpScoper416e75c46c6e\\Sonata\\Twig\\Extension\\TemplateExtension'];
    /**
    ...
    private function shouldSkipDefinition(\_PhpScoper416e75c46c6e\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \_PhpScoper416e75c46c6e\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ((bool) \_PhpScoper416e75c46c6e\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\_PhpScoper416e75c46c6e\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \_PhpScoper416e75c46c6e\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function shouldSkipParameter(\ReflectionMethod $reflectionMethod, \_PhpScoper416e75c46c6e\Symfony\Component\DependencyInjection\Definition $definition, \ReflectionParameter $reflectionParameter) : bool
    {
    ...
    private function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $result = \_PhpScoper416e75c46c6e\Nette\Utils\Strings::match((string) $reflectionMethod->getDocComment(), $parameterDocTypeRegex);
        if ($result === null) {
            return null;
        }
        ...
        return \_PhpScoper416e75c46c6e\Nette\Utils\Reflection::expandClassName($result['type'], $reflectionMethod->getDeclaringClass());
    }
    /**
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \_PhpScoper416e75c46c6e\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
}

...
use _PhpScoper1ff8e175c295\Nette\Utils\Reflection;
use _PhpScoper1ff8e175c295\Nette\Utils\Strings;
use ReflectionClass;
 ...
 */
final class AutowireArrayParameterCompilerPass implements \_PhpScoper1ff8e175c295\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['_PhpScoper1ff8e175c295\\Symfony\\Component\\Form\\FormExtensionInterface', '_PhpScoper1ff8e175c295\\Symfony\\Component\\Asset\\PackageInterface', '_PhpScoper1ff8e175c295\\Symfony\\Component\\Config\\Loader\\LoaderInterface', '_PhpScoper1ff8e175c295\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', '_PhpScoper1ff8e175c295\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', '_PhpScoper1ff8e175c295\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', '_PhpScoper1ff8e175c295\\Sonata\\Doctrine\\Adapter\\AdapterChain', '_PhpScoper1ff8e175c295\\Sonata\\Twig\\Extension\\TemplateExtension'];
    /**
    ...
    public function process(\_PhpScoper1ff8e175c295\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
    ...
    private function shouldSkipDefinition(\_PhpScoper1ff8e175c295\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \_PhpScoper1ff8e175c295\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ((bool) \_PhpScoper1ff8e175c295\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\_PhpScoper1ff8e175c295\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \_PhpScoper1ff8e175c295\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function shouldSkipParameter(\ReflectionMethod $reflectionMethod, \_PhpScoper1ff8e175c295\Symfony\Component\DependencyInjection\Definition $definition, \ReflectionParameter $reflectionParameter) : bool
    {
    ...
    private function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $result = \_PhpScoper1ff8e175c295\Nette\Utils\Strings::match((string) $reflectionMethod->getDocComment(), $parameterDocTypeRegex);
        if ($result === null) {
            return null;
        }
        ...
        return \_PhpScoper1ff8e175c295\Nette\Utils\Reflection::expandClassName($result['type'], $reflectionMethod->getDeclaringClass());
    }
    /**
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \_PhpScoper1ff8e175c295\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }

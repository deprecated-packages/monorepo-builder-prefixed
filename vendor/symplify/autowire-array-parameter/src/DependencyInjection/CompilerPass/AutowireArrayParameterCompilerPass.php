...
use _PhpScoperef96225926e2\Nette\Utils\Reflection;
 ...
 */
final class AutowireArrayParameterCompilerPass implements \_PhpScoperef96225926e2\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['_PhpScoperef96225926e2\\Symfony\\Component\\Form\\FormExtensionInterface', '_PhpScoperef96225926e2\\Symfony\\Component\\Asset\\PackageInterface', '_PhpScoperef96225926e2\\Symfony\\Component\\Config\\Loader\\LoaderInterface', '_PhpScoperef96225926e2\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', '_PhpScoperef96225926e2\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', '_PhpScoperef96225926e2\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', '_PhpScoperef96225926e2\\Sonata\\Doctrine\\Adapter\\AdapterChain', '_PhpScoperef96225926e2\\Sonata\\Twig\\Extension\\TemplateExtension'];
    /**
    ...
    public function process(\_PhpScoperef96225926e2\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
    ...
    private function shouldSkipDefinition(\_PhpScoperef96225926e2\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \_PhpScoperef96225926e2\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ((bool) \_PhpScoperef96225926e2\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\_PhpScoperef96225926e2\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \_PhpScoperef96225926e2\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function shouldSkipParameter(\ReflectionMethod $reflectionMethod, \_PhpScoperef96225926e2\Symfony\Component\DependencyInjection\Definition $definition, \ReflectionParameter $reflectionParameter) : bool
    {
    ...
    private function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $result = \_PhpScoperef96225926e2\Nette\Utils\Strings::match((string) $reflectionMethod->getDocComment(), $parameterDocTypeRegex);
        if ($result === null) {
            return null;
        }
        ...
        return \_PhpScoperef96225926e2\Nette\Utils\Reflection::expandClassName($result['type'], $reflectionMethod->getDeclaringClass());
    }
    /**
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \_PhpScoperef96225926e2\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }

...
use _PhpScoperc35444adb584\Nette\Utils\Reflection;
use _PhpScoperc35444adb584\Nette\Utils\Strings;
use ReflectionClass;
 ...
 */
final class AutowireArrayParameterCompilerPass implements \_PhpScoperc35444adb584\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     ...
     * @noRector
     */
    private $excludedFatalClasses = ['_PhpScoperc35444adb584\\Symfony\\Component\\Form\\FormExtensionInterface', '_PhpScoperc35444adb584\\Symfony\\Component\\Asset\\PackageInterface', '_PhpScoperc35444adb584\\Symfony\\Component\\Config\\Loader\\LoaderInterface', '_PhpScoperc35444adb584\\Symfony\\Component\\VarDumper\\Dumper\\ContextProvider\\ContextProviderInterface', '_PhpScoperc35444adb584\\EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\Configurator\\TypeConfiguratorInterface', '_PhpScoperc35444adb584\\Sonata\\CoreBundle\\Model\\Adapter\\AdapterInterface', '_PhpScoperc35444adb584\\Sonata\\Doctrine\\Adapter\\AdapterChain', '_PhpScoperc35444adb584\\Sonata\\Twig\\Extension\\TemplateExtension'];
    /**
    ...
    public function process(\_PhpScoperc35444adb584\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
    ...
    private function shouldSkipDefinition(\_PhpScoperc35444adb584\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \_PhpScoperc35444adb584\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ((bool) \_PhpScoperc35444adb584\Nette\Utils\Strings::match($resolvedClassName, $excludedNamespacePattern)) {
            return \true;
        }
    ...
    private function processParameters(\_PhpScoperc35444adb584\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, \ReflectionMethod $reflectionMethod, \_PhpScoperc35444adb584\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
    ...
    private function shouldSkipParameter(\ReflectionMethod $reflectionMethod, \_PhpScoperc35444adb584\Symfony\Component\DependencyInjection\Definition $definition, \ReflectionParameter $reflectionParameter) : bool
    {
    ...
    private function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $result = \_PhpScoperc35444adb584\Nette\Utils\Strings::match((string) $reflectionMethod->getDocComment(), $parameterDocTypeRegex);
        if ($result === null) {
            return null;
        }
        ...
        return \_PhpScoperc35444adb584\Nette\Utils\Reflection::expandClassName($result['type'], $reflectionMethod->getDeclaringClass());
    }
    /**
    ...
    private function createReferencesFromDefinitions(array $definitions) : array
    {
        ...
        foreach ($definitionOfTypeNames as $definitionOfTypeName) {
            $references[] = new \_PhpScoperc35444adb584\Symfony\Component\DependencyInjection\Reference($definitionOfTypeName);
        }
        return $references;
    }
}

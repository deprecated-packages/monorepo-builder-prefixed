...
final class ComposerJsonFactoryTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    /**
     * @var ComposerJson
     */
    ...
    public function test() : void
    {
        ...
        $this->assertInstanceOf(\Symplify\SmartFileSystem\SmartFileInfo::class, $fileInfo);
        ...
        $this->assertSame(['symplify/autodiscovery' => '^8.3.45'], $this->composerJson->getReplace());
    }
}

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper018f70acf6cc\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper018f70acf6cc\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper018f70acf6cc\Nette\Utils\Json::decode($fileContent, \_PhpScoper018f70acf6cc\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper018f70acf6cc\Nette\Utils\Json::encode($json, \_PhpScoper018f70acf6cc\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

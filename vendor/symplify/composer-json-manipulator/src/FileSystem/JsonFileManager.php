...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper09a4cc789a22\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper09a4cc789a22\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper09a4cc789a22\Nette\Utils\Json::decode($fileContent, \_PhpScoper09a4cc789a22\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper09a4cc789a22\Nette\Utils\Json::encode($json, \_PhpScoper09a4cc789a22\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopere97aad8070b4\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopere97aad8070b4\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopere97aad8070b4\Nette\Utils\Json::decode($fileContent, \_PhpScopere97aad8070b4\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopere97aad8070b4\Nette\Utils\Json::encode($json, \_PhpScopere97aad8070b4\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera85504f0ea7b\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera85504f0ea7b\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopera85504f0ea7b\Nette\Utils\Json::decode($fileContent, \_PhpScopera85504f0ea7b\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera85504f0ea7b\Nette\Utils\Json::encode($json, \_PhpScopera85504f0ea7b\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

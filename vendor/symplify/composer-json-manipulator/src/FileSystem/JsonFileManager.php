...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper43a95e2f69bc\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper43a95e2f69bc\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper43a95e2f69bc\Nette\Utils\Json::decode($fileContent, \_PhpScoper43a95e2f69bc\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper43a95e2f69bc\Nette\Utils\Json::encode($json, \_PhpScoper43a95e2f69bc\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

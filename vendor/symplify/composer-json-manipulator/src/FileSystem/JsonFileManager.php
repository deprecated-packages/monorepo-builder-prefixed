...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperf8eaec7affbd\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperf8eaec7affbd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperf8eaec7affbd\Nette\Utils\Json::decode($fileContent, \_PhpScoperf8eaec7affbd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperf8eaec7affbd\Nette\Utils\Json::encode($json, \_PhpScoperf8eaec7affbd\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

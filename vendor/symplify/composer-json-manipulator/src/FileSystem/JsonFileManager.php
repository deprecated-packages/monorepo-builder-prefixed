...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper66a1b4bf441c\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper66a1b4bf441c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper66a1b4bf441c\Nette\Utils\Json::decode($fileContent, \_PhpScoper66a1b4bf441c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper66a1b4bf441c\Nette\Utils\Json::encode($json, \_PhpScoper66a1b4bf441c\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopere10afbb60721\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopere10afbb60721\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopere10afbb60721\Nette\Utils\Json::decode($fileContent, \_PhpScopere10afbb60721\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopere10afbb60721\Nette\Utils\Json::encode($json, \_PhpScopere10afbb60721\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

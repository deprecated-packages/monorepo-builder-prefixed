...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperaff2103cee1d\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperaff2103cee1d\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperaff2103cee1d\Nette\Utils\Json::decode($fileContent, \_PhpScoperaff2103cee1d\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperaff2103cee1d\Nette\Utils\Json::encode($json, \_PhpScoperaff2103cee1d\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopere0f28e6b9bde\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopere0f28e6b9bde\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopere0f28e6b9bde\Nette\Utils\Json::decode($fileContent, \_PhpScopere0f28e6b9bde\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopere0f28e6b9bde\Nette\Utils\Json::encode($json, \_PhpScopere0f28e6b9bde\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

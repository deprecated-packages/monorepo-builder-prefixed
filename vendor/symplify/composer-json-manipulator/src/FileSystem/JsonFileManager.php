...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopercd5c1af09a49\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopercd5c1af09a49\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopercd5c1af09a49\Nette\Utils\Json::decode($fileContent, \_PhpScopercd5c1af09a49\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopercd5c1af09a49\Nette\Utils\Json::encode($json, \_PhpScopercd5c1af09a49\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

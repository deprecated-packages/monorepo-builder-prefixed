...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera5e5d165d78c\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera5e5d165d78c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopera5e5d165d78c\Nette\Utils\Json::decode($fileContent, \_PhpScopera5e5d165d78c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera5e5d165d78c\Nette\Utils\Json::encode($json, \_PhpScopera5e5d165d78c\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

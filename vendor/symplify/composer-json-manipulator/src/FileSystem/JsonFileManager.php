...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperce084f4275dd\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperce084f4275dd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperce084f4275dd\Nette\Utils\Json::decode($fileContent, \_PhpScoperce084f4275dd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperce084f4275dd\Nette\Utils\Json::encode($json, \_PhpScoperce084f4275dd\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

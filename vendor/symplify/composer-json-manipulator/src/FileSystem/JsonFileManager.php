...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperf4997c409394\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperf4997c409394\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperf4997c409394\Nette\Utils\Json::decode($fileContent, \_PhpScoperf4997c409394\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperf4997c409394\Nette\Utils\Json::encode($json, \_PhpScoperf4997c409394\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper46d05083fbc3\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper46d05083fbc3\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper46d05083fbc3\Nette\Utils\Json::decode($fileContent, \_PhpScoper46d05083fbc3\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper46d05083fbc3\Nette\Utils\Json::encode($json, \_PhpScoper46d05083fbc3\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

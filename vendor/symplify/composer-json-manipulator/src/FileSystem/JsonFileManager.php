...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperec2b815193b4\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperec2b815193b4\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperec2b815193b4\Nette\Utils\Json::decode($fileContent, \_PhpScoperec2b815193b4\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperec2b815193b4\Nette\Utils\Json::encode($json, \_PhpScoperec2b815193b4\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

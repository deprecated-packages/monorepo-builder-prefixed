...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperbb737891eded\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperbb737891eded\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperbb737891eded\Nette\Utils\Json::decode($fileContent, \_PhpScoperbb737891eded\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperbb737891eded\Nette\Utils\Json::encode($json, \_PhpScoperbb737891eded\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperedfa898a454f\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperedfa898a454f\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperedfa898a454f\Nette\Utils\Json::decode($fileContent, \_PhpScoperedfa898a454f\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperedfa898a454f\Nette\Utils\Json::encode($json, \_PhpScoperedfa898a454f\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

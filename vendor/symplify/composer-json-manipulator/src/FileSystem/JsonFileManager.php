...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper95e170f0b4ac\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper95e170f0b4ac\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper95e170f0b4ac\Nette\Utils\Json::decode($fileContent, \_PhpScoper95e170f0b4ac\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper95e170f0b4ac\Nette\Utils\Json::encode($json, \_PhpScoper95e170f0b4ac\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

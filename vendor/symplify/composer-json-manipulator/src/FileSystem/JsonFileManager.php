...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperda849baa4a45\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperda849baa4a45\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperda849baa4a45\Nette\Utils\Json::decode($fileContent, \_PhpScoperda849baa4a45\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperda849baa4a45\Nette\Utils\Json::encode($json, \_PhpScoperda849baa4a45\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

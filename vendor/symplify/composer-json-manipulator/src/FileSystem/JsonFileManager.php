...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopere6d124d1f7ba\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopere6d124d1f7ba\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopere6d124d1f7ba\Nette\Utils\Json::decode($fileContent, \_PhpScopere6d124d1f7ba\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopere6d124d1f7ba\Nette\Utils\Json::encode($json, \_PhpScopere6d124d1f7ba\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

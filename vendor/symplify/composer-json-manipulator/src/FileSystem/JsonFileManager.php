...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperdd624bbcb4e5\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperdd624bbcb4e5\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperdd624bbcb4e5\Nette\Utils\Json::decode($fileContent, \_PhpScoperdd624bbcb4e5\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperdd624bbcb4e5\Nette\Utils\Json::encode($json, \_PhpScoperdd624bbcb4e5\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

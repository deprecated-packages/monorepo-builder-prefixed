...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopercdfd316eda69\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopercdfd316eda69\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopercdfd316eda69\Nette\Utils\Json::decode($fileContent, \_PhpScopercdfd316eda69\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopercdfd316eda69\Nette\Utils\Json::encode($json, \_PhpScopercdfd316eda69\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

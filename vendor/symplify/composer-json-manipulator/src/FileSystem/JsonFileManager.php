...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopereaa2cae8e093\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopereaa2cae8e093\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopereaa2cae8e093\Nette\Utils\Json::decode($fileContent, \_PhpScopereaa2cae8e093\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopereaa2cae8e093\Nette\Utils\Json::encode($json, \_PhpScopereaa2cae8e093\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperdfa889d8967a\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperdfa889d8967a\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperdfa889d8967a\Nette\Utils\Json::decode($fileContent, \_PhpScoperdfa889d8967a\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperdfa889d8967a\Nette\Utils\Json::encode($json, \_PhpScoperdfa889d8967a\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper5e83c3f77e04\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper5e83c3f77e04\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper5e83c3f77e04\Nette\Utils\Json::decode($fileContent, \_PhpScoper5e83c3f77e04\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper5e83c3f77e04\Nette\Utils\Json::encode($json, \_PhpScoper5e83c3f77e04\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

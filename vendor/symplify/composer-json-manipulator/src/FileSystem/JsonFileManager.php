...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera28be7b3fe51\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera28be7b3fe51\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera28be7b3fe51\Nette\Utils\Json::encode($json, \_PhpScopera28be7b3fe51\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

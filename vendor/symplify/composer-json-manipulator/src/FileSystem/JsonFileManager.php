...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperab3ccffcffcd\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperab3ccffcffcd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperab3ccffcffcd\Nette\Utils\Json::decode($fileContent, \_PhpScoperab3ccffcffcd\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperab3ccffcffcd\Nette\Utils\Json::encode($json, \_PhpScoperab3ccffcffcd\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperc693a7d83f11\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperc693a7d83f11\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperc693a7d83f11\Nette\Utils\Json::decode($fileContent, \_PhpScoperc693a7d83f11\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperc693a7d83f11\Nette\Utils\Json::encode($json, \_PhpScoperc693a7d83f11\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

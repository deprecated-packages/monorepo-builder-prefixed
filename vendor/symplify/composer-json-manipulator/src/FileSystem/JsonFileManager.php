...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera763b4be90d0\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera763b4be90d0\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera763b4be90d0\Nette\Utils\Json::encode($json, \_PhpScopera763b4be90d0\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

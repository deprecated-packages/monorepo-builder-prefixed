...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperf78d2b40800e\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperf78d2b40800e\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperf78d2b40800e\Nette\Utils\Json::decode($fileContent, \_PhpScoperf78d2b40800e\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperf78d2b40800e\Nette\Utils\Json::encode($json, \_PhpScoperf78d2b40800e\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

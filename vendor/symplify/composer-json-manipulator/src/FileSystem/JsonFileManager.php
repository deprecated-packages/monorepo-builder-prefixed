...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper31b05558ad5c\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper31b05558ad5c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper31b05558ad5c\Nette\Utils\Json::decode($fileContent, \_PhpScoper31b05558ad5c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper31b05558ad5c\Nette\Utils\Json::encode($json, \_PhpScoper31b05558ad5c\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

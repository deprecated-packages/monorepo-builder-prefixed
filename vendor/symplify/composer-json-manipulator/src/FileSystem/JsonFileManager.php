...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperb25e75e9febe\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperb25e75e9febe\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperb25e75e9febe\Nette\Utils\Json::decode($fileContent, \_PhpScoperb25e75e9febe\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperb25e75e9febe\Nette\Utils\Json::encode($json, \_PhpScoperb25e75e9febe\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopercd844fca8af3\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopercd844fca8af3\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopercd844fca8af3\Nette\Utils\Json::decode($fileContent, \_PhpScopercd844fca8af3\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopercd844fca8af3\Nette\Utils\Json::encode($json, \_PhpScopercd844fca8af3\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

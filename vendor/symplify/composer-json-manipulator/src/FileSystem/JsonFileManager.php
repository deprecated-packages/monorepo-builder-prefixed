...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopere3ed9f66440c\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopere3ed9f66440c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopere3ed9f66440c\Nette\Utils\Json::decode($fileContent, \_PhpScopere3ed9f66440c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopere3ed9f66440c\Nette\Utils\Json::encode($json, \_PhpScopere3ed9f66440c\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopere7b233920bf2\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopere7b233920bf2\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopere7b233920bf2\Nette\Utils\Json::decode($fileContent, \_PhpScopere7b233920bf2\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopere7b233920bf2\Nette\Utils\Json::encode($json, \_PhpScopere7b233920bf2\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

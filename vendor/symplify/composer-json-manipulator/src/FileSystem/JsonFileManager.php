...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperd2185c67a4b4\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperd2185c67a4b4\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperd2185c67a4b4\Nette\Utils\Json::decode($fileContent, \_PhpScoperd2185c67a4b4\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperd2185c67a4b4\Nette\Utils\Json::encode($json, \_PhpScoperd2185c67a4b4\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

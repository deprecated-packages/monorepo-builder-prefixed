...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopere32570efa19a\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopere32570efa19a\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopere32570efa19a\Nette\Utils\Json::decode($fileContent, \_PhpScopere32570efa19a\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopere32570efa19a\Nette\Utils\Json::encode($json, \_PhpScopere32570efa19a\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

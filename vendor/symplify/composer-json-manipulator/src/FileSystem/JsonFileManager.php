...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperddf2171d3d2c\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperddf2171d3d2c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperddf2171d3d2c\Nette\Utils\Json::decode($fileContent, \_PhpScoperddf2171d3d2c\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperddf2171d3d2c\Nette\Utils\Json::encode($json, \_PhpScoperddf2171d3d2c\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopere846b54512fc\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopere846b54512fc\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopere846b54512fc\Nette\Utils\Json::decode($fileContent, \_PhpScopere846b54512fc\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopere846b54512fc\Nette\Utils\Json::encode($json, \_PhpScopere846b54512fc\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

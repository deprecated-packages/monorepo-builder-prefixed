...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopere691b6ebfa72\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopere691b6ebfa72\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopere691b6ebfa72\Nette\Utils\Json::encode($json, \_PhpScopere691b6ebfa72\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

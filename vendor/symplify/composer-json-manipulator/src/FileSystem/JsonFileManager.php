...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopercdc90a6628b6\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopercdc90a6628b6\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopercdc90a6628b6\Nette\Utils\Json::decode($fileContent, \_PhpScopercdc90a6628b6\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopercdc90a6628b6\Nette\Utils\Json::encode($json, \_PhpScopercdc90a6628b6\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

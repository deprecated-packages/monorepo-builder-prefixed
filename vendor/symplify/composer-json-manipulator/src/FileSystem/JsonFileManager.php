...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperaa2560a8a931\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperaa2560a8a931\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperaa2560a8a931\Nette\Utils\Json::decode($fileContent, \_PhpScoperaa2560a8a931\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperaa2560a8a931\Nette\Utils\Json::encode($json, \_PhpScoperaa2560a8a931\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

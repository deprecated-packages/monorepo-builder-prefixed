...
final class JsonFileManager
{
    ...
    {
        return \_PhpScopera1d8e0344ecf\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScopera1d8e0344ecf\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScopera1d8e0344ecf\Nette\Utils\Json::decode($fileContent, \_PhpScopera1d8e0344ecf\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScopera1d8e0344ecf\Nette\Utils\Json::encode($json, \_PhpScopera1d8e0344ecf\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

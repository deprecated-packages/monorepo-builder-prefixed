...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoper59bf8deb8cc1\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoper59bf8deb8cc1\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoper59bf8deb8cc1\Nette\Utils\Json::decode($fileContent, \_PhpScoper59bf8deb8cc1\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoper59bf8deb8cc1\Nette\Utils\Json::encode($json, \_PhpScoper59bf8deb8cc1\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

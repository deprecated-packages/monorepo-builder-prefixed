...
final class JsonFileManager
{
    ...
    {
        return \_PhpScoperd79f30a2f8be\Nette\Utils\Json::decode($smartFileInfo->getContents(), \_PhpScoperd79f30a2f8be\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @return mixed[]
     */
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \_PhpScoperd79f30a2f8be\Nette\Utils\Json::decode($fileContent, \_PhpScoperd79f30a2f8be\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \_PhpScoperd79f30a2f8be\Nette\Utils\Json::encode($json, \_PhpScoperd79f30a2f8be\Nette\Utils\Json::PRETTY) . \Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();

...
use function _PhpScoperbb737891eded\Symfony\Component\DependencyInjection\Loader\Configurator\service;
return static function (\_PhpScoperbb737891eded\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoperbb737891eded\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\_PhpScoperbb737891eded\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
    // filesystem
    ...
    $services->set(\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\_PhpScoperbb737891eded\Symfony\Component\DependencyInjection\Loader\Configurator\service(\_PhpScoperbb737891eded\Symfony\Component\DependencyInjection\ContainerInterface::class)]);

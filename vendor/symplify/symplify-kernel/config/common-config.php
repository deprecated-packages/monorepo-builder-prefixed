...
use function _PhpScoper0d4928f7af97\Symfony\Component\DependencyInjection\Loader\Configurator\ref;
return static function (\_PhpScoper0d4928f7af97\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper0d4928f7af97\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\_PhpScoper0d4928f7af97\Symfony\Component\DependencyInjection\Loader\Configurator\ref(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
    // filesystem
    ...
    $services->set(\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\_PhpScoper0d4928f7af97\Symfony\Component\DependencyInjection\Loader\Configurator\ref(\_PhpScoper0d4928f7af97\Symfony\Component\DependencyInjection\ContainerInterface::class)]);

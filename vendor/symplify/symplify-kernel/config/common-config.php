...
use function _PhpScoperc8aee0bf0015\Symfony\Component\DependencyInjection\Loader\Configurator\service;
return static function (\_PhpScoperc8aee0bf0015\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoperc8aee0bf0015\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\_PhpScoperc8aee0bf0015\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
    // filesystem
    ...
    $services->set(\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\_PhpScoperc8aee0bf0015\Symfony\Component\DependencyInjection\Loader\Configurator\service(\_PhpScoperc8aee0bf0015\Symfony\Component\DependencyInjection\ContainerInterface::class)]);

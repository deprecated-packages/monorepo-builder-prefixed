...
use function _PhpScoper47d898182bf9\Symfony\Component\DependencyInjection\Loader\Configurator\ref;
return static function (\_PhpScoper47d898182bf9\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoper47d898182bf9\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\_PhpScoper47d898182bf9\Symfony\Component\DependencyInjection\Loader\Configurator\ref(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
    // filesystem
    ...
    $services->set(\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\_PhpScoper47d898182bf9\Symfony\Component\DependencyInjection\Loader\Configurator\ref(\_PhpScoper47d898182bf9\Symfony\Component\DependencyInjection\ContainerInterface::class)]);

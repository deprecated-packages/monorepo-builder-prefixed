...
use function _PhpScoperff72c38d4e2a\Symfony\Component\DependencyInjection\Loader\Configurator\service;
return static function (\_PhpScoperff72c38d4e2a\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->set(\_PhpScoperff72c38d4e2a\Symfony\Component\Console\Style\SymfonyStyle::class)->factory([\_PhpScoperff72c38d4e2a\Symfony\Component\DependencyInjection\Loader\Configurator\service(\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory::class), 'create']);
    // filesystem
    ...
    $services->set(\Symplify\PackageBuilder\Parameter\ParameterProvider::class)->args([\_PhpScoperff72c38d4e2a\Symfony\Component\DependencyInjection\Loader\Configurator\service(\_PhpScoperff72c38d4e2a\Symfony\Component\DependencyInjection\ContainerInterface::class)]);

...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper1ceaf4cbd5cb\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper1ceaf4cbd5cb\Symfony\Component\Console\Application::class, $application);
    }
}

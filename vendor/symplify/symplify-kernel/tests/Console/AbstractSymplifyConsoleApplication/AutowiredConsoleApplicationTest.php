...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoperdfa889d8967a\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperdfa889d8967a\Symfony\Component\Console\Application::class, $application);
    }
}

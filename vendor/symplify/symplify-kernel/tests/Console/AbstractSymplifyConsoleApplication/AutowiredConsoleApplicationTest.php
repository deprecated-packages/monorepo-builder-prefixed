...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperf40000691b7b\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperf40000691b7b\Symfony\Component\Console\Application::class, $application);
    }
}

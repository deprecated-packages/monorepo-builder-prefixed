...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper722a1d9fee2c\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper722a1d9fee2c\Symfony\Component\Console\Application::class, $application);
    }
}

...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper204b3b8f3e0d\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper204b3b8f3e0d\Symfony\Component\Console\Application::class, $application);
    }
}

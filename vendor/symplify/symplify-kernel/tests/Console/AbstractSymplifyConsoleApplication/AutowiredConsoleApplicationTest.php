...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperb2257feafd7d\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperb2257feafd7d\Symfony\Component\Console\Application::class, $application);
    }
}

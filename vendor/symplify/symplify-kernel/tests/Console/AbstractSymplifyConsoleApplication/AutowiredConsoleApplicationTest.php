...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScopercd5c1af09a49\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopercd5c1af09a49\Symfony\Component\Console\Application::class, $application);
    }
}

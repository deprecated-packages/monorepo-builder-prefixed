...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper2f9b0ac741dd\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper2f9b0ac741dd\Symfony\Component\Console\Application::class, $application);
    }
}

...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper97d4f3c5628a\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper97d4f3c5628a\Symfony\Component\Console\Application::class, $application);
    }
}

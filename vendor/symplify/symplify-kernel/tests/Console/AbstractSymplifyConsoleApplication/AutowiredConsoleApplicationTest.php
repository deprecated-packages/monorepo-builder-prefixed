...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperd1c9c8ec01a8\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperd1c9c8ec01a8\Symfony\Component\Console\Application::class, $application);
    }
}

...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper847a0f3260b6\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper847a0f3260b6\Symfony\Component\Console\Application::class, $application);
    }
}

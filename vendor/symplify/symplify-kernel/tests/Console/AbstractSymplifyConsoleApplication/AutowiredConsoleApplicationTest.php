...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper0087e037e0f7\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper0087e037e0f7\Symfony\Component\Console\Application::class, $application);
    }
}

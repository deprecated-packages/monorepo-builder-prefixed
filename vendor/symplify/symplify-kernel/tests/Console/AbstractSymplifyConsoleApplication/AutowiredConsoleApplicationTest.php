...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper68e56c1b5bd9\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper68e56c1b5bd9\Symfony\Component\Console\Application::class, $application);
    }
}

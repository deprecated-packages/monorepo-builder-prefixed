...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper120e1a259c7c\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper120e1a259c7c\Symfony\Component\Console\Application::class, $application);
    }
}

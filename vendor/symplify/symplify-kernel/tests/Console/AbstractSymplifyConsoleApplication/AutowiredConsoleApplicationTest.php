...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScopere846b54512fc\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopere846b54512fc\Symfony\Component\Console\Application::class, $application);
    }
}

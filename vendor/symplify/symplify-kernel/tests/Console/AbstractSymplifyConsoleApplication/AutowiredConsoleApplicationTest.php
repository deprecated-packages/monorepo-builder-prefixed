...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoperf0b2c071f15d\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperf0b2c071f15d\Symfony\Component\Console\Application::class, $application);
    }
}

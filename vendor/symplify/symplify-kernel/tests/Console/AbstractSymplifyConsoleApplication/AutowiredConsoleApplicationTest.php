...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScopere1b4619561f2\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopere1b4619561f2\Symfony\Component\Console\Application::class, $application);
    }
}

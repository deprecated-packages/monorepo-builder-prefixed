...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoper5da899d87662\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper5da899d87662\Symfony\Component\Console\Application::class, $application);
    }
}

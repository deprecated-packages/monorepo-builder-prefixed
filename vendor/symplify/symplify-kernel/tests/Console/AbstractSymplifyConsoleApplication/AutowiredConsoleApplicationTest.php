...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperab93339c6bca\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperab93339c6bca\Symfony\Component\Console\Application::class, $application);
    }
}

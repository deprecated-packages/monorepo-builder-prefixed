...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScopereb7fcd8f999a\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopereb7fcd8f999a\Symfony\Component\Console\Application::class, $application);
    }
}

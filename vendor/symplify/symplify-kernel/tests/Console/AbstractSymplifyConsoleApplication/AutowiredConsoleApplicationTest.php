...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScopera2f1d1d42b88\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopera2f1d1d42b88\Symfony\Component\Console\Application::class, $application);
    }
}

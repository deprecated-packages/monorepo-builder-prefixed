...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperdd624bbcb4e5\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperdd624bbcb4e5\Symfony\Component\Console\Application::class, $application);
    }
}

...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScopera2ff5fd2b59c\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScopera2ff5fd2b59c\Symfony\Component\Console\Application::class, $application);
    }
}

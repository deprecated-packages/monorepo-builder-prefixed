...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperf6f8e31183c3\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperf6f8e31183c3\Symfony\Component\Console\Application::class, $application);
    }
}

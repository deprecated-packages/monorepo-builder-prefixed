...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoper78864f032ec6\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoper78864f032ec6\Symfony\Component\Console\Application::class, $application);
    }
}

...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = $this->getService(\_PhpScoperef96225926e2\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperef96225926e2\Symfony\Component\Console\Application::class, $application);
    }
}

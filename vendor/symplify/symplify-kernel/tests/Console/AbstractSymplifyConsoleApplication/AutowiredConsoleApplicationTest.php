...
final class AutowiredConsoleApplicationTest extends \Symplify\PackageBuilder\Testing\AbstractKernelTestCase
{
    ...
    {
        $application = self::$container->get(\_PhpScoperd659a053ca1c\Symfony\Component\Console\Application::class);
        $this->assertInstanceOf(\_PhpScoperd659a053ca1c\Symfony\Component\Console\Application::class, $application);
    }
}

...
final class KernelBootAndApplicationRun
{
    ...
    private function createKernel() : \_PhpScoperc53cafc6ca57\Symfony\Component\HttpKernel\KernelInterface
    {
    ...
    private function booKernelAndRunApplication() : void
    {
        ...
        $application = $container->get(\_PhpScoperc53cafc6ca57\Symfony\Component\Console\Application::class);
        exit($application->run());
    }
    private function setExtraConfigs(\_PhpScoperc53cafc6ca57\Symfony\Component\HttpKernel\KernelInterface $kernel, string $kernelClass) : void
    {
    ...
    {
        if (!\is_a($kernelClass, \_PhpScoperc53cafc6ca57\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            $message = \sprintf('Class "%s" must by type of "%s"', $kernelClass, \_PhpScoperc53cafc6ca57\Symfony\Component\HttpKernel\KernelInterface::class);
            throw new \Symplify\SymplifyKernel\Exception\BootException($message);
        }

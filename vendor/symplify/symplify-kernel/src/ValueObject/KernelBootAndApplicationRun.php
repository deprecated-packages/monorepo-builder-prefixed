...
final class KernelBootAndApplicationRun
{
    ...
    private function createKernel() : \_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\KernelInterface
    {
    ...
    private function booKernelAndRunApplication() : void
    {
        ...
        $application = $container->get(\_PhpScoperda849baa4a45\Symfony\Component\Console\Application::class);
        exit($application->run());
    }
    private function setExtraConfigs(\_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\KernelInterface $kernel, string $kernelClass) : void
    {
    ...
    {
        if (!\is_a($kernelClass, \_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            $message = \sprintf('Class "%s" must by type of "%s"', $kernelClass, \_PhpScoperda849baa4a45\Symfony\Component\HttpKernel\KernelInterface::class);
            throw new \Symplify\SymplifyKernel\Exception\BootException($message);
        }

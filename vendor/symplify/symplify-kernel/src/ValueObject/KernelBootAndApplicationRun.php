...
final class KernelBootAndApplicationRun
{
    ...
    private function createKernel() : \_PhpScopere32570efa19a\Symfony\Component\HttpKernel\KernelInterface
    {
    ...
    private function booKernelAndRunApplication() : void
    {
        ...
        $application = $container->get(\_PhpScopere32570efa19a\Symfony\Component\Console\Application::class);
        exit($application->run());
    }
    private function setExtraConfigs(\_PhpScopere32570efa19a\Symfony\Component\HttpKernel\KernelInterface $kernel, string $kernelClass) : void
    {
    ...
    {
        if (!\is_a($kernelClass, \_PhpScopere32570efa19a\Symfony\Component\HttpKernel\KernelInterface::class, \true)) {
            $message = \sprintf('Class "%s" must by type of "%s"', $kernelClass, \_PhpScopere32570efa19a\Symfony\Component\HttpKernel\KernelInterface::class);
            throw new \Symplify\SymplifyKernel\Exception\BootException($message);
        }

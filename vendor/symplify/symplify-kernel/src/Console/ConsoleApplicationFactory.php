...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperfa8ac9431c57\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperfa8ac9431c57\Jean85\PrettyVersions::getVersion($packageName);

...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper1e8bd38a2146\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper1e8bd38a2146\Jean85\PrettyVersions::getVersion($packageName);

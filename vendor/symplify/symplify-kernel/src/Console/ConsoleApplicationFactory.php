...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperb15c77d6bb3b\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperb15c77d6bb3b\Jean85\PrettyVersions::getVersion($packageName);

...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperd79f30a2f8be\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperd79f30a2f8be\Jean85\PrettyVersions::getVersion($packageName);

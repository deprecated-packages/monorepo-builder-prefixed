...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperbe77f3b0e77d\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperbe77f3b0e77d\Jean85\PrettyVersions::getVersion($packageName);

...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperc0c27da9e1f7\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperc0c27da9e1f7\Jean85\PrettyVersions::getVersion($packageName);

...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper0f23ef1f1d10\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper0f23ef1f1d10\Jean85\PrettyVersions::getVersion($packageName);

...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperbd03d493ccc6\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperbd03d493ccc6\Jean85\PrettyVersions::getVersion($packageName);

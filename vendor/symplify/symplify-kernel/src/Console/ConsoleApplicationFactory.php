...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper0ce3ac6864aa\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper0ce3ac6864aa\Jean85\PrettyVersions::getVersion($packageName);

...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper3bda9af7e0fd\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper3bda9af7e0fd\Jean85\PrettyVersions::getVersion($packageName);

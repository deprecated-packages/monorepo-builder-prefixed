...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper12b9214dc5a9\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper12b9214dc5a9\Jean85\PrettyVersions::getVersion($packageName);

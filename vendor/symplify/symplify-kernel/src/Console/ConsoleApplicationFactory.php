...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper9a3298f96fa4\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper9a3298f96fa4\Jean85\PrettyVersions::getVersion($packageName);

...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper1ceaf4cbd5cb\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper1ceaf4cbd5cb\Jean85\PrettyVersions::getVersion($packageName);

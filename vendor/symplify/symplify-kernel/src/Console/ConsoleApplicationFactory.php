...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper29aa9f1ba53d\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper29aa9f1ba53d\Jean85\PrettyVersions::getVersion($packageName);

...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper1c1f12bbe5a7\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper1c1f12bbe5a7\Jean85\PrettyVersions::getVersion($packageName);

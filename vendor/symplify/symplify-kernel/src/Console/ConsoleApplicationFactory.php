...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper59bf8deb8cc1\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper59bf8deb8cc1\Jean85\PrettyVersions::getVersion($packageName);

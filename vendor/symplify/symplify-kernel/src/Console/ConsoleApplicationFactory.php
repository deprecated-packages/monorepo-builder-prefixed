...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperd2185c67a4b4\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperd2185c67a4b4\Jean85\PrettyVersions::getVersion($packageName);

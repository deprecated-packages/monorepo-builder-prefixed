...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper6d6fbd28d6a9\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper6d6fbd28d6a9\Jean85\PrettyVersions::getVersion($packageName);

...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperd9ee792cdaf4\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperd9ee792cdaf4\Jean85\PrettyVersions::getVersion($packageName);

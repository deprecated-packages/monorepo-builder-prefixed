...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper204b3b8f3e0d\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper204b3b8f3e0d\Jean85\PrettyVersions::getVersion($packageName);

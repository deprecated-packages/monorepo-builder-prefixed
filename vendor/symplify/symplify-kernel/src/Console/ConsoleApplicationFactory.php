...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper0fa0b2363a34\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper0fa0b2363a34\Jean85\PrettyVersions::getVersion($packageName);

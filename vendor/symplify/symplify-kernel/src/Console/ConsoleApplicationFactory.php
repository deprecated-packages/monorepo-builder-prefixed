...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper9a38f5ee6cbc\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper9a38f5ee6cbc\Jean85\PrettyVersions::getVersion($packageName);

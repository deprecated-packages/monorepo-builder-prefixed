...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperee3ad0c2c096\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperee3ad0c2c096\Jean85\PrettyVersions::getVersion($packageName);

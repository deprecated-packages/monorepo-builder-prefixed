...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper4f38ae1287f3\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper4f38ae1287f3\Jean85\PrettyVersions::getVersion($packageName);

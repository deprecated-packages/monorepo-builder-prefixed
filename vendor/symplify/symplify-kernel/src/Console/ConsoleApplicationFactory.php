...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperdd624bbcb4e5\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperdd624bbcb4e5\Jean85\PrettyVersions::getVersion($packageName);

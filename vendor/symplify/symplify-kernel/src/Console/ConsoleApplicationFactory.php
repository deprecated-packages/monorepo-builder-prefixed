...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper7cc068f3f5d1\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper7cc068f3f5d1\Jean85\PrettyVersions::getVersion($packageName);

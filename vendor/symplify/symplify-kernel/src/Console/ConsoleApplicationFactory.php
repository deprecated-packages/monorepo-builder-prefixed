...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper93a7e58d9dd1\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper93a7e58d9dd1\Jean85\PrettyVersions::getVersion($packageName);

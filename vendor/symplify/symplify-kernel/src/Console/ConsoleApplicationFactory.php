...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperfa13b4bfa005\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperfa13b4bfa005\Jean85\PrettyVersions::getVersion($packageName);

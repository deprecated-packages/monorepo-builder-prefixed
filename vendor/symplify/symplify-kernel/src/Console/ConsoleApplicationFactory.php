...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper8b5497cf20f8\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper8b5497cf20f8\Jean85\PrettyVersions::getVersion($packageName);

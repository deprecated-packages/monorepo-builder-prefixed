...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper722a1d9fee2c\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper722a1d9fee2c\Jean85\PrettyVersions::getVersion($packageName);

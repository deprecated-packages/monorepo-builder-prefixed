...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper3a64dbb4e14f\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper3a64dbb4e14f\Jean85\PrettyVersions::getVersion($packageName);

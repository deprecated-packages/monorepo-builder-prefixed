...
use _PhpScoperdab52924cf3e\Jean85\PrettyVersions;
...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoperdab52924cf3e\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoperdab52924cf3e\Jean85\PrettyVersions::getVersion($packageName);

...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper84d68f9a1b63\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper84d68f9a1b63\Jean85\PrettyVersions::getVersion($packageName);

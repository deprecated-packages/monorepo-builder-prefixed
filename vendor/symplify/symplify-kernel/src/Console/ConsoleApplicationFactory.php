...
final class ConsoleApplicationFactory
{
    ...
    private function decorateApplicationWithNameAndVersion(\_PhpScoper31a2d0e8f655\Symfony\Component\Console\Application $application) : void
    {
    ...
    {
        try {
            $version = \_PhpScoper31a2d0e8f655\Jean85\PrettyVersions::getVersion($packageName);

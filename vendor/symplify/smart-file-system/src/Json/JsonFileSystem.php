...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoper722a1d9fee2c\Nette\Utils\Json::encode($jsonArray, \_PhpScoper722a1d9fee2c\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoper722a1d9fee2c\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);

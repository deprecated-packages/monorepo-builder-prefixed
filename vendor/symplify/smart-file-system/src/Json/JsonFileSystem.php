...
use _PhpScoperfa13b4bfa005\Nette\Utils\Arrays;
...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoperfa13b4bfa005\Nette\Utils\Json::encode($jsonArray, \_PhpScoperfa13b4bfa005\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoperfa13b4bfa005\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);

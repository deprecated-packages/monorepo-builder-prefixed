...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScoperd607abf1de8e\Nette\Utils\Json::encode($jsonArray, \_PhpScoperd607abf1de8e\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScoperd607abf1de8e\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);

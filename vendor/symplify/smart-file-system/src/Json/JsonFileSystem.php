...
use _PhpScopereb7fcd8f999a\Nette\Utils\Arrays;
...
final class JsonFileSystem
{
    ...
    {
        $jsonContent = \_PhpScopereb7fcd8f999a\Nette\Utils\Json::encode($jsonArray, \_PhpScopereb7fcd8f999a\Nette\Utils\Json::PRETTY) . \PHP_EOL;
        $this->smartFileSystem->dumpFile($filePath, $jsonContent);
    }
    public function mergeArrayToJsonFile(string $filePath, array $newJsonArray) : void
    {
        $jsonArray = $this->loadFilePathToJson($filePath);
        $newComposerJsonArray = \_PhpScopereb7fcd8f999a\Nette\Utils\Arrays::mergeTree($jsonArray, $newJsonArray);

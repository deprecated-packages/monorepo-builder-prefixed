...
use _PhpScoper2f9b0ac741dd\Nette\Utils\Html;
...
final class SmartFileSystem extends \_PhpScoper2f9b0ac741dd\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScoper2f9b0ac741dd\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScoper2f9b0ac741dd\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}

...
use _PhpScopera5e5d165d78c\Nette\Utils\Html;
...
final class SmartFileSystem extends \_PhpScopera5e5d165d78c\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \_PhpScopera5e5d165d78c\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    ...
    private function getLastError() : string
    {
        ...
        return \_PhpScopera5e5d165d78c\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX);
    }
}

 ...
 */
final class SmartFileInfo extends \_PhpScoper31a2d0e8f655\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper31a2d0e8f655\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper31a2d0e8f655\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper31a2d0e8f655\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

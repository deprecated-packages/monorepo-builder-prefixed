 ...
 */
final class SmartFileInfo extends \_PhpScoper9693ff52999d\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper9693ff52999d\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper9693ff52999d\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper9693ff52999d\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

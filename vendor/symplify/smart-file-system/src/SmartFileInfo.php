...
use _PhpScoper485f3a9238ad\Symfony\Component\Finder\SplFileInfo;
 ...
 */
final class SmartFileInfo extends \_PhpScoper485f3a9238ad\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper485f3a9238ad\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper485f3a9238ad\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper485f3a9238ad\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper485f3a9238ad\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }

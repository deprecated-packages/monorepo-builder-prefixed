 ...
 */
final class SmartFileInfo extends \_PhpScopera763b4be90d0\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScopera763b4be90d0\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScopera763b4be90d0\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScopera763b4be90d0\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

 ...
 */
final class SmartFileInfo extends \_PhpScoper323d4c178bee\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper323d4c178bee\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper323d4c178bee\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper323d4c178bee\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

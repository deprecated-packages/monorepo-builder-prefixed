 ...
 */
final class SmartFileInfo extends \_PhpScoperf78d2b40800e\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperf78d2b40800e\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperf78d2b40800e\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperf78d2b40800e\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

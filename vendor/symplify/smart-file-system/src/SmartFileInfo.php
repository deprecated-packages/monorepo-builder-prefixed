 ...
 */
final class SmartFileInfo extends \_PhpScoper66a1b4bf441c\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper66a1b4bf441c\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper66a1b4bf441c\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper66a1b4bf441c\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

...
use _PhpScoper9aa6186049d8\Symfony\Component\Finder\SplFileInfo;
 ...
 */
final class SmartFileInfo extends \_PhpScoper9aa6186049d8\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper9aa6186049d8\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper9aa6186049d8\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper9aa6186049d8\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }
    ...
    {
        return \_PhpScoper9aa6186049d8\Nette\Utils\Strings::startsWith($this->getNormalizedRealPath(), $partialPath);
    }

...
use _PhpScoper6b2f62f5c7a4\Symfony\Component\Finder\SplFileInfo;
 ...
 */
final class SmartFileInfo extends \_PhpScoper6b2f62f5c7a4\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper6b2f62f5c7a4\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper6b2f62f5c7a4\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper6b2f62f5c7a4\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

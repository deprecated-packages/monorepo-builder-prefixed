 ...
 */
final class SmartFileInfo extends \_PhpScoper503cab241f82\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper503cab241f82\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper503cab241f82\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper503cab241f82\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

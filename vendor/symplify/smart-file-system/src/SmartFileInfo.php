 ...
 */
final class SmartFileInfo extends \_PhpScopere846b54512fc\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScopere846b54512fc\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScopere846b54512fc\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScopere846b54512fc\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

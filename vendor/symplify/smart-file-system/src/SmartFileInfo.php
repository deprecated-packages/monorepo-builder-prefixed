 ...
 */
final class SmartFileInfo extends \_PhpScoper2a80719fd449\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper2a80719fd449\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper2a80719fd449\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper2a80719fd449\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

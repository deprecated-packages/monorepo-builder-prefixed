 ...
 */
final class SmartFileInfo extends \_PhpScoper931cda798d50\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper931cda798d50\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper931cda798d50\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper931cda798d50\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

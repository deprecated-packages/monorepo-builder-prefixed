 ...
 */
final class SmartFileInfo extends \_PhpScoper0fa0b2363a34\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper0fa0b2363a34\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper0fa0b2363a34\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper0fa0b2363a34\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

 ...
 */
final class SmartFileInfo extends \_PhpScoper600b802aef08\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper600b802aef08\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper600b802aef08\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper600b802aef08\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

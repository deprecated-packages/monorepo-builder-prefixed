 ...
 */
final class SmartFileInfo extends \_PhpScoper416e75c46c6e\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper416e75c46c6e\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper416e75c46c6e\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper416e75c46c6e\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

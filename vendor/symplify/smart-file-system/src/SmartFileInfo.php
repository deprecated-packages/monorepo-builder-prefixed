 ...
 */
final class SmartFileInfo extends \_PhpScoper9175a5176ce9\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper9175a5176ce9\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper9175a5176ce9\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper9175a5176ce9\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

 ...
 */
final class SmartFileInfo extends \_PhpScoper22d98a58be40\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoper22d98a58be40\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoper22d98a58be40\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoper22d98a58be40\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

...
use _PhpScoperf9ff1c3447b1\Symfony\Component\Finder\SplFileInfo;
 ...
 */
final class SmartFileInfo extends \_PhpScoperf9ff1c3447b1\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperf9ff1c3447b1\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperf9ff1c3447b1\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperf9ff1c3447b1\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

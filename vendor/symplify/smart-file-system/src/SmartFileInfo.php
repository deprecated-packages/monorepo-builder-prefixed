...
use _PhpScoperd3e9cfbe9d90\Symfony\Component\Finder\SplFileInfo;
 ...
 */
final class SmartFileInfo extends \_PhpScoperd3e9cfbe9d90\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperd3e9cfbe9d90\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperd3e9cfbe9d90\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperd3e9cfbe9d90\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

 ...
 */
final class SmartFileInfo extends \_PhpScoperf968abd60cb0\Symfony\Component\Finder\SplFileInfo
{
    /**
     * @var string
    ...
    public function __construct($filePath)
    {
        ...
        if (\_PhpScoperf968abd60cb0\Nette\Utils\Strings::startsWith($filePath, 'phar://')) {
    ...
    {
        return \_PhpScoperf968abd60cb0\Nette\Utils\Strings::replace($this->getRealPath(), self::LAST_SUFFIX_REGEX, '');
    }
    ...
    {
        return \_PhpScoperf968abd60cb0\Nette\Utils\Strings::endsWith($this->getNormalizedRealPath(), $string);
    }

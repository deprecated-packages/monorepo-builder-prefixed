...
use _PhpScoper7d1be3c5de07\Nette\Utils\Finder as NetteFinder;
use _PhpScoper7d1be3c5de07\Nette\Utils\Strings;
use _PhpScoper7d1be3c5de07\PHPUnit\Framework\TestCase;
use SplFileInfo;
use _PhpScoper7d1be3c5de07\Symfony\Component\Finder\Finder as SymfonyFinder;
use _PhpScoper7d1be3c5de07\Symfony\Component\Finder\SplFileInfo as SymfonySplFileInfo;
use Symplify\SmartFileSystem\Finder\FinderSanitizer;
use Symplify\SmartFileSystem\SmartFileInfo;
final class FinderSanitizerTest extends \_PhpScoper7d1be3c5de07\PHPUnit\Framework\TestCase
{
    /**
     * @var FinderSanitizer
     */
    ...
    {
        $symfonyFinder = \_PhpScoper7d1be3c5de07\Symfony\Component\Finder\Finder::create()->files()->in(__DIR__ . '/Source');
    ...
    {
        $netteFinder = \_PhpScoper7d1be3c5de07\Nette\Utils\Finder::findFiles('*')->from(__DIR__ . '/Source');
    ...
    private function assertFilesEqualFixtureFiles(\Symplify\SmartFileSystem\SmartFileInfo $firstSmartFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $secondSmartFileInfo) : void
    {
        ...
        $this->assertTrue(\_PhpScoper7d1be3c5de07\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php') && \_PhpScoper7d1be3c5de07\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') || \_PhpScoper7d1be3c5de07\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') && \_PhpScoper7d1be3c5de07\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php'));
    }
    private function assertFileIsFromFixtureDirAndHasCorrectClass(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $this->assertInstanceOf(\_PhpScoper7d1be3c5de07\Symfony\Component\Finder\SplFileInfo::class, $smartFileInfo);

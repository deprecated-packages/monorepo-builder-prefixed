...
use _PhpScopere846b54512fc\Nette\Utils\Finder as NetteFinder;
use _PhpScopere846b54512fc\Nette\Utils\Strings;
use _PhpScopere846b54512fc\PHPUnit\Framework\TestCase;
use SplFileInfo;
use _PhpScopere846b54512fc\Symfony\Component\Finder\Finder as SymfonyFinder;
use _PhpScopere846b54512fc\Symfony\Component\Finder\SplFileInfo as SymfonySplFileInfo;
use Symplify\SmartFileSystem\Finder\FinderSanitizer;
use Symplify\SmartFileSystem\SmartFileInfo;
final class FinderSanitizerTest extends \_PhpScopere846b54512fc\PHPUnit\Framework\TestCase
{
    /**
     * @var FinderSanitizer
     */
    ...
    {
        $symfonyFinder = \_PhpScopere846b54512fc\Symfony\Component\Finder\Finder::create()->files()->in(__DIR__ . '/Source');
    ...
    {
        $netteFinder = \_PhpScopere846b54512fc\Nette\Utils\Finder::findFiles('*')->from(__DIR__ . '/Source');
    ...
    private function assertFilesEqualFixtureFiles(\Symplify\SmartFileSystem\SmartFileInfo $firstSmartFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $secondSmartFileInfo) : void
    {
        ...
        $this->assertTrue(\_PhpScopere846b54512fc\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php') && \_PhpScopere846b54512fc\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') || \_PhpScopere846b54512fc\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') && \_PhpScopere846b54512fc\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php'));
    }
    private function assertFileIsFromFixtureDirAndHasCorrectClass(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $this->assertInstanceOf(\_PhpScopere846b54512fc\Symfony\Component\Finder\SplFileInfo::class, $smartFileInfo);

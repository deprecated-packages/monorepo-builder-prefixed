...
use _PhpScoperba481e4bff85\Nette\Utils\Finder as NetteFinder;
use _PhpScoperba481e4bff85\Nette\Utils\Strings;
use _PhpScoperba481e4bff85\PHPUnit\Framework\TestCase;
use SplFileInfo;
use _PhpScoperba481e4bff85\Symfony\Component\Finder\Finder as SymfonyFinder;
use _PhpScoperba481e4bff85\Symfony\Component\Finder\SplFileInfo as SymfonySplFileInfo;
use Symplify\SmartFileSystem\Finder\FinderSanitizer;
use Symplify\SmartFileSystem\SmartFileInfo;
final class FinderSanitizerTest extends \_PhpScoperba481e4bff85\PHPUnit\Framework\TestCase
{
    /**
     * @var FinderSanitizer
     */
    ...
    {
        $symfonyFinder = \_PhpScoperba481e4bff85\Symfony\Component\Finder\Finder::create()->files()->in(__DIR__ . '/Source');
    ...
    {
        $netteFinder = \_PhpScoperba481e4bff85\Nette\Utils\Finder::findFiles('*')->from(__DIR__ . '/Source');
    ...
    private function assertFilesEqualFixtureFiles(\Symplify\SmartFileSystem\SmartFileInfo $firstSmartFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $secondSmartFileInfo) : void
    {
        ...
        $this->assertTrue(\_PhpScoperba481e4bff85\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php') && \_PhpScoperba481e4bff85\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') || \_PhpScoperba481e4bff85\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') && \_PhpScoperba481e4bff85\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php'));
    }
    private function assertFileIsFromFixtureDirAndHasCorrectClass(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $this->assertInstanceOf(\_PhpScoperba481e4bff85\Symfony\Component\Finder\SplFileInfo::class, $smartFileInfo);

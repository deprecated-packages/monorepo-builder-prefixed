...
use _PhpScoperad3f32c1b87c\Nette\Utils\Finder as NetteFinder;
use _PhpScoperad3f32c1b87c\Nette\Utils\Strings;
use _PhpScoperad3f32c1b87c\PHPUnit\Framework\TestCase;
use SplFileInfo;
use _PhpScoperad3f32c1b87c\Symfony\Component\Finder\Finder as SymfonyFinder;
use _PhpScoperad3f32c1b87c\Symfony\Component\Finder\SplFileInfo as SymfonySplFileInfo;
use Symplify\SmartFileSystem\Finder\FinderSanitizer;
use Symplify\SmartFileSystem\SmartFileInfo;
final class FinderSanitizerTest extends \_PhpScoperad3f32c1b87c\PHPUnit\Framework\TestCase
{
    /**
     * @var FinderSanitizer
     */
    ...
    {
        $symfonyFinder = \_PhpScoperad3f32c1b87c\Symfony\Component\Finder\Finder::create()->files()->in(__DIR__ . '/Source');
    ...
    {
        $netteFinder = \_PhpScoperad3f32c1b87c\Nette\Utils\Finder::findFiles('*')->from(__DIR__ . '/Source');
    ...
    private function assertFilesEqualFixtureFiles(\Symplify\SmartFileSystem\SmartFileInfo $firstSmartFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $secondSmartFileInfo) : void
    {
        ...
        $this->assertTrue(\_PhpScoperad3f32c1b87c\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php') && \_PhpScoperad3f32c1b87c\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') || \_PhpScoperad3f32c1b87c\Nette\Utils\Strings::endsWith($firstSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/EmptyFile.php') && \_PhpScoperad3f32c1b87c\Nette\Utils\Strings::endsWith($secondSmartFileInfo->getRelativeFilePath(), 'NestedDirectory/FileWithClass.php'));
    }
    private function assertFileIsFromFixtureDirAndHasCorrectClass(\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : void
    {
        $this->assertInstanceOf(\_PhpScoperad3f32c1b87c\Symfony\Component\Finder\SplFileInfo::class, $smartFileInfo);

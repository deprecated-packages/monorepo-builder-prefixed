 ...
 * @coversNothing
 */
abstract class LongestCommonSubsequenceTest extends \_PhpScoper9175a5176ce9\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $from = [\false, 0, 0.0, '', null, [], \true, 1, 1.0, 'foo', ['foo', 'bar'], ['foo' => 'bar']];
        $to = $from;
        $common = $this->implementation->calculate($from, $to);
        $this->assertSame($from, $common);
        $to = [\false, \false, \false, \false, \false, \false, \true, \true, \true, \true, \true, \true];
        $expected = [\false, \true];
        $common = $this->implementation->calculate($from, $to);
     ...
     */
    protected abstract function createImplementation() : \_PhpScoper9175a5176ce9\SebastianBergmann\Diff\LongestCommonSubsequenceCalculator;
}

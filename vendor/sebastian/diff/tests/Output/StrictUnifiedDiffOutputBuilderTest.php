 ...
 */
namespace _PhpScoper27e2e7523871\SebastianBergmann\Diff\Output;

use _PhpScoper27e2e7523871\PHPUnit\Framework\TestCase;
use _PhpScoper27e2e7523871\SebastianBergmann\Diff\ConfigurationException;
use _PhpScoper27e2e7523871\SebastianBergmann\Diff\Differ;
use _PhpScoper27e2e7523871\SebastianBergmann\Diff\Utils\UnifiedDiffAssertTrait;
/**
 * @covers SebastianBergmann\Diff\Output\StrictUnifiedDiffOutputBuilder
 *
 * @uses SebastianBergmann\Diff\Differ
 */
final class StrictUnifiedDiffOutputBuilderTest extends \_PhpScoper27e2e7523871\PHPUnit\Framework\TestCase
{
    ...
    {
        return \_PhpScoper27e2e7523871\SebastianBergmann\Diff\Output\StrictUnifiedDiffOutputBuilderDataProvider::provideOutputBuildingCases();
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \_PhpScoper27e2e7523871\SebastianBergmann\Diff\Output\StrictUnifiedDiffOutputBuilderDataProvider::provideSample();
    }
    /**
     * @param string $expected
     * @param string $from
    ...
    {
        return \_PhpScoper27e2e7523871\SebastianBergmann\Diff\Output\StrictUnifiedDiffOutputBuilderDataProvider::provideBasicDiffGeneration();
    }
    /**
     * @param string $expected
     * @param string $from
...
', $diff);
    ...
    {
        $builder = new \_PhpScoper27e2e7523871\SebastianBergmann\Diff\Output\StrictUnifiedDiffOutputBuilder(['fromFile' => 'input.txt', 'toFile' => 'output.txt']);
    ...
    {
        $this->expectException(\_PhpScoper27e2e7523871\SebastianBergmann\Diff\ConfigurationException::class);
        $this->expectExceptionMessageRegExp(\sprintf('#^%s$#', \preg_quote($message, '#')));
        new \_PhpScoper27e2e7523871\SebastianBergmann\Diff\Output\StrictUnifiedDiffOutputBuilder($options);
    }
...
', "A\nX\nV\nY\n1\nA\n2\nA\n3\nA\n4\nA\n8\nA\n9\nA\n5\nA\nA\nA\nA\nA\nA\nA\nA\nA\nA\nA\n", "A\nB\nV\nD\n1\nA\n2\nA\n3\nA\n4\nA\n8\nA\n9\nA\n5\nA\nA\nA\nA\nA\nA\nA\nA\nA\nA\nA\n", 9999, 99999]];
     ...
     * @return Differ
     */
    private function getDiffer(array $options = []) : \_PhpScoper27e2e7523871\SebastianBergmann\Diff\Differ
    {
        return new \_PhpScoper27e2e7523871\SebastianBergmann\Diff\Differ(new \_PhpScoper27e2e7523871\SebastianBergmann\Diff\Output\StrictUnifiedDiffOutputBuilder($options));
    }
}

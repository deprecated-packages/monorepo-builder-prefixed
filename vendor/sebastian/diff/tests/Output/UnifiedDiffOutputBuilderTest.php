 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoper3d7663d13234\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper3d7663d13234\SebastianBergmann\Diff\Differ(new \_PhpScoper3d7663d13234\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoper3d7663d13234\SebastianBergmann\Diff\Differ(new \_PhpScoper3d7663d13234\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoper3d7663d13234\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}

 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScopere6fd569fd43f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScopere6fd569fd43f\SebastianBergmann\Diff\Differ(new \_PhpScopere6fd569fd43f\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScopere6fd569fd43f\SebastianBergmann\Diff\Differ(new \_PhpScopere6fd569fd43f\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScopere6fd569fd43f\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}

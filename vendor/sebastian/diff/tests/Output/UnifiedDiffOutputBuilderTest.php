 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoper2a80719fd449\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper2a80719fd449\SebastianBergmann\Diff\Differ(new \_PhpScoper2a80719fd449\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoper2a80719fd449\SebastianBergmann\Diff\Differ(new \_PhpScoper2a80719fd449\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoper2a80719fd449\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}

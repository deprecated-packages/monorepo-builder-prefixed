 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScopere32570efa19a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScopere32570efa19a\SebastianBergmann\Diff\Differ(new \_PhpScopere32570efa19a\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScopere32570efa19a\SebastianBergmann\Diff\Differ(new \_PhpScopere32570efa19a\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScopere32570efa19a\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}

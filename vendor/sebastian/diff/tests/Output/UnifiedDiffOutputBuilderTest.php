 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoperce084f4275dd\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoperce084f4275dd\SebastianBergmann\Diff\Differ(new \_PhpScoperce084f4275dd\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoperce084f4275dd\SebastianBergmann\Diff\Differ(new \_PhpScoperce084f4275dd\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoperce084f4275dd\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}

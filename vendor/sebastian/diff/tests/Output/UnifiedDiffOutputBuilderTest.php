 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoper1ff8e175c295\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Differ(new \_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Differ(new \_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}

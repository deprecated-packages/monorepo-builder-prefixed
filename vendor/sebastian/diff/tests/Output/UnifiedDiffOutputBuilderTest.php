 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScopera5e5d165d78c\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Differ(new \_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Differ(new \_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}

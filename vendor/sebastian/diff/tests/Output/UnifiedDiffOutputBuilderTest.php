 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoperef4638f5d8b1\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoperef4638f5d8b1\SebastianBergmann\Diff\Differ(new \_PhpScoperef4638f5d8b1\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoperef4638f5d8b1\SebastianBergmann\Diff\Differ(new \_PhpScoperef4638f5d8b1\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoperef4638f5d8b1\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}

 ...
 */
final class UnifiedDiffOutputBuilderTest extends \_PhpScoperb9e77befe692\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoperb9e77befe692\SebastianBergmann\Diff\Differ(new \_PhpScoperb9e77befe692\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder($header));
    ...
    {
        $differ = new \_PhpScoperb9e77befe692\SebastianBergmann\Diff\Differ(new \_PhpScoperb9e77befe692\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder("--- Original\n+++ New\n", \true));
        $this->assertSame($expected, $differ->diff($from, $to));
    }
    public function provideDiffWithLineNumbers() : array
    {
        return \_PhpScoperb9e77befe692\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers();
    }
}

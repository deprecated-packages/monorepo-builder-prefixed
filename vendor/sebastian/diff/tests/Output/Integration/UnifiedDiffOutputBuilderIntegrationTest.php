 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoperd3e9cfbe9d90\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoperd3e9cfbe9d90\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

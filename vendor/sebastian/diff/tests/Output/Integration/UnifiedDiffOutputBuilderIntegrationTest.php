 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoper8a1d608a1a7e\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoper8a1d608a1a7e\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

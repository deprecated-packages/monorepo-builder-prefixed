 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoper93a7e58d9dd1\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoper93a7e58d9dd1\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

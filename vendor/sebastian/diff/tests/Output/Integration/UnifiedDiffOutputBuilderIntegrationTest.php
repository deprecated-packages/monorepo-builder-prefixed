 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoperdfdcb3d4cca0\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoperdfdcb3d4cca0\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

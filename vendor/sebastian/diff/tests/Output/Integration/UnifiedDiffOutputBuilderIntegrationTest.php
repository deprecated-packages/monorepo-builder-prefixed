 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoper3b1a4d12ef28\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoper3b1a4d12ef28\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

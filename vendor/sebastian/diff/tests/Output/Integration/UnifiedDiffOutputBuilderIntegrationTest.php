 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoperf2e2fcfe7ee6\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoperf2e2fcfe7ee6\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

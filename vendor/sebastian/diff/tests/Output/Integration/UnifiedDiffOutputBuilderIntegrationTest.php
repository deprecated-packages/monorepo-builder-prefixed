 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScopere57ee17947a3\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScopere57ee17947a3\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

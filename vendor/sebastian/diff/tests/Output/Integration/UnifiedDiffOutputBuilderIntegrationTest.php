 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScopera28be7b3fe51\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScopera28be7b3fe51\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

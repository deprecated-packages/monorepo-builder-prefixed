 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoperab3ccffcffcd\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoperab3ccffcffcd\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

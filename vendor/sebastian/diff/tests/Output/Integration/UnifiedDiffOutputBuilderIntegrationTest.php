 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoper8d3e33bd2be8\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoper8d3e33bd2be8\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoper31a2d0e8f655\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoper31a2d0e8f655\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

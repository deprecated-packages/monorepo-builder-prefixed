 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoperfdd2db5e123d\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoperfdd2db5e123d\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

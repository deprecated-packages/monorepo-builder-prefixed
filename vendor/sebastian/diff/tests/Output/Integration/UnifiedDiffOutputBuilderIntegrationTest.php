 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoper8068fe8d25a3\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoper8068fe8d25a3\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

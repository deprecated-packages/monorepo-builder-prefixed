 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoperd9ee792cdaf4\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoperd9ee792cdaf4\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

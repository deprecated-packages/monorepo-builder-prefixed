 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoper8a4bdaafa6ec\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoper8a4bdaafa6ec\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

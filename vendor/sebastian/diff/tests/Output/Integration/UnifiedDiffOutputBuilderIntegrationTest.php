 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScopercdfd316eda69\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScopercdfd316eda69\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

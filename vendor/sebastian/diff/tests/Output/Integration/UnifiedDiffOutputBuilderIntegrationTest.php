 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScopera31d0d6ff47a\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScopera31d0d6ff47a\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

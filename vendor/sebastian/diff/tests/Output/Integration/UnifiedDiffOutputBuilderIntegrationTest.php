 ...
 * @requires OS Linux
 */
final class UnifiedDiffOutputBuilderIntegrationTest extends \_PhpScoper77bdbacdc821\PHPUnit\Framework\TestCase
{
    ...
    {
        return \array_filter(\_PhpScoper77bdbacdc821\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilderDataProvider::provideDiffWithLineNumbers(), static function ($key) {

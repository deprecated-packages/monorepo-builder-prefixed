 ...
 */
final class AbstractChunkOutputBuilderTest extends \_PhpScoper931cda798d50\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $output = new class extends \_PhpScoper931cda798d50\SebastianBergmann\Diff\Output\AbstractChunkOutputBuilder
        {
        ...
        $this->assertSame($expected, $output->getChunks((new \_PhpScoper931cda798d50\SebastianBergmann\Diff\Differ())->diffToArray($from, $to), $lineThreshold));
    }

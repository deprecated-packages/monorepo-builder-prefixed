 ...
 */
final class AbstractChunkOutputBuilderTest extends \_PhpScopercdfd316eda69\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $output = new class extends \_PhpScopercdfd316eda69\SebastianBergmann\Diff\Output\AbstractChunkOutputBuilder
        {
        ...
        $this->assertSame($expected, $output->getChunks((new \_PhpScopercdfd316eda69\SebastianBergmann\Diff\Differ())->diffToArray($from, $to), $lineThreshold));
    }

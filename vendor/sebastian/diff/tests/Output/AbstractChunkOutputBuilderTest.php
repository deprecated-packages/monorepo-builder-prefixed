 ...
 */
final class AbstractChunkOutputBuilderTest extends \_PhpScoper650fbdd90fa0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $output = new class extends \_PhpScoper650fbdd90fa0\SebastianBergmann\Diff\Output\AbstractChunkOutputBuilder
        {
        ...
        $this->assertSame($expected, $output->getChunks((new \_PhpScoper650fbdd90fa0\SebastianBergmann\Diff\Differ())->diffToArray($from, $to), $lineThreshold));
    }

 ...
 */
final class AbstractChunkOutputBuilderTest extends \_PhpScoper3a64dbb4e14f\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $output = new class extends \_PhpScoper3a64dbb4e14f\SebastianBergmann\Diff\Output\AbstractChunkOutputBuilder
        {
        ...
        $this->assertSame($expected, $output->getChunks((new \_PhpScoper3a64dbb4e14f\SebastianBergmann\Diff\Differ())->diffToArray($from, $to), $lineThreshold));
    }

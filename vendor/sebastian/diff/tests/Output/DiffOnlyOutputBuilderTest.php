 ...
 */
final class DiffOnlyOutputBuilderTest extends \_PhpScoper650fbdd90fa0\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $differ = new \_PhpScoper650fbdd90fa0\SebastianBergmann\Diff\Differ(new \_PhpScoper650fbdd90fa0\SebastianBergmann\Diff\Output\DiffOnlyOutputBuilder($header));

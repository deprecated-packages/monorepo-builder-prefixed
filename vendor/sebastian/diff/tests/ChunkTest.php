 ...
 */
final class ChunkTest extends \_PhpScoper7371f586a1d2\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper7371f586a1d2\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper7371f586a1d2\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper7371f586a1d2\SebastianBergmann\Diff\Line(\_PhpScoper7371f586a1d2\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper7371f586a1d2\SebastianBergmann\Diff\Line(\_PhpScoper7371f586a1d2\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

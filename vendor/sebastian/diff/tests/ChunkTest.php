 ...
 */
final class ChunkTest extends \_PhpScoper8e7700b08cb9\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper8e7700b08cb9\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper8e7700b08cb9\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper8e7700b08cb9\SebastianBergmann\Diff\Line(\_PhpScoper8e7700b08cb9\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper8e7700b08cb9\SebastianBergmann\Diff\Line(\_PhpScoper8e7700b08cb9\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

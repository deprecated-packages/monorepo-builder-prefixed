 ...
 */
final class ChunkTest extends \_PhpScoper31a2d0e8f655\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper31a2d0e8f655\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper31a2d0e8f655\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper31a2d0e8f655\SebastianBergmann\Diff\Line(\_PhpScoper31a2d0e8f655\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper31a2d0e8f655\SebastianBergmann\Diff\Line(\_PhpScoper31a2d0e8f655\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

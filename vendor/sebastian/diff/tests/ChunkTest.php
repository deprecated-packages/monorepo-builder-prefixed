 ...
 */
final class ChunkTest extends \_PhpScoper3a64dbb4e14f\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper3a64dbb4e14f\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper3a64dbb4e14f\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper3a64dbb4e14f\SebastianBergmann\Diff\Line(\_PhpScoper3a64dbb4e14f\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper3a64dbb4e14f\SebastianBergmann\Diff\Line(\_PhpScoper3a64dbb4e14f\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoper1ff8e175c295\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Line(\_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Line(\_PhpScoper1ff8e175c295\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

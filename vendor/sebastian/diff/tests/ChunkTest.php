 ...
 */
final class ChunkTest extends \_PhpScoperdfa889d8967a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperdfa889d8967a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperdfa889d8967a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperdfa889d8967a\SebastianBergmann\Diff\Line(\_PhpScoperdfa889d8967a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperdfa889d8967a\SebastianBergmann\Diff\Line(\_PhpScoperdfa889d8967a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

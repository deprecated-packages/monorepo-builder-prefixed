 ...
 */
final class ChunkTest extends \_PhpScopere57ee17947a3\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopere57ee17947a3\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopere57ee17947a3\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopere57ee17947a3\SebastianBergmann\Diff\Line(\_PhpScopere57ee17947a3\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopere57ee17947a3\SebastianBergmann\Diff\Line(\_PhpScopere57ee17947a3\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

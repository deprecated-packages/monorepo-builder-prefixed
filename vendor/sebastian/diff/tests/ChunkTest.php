 ...
 */
final class ChunkTest extends \_PhpScoper3bda9af7e0fd\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper3bda9af7e0fd\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper3bda9af7e0fd\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper3bda9af7e0fd\SebastianBergmann\Diff\Line(\_PhpScoper3bda9af7e0fd\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper3bda9af7e0fd\SebastianBergmann\Diff\Line(\_PhpScoper3bda9af7e0fd\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

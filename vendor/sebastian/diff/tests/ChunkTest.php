 ...
 */
final class ChunkTest extends \_PhpScopera763b4be90d0\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera763b4be90d0\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera763b4be90d0\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera763b4be90d0\SebastianBergmann\Diff\Line(\_PhpScopera763b4be90d0\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera763b4be90d0\SebastianBergmann\Diff\Line(\_PhpScopera763b4be90d0\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

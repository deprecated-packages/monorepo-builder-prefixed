 ...
 */
final class ChunkTest extends \_PhpScoperf78d2b40800e\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperf78d2b40800e\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperf78d2b40800e\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperf78d2b40800e\SebastianBergmann\Diff\Line(\_PhpScoperf78d2b40800e\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperf78d2b40800e\SebastianBergmann\Diff\Line(\_PhpScoperf78d2b40800e\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

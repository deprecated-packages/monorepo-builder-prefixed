 ...
 */
final class ChunkTest extends \_PhpScoper7606a7c2799b\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper7606a7c2799b\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper7606a7c2799b\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper7606a7c2799b\SebastianBergmann\Diff\Line(\_PhpScoper7606a7c2799b\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper7606a7c2799b\SebastianBergmann\Diff\Line(\_PhpScoper7606a7c2799b\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

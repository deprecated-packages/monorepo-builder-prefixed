 ...
 */
final class ChunkTest extends \_PhpScoper34ecf47f3155\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper34ecf47f3155\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper34ecf47f3155\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper34ecf47f3155\SebastianBergmann\Diff\Line(\_PhpScoper34ecf47f3155\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper34ecf47f3155\SebastianBergmann\Diff\Line(\_PhpScoper34ecf47f3155\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

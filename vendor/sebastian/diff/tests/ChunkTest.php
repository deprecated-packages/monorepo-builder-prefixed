 ...
 */
final class ChunkTest extends \_PhpScoper8d3e33bd2be8\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper8d3e33bd2be8\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper8d3e33bd2be8\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper8d3e33bd2be8\SebastianBergmann\Diff\Line(\_PhpScoper8d3e33bd2be8\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper8d3e33bd2be8\SebastianBergmann\Diff\Line(\_PhpScoper8d3e33bd2be8\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoper9e0a2007d758\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper9e0a2007d758\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper9e0a2007d758\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper9e0a2007d758\SebastianBergmann\Diff\Line(\_PhpScoper9e0a2007d758\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper9e0a2007d758\SebastianBergmann\Diff\Line(\_PhpScoper9e0a2007d758\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoper3b1a4d12ef28\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper3b1a4d12ef28\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper3b1a4d12ef28\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper3b1a4d12ef28\SebastianBergmann\Diff\Line(\_PhpScoper3b1a4d12ef28\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper3b1a4d12ef28\SebastianBergmann\Diff\Line(\_PhpScoper3b1a4d12ef28\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

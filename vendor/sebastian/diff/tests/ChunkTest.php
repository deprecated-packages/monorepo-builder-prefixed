 ...
 */
final class ChunkTest extends \_PhpScoperf9ff1c3447b1\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperf9ff1c3447b1\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperf9ff1c3447b1\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperf9ff1c3447b1\SebastianBergmann\Diff\Line(\_PhpScoperf9ff1c3447b1\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperf9ff1c3447b1\SebastianBergmann\Diff\Line(\_PhpScoperf9ff1c3447b1\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoperce084f4275dd\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperce084f4275dd\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperce084f4275dd\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperce084f4275dd\SebastianBergmann\Diff\Line(\_PhpScoperce084f4275dd\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperce084f4275dd\SebastianBergmann\Diff\Line(\_PhpScoperce084f4275dd\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoperedfa898a454f\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperedfa898a454f\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperedfa898a454f\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperedfa898a454f\SebastianBergmann\Diff\Line(\_PhpScoperedfa898a454f\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperedfa898a454f\SebastianBergmann\Diff\Line(\_PhpScoperedfa898a454f\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

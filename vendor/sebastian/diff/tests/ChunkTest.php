 ...
 */
final class ChunkTest extends \_PhpScoper244a857c31f6\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper244a857c31f6\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper244a857c31f6\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper244a857c31f6\SebastianBergmann\Diff\Line(\_PhpScoper244a857c31f6\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper244a857c31f6\SebastianBergmann\Diff\Line(\_PhpScoper244a857c31f6\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

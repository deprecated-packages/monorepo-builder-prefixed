 ...
 */
final class ChunkTest extends \_PhpScoper4a734d287afc\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper4a734d287afc\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper4a734d287afc\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper4a734d287afc\SebastianBergmann\Diff\Line(\_PhpScoper4a734d287afc\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper4a734d287afc\SebastianBergmann\Diff\Line(\_PhpScoper4a734d287afc\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

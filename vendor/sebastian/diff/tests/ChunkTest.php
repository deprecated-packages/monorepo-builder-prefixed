 ...
 */
final class ChunkTest extends \_PhpScoper323d4c178bee\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper323d4c178bee\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper323d4c178bee\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper323d4c178bee\SebastianBergmann\Diff\Line(\_PhpScoper323d4c178bee\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper323d4c178bee\SebastianBergmann\Diff\Line(\_PhpScoper323d4c178bee\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

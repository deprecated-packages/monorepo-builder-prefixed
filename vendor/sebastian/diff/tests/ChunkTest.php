 ...
 */
final class ChunkTest extends \_PhpScoper84d68f9a1b63\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper84d68f9a1b63\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper84d68f9a1b63\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper84d68f9a1b63\SebastianBergmann\Diff\Line(\_PhpScoper84d68f9a1b63\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper84d68f9a1b63\SebastianBergmann\Diff\Line(\_PhpScoper84d68f9a1b63\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoper711ac919263f\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper711ac919263f\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper711ac919263f\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper711ac919263f\SebastianBergmann\Diff\Line(\_PhpScoper711ac919263f\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper711ac919263f\SebastianBergmann\Diff\Line(\_PhpScoper711ac919263f\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

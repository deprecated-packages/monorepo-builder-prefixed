 ...
 */
final class ChunkTest extends \_PhpScoper1600de59048a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper1600de59048a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper1600de59048a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper1600de59048a\SebastianBergmann\Diff\Line(\_PhpScoper1600de59048a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper1600de59048a\SebastianBergmann\Diff\Line(\_PhpScoper1600de59048a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

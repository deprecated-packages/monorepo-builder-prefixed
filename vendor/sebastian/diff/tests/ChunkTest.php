 ...
 */
final class ChunkTest extends \_PhpScoper30f4a2553084\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper30f4a2553084\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper30f4a2553084\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper30f4a2553084\SebastianBergmann\Diff\Line(\_PhpScoper30f4a2553084\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper30f4a2553084\SebastianBergmann\Diff\Line(\_PhpScoper30f4a2553084\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

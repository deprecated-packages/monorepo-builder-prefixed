 ...
 */
final class ChunkTest extends \_PhpScoperf1163522a13e\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperf1163522a13e\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperf1163522a13e\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperf1163522a13e\SebastianBergmann\Diff\Line(\_PhpScoperf1163522a13e\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperf1163522a13e\SebastianBergmann\Diff\Line(\_PhpScoperf1163522a13e\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoper9aac61c94bdb\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper9aac61c94bdb\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper9aac61c94bdb\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper9aac61c94bdb\SebastianBergmann\Diff\Line(\_PhpScoper9aac61c94bdb\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper9aac61c94bdb\SebastianBergmann\Diff\Line(\_PhpScoper9aac61c94bdb\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoperd2185c67a4b4\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperd2185c67a4b4\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperd2185c67a4b4\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperd2185c67a4b4\SebastianBergmann\Diff\Line(\_PhpScoperd2185c67a4b4\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperd2185c67a4b4\SebastianBergmann\Diff\Line(\_PhpScoperd2185c67a4b4\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

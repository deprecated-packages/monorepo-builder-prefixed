 ...
 */
final class ChunkTest extends \_PhpScoper860bc98a0f96\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper860bc98a0f96\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper860bc98a0f96\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper860bc98a0f96\SebastianBergmann\Diff\Line(\_PhpScoper860bc98a0f96\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper860bc98a0f96\SebastianBergmann\Diff\Line(\_PhpScoper860bc98a0f96\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

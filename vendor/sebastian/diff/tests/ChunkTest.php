 ...
 */
final class ChunkTest extends \_PhpScoperec2b815193b4\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperec2b815193b4\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperec2b815193b4\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperec2b815193b4\SebastianBergmann\Diff\Line(\_PhpScoperec2b815193b4\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperec2b815193b4\SebastianBergmann\Diff\Line(\_PhpScoperec2b815193b4\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

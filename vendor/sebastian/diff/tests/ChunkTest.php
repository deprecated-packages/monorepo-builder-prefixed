 ...
 */
final class ChunkTest extends \_PhpScoper650fbdd90fa0\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper650fbdd90fa0\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper650fbdd90fa0\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper650fbdd90fa0\SebastianBergmann\Diff\Line(\_PhpScoper650fbdd90fa0\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper650fbdd90fa0\SebastianBergmann\Diff\Line(\_PhpScoper650fbdd90fa0\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

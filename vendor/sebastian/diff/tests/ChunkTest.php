 ...
 */
final class ChunkTest extends \_PhpScoper22d98a58be40\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper22d98a58be40\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper22d98a58be40\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper22d98a58be40\SebastianBergmann\Diff\Line(\_PhpScoper22d98a58be40\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper22d98a58be40\SebastianBergmann\Diff\Line(\_PhpScoper22d98a58be40\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

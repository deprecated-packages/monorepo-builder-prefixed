 ...
 */
final class ChunkTest extends \_PhpScoper9dd242015966\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper9dd242015966\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper9dd242015966\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper9dd242015966\SebastianBergmann\Diff\Line(\_PhpScoper9dd242015966\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper9dd242015966\SebastianBergmann\Diff\Line(\_PhpScoper9dd242015966\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

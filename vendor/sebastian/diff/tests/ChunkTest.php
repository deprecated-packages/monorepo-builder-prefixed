 ...
 */
final class ChunkTest extends \_PhpScoper8f797d20934a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper8f797d20934a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper8f797d20934a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper8f797d20934a\SebastianBergmann\Diff\Line(\_PhpScoper8f797d20934a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper8f797d20934a\SebastianBergmann\Diff\Line(\_PhpScoper8f797d20934a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

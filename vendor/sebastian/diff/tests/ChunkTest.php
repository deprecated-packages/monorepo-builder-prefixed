 ...
 */
final class ChunkTest extends \_PhpScoper722a1d9fee2c\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper722a1d9fee2c\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper722a1d9fee2c\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper722a1d9fee2c\SebastianBergmann\Diff\Line(\_PhpScoper722a1d9fee2c\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper722a1d9fee2c\SebastianBergmann\Diff\Line(\_PhpScoper722a1d9fee2c\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

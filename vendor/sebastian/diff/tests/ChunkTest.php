 ...
 */
final class ChunkTest extends \_PhpScoper9175a5176ce9\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper9175a5176ce9\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper9175a5176ce9\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper9175a5176ce9\SebastianBergmann\Diff\Line(\_PhpScoper9175a5176ce9\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper9175a5176ce9\SebastianBergmann\Diff\Line(\_PhpScoper9175a5176ce9\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

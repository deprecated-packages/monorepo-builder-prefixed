 ...
 */
final class ChunkTest extends \_PhpScopera5e5d165d78c\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Line(\_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Line(\_PhpScopera5e5d165d78c\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

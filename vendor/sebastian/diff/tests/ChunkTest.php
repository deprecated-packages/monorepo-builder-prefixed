 ...
 */
final class ChunkTest extends \_PhpScoper5818bcaf1010\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper5818bcaf1010\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper5818bcaf1010\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper5818bcaf1010\SebastianBergmann\Diff\Line(\_PhpScoper5818bcaf1010\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper5818bcaf1010\SebastianBergmann\Diff\Line(\_PhpScoper5818bcaf1010\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

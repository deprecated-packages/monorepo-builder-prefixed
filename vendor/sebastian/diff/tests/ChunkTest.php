 ...
 */
final class ChunkTest extends \_PhpScoper46d05083fbc3\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper46d05083fbc3\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper46d05083fbc3\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper46d05083fbc3\SebastianBergmann\Diff\Line(\_PhpScoper46d05083fbc3\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper46d05083fbc3\SebastianBergmann\Diff\Line(\_PhpScoper46d05083fbc3\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoper8a1d608a1a7e\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper8a1d608a1a7e\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper8a1d608a1a7e\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper8a1d608a1a7e\SebastianBergmann\Diff\Line(\_PhpScoper8a1d608a1a7e\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper8a1d608a1a7e\SebastianBergmann\Diff\Line(\_PhpScoper8a1d608a1a7e\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

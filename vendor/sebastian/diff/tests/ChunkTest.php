 ...
 */
final class ChunkTest extends \_PhpScoper120e1a259c7c\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper120e1a259c7c\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper120e1a259c7c\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper120e1a259c7c\SebastianBergmann\Diff\Line(\_PhpScoper120e1a259c7c\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper120e1a259c7c\SebastianBergmann\Diff\Line(\_PhpScoper120e1a259c7c\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

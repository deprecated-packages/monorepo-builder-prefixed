 ...
 */
final class ChunkTest extends \_PhpScopercd844fca8af3\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopercd844fca8af3\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopercd844fca8af3\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopercd844fca8af3\SebastianBergmann\Diff\Line(\_PhpScopercd844fca8af3\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopercd844fca8af3\SebastianBergmann\Diff\Line(\_PhpScopercd844fca8af3\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

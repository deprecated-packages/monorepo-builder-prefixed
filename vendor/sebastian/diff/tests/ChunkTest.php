 ...
 */
final class ChunkTest extends \_PhpScopera2f1d1d42b88\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera2f1d1d42b88\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera2f1d1d42b88\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera2f1d1d42b88\SebastianBergmann\Diff\Line(\_PhpScopera2f1d1d42b88\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera2f1d1d42b88\SebastianBergmann\Diff\Line(\_PhpScopera2f1d1d42b88\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

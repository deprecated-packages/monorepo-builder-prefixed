 ...
 */
final class ChunkTest extends \_PhpScoper47e141fb470a\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper47e141fb470a\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper47e141fb470a\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper47e141fb470a\SebastianBergmann\Diff\Line(\_PhpScoper47e141fb470a\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper47e141fb470a\SebastianBergmann\Diff\Line(\_PhpScoper47e141fb470a\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

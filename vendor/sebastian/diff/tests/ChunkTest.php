 ...
 */
final class ChunkTest extends \_PhpScoper600b802aef08\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper600b802aef08\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper600b802aef08\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper600b802aef08\SebastianBergmann\Diff\Line(\_PhpScoper600b802aef08\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper600b802aef08\SebastianBergmann\Diff\Line(\_PhpScoper600b802aef08\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoperda849baa4a45\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperda849baa4a45\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperda849baa4a45\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperda849baa4a45\SebastianBergmann\Diff\Line(\_PhpScoperda849baa4a45\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperda849baa4a45\SebastianBergmann\Diff\Line(\_PhpScoperda849baa4a45\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoperf8eaec7affbd\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperf8eaec7affbd\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperf8eaec7affbd\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperf8eaec7affbd\SebastianBergmann\Diff\Line(\_PhpScoperf8eaec7affbd\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperf8eaec7affbd\SebastianBergmann\Diff\Line(\_PhpScoperf8eaec7affbd\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

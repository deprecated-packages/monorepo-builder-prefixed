 ...
 */
final class ChunkTest extends \_PhpScoper87c95ce1b4e5\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper87c95ce1b4e5\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper87c95ce1b4e5\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper87c95ce1b4e5\SebastianBergmann\Diff\Line(\_PhpScoper87c95ce1b4e5\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper87c95ce1b4e5\SebastianBergmann\Diff\Line(\_PhpScoper87c95ce1b4e5\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

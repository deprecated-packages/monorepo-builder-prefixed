 ...
 */
final class ChunkTest extends \_PhpScoperf968abd60cb0\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperf968abd60cb0\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperf968abd60cb0\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperf968abd60cb0\SebastianBergmann\Diff\Line(\_PhpScoperf968abd60cb0\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperf968abd60cb0\SebastianBergmann\Diff\Line(\_PhpScoperf968abd60cb0\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

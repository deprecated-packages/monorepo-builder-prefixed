 ...
 */
final class ChunkTest extends \_PhpScoper88e2bb777a57\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper88e2bb777a57\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper88e2bb777a57\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper88e2bb777a57\SebastianBergmann\Diff\Line(\_PhpScoper88e2bb777a57\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper88e2bb777a57\SebastianBergmann\Diff\Line(\_PhpScoper88e2bb777a57\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

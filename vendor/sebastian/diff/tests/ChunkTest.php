 ...
 */
final class ChunkTest extends \_PhpScoper47d898182bf9\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper47d898182bf9\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper47d898182bf9\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper47d898182bf9\SebastianBergmann\Diff\Line(\_PhpScoper47d898182bf9\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper47d898182bf9\SebastianBergmann\Diff\Line(\_PhpScoper47d898182bf9\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

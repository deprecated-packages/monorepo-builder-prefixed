 ...
 */
final class ChunkTest extends \_PhpScopera42d72b2de70\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera42d72b2de70\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera42d72b2de70\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera42d72b2de70\SebastianBergmann\Diff\Line(\_PhpScopera42d72b2de70\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera42d72b2de70\SebastianBergmann\Diff\Line(\_PhpScopera42d72b2de70\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class ChunkTest extends \_PhpScoperf2e2fcfe7ee6\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperf2e2fcfe7ee6\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperf2e2fcfe7ee6\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperf2e2fcfe7ee6\SebastianBergmann\Diff\Line(\_PhpScoperf2e2fcfe7ee6\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperf2e2fcfe7ee6\SebastianBergmann\Diff\Line(\_PhpScoperf2e2fcfe7ee6\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

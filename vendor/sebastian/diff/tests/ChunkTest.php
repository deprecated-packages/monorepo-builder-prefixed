 ...
 */
final class ChunkTest extends \_PhpScopere97aad8070b4\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopere97aad8070b4\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopere97aad8070b4\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopere97aad8070b4\SebastianBergmann\Diff\Line(\_PhpScopere97aad8070b4\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopere97aad8070b4\SebastianBergmann\Diff\Line(\_PhpScopere97aad8070b4\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

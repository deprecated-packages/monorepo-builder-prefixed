 ...
 */
final class ChunkTest extends \_PhpScoperf4997c409394\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoperf4997c409394\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoperf4997c409394\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoperf4997c409394\SebastianBergmann\Diff\Line(\_PhpScoperf4997c409394\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoperf4997c409394\SebastianBergmann\Diff\Line(\_PhpScoperf4997c409394\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

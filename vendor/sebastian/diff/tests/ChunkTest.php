 ...
 */
final class ChunkTest extends \_PhpScopera2ff5fd2b59c\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScopera2ff5fd2b59c\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScopera2ff5fd2b59c\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScopera2ff5fd2b59c\SebastianBergmann\Diff\Line(\_PhpScopera2ff5fd2b59c\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScopera2ff5fd2b59c\SebastianBergmann\Diff\Line(\_PhpScopera2ff5fd2b59c\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

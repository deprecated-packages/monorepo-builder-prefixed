 ...
 */
final class ChunkTest extends \_PhpScoper058a557299a1\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \_PhpScoper058a557299a1\SebastianBergmann\Diff\Chunk();
    }
    ...
    {
        $this->assertInstanceOf(\_PhpScoper058a557299a1\SebastianBergmann\Diff\Chunk::class, $this->chunk);
    }
    ...
    {
        $lines = [new \_PhpScoper058a557299a1\SebastianBergmann\Diff\Line(\_PhpScoper058a557299a1\SebastianBergmann\Diff\Line::ADDED, 'added'), new \_PhpScoper058a557299a1\SebastianBergmann\Diff\Line(\_PhpScoper058a557299a1\SebastianBergmann\Diff\Line::REMOVED, 'removed')];

 ...
 */
final class UnifiedDiffAssertTraitTest extends \_PhpScoper79999b045682\PHPUnit\Framework\TestCase
{
...
'], 'empty diff. is valid' => ['']];
    ...
    public function testInvalidStartHeader3() : void
    {
        ...
        $this->assertValidUnifiedDiffFormat("--- Original\t[invalid date]\n+++ New\n@@ -1,2 +1,2 @@\n-A\n+B\n " . '
');
    }
    public function testInvalidStartHeader4() : void
    {
        ...
        $this->assertValidUnifiedDiffFormat('--- Original
+++INVALID
@@ -1,2 +1,2 @@
-A
+B
...
');
    ...
    public function testMisplacedComment() : void
    {
        ...
        $this->assertValidUnifiedDiffFormat('\\ No newline at end of file
');
    }

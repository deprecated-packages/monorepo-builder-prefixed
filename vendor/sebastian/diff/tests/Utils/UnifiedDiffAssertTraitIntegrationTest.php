 ...
 */
namespace _PhpScoperb25e75e9febe\SebastianBergmann\Diff\Utils;
 ...
 * @coversNothing
 */
final class UnifiedDiffAssertTraitIntegrationTest extends \_PhpScoperb25e75e9febe\PHPUnit\Framework\TestCase
{
    ...
    public function testValidPatches(string $fileFrom, string $fileTo) : void
    {
        ...
        $this->assertValidUnifiedDiffFormat(\_PhpScoperb25e75e9febe\SebastianBergmann\Diff\Utils\FileUtils::getFileContent($this->filePatch));
    }
    /**

 ...
 */
namespace _PhpScoper9dd242015966\SebastianBergmann\Diff\Utils;
 ...
 * @coversNothing
 */
final class UnifiedDiffAssertTraitIntegrationTest extends \_PhpScoper9dd242015966\PHPUnit\Framework\TestCase
{
    ...
    public function testValidPatches(string $fileFrom, string $fileTo) : void
    {
        ...
        $this->assertValidUnifiedDiffFormat(\_PhpScoper9dd242015966\SebastianBergmann\Diff\Utils\FileUtils::getFileContent($this->filePatch));
    }
    /**

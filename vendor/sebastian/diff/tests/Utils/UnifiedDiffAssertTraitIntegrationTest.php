 ...
 */
namespace _PhpScoper0d4928f7af97\SebastianBergmann\Diff\Utils;
 ...
 * @coversNothing
 */
final class UnifiedDiffAssertTraitIntegrationTest extends \_PhpScoper0d4928f7af97\PHPUnit\Framework\TestCase
{
    ...
    public function testValidPatches(string $fileFrom, string $fileTo) : void
    {
        ...
        $this->assertValidUnifiedDiffFormat(\_PhpScoper0d4928f7af97\SebastianBergmann\Diff\Utils\FileUtils::getFileContent($this->filePatch));
    }
    /**

 ...
 */
namespace _PhpScoper9175a5176ce9\SebastianBergmann\Diff\Utils;
 ...
 * @coversNothing
 */
final class UnifiedDiffAssertTraitIntegrationTest extends \_PhpScoper9175a5176ce9\PHPUnit\Framework\TestCase
{
    ...
    public function testValidPatches(string $fileFrom, string $fileTo) : void
    {
        ...
        $this->assertValidUnifiedDiffFormat(\_PhpScoper9175a5176ce9\SebastianBergmann\Diff\Utils\FileUtils::getFileContent($this->filePatch));
    }
    /**

 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoper9e0a2007d758\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoper9e0a2007d758\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

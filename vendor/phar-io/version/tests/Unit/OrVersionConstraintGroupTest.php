 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoper1ff8e175c295\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoper1ff8e175c295\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

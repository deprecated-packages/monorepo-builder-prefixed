 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScopera2bd9a9af620\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScopera2bd9a9af620\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

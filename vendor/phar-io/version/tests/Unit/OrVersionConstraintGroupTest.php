 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScopere97aad8070b4\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScopere97aad8070b4\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

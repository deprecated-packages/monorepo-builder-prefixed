 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScopere846b54512fc\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScopere846b54512fc\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoper61d2aa534566\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoper61d2aa534566\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

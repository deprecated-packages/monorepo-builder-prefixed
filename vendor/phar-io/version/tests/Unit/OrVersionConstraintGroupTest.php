 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoper323d4c178bee\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoper323d4c178bee\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScopera2c403aec9a8\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScopera2c403aec9a8\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

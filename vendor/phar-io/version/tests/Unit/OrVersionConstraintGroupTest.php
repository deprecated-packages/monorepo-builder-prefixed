 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScopercd844fca8af3\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScopercd844fca8af3\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoper3d7663d13234\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoper3d7663d13234\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoper8e7700b08cb9\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoper8e7700b08cb9\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

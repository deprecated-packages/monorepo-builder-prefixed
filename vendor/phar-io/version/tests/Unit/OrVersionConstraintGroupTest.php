 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoper9aac61c94bdb\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoper9aac61c94bdb\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

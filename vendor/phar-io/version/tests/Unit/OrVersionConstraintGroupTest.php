 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoper905a278e297d\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoper905a278e297d\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

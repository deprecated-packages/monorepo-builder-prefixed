 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScopera2ff5fd2b59c\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScopera2ff5fd2b59c\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

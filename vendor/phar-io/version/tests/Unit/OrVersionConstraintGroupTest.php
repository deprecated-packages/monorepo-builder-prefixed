 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoper7606a7c2799b\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoper7606a7c2799b\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

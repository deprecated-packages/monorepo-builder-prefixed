 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoper1d5917c620d0\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoper1d5917c620d0\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

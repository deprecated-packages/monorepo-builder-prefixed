 ...
 */
class OrVersionConstraintGroupTest extends \_PhpScoperedfa898a454f\PHPUnit\Framework\TestCase
{
    public function testReturnsTrueIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoperedfa898a454f\PharIo\Version\OrVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

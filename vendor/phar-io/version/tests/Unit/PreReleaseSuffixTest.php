 ...
 */
class PreReleaseSuffixTest extends \_PhpScopera2bd9a9af620\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $leftSuffix = new \_PhpScopera2bd9a9af620\PharIo\Version\PreReleaseSuffix($leftSuffixValue);
        $rightSuffix = new \_PhpScopera2bd9a9af620\PharIo\Version\PreReleaseSuffix($rightSuffixValue);

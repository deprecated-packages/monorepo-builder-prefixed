 ...
 */
class PreReleaseSuffixTest extends \_PhpScoperd2185c67a4b4\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $leftSuffix = new \_PhpScoperd2185c67a4b4\PharIo\Version\PreReleaseSuffix($leftSuffixValue);
        $rightSuffix = new \_PhpScoperd2185c67a4b4\PharIo\Version\PreReleaseSuffix($rightSuffixValue);

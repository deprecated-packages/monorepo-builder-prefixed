 ...
 */
class PreReleaseSuffixTest extends \_PhpScopercdc90a6628b6\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $leftSuffix = new \_PhpScopercdc90a6628b6\PharIo\Version\PreReleaseSuffix($leftSuffixValue);
        $rightSuffix = new \_PhpScopercdc90a6628b6\PharIo\Version\PreReleaseSuffix($rightSuffixValue);

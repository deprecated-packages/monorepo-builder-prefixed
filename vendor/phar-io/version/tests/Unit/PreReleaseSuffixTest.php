 ...
 */
class PreReleaseSuffixTest extends \_PhpScoperf4997c409394\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $leftSuffix = new \_PhpScoperf4997c409394\PharIo\Version\PreReleaseSuffix($leftSuffixValue);
        $rightSuffix = new \_PhpScoperf4997c409394\PharIo\Version\PreReleaseSuffix($rightSuffixValue);

 ...
 */
class PreReleaseSuffixTest extends \_PhpScopera3403994bd90\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $leftSuffix = new \_PhpScopera3403994bd90\PharIo\Version\PreReleaseSuffix($leftSuffixValue);
        $rightSuffix = new \_PhpScopera3403994bd90\PharIo\Version\PreReleaseSuffix($rightSuffixValue);

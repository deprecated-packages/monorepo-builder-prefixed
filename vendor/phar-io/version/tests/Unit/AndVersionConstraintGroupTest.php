 ...
 */
class AndVersionConstraintGroupTest extends \_PhpScopere57ee17947a3\PHPUnit\Framework\TestCase
{
    public function testReturnsFalseIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScopere57ee17947a3\PharIo\Version\AndVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

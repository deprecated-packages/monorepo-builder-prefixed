 ...
 */
class AndVersionConstraintGroupTest extends \_PhpScoperf8eaec7affbd\PHPUnit\Framework\TestCase
{
    public function testReturnsFalseIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoperf8eaec7affbd\PharIo\Version\AndVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

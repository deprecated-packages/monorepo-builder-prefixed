 ...
 */
class AndVersionConstraintGroupTest extends \_PhpScopere73d4c0b7ec8\PHPUnit\Framework\TestCase
{
    public function testReturnsFalseIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScopere73d4c0b7ec8\PharIo\Version\AndVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

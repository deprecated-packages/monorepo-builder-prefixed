 ...
 */
class AndVersionConstraintGroupTest extends \_PhpScoperabb8c88e9df1\PHPUnit\Framework\TestCase
{
    public function testReturnsFalseIfOneConstraintReturnsFalse()
    {
        ...
        $group = new \_PhpScoperabb8c88e9df1\PharIo\Version\AndVersionConstraintGroup('foo', [$firstConstraint, $secondConstraint]);

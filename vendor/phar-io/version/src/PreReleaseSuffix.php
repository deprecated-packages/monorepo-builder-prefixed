...
class PreReleaseSuffix
{
    ...
    public function isGreaterThan(\_PhpScoperfa7966ff486f\PharIo\Version\PreReleaseSuffix $suffix) : bool
    {
    ...
    private function parseValue($value) : void
    {
        ...
        if (\preg_match($regex, $value, $matches) !== 1) {
            throw new \_PhpScoperfa7966ff486f\PharIo\Version\InvalidPreReleaseSuffixException(\sprintf('Invalid label %s', $value));
        }
        $this->full = $matches[1];

...
class PreReleaseSuffix
{
     ...
     * @return bool
     */
    public function isGreaterThan(\_PhpScoper79999b045682\PharIo\Version\PreReleaseSuffix $suffix)
    {
    ...
    private function parseValue($value)
    {
        ...
        if (\preg_match($regex, $value, $matches) !== 1) {
            throw new \_PhpScoper79999b045682\PharIo\Version\InvalidPreReleaseSuffixException(\sprintf('Invalid label %s', $value));
        }

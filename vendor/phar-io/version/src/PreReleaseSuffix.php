...
class PreReleaseSuffix
{
     ...
     * @return bool
     */
    public function isGreaterThan(\_PhpScoper9175a5176ce9\PharIo\Version\PreReleaseSuffix $suffix)
    {
    ...
    private function parseValue($value)
    {
        ...
        if (\preg_match($regex, $value, $matches) !== 1) {
            throw new \_PhpScoper9175a5176ce9\PharIo\Version\InvalidPreReleaseSuffixException(\sprintf('Invalid label %s', $value));
        }

...
class PreReleaseSuffix
{
    ...
    public function isGreaterThan(\_PhpScoperec2b815193b4\PharIo\Version\PreReleaseSuffix $suffix) : bool
    {
    ...
    private function parseValue($value) : void
    {
        ...
        if (\preg_match($regex, $value, $matches) !== 1) {
            throw new \_PhpScoperec2b815193b4\PharIo\Version\InvalidPreReleaseSuffixException(\sprintf('Invalid label %s', $value));
        }
        $this->full = $matches[1];

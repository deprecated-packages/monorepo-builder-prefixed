...
class PreReleaseSuffix
{
     ...
     * @return bool
     */
    public function isGreaterThan(\_PhpScoperee8f03533f8b\PharIo\Version\PreReleaseSuffix $suffix)
    {
    ...
    private function parseValue($value)
    {
        ...
        if (\preg_match($regex, $value, $matches) !== 1) {
            throw new \_PhpScoperee8f03533f8b\PharIo\Version\InvalidPreReleaseSuffixException(\sprintf('Invalid label %s', $value));
        }

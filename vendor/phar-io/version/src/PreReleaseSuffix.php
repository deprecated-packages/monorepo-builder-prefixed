...
{
    private $valueScoreMap = ['dev' => 0, 'a' => 1, 'alpha' => 1, 'b' => 2, 'beta' => 2, 'rc' => 3, 'p' => 4, 'patch' => 4];
    /**
     * @var string
     */
    private $value;
     ...
     * @return bool
     */
    public function isGreaterThan(\_PhpScoper84ee03573073\PharIo\Version\PreReleaseSuffix $suffix)
    {
    ...
    private function parseValue($value)
    {
        ...
        if (\preg_match($regex, $value, $matches) !== 1) {
            throw new \_PhpScoper84ee03573073\PharIo\Version\InvalidPreReleaseSuffixException(\sprintf('Invalid label %s', $value));
        }

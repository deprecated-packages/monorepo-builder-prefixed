...
class PreReleaseSuffix
{
    ...
    public function isGreaterThan(\_PhpScopere10afbb60721\PharIo\Version\PreReleaseSuffix $suffix) : bool
    {
    ...
    private function parseValue($value) : void
    {
        ...
        if (\preg_match($regex, $value, $matches) !== 1) {
            throw new \_PhpScopere10afbb60721\PharIo\Version\InvalidPreReleaseSuffixException(\sprintf('Invalid label %s', $value));
        }
        $this->full = $matches[1];

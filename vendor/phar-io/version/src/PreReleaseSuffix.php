...
class PreReleaseSuffix
{
     ...
     * @return bool
     */
    public function isGreaterThan(\_PhpScoperb2724c6b069f\PharIo\Version\PreReleaseSuffix $suffix)
    {
    ...
    private function parseValue($value)
    {
        ...
        if (\preg_match($regex, $value, $matches) !== 1) {
            throw new \_PhpScoperb2724c6b069f\PharIo\Version\InvalidPreReleaseSuffixException(\sprintf('Invalid label %s', $value));
        }

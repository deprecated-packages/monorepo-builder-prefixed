...
class Version
{
    ...
    public function getPreReleaseSuffix() : \_PhpScoperfa7966ff486f\PharIo\Version\PreReleaseSuffix
    {
    ...
    public function equals(\_PhpScoperfa7966ff486f\PharIo\Version\Version $other) : bool
    {
        return $this->getVersionString() === $other->getVersionString();
    }
    public function isGreaterThan(\_PhpScoperfa7966ff486f\PharIo\Version\Version $version) : bool
    {
    ...
    {
        $this->major = new \_PhpScoperfa7966ff486f\PharIo\Version\VersionNumber((int) $matches['Major']);
        $this->minor = new \_PhpScoperfa7966ff486f\PharIo\Version\VersionNumber((int) $matches['Minor']);
        $this->patch = isset($matches['Patch']) ? new \_PhpScoperfa7966ff486f\PharIo\Version\VersionNumber((int) $matches['Patch']) : new \_PhpScoperfa7966ff486f\PharIo\Version\VersionNumber(0);
        if (isset($matches['PreReleaseSuffix'])) {
            $this->preReleaseSuffix = new \_PhpScoperfa7966ff486f\PharIo\Version\PreReleaseSuffix($matches['PreReleaseSuffix']);
        }
    }
    /**
    ...
    private function ensureVersionStringIsValid($version) : void
    {
        ...
        if (\preg_match($regex, $version, $matches) !== 1) {
            throw new \_PhpScoperfa7966ff486f\PharIo\Version\InvalidVersionException(\sprintf("Version string '%s' does not follow SemVer semantics", $version));
        }

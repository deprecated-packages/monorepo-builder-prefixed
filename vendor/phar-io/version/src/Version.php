...
class Version
{
    ...
    public function getPreReleaseSuffix() : \_PhpScoperd1c9c8ec01a8\PharIo\Version\PreReleaseSuffix
    {
    ...
    public function equals(\_PhpScoperd1c9c8ec01a8\PharIo\Version\Version $other) : bool
    {
        return $this->getVersionString() === $other->getVersionString();
    }
    public function isGreaterThan(\_PhpScoperd1c9c8ec01a8\PharIo\Version\Version $version) : bool
    {
    ...
    {
        $this->major = new \_PhpScoperd1c9c8ec01a8\PharIo\Version\VersionNumber((int) $matches['Major']);
        $this->minor = new \_PhpScoperd1c9c8ec01a8\PharIo\Version\VersionNumber((int) $matches['Minor']);
        $this->patch = isset($matches['Patch']) ? new \_PhpScoperd1c9c8ec01a8\PharIo\Version\VersionNumber((int) $matches['Patch']) : new \_PhpScoperd1c9c8ec01a8\PharIo\Version\VersionNumber(0);
        if (isset($matches['PreReleaseSuffix'])) {
            $this->preReleaseSuffix = new \_PhpScoperd1c9c8ec01a8\PharIo\Version\PreReleaseSuffix($matches['PreReleaseSuffix']);
        }
    }
    /**
    ...
    private function ensureVersionStringIsValid($version) : void
    {
        ...
        if (\preg_match($regex, $version, $matches) !== 1) {
            throw new \_PhpScoperd1c9c8ec01a8\PharIo\Version\InvalidVersionException(\sprintf("Version string '%s' does not follow SemVer semantics", $version));
        }

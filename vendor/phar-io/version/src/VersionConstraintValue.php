...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoperac0a9a33ae94\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoperac0a9a33ae94\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoperac0a9a33ae94\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoperb2257feafd7d\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoperb2257feafd7d\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoperb2257feafd7d\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

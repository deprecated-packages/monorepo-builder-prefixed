...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoperf40000691b7b\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoperf40000691b7b\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoperf40000691b7b\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

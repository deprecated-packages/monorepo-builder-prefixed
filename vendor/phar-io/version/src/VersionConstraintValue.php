...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoper9ce838b06e67\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoper9ce838b06e67\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoper9ce838b06e67\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

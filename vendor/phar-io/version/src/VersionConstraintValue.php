...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoper95e170f0b4ac\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoper95e170f0b4ac\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoper95e170f0b4ac\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

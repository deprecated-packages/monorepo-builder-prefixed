...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString)
    {
        ...
        $this->major = new \_PhpScoper87c95ce1b4e5\PharIo\Version\VersionNumber($versionSegments[0]);
        $minorValue = isset($versionSegments[1]) ? $versionSegments[1] : null;
        $patchValue = isset($versionSegments[2]) ? $versionSegments[2] : null;
        $this->minor = new \_PhpScoper87c95ce1b4e5\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoper87c95ce1b4e5\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

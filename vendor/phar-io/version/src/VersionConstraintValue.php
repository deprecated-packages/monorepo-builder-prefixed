...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoperb2067b9f36f8\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoperb2067b9f36f8\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoperb2067b9f36f8\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoperdab52924cf3e\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoperdab52924cf3e\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoperdab52924cf3e\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

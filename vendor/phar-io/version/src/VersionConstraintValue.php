...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoperbecbc4cd500f\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoperbecbc4cd500f\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoperbecbc4cd500f\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

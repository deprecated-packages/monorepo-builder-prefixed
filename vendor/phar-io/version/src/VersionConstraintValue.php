...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoperaf523e5605cc\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoperaf523e5605cc\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoperaf523e5605cc\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

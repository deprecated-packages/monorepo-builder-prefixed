...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoper7d795aa8de8d\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoper7d795aa8de8d\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoper7d795aa8de8d\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

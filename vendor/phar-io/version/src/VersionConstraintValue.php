...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoperd79f30a2f8be\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoperd79f30a2f8be\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoperd79f30a2f8be\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoperab93339c6bca\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoperab93339c6bca\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoperab93339c6bca\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoper0087e037e0f7\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoper0087e037e0f7\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoper0087e037e0f7\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

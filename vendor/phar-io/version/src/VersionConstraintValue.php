...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoper69b0f14b2eca\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoper69b0f14b2eca\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoper69b0f14b2eca\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

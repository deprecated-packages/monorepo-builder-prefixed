...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScoperee3ad0c2c096\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScoperee3ad0c2c096\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScoperee3ad0c2c096\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */

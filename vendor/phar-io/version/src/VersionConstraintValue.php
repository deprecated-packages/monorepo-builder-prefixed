...
class VersionConstraintValue
{
    ...
    private function parseVersion($versionString) : void
    {
        ...
        $this->major = new \_PhpScopere691b6ebfa72\PharIo\Version\VersionNumber(\is_numeric($versionSegments[0]) ? (int) $versionSegments[0] : null);
        ...
        $this->minor = new \_PhpScopere691b6ebfa72\PharIo\Version\VersionNumber($minorValue);
        $this->patch = new \_PhpScopere691b6ebfa72\PharIo\Version\VersionNumber($patchValue);
    }
    /**
     * @param string $versionString
     */
